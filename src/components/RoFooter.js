...
const overrides = {
	...
	"link4": {
		"kind": "Link",
		"props": {
			"href": "https://ukit.com/ro/agreement",
			"text-decoration-line": "initial",
			"font": "--footer",
			"color": "--grey",
			"hover-color": "--primary",
	...
	"link5": {
		"kind": "Link",
		"props": {
			"href": "https://ukit.com/ro/storage",
			"text-decoration-line": "initial",
			"font": "--footer",
			"color": "--grey",
			"hover-color": "--primary",
	...
	"link6": {
		"kind": "Link",
		"props": {
			"href": "https://ukit.com/ro/privacy",
			"text-decoration-line": "initial",
			"font": "--footer",
			"color": "--grey",
			"hover-color": "--primary",
			...
			"padding": "5px 0px 5px 0px",
			"md-margin": "0px 0px 0px 0px",
			"children": "Confidențialitate"
		}
	},
	"link7": {
		"kind": "Link",
		"props": {
			"href": "https://ukit.com/ro/details",
			"text-decoration-line": "initial",
			"font": "--footer",
			"color": "--grey",
			"hover-color": "--primary",
	...
	"link8": {
		...
		"props": {
			...
			"padding": "5px 0px 5px 0px",
			"md-margin": "0px 0px 0px 0px",
			"children": "Soluții predefinite"
		}
	}
};

const RoFooter = props => {
	const {
		override,
		children,
		rest
...
Object.assign(RoFooter, { ...Section,
	defaultProps,
	overrides
});
