...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/ile-kosztuje-utworzenie-witryny"} />
		<Helmet>
			<title>
				Ile kosztuje utworzenie witryny? — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Stwórz własną stronę internetową z uKit – od 2,5 USD/mies. Nie są wymagane żadna specjalna wiedza ani umiejętności. Wszystko, nad czym musisz pracować, by promować swoją witrynę, jest już na platformie! Dodatkowo otrzymujesz nieograniczony hosting. Potrzebujesz gotowej witryny, ale nie masz czasu na samodzielne jej opracowanie? Możemy to za Ciebie zrobić w cenie już od 100$"} />
			<meta property={"og:title"} content={"Ile kosztuje utworzenie witryny? — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Stwórz własną stronę internetową z uKit – od 2,5 USD/mies. Nie są wymagane żadna specjalna wiedza ani umiejętności. Wszystko, nad czym musisz pracować, by promować swoją witrynę, jest już na platformie! Dodatkowo otrzymujesz nieograniczony hosting. Potrzebujesz gotowej witryny, ale nie masz czasu na samodzielne jej opracowanie? Możemy to za Ciebie zrobić w cenie już od 100$"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Stwórz własną stronę internetową z uKit — od 2,5 USD/mies. Nie są wymagane żadna specjalna wiedza ani umiejętności. Wszystko, nad czym musisz pracować, by promować swoją witrynę, jest już na platformie! Dodatkowo otrzymujesz nieograniczony hosting. Potrzebujesz gotowej witryny, ale nie masz czasu na samodzielne jej opracowanie? Możemy to za Ciebie zrobić w cenie już od 100$
				</Text>
				<Link
					color="--white"
					border-width="1px"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Nieograniczona liczba stron i plików
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Przykłady gotowych szablonów tematycznych
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Wszystkie projekty są nowoczesne, adaptacyjne i całkowicie bezpłatne. Na pewno znajdziesz projekt dla swojej firmy. Możesz także aktywować wersję strony dla osób niedowidzących oraz zmienić schemat kolorów i czcionki. Każdy szablon zawiera sensowną treść i wyskakujące formularze. Połącz swoją domenę, zaktualizuj informacje kontaktowe i opublikuj witrynę
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Edytor przyjazny dla użytkownika. Dowolną stronę można zbudować z gotowych bloków i elementów, przeciągając je i upuszczając. Przystępne ceny subskrypcji dla firm i osób fizycznych
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Wbudowane narzędzia sklepu internetowego i strona z wiadomościami
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Nieograniczony hosting i liczba stron w każdym planie
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gotowe integracje z CRM, czatem na żywo, newsletterem i innymi usługami
					</Text>
				</Box>
				<Box
					align-items="flex-start"
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Jak stworzyć stronę internetową za pomocą uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Wszystkie funkcje uKit są zawarte w Twoim abonamencie: gotowe szablony, kreator SEO, łączenie domeny i analityka. Przy odrobinie czasu i wkładu możesz stworzyć własną stronę internetową. I nie potrzebujesz żadnej specjalnej wiedzy ani umiejętności
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Wszystkie gotowe szablony w naszej bibliotece są całkowicie bezpłatne. Możesz wybrać dowolny z nich i zmienić schemat kolorów, czcionki, tło i inne parametry projektu. Brak dodatkowych płatnych opcji. Wszystko w cenie
					</Text>
					<Link
						display="inline"
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Darmowy, przyjazny dla użytkownika edytor
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Otrzymasz dostęp do wszystkich niezbędnych bloków i widżetów w dowolnym planie: czatów na żywo, suwaków, galerii, liczników odliczania, formularzy opinii, przycisków oddzwaniania, cenników, osi czasu, recenzji i nie tylko. Po prostu przeciągnij i upuść, a następnie dostosuj je. Niektóre plany dają dostęp do edytora kodu HTML (dla profesjonalistów) i widżetów sklepu internetowego (aby uzyskać płatności online)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Wszystkie gotowe szablony i bloki w kreatorze są adaptacyjne. Dzięki temu Twoja witryna będzie wyglądać idealnie na wszystkich urządzeniach. Obrazy są automatycznie dostosowywane do żądanej rozdzielczości — aby zoptymalizować ruch klientów i aby obrazy wczytały się jak najszybciej. Możliwe jest ukrywanie poszczególnych bloków lub dostosowywanie ich wyglądu do wybranych typów urządzeń: telefonów, tabletów i komputerów PC. Lazy loading obrazów i stylów jest aktywowane jednym kliknięciem. Wszystkie te funkcje są już uwzględnione w Twoim planie
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Wszyscy użytkownicy uKit otrzymują bezpłatne konfigurowalne domeny trzeciego poziomu z popularnymi rozszerzeniami. Możesz także ustawić preferowany adres URL dla swojej witryny. Jeśli potrzebujesz domeny drugiego poziomu, możesz zarejestrować ją bezpośrednio w panelu uKit od 8,99 USD/rok (rejestracja i odnowienie). Zawsze możesz podłączyć istniejącą domenę kupioną od dowolnego zewnętrznego rejestratora. Niezależnie od wybranej opcji, certyfikaty SSL są bezpłatne i konfigurowane automatycznie
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Darmowe kopie zapasowe i nieograniczony hosting
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Edytuj i opublikuj swoją witrynę, edytuj ponownie, a następnie opublikuj ponownie. Dodaj tyle stron, ile potrzebujesz. Otrzymujesz nieograniczoną ilość miejsca na dysku i możesz dodać dowolną liczbę plików do swojej witryny, niezależnie od abonamentu, który subskrybujesz. System może utworzyć do 10 kopii zapasowych Twojej witryny. Tworzone są zarówno automatycznie, jak i ręcznie i można je przywrócić jednym kliknięciem. Wszystko to jest domyślnie zawarte w każdym planie uKit
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				<Box
					...
					md-padding="0px 15px 0px 15px"
				>
					<Image src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/6.svg?v=2021-09-28T20:17:25.803Z" margin="0px 0px 24px 0px" width="48px" height="48px" />
					<Text color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px">
						Sklep internetowy — od 6 USD/mies
					</Text>
					<Text
						width="84%"
						lg-width="100%"
						...
						font="--base"
					>
						Akceptuj płatności online, integruj usługi CRM i newslettera, wyznaczaj cele w analityce. Dowolna ilość produktów, pola w formularzach, kody promocyjne, różne sposoby wysyłki
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				<Box
					...
					md-width="100%"
				>
					<Image height="48px" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/7.svg?v=2021-09-28T20:17:31.417Z" margin="0px 0px 24px 0px" width="48px" />
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Kreator SEO
					</Text>
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Niektóre zadania są zautomatyzowane, więc nie zabierają one Twojego czasu. Na przykład specjalny kreator SEO pomoże Ci sprawdzić, czy witryna jest gotowa do promocji. Możesz także połączyć zewnętrzne narzędzia analityczne kilkoma kliknięciami, aby zbierać i analizować informacje o odwiedzających Twoją witrynę
					</Text>
					<Link
						href="https://ukit.com/pl/signUp"
						color="--white"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Nie masz czasu zajmować się wszystkimi tymi krokami? Wystarczy zatrudnić jednego z naszych profesjonalistów z agencji internetowej Divly
				</Text>
				<Link
					color="--white"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Nasza platforma umożliwia tworzenie wszelkiego rodzaju witryn biznesowych w krótkim czasie i bez specjalnych umiejętności: strony docelowe, strony promocyjne, katalogi, portfolio, blogi firmowe, sklepy internetowe, strony internetowe dla nauczycieli, instytucje edukacyjne i inne projekty
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Link href="/lp/pl/hosting-z-kreatorem-stron" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							border-radius="18px"
			...
			>
				<Box
					...
					flex-direction="column"
				>
					<Link text-decoration-line="initial" href="/lp/pl/stworz-strone-internetowa-placowki-edukacyjnej" color="--darkL1" hover-color="--primary">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pl/utworz-portfolio-artysty" color="--darkL1">
						<Image
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/pl/utworz-strone-internetowa-hotelu" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							width="100%"
							display="flex"
							align-items="center"
		...
		>
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Stwórz stronę internetową za pomocą uKit — od 2,5 USD/mies
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Uzyskaj bezpłatny 14-dniowy okres próbny ze wszystkimi funkcjami uKit, w tym ze sklepem internetowym. Nie musisz podawać żadnych danych osobowych. Subskrybuj uKit tylko wtedy, gdy podobają Ci się uzyskiwane wyniki!
				</Text>
				<Link
					display="inline"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/ile-kosztuje-utworzenie-witryny/"} place={"endOfHead"} rawKey={"619e9e36d6eb73a50d0f5c51"} />
		</RawHtml>
	</Theme>;
});