...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/stworz-portfolio-projektanta-wnetrz"} />
		<Helmet>
			<title>
				Stwórz portfolio projektanta wnętrz — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"To nigdy nie było prostsze, po prostu użyj uKit. Nieograniczony hosting, gotowe szablony i przyjazny dla użytkownika edytor. Możesz obsłużyć wszystko bez zatrudniania zewnętrznych specjalistów internetowych."} />
			<meta property={"og:title"} content={"Stwórz portfolio projektanta wnętrz — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"To nigdy nie było prostsze, po prostu użyj uKit. Nieograniczony hosting, gotowe szablony i przyjazny dla użytkownika edytor. Możesz obsłużyć wszystko bez zatrudniania zewnętrznych specjalistów internetowych."} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					To nigdy nie było prostsze, po prostu użyj uKit. Nieograniczony hosting, gotowe szablony i przyjazny dla użytkownika edytor. Możesz obsłużyć wszystko bez zatrudniania zewnętrznych specjalistów internetowych
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				<Text color="--darkL1" font="--lead" margin="0px 0px 0px 0px">
					Kolekcjonowanie formularzy przesłanych ze strony internetowej
				</Text>
			</Box>
			<Box
				width="25%"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Przykłady szablonów stron internetowych dla projektantów wnętrz
				</Text>
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Gotowy do użycia szablon portfolio wymaga minimalnego wysiłku przy przeprojektowaniu. Platforma uKit zapewnia wszystkie potrzebne funkcje. Nawet nowicjusz poradzi sobie z procesem edycji
				</Text>
			</Box>
			<Box
				flex-direction="row"
			...
			>
				...
				/>
				<Image loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_fastfood_en.webp?v=2021-09-28T15:59:35.774Z" border-radius="18px" sm-border-radius="6px" />
			</Box>
			<Box
				lg-width="100%"
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					color="--white"
				>
					Kluczowe funkcje stron internetowych poświęconych projektowaniu wnętrz
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Kreator jest łatwy w nawigacji, ma gotowe bloki i domyślną zawartość. Cała funkcjonalność znajduje się w jednym miejscu i można ją skonfigurować bez umiejętności kodowania — wystarczy kilka kliknięć. Każdy pomysł możesz zrealizować samodzielnie
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Czaty i widżety do zbierania opinii odwiedzających
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Darmowe powiadomienia SMS ze strony
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Wbudowany edytor zdjęć z różnymi filtrami
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Jak stworzyć portfolio wnętrzarskie z uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Nie musisz się martwić, że nie sprostasz zadaniu. Kreator uKit jest bardzo łatwy w użyciu dla każdego, nawet jeśli nie masz żadnego doświadczenia w tworzeniu stron internetowych
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Możesz użyć dowolnego szablonu, który odpowiada celom Twojej przyszłej witryny. W każdej chwili szablon z innym. Kolorystyka i czcionki są zmieniane centralnie. Strukturę bloków można łatwo zmienić za pomocą prostego przeciągania i upuszczania. Nie są wymagane żadne umiejętności techniczne, wystarczy ten wygodny kreator online
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Szablony tematyczne zawierają domyślną treść. Możesz go zachować, edytować lub całkowicie zastąpić w zależności od tego, co byłoby lepsze dla Twojej witryny. Możesz przesyłać własne obrazy, edytować je online, stosować filtry, a także dodawać filmy, dokumenty, pliki i nie tylko. Brak ograniczeń co do struktury i liczby stron. Dodatkowo otrzymujesz nieograniczony hosting
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Jeśli jesteś zadowolony z nowo utworzonej witryny, opublikuj ją. uKit automatycznie dostosowuje go do wszystkich urządzeń. W razie potrzeby możesz wprowadzić pewne zmiany dla każdej rozdzielczości ekranu: ukryć niektóre elementy, zmienić kolory lub dostosować specjalne menu
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Każdy projekt uKit otrzymuje bezpłatną nazwę domeny. Aby jednak pokazać swój profesjonalizm i uzyskać lepszą pozycję w wyszukiwarkach, lepiej kupić własną domenę drugiego poziomu. Możesz to zrobić bezpośrednio na pulpicie nawigacyjnym uKit. Protokół HTTPS zostanie skonfigurowany automatycznie
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						W przypadku problemów i błędów system automatycznie tworzy kopie zapasowe serwisu przy każdej zmianie treści. Więc nie musisz się martwić, że zrobisz coś złego. Możesz edytować strony tyle, ile potrzebujesz. Nie zapomnij tylko nacisnąć przycisku «Opublikuj», aby użytkownicy mogli zobaczyć zmiany
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Dodaj witrynę do wyszukiwarek, aby rozpocząć jej indeksowanie. Chcesz uzyskać więcej informacji o zachowaniu użytkowników? Skonfiguruj integrację z Google Analytics. Nie wiesz, czy Twoja witryna jest gotowa do promocji? Sprawdź to w naszym kreatorze SEO. Wszystkie te funkcje są już wbudowane w Twój pulpit nawigacyjny
				</Text>
				<Link
					border-style="solid"
					border-radius="100px"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Nasz kreator online umożliwia uruchomienie dowolnego rodzaju witryny biznesowej bez specjalnej wiedzy i umiejętności. Interfejs usługi został opracowany z myślą o początkujących. Tutaj możesz łatwo tworzyć strony docelowe, strony promocyjne, portfolio, katalogi, a nawet sklepy internetowe
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				<Box
					...
					md-width="100%"
				>
					<Link text-decoration-line="initial" href="/lp/pl/utworz-strone-internetowa-dla-prawnika" color="--darkL1" hover-color="--primary">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
			...
			>
				...
				<Box
					...
					md-width="100%"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pl/stworz-strone-internetowa-kliniki-stomatologicznej" color="--darkL1">
						<Image
							loading="lazy"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					color="--white"
				>
					Stwórz portfolio kreatora wnętrz z uKit
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Bezpłatny 14-dniowy okres próbny pozwoli Ci wypróbować wszystkie funkcje uKit i zobaczyć, jak działają
					<Link
						text-overflow="clip"
						hyphens="manual"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/stworz-portfolio-projektanta-wnetrz/"} place={"endOfHead"} rawKey={"6159dd49eca9df435759a9f6"} />
		</RawHtml>
	</Theme>;
});