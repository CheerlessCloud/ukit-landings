...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/kreator-stron-internetowych"} />
		<Helmet>
			<title>
				uKit – Kreator stron internetowych 
			</title>
			<meta name={"description"} content={"Chcesz szybko utworzyć witrynę jednostronicową bez zatrudniania specjalistów zewnętrznych? uKit jest tutaj, aby pomóc! Posiada bogatą bibliotekę gotowych szablonów stron docelowych i witryn promocyjnych, wszystkie niezbędne bloki i narzędzia, a także dodatkowe opcje SEO "} />
			<meta property={"og:title"} content={"uKit – Kreator stron internetowych "} />
			<meta property={"og:description"} content={"Chcesz szybko utworzyć witrynę jednostronicową bez zatrudniania specjalistów zewnętrznych? uKit jest tutaj, aby pomóc! Posiada bogatą bibliotekę gotowych szablonów stron docelowych i witryn promocyjnych, wszystkie niezbędne bloki i narzędzia, a także dodatkowe opcje SEO "} />
		...
		>
			...
			<Box margin="36px 0px 30px 0px" width="100%" display="flex" flex-wrap="wrap">
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/pl/kreator-stron-internetowych" color="--darkL1" hover-color="--primary">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/utworz-strone-internetowa-psychologa-lub-psychoterapeuty">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/kreator-stron-internetowych/"} place={"endOfHead"} rawKey={"61728b2456c65c1a397047dd"} />
		</RawHtml>
	</Theme>;
});