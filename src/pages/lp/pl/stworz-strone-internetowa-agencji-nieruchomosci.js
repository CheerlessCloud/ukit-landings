...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/stworz-strone-internetowa-agencji-nieruchomosci"} />
		<Helmet>
			<title>
				Stwórz stronę internetową agencji nieruchomości — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Nieograniczony hosting i nieograniczona ilość stron, gotowe projekty, przyjazny edytor wizualny, integracja z CRM, powiadomienia SMS. Nie są wymagane żadne umiejętności programowania. Możesz stworzyć własną stronę internetową za jednym razem."} />
			<meta property={"og:title"} content={"Stwórz stronę internetową agencji nieruchomości — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Nieograniczony hosting i nieograniczona ilość stron, gotowe projekty, przyjazny edytor wizualny, integracja z CRM, powiadomienia SMS. Nie są wymagane żadne umiejętności programowania. Możesz stworzyć własną stronę internetową za jednym razem."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Nieograniczony hosting i nieograniczona ilość stron, gotowe projekty, przyjazny edytor wizualny, integracja z CRM, powiadomienia SMS. Nie są wymagane żadne umiejętności programowania. Możesz stworzyć własną stronę internetową za jednym razem
				</Text>
				<Link
					border-radius="100px"
					background="#4773ff"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Przykłady szablonów stron internetowych agencji nieruchomości
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Wszystko, czego potrzebujesz do swojej witryny, znajdziesz w uKit: zakup własnej domeny, integracje z CRM i czatami na żywo, domenę e-mail, bezpłatny certyfikat SSL, nieograniczony hosting, itp. Wystarczy wybrać jedną z opcji projektowych lub zacząć budować witrynę od podstaw
				</Text>
			</Box>
			<Box
		...
		<Section padding="130px 0 130px 0" lg-padding="100px 0 100px 0" background="--color-secondary">
			...
			>
				<Text
					...
					as="h2"
				>
					Kluczowe funkcje tworzenia stron internetowych agencji nieruchomości
				</Text>
				<Text color="--white" margin="0px 0px 30px 0px" font="--base">
					Nie musisz zatrudniać programistów ani uczyć się podstaw projektowania stron internetowych, aby tworzyć wysokiej jakości strony internetowe dla agentów nieruchomości za pomocą uKit. Możesz błyskawicznie stworzyć witrynę w specjalnym kreatorze online, korzystając z gotowych widżetów i bloków
				</Text>
			</Box>
			<Box
				lg-flex-wrap="wrap"
			...
			>
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Szablony tematyczne dla agencji nieruchomości
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Łatwa integracja z CRM i kreatorem formularzy uCalc
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Czaty na żywo i formularze zwrotne
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Kroki, terminy, recenzje i inne gotowe elementy
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Jak stworzyć stronę internetową agencji nieruchomości z uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Nawet jeśli jesteś zupełnie nowy na platformie i nie masz żadnych umiejętności technicznych w zakresie tworzenia witryn, nadal możesz tworzyć to, czego potrzebujesz. Będziesz miał dostęp do funkcjonalnej platformy internetowej, na której możesz dodawać opisy swoich usług/produktów, cenniki, formularze opinii i inne elementy
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Możesz zacząć od projektu tematycznego lub dowolnego innego szablonu z katalogu — jest ich ponad 300. Możesz zmienić ich czcionkę lub schemat kolorów za jednym razem. Możesz także dodawać, modyfikować i usuwać dowolne elementy i widżety, których potrzebujesz. W każdej chwili szablon można edytować, a treść pozostanie niezmieniona
					</Text>
					<Link
						border-radius="100px"
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Możesz zostawić tekst i obrazy dołączone do szablonu. Ale jeśli chcesz stworzyć bardziej profesjonalnie wyglądającą witrynę, dodaj niestandardową zawartość: teksty, zdjęcia i filmy. Możesz także edytować obrazy w kreatorze: używać filtrów, przycinać obrazy, nakładać kształty i nie tylko
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Wszystkie elementy interfejsu automatycznie dostosowują się do rozdzielczości ekranu wszystkich urządzeń. Jeśli nie podoba Ci się wygląd danego elementu, możesz ukryć go na określonym urządzeniu lub stworzyć alternatywny wygląd, np. zmieniając tło i liczbę kolumn
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Wymyśl własną nazwę domeny i zarejestruj ją bezpośrednio na pulpicie nawigacyjnym uKit lub podłącz istniejącą. Nie musisz nawet ręcznie edytować rekordów DNS, aby przekierować do hostingu. Bezpłatne certyfikaty SSL obsługujące wersję witryny HTTPS są generowane i konfigurowane automatycznie
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Kliknij «Opublikuj», a Twoja witryna będzie całkowicie gotowa dla pierwszych odwiedzających. Możesz swobodnie zmieniać zawartość strony i eksperymentować: uKit może przechowywać do 10 ręcznych i automatycznych kopii zapasowych. Czy coś poszło nie tak? Po prostu przywróć poprawną wersję witryny z kopii zapasowej
					</Text>
				</Box>
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text text-align="center" margin="0px 0px 36px 0px" font="--base" color="--darkL1">
					Aby ułatwić odwiedzającym znalezienie Twojej witryny, zwróć uwagę na metatagi SEO na każdej stronie. Aby upewnić się, że Twoja witryna jest gotowa do publikacji, użyj wbudowanego kreatora SEO, aby ulepszyć witrynę
				</Text>
				<Link
					hover-background="linear-gradient(to right,#537cff,#537cff)"
					color="--white"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					uKit to przyjazny dla użytkownika i bardzo skuteczny kreator online do tworzenia witryny biznesowej. Nie jest wymagana żadna specjalna wiedza ani doświadczenie. Każdy projekt możesz wykonać samodzielnie w zaledwie kilka godzin
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/pl/stworz-portfolio-projektanta-wnetrz" color="--darkL1" hover-color="--primary">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
		...
		<Section background="--color-secondary" lg-padding="100px 0 100px 0" padding="130px 0 130px 0" color="--darkL1">
			...
			>
				<Text
					...
					color="--white"
				>
					Stwórz stronę internetową agencji nieruchomości z uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Sprawdź piękne wzory i funkcjonalność uKit teraz za darmo. Na pewno to pokochasz!
				</Text>
				<Link
					color="--secondary"
					text-decoration-line="initial"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/stworz-strone-internetowa-agencji-nieruchomosci/"} place={"endOfHead"} rawKey={"615d5350c3297f01fde1b758"} />
		</RawHtml>
	</Theme>;
});