...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/kreator-portfolio"} />
		<Helmet>
			<title>
				uKit - Kreator Portfolio
			</title>
			<meta name={"description"} content={"Opowiedz potencjalnym klientom o sobie i pokaż im swoją najlepszą pracę na swojej stronie – stworzonej za pomocą uKit. Setki szablonów tematycznych, integracje i nieograniczony hosting pozwolą Ci uruchomić Twoją witrynę "} />
			<meta property={"og:title"} content={"uKit - Kreator Portfolio"} />
			<meta property={"og:description"} content={"Opowiedz potencjalnym klientom o sobie i pokaż im swoją najlepszą pracę na swojej stronie – stworzonej za pomocą uKit. Setki szablonów tematycznych, integracje i nieograniczony hosting pozwolą Ci uruchomić Twoją witrynę "} />
		...
		<Section md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px">
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Opowiedz potencjalnym klientom o sobie i pokaż im swoją najlepszą pracę na swojej stronie — stworzonej za pomocą uKit. Setki szablonów tematycznych, integracje i nieograniczony hosting pozwolą Ci uruchomić Twoją witrynę
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Przykłady Szablonów Portfolio
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Na pewno znajdziesz odpowiedni projekt tematyczny dla swojej firmy w bogatej bibliotece platformy. Na przykład za pomocą kilku kliknięć możesz utworzyć portfolio projektanta wnętrz czy portfolio dewelopera. Wszystkie szablony można dostosować: możesz zmienić tło, schematy kolorów, czcionki, położenie bloków na stronach, efekty animacji i nie tylko
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				<Image
					...
					sm-left="auto"
				/>
				<Image loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_industry_en.jpg?v=2021-10-31T16:06:43.865Z" border-radius="18px" sm-border-radius="6px" />
			</Box>
			<Box
				align-items="center"
				position="relative"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					uKit — najlepszy wszechstronny kreator portfolio
				</Text>
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					Nie musisz być programistą ani projektantem stron internetowych. Możesz stworzyć własne portfolio, nawet jeśli nigdy wcześniej nie budowałeś strony. Wszystko możesz zrobić sam, bez zatrudniania specjalistów
				</Text>
			</Box>
			<Box
				justify-content="center"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gotowe projekty adaptacyjne dla portfolio
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Nieograniczony hosting (miejsce na dysku, ruch i strony)
					</Text>
				</Box>
				<Box
					flex-direction="column"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Jak Stworzyć Portfolio z uKit
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					Wiele zadań jest już zautomatyzowanych i wymaga od Ciebie niewielkiego wysiłku. Wystarczy wykonać poniższe czynności, a witryna będzie gotowa do działania. Rezultaty Cię oczarują!
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Projektowanie stron internetowych to twarz Twojego portfolio. Wszystkie szablony uKit są bezpłatne i mają gotowe strukturę i treść. Są projektowane przez profesjonalistów. Zmiana strony będzie wymagać od Ciebie minimalnego wysiłku. Jeśli chcesz, możesz łatwo edytować schemat kolorów, tło i parametry czcionki, a także włączyć efekty animacji na różnych blokach. Ustawienia są łatwe w obsłudze
					</Text>
					<Link
						color="--white"
						text-decoration-line="initial"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Opisz swoje umiejętności i pokaż przykłady swojej pracy
					</Text>
					<Text
						color="--dark"
						font="--base"
						...
						margin="0px 0px 24px 0px"
					>
						Możesz utworzyć osobną stronę dla każdej swojej pracy i przesłać dowolną liczbę plików multimedialnych. Mamy też wbudowany edytor zdjęć. Hosting uKit jest nieograniczony, więc nie musisz się martwić o limity miejsca lub ruchu. Nie zapomnij dodać różnych sposobów kontaktowania się z Tobą: czaty na żywo, formularze, przyciski oddzwaniania, linki do sieci społecznościowych i komunikatorów, numer telefonu i e-mail. Powiadomienia będziesz otrzymywać za darmo
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Wszystkie witryny i strony stworzone w uKit wyglądają świetnie na każdym urządzeniu dzięki adaptacyjnym blokom i szablonom. Możesz zostawić wszystko «tak jak jest», możesz ukryć poszczególne bloki czy elementy albo zmienić ich wygląd na telefonach, tabletach lub komputerach
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Wybierz bezpłatną domenę lub zarejestruj nową nazwę w panelu uKit Dashboard. Nawet jeśli masz już własną domenę, możesz połączyć ją ze swoją witryną uKit. Dostajesz również bezpłatny protokół HTTPS i certyfikat SSL
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Po kliknięciu przycisku «Opublikuj» wszelkie wprowadzone zmiany zostaną przeniesione do głównej wersji witryny. Nie zapomnij ponownie opublikować swojej witryny po każdej zmianie. Aby mieć pewność, że Twoja praca nie zostanie utracona, skorzystaj z bezpłatnego systemu tworzenia kopii zapasowych: do 10 ręcznych kopii zapasowych + automatyczne kopie zapasowe
					</Text>
				</Box>
				<Box display="flex" md-width="100%" width="50%" margin="0px 0px 0px 0px">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Zaktualizuj swoją witrynę o przykłady nowych dzieł i monitoruj statystyki odwiedzin oraz stan indeksowania. Dodaj swoją witrynę do Google Search Console lub połącz Google Analytics bezpośrednio z pulpitem uKit za pomocą kilku kliknięć
				</Text>
				<Link
					color="--white"
					text-decoration-line="initial"
		...
		<Section md-padding="80px 0 100px 0" padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 0px 0px" font="--base">
					Nasza platforma może być wykorzystywana do różnych zadań, na przykład do uruchomienia witryny dla prawnika, nauczyciela, radcy prawnego, projektanta, artysty, wizażysty itp. uKit jest idealnym kreatorem dla każdej firmy
				</Text>
			</Box>
			...
			>
				<Box
					...
					display="flex"
				>
					<Link text-decoration-line="initial" href="/lp/pl/kreator-strony-promocyjnej" color="--darkL1" hover-color="--primary">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
			...
			>
				<Box
					...
					padding="0px 15px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/pl/utworz-witryne-warsztatu-samochodowego" color="--darkL1" hover-color="--primary">
						<Image
							width="100%"
							display="flex"
							align-items="center"
				...
				<Box
					...
					flex-direction="column"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/hosting-z-kreatorem-stron">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
		...
		<Section color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0" padding="130px 0 130px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Aby rozpocząć pracę z platformą i skorzystać z bezpłatnego okresu próbnego, wystarczy zarejestrować się w systemie. Sprawdź funkcje uKit i przekonaj się, jak skuteczny jest dla Ciebie
				</Text>
				<Link
					color="--secondary"
					text-decoration-line="initial"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/kreator-portfolio/"} place={"endOfHead"} rawKey={"6176819f0a8d1dbdd2983598"} />
		</RawHtml>
	</Theme>;
});