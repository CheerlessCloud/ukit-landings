...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/utworz-portfolio-deweloperskie"} />
		<Helmet>
			<title>
				Utwórz portfolio deweloperskie — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Nie masz czasu na kodowanie? Brak pomysłów na projekt? Nie ma problemu – możesz szybko zbudować swoje portfolio za pomocą uKit: bogata biblioteka gotowych szablonów, prosty i wygodny edytor wizualny oraz całkowicie nieograniczony hosting"} />
			<meta property={"og:title"} content={"Utwórz portfolio deweloperskie — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Nie masz czasu na kodowanie? Brak pomysłów na projekt? Nie ma problemu – możesz szybko zbudować swoje portfolio za pomocą uKit: bogata biblioteka gotowych szablonów, prosty i wygodny edytor wizualny oraz całkowicie nieograniczony hosting"} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Nie masz czasu na kodowanie? Brak pomysłów na projekt? Nie ma problemu — możesz szybko zbudować swoje portfolio za pomocą uKit: bogata biblioteka gotowych szablonów, prosty i wygodny edytor wizualny oraz całkowicie nieograniczony hosting
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Przykłady projektów portfolio deweloperskiego
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Wszystkie funkcje są gotowe do użycia. Dostępne są tematyczne jedno- i wielostronicowe, nowoczesne i popularne opcje projektowania. Po wybraniu szablonu wystarczy podłączyć domenę i opublikować witrynę
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Ten elastyczny, przyjazny dla użytkownika kreator pozwala opowiedzieć potencjalnym klientom o sobie, swoich umiejętnościach i doświadczeniu, a także pokazać przykłady swojej pracy
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gotowe bloki do portfolio i stron docelowych
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Wyskakujące okienka, przyciski czatu na żywo i formularze opinii
					</Text>
				</Box>
				<Box
					align-items="flex-start"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Jak stworzyć witrynę dla programistów za pomocą uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Zainwestuj trochę czasu, a uzyskasz naprawdę imponujący wynik. uKit ma wszystko, aby szybko zbudować witrynę — wystarczy skonfigurować poszczególne parametry i opublikować stronę
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Tworzysz aplikacje mobilne lub specjalizujesz się w Pythonie, C++ lub Javie? Mamy setki gotowych szablonów dla różnych firm. Możesz wybrać dowolny z nich. Każdy szablon ma kilka schematów kolorów, czcionek, efektów animacji i tła, które można edytować. Zestaw bloków i strukturę strony można łatwo zmienić, aby spełnić Twoje wymagania
					</Text>
					<Link
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Opowiedz światu o swoich najlepszych umiejętnościach i udowodnij swój profesjonalizm przykładami. Dzięki uKit możesz tworzyć dowolną liczbę stron, przesyłać pliki, dodawać filmy, obrazy i inne treści. Hosting jest absolutnie nieograniczony. Obrazy można edytować bezpośrednio w kreatorze: przycinać, stosować efekty, obracać itp.
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1" font="--headline3">
						Skonfiguruj wersje mobilne na telefony i tablety
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Wszystkie bloki i widżety uKit reagują na wszystkich urządzeniach, więc nie musisz niczego przerabiać. Ale jeśli potrzebujesz, możesz ukryć wybrane elementy lub sekcje, a także zmienić ich tło i wygląd dla telefonów lub tabletów. uKit automatycznie dostosowuje obrazy do rozmiaru ekranu, a także działa z leniwym ładowaniem dużych plików multimedialnych, dzięki czemu strony ładują się szybko na wszystkich urządzeniach
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Popularne rozszerzenie domeny możesz kupić na pulpicie nawigacyjnym uKit. Wersja HTTPS jest skonfigurowana i działa domyślnie — żadnych ostrzeżeń dotyczących bezpieczeństwa dla odwiedzających Twoją witrynę
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Możesz dowolnie zmieniać i dostosowywać strony. Wchodzą w życie dopiero po publikacji. uKit może tworzyć automatyczne i ręczne kopie zapasowe witryny (do 10 wersji), co oznacza możliwość przywrócenia ich za jednym kliknięciem
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Możesz także połączyć analitykę i dodać swoją witrynę do Google Search Console na pulpicie nawigacyjnym uKit. Nastąpi to automatycznie. Możesz również sprawdzić, czy Twoja witryna jest gotowa do promocji za pomocą specjalnie wbudowanego kreatora SEO
				</Text>
				<Link
					background="--color-secondary"
					display="inline"
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					W naszym kreatorze możesz tworzyć nie tylko portfolio, ale także strony promocyjne, katalogi, strony biznesowe, sklepy internetowe, strony docelowe i inne typy witryn
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Stwórz portfolio programisty z uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					14-dniowy bezpłatny okres próbny bez podawania danych osobowych. Zarejestruj się już teraz i przekonaj się, jak kreator może dla Ciebie pracować
				</Text>
				<Link
					font="--lead"
					margin="0px 0px 0px 0px"
		...
		<RawHtml>
			...
			<link href={"/lp/pl/utworz-portfolio-deweloperskie/"} rel={"canonical"} place={"endOfHead"} rawKey={"617ea5961822ad90071748f2"} />
		</RawHtml>
	</Theme>;
});