...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/stworz-witryne-kawiarni-lub-restauracji"} />
		<Helmet>
			<title>
				Stwórz witrynę kawiarni lub restauracji — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Dzięki uKit możesz samodzielnie stworzyć profesjonalną, dobrze wyglądającą i funkcjonalną witrynę kawiarni lub restauracji. Zawiera nieograniczony hosting, bezpłatne powiadomienia SMS i gotowe narzędzia SEO"} />
			<meta property={"og:title"} content={"Stwórz witrynę kawiarni lub restauracji — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Dzięki uKit możesz samodzielnie stworzyć profesjonalną, dobrze wyglądającą i funkcjonalną witrynę kawiarni lub restauracji. Zawiera nieograniczony hosting, bezpłatne powiadomienia SMS i gotowe narzędzia SEO"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Dzięki uKit możesz samodzielnie stworzyć profesjonalną, dobrze wyglądającą i funkcjonalną witrynę kawiarni lub restauracji. Zawiera nieograniczony hosting, bezpłatne powiadomienia SMS i gotowe narzędzia SEO
				</Text>
				<Link
					background="#4773ff"
					display="inline"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Przykłady projektów stron internetowych kawiarni i restauracji
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Szablony pomogą Ci rozpocząć tworzenie witryny, nawet jeśli nie masz doświadczenia ani specjalnej wiedzy. Wszystko, co Ci się nie podoba, można łatwo zmienić w interfejsie wizualnym online. A potem po prostu podłącz swoją domenę i opublikuj witrynę
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Nie musisz zatrudniać nikogo do obsługi witryny, projektowania jej lub konfigurowania SEO. Wszystko to możesz zrobić sam z uKit. Istnieje specjalne narzędzie lub rozwiązanie do każdego zadania
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gotowe klocki do menu i galerii
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Edytor zdjęć z gotowymi do użycia filtrami
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formularze opinii i zamówień, wyskakujące okienka
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integracja z CRM i darmowymi powiadomieniami
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Nieograniczona liczba stron i obrazów
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Jak stworzyć stronę internetową kawiarni lub restauracji za pomocą uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Proces tworzenia witryny jest płynny, więc nie musisz zatrudniać żadnych profesjonalnych programistów. Potrzebujesz tylko trochę czasu i inspiracji. Aby mieć pewność, że niczego nie przegapisz, wykonaj poniższe czynności
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Polecamy zacząć od jednego z gotowych szablonów z naszego katalogu. Wszystkie mają różne schematy kolorystyczne. Czcionki i inne parametry projektowe można zmienić za pomocą kilku kliknięć. Jeśli masz własną wizję witryny, możesz zacząć od pustej kartki i zbudować swoją witrynę z gotowych elementów
					</Text>
					<Link
						color="--white"
						text-decoration-line="initial"
			...
			>
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Powiedz swoim klientom o sobie
					</Text>
					<Text
						color="--dark"
						font="--base"
						...
						margin="0px 0px 24px 0px"
					>
						Prześlij zdjęcie lub film z wnętrza kawiarni/restauracji, dodaj swoje menu i najpopularniejsze dania. Pokaż ceny i oferty specjalne. Nie zapomnij przedstawić obsługi lub przynajmniej szefa kuchni. Udostępnij godziny pracy i pokaż lokalizację w Mapach Google. Nasz kreator online pomoże Ci wykonać wszystkie te zadania. Przeciągnij i upuść niezbędne bloki na stronę, zmień zawartość i dostosuj projekt
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Twoja witryna będzie automatycznie wyglądać idealnie na telefonach i tabletach. Ale w razie potrzeby możesz ręcznie włączać lub wyłączać poszczególne elementy lub bloki na różnych urządzeniach, zmieniać ich parametry projektowe
					</Text>
				</Box>
			...
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Utwórz przyjazny dla użytkownika adres URL
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Możesz zarejestrować swoją domenę drugiego poziomu bezpośrednio na pulpicie nawigacyjnym uKit. Rekordy DNS i bezpieczny protokół HTTPS zostaną skonfigurowane automatycznie. Nie chcesz wydawać pieniędzy na domenę? Użyj bezpłatnej domeny trzeciego poziomu opartej na rozszerzeniach oferowanych przez uKit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Twoja witryna będzie gotowa do odwiedzenia zaraz po jej opublikowaniu. Wszystko, co musisz zrobić, to kliknąć przycisk «Opublikuj» i wszystkie zmiany zostaną zapisane. Nie bój się zepsuć ani zgubić czegokolwiek: uKit automatycznie tworzy kopie zapasowe witryny (+ do 10 ręcznych kopii zapasowych). Jednym kliknięciem możesz przywrócić starszą wersję
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Zintegruj swoją witrynę z CRM, jeśli zajdzie taka potrzeba. Skonfiguruj natychmiastowe powiadomienia z formularzy, aby szybko odpowiadać klientom. Dodaj witrynę do Google na pulpicie nawigacyjnym uKit i zintegruj systemy analityczne. Dzięki uKit możesz to wszystko zrobić za pomocą kilku kliknięć. Możesz także poprawić pozycję swojej witryny w wynikach wyszukiwania, korzystając z naszego specjalnego kreatora SEO. Wiele funkcji jest zautomatyzowanych
				</Text>
				<Link
					href="https://ukit.com/pl/signUp"
					color="--white"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Nasz kreator pozwala tworzyć i utrzymywać dowolne witryny dla Twojej firmy, nawet z zerowym doświadczeniem i wiedzą: witryny promocyjne, portfolio, strony docelowe, a nawet sklepy internetowe
				</Text>
			</Box>
			<Box margin="36px 0px 30px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pl/utworz-strone-docelowa" color="--darkL1">
						<Image
							border-radius="18px"
			...
			>
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/pl/utworz-strone-internetowa-firmy-deweloperskiej" color="--darkL1" hover-color="--primary">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
		...
		>
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Stwórz witrynę kawiarni lub restauracji za pomocą uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Chcesz to zobaczyć na własne oczy? Platformę możesz wypróbować bezpłatnie podczas 14-dniowego okresu próbnego. Sprawdź wszystkie funkcje uKit i zobacz, co wymyślisz
				</Text>
				<Link
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/stworz-witryne-kawiarni-lub-restauracji/"} place={"endOfHead"} rawKey={"618a4c41e658bd023e2315b2"} />
		</RawHtml>
	</Theme>;
});