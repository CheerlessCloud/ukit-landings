...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/stworz-strone-internetowa-kliniki-stomatologicznej"} />
		<Helmet>
			<title>
				Stwórz stronę internetową kliniki stomatologicznej — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Bez programistów, bez kodu. Stwórz atrakcyjną stronę internetową w mgnieniu oka, korzystając z naszych szablonów. Nieograniczony hosting i powiadomienia o witrynie.\n\nDzięki intuicyjnej funkcjonalności, nie zajmie Ci to dużo czasu."} />
			<meta property={"og:title"} content={"Stwórz stronę internetową kliniki stomatologicznej — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Bez programistów, bez kodu. Stwórz atrakcyjną stronę internetową w mgnieniu oka, korzystając z naszych szablonów. Nieograniczony hosting i powiadomienia o witrynie.\n\nDzięki intuicyjnej funkcjonalności, nie zajmie Ci to dużo czasu."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Bez programistów, bez kodu. Stwórz atrakcyjną stronę internetową w mgnieniu oka, korzystając z naszych szablonów. Nieograniczony hosting i powiadomienia o witrynie.
					<br />
					Dzięki intuicyjnej funkcjonalności, nie zajmie Ci to dużo czasu
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Przykładowe projekty stron internetowych kliniki stomatologicznej
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Idealne dopasowanie szablonu, elastyczne możliwości edycji. Wszystkie szablony można dostosować: możesz łatwo dodać wszystkie potrzebne bloki i funkcje. Wbudowana biblioteka obrazów i ikon. Mnóstwo innych funkcji, które ułatwią Ci życie
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--lead" color="--white">
					do stworzenia olśniewającej strony kliniki stomatologicznej
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Pełny zestaw wszystkich funkcji, których możesz potrzebować w jednym miejscu: od gotowych projektów tematycznych z domyślną zawartością po wbudowany kreator SEO i błyskawiczne dodawanie witryny do wyszukiwarek. Bez kodowania i zatrudniania zewnętrznych specjalistów internetowych. Możesz stworzyć własną stronę internetową kliniki za jednym razem
				</Text>
			</Box>
			<Box
				lg-flex-wrap="wrap"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gotowe szablony i połączenia stron w kreatorze
					</Text>
				</Box>
				<Icon
					category="bs"
				...
				>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Darmowa domena na podstawie Twojego adresu e-mail
					</Text>
				</Box>
				<Icon
					margin="0 0 18px 0"
				...
				>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Odbiór przesłanych formularzy i powiadomień na e-mail
					</Text>
				</Box>
				<Icon
					color="--white"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Jak stworzyć stronę internetową kliniki stomatologicznej za pomocą uKit
				</Text>
				<Text color="--darkL1" margin="0px 0px 0px 0px" font="--base">
					Zaznajomienie się z uKit nie zajmie Ci dużo czasu. Będziesz mógł stworzyć własną witrynę nawet bez wiedzy technicznej i umiejętności. Aby jeszcze bardziej ułatwić ten proces, wykonaj poniższe czynności:
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Sprawdź naszą bogatą bibliotekę szablonów i wybierz motyw tematyczny lub dowolny inny projekt oraz szablon jednostronicowy lub wielostronicowy. Zawartość bloków lub kolejność bloków można zmienić w dowolnym momencie, podobnie jak czcionki i schematy kolorów
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Opisz usługi swojej kliniki prostym językiem, podaj dane kontaktowe, dodaj formularz opinii, cennik i wszelkie inne informacje, które chcesz. Przesyłaj obrazy, filmy i inne materiały oraz dodawaj referencje. Wiele z tych funkcji jest zaimplementowanych w gotowych blokach. Aby sprawdzić, czy Twoja witryna jest gotowa do publikacji, skorzystaj z naszego kreatora SEO
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Wszystkie szablony, bloki i poszczególne elementy projektu w uKit są automatycznie dostosowywane do wszystkich urządzeń. Zawartość witryny jest zoptymalizowana pod kątem ładowania na wolnych połączeniach. W razie potrzeby możesz dostosować wersję witryny mobilnej. Na przykład ukryj niektóre bloki lub zmień kolory
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Jeśli połączysz niestandardową domenę za pośrednictwem uKit, nie będziesz musiał jej nawet konfigurować. Ruch Twoich klientów jest automatycznie szyfrowany i przekierowywany do protokołu HTTPS. Nie musisz kupować własnych certyfikatów SSL
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Gdy Twoja witryna jest gotowa dla pierwszych odwiedzających, po prostu kliknij «Opublikuj». Możesz kontynuować edytowanie stron, a Twoi klienci nie zobaczą aktualizacji, dopóki nie opublikujesz swojej witryny. Boisz się popełniać błędy? Możesz łatwo wrócić do poprzedniej wersji, klikając przycisk «Wstecz» lub przywracając kopię zapasową
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Dodaj witrynę kliniki do wyszukiwarek, sprawdź jakość witryny oraz dodaj analitykę i inne usługi zewnętrzne. Wszystkie te zadania możesz wykonać na pulpicie nawigacyjnym uKit. Stworzyliśmy uKit z myślą o Tobie
				</Text>
				<Link
					font="--lead"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Stwórz dowolny rodzaj strony internetowej (strona promocyjna, portfolio, strona docelowa, katalog, sklep internetowy i inne) samodzielnie, nawet jeśli nigdy wcześniej tego nie robiłeś
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/utworz-strone-internetowa-dla-prawnika">
						<Image
							loading="lazy"
			...
			>
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/stworz-strone-internetowa-agencji-nieruchomosci">
						<Image
		...
		>
			...
			>
				<Text
					...
					text-align="center"
				>
					Stwórz stronę internetową kliniki stomatologicznej z uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Zbuduj witrynę, o której marzyłeś, w ciągu zaledwie kilku godzin. Nie są potrzebne żadne umiejętności programistyczne ani specjalna wiedza
				</Text>
				<Link
					display="inline"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/stworz-strone-internetowa-kliniki-stomatologicznej/"} place={"endOfHead"} rawKey={"61545a1ed6362bfde9364ffe"} />
		</RawHtml>
	</Theme>;
});