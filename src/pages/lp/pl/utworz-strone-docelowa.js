...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/utworz-strone-docelowa"} />
		<Helmet>
			<title>
				Utwórz stronę docelową — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Gotowe szablony, szeroka gama kategorii tematycznych i elementów projektu, powiadomienia z formularzy, integracje, nielimitowany hosting.\nStwórz sam stronę docelową w kilka godzin"} />
			<meta property={"og:title"} content={"Utwórz stronę docelową — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Gotowe szablony, szeroka gama kategorii tematycznych i elementów projektu, powiadomienia z formularzy, integracje, nielimitowany hosting.\nStwórz sam stronę docelową w kilka godzin"} />
		...
		<Section md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Gotowe szablony, szeroka gama kategorii tematycznych i elementów projektu, powiadomienia z formularzy, integracje, nielimitowany hosting.
					<br />
					Stwórz sam stronę docelową w kilka godzin
				</Text>
				<Link
		...
		>
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Wybierz dowolny szablon z biblioteki. Dostosuj jego zawartość lub w razie potrzeby wymień szablon na inny później. Nieograniczony hosting i bezpłatne certyfikaty SSL we wszystkich planach
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Co otrzymujesz dla swojej strony docelowej
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Dzięki uKit nie musisz być profesjonalistą w sieci, aby tworzyć wysokiej jakości, piękne strony docelowe, które działają jak marzenie. Nie musisz też pracować z kodem źródłowym — wystarczą gotowe bloki i widżety. Duża swoboda projektowania i integracje z innymi firmami
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Wysokiej jakości system analityczny
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Czaty i przyciski oddzwaniania
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					Nawet jeśli nie jesteś specjalistą od stron internetowych i po raz pierwszy korzystasz z kreatora uKit, możesz stworzyć swoją pierwszą stronę docelową w ciągu zaledwie kilku godzin
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Mamy wiele tematycznych opcji projektowych dla wielu branż. Po prostu wybierz ten, który najbardziej Ci odpowiada i dostosuj go. Dodaj lub usuń widżety, a następnie ustaw żądaną czcionkę i kolor tekstu
					</Text>
					<Link
						text-decoration-line="initial"
						margin="0px 0px 0px 0px"
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Szablony zawierają już znaczące teksty domyślne. Ale jeśli chcesz mieć wyjątkową i skuteczną witrynę, powinieneś dodać niestandardowy tekst. Przesyłaj obrazy i dodawaj filmy tam, gdzie ich potrzebujesz: uKit ma wbudowany edytor obrazów
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Możesz ukryć dowolne elementy lub całe bloki i wdrożyć alternatywny styl projektowania na telefon komórkowy i tablet.
						<br />
						Możesz też po prostu upewnić się, że wszystko działa tak, jak powinno w trybie podglądu i opuścić witrynę bez zmian
					</Text>
				</Box>
				<Box display="flex" md-width="100%" width="50%" margin="0px 0px 0px 0px">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Połącz swoją domenę i opublikuj swoją stronę docelową
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Możesz uzyskać nową domenę na pulpicie nawigacyjnym uKit. W takim przypadku rekordy DNS zostaną ustawione automatycznie. Certyfikaty SSL są bezpłatne, a także konfigurowane automatycznie. Nie musisz niczego edytować ręcznie.
						<br />
						uKit przechowuje do 10 kopii zapasowych Twojej witryny. Nie bój się edytować swojej witryny ani popełniać błędów. W każdej chwili możesz uzyskać kopię zapasową swojej witryny
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Możesz połączyć Google Analytics i Facebook Pixel. To zajmie tylko kilka minut.
						<br />
						Śledź skuteczność strony docelowej w czasie rzeczywistym lub przez określony czas bez opuszczania pulpitu nawigacyjnego uKit
					</Text>
				</Box>
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Teraz musisz dodać witrynę do wyszukiwarek i skonfigurować ustawienia SEO. uKit pozwala ustawić metatagi dla każdej strony Twojej witryny. Dodatkowo uKit ma wbudowany kreator SEO, który sprawdza, czy Twoja witryna jest gotowa do publikacji
				</Text>
				<Link
					hover-background="linear-gradient(to right,#537cff,#537cff)"
					font="--lead"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Stwórz samodzielnie dowolny rodzaj strony internetowej, nawet jeśli nigdy wcześniej tego nie robiłeś
				</Text>
			</Box>
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					text-align="center"
				>
					Czy jesteś gotowy, aby stworzyć swoją stronę docelową na uKit?
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Zbuduj swoją własną stronę docelową już teraz od podstaw za pomocą bloków lub gotowego szablonu. Nie są potrzebne żadne umiejętności programistyczne ani specjalna wiedza
				</Text>
				<Link
					display="inline"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/utworz-strone-docelowa/"} place={"endOfHead"} rawKey={"6153428713a22cefa64c1f19"} />
		</RawHtml>
	</Theme>;
});