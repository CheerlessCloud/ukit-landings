...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/utworz-portfolio-artysty"} />
		<Helmet>
			<title>
				Utwórz portfolio artysty — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Z uKit możesz zbudować funkcjonalne portfolio o nowoczesnym designie i wersji mobilnej bez konieczności programowania – wystarczy jedna noc i Twoja wyobraźnia"} />
			<meta property={"og:title"} content={"Utwórz portfolio artysty — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Z uKit możesz zbudować funkcjonalne portfolio o nowoczesnym designie i wersji mobilnej bez konieczności programowania – wystarczy jedna noc i Twoja wyobraźnia"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Z uKit możesz zbudować funkcjonalne portfolio o nowoczesnym designie i wersji mobilnej bez konieczności programowania — wystarczy jedna noc i Twoja wyobraźnia
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Przykłady projektów portfolio artystów
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Możesz wybrać dowolny wzór z katalogu. Szablony można łatwo przeprojektować zgodnie z własnymi potrzebami i celami. Nie ma potrzeby edytowania kodu. To bułka z masłem!
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Nawet jeśli jesteś nowy na platformie, masz gwarancję wysokiej jakości witryny z portfolio. Nie są wymagane żadne umiejętności programowania. Strony zbudowane są z gotowych widżetów i elementów — po prostu przeciągnij je i upuść tam, gdzie chcesz
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Szablony tematyczne do portfolio
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Wbudowany edytor zdjęć (z gotowymi efektami animacji)
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Feedback, formularze zwrotne, czaty na żywo
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Jak stworzyć portfolio artysty za pomocą uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Wystarczy wykonać poniższe kroki, a już za kilka godzin będziesz mieć portfolio. Nie musisz się martwić, że coś pójdzie nie tak. Nawet początkujący sobie z tym poradzą
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Nasz katalog pełen jest tematycznych i uniwersalnych wzorów. Możesz wybrać ten, który Ci się podoba. Dodatkowo możesz dostosować kolory, czcionki, tła i inne opcje projektowania
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Opowiedz nam o sobie i swojej pracy. I pamiętaj, aby podać przykłady. Możesz zbudować jedno- lub wielostronicowe portfolio — nie ma ograniczeń co do liczby stron lub elementów. Ponadto uKit zapewnia nieograniczony hosting, dzięki czemu możesz przesyłać dowolną liczbę dzieł sztuki. Aby Twoja praca wyglądała jeszcze bardziej atrakcyjnie, możesz użyć widżetów suwaka i galerii
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Wszystkie szablony i bloki uKit są adaptacyjne, dzięki czemu Twoja witryna będzie wyglądać świetnie na wszystkich urządzeniach. W razie potrzeby możesz ukryć poszczególne elementy lub ustawić alternatywne bloki projektowe dla telefonów i tabletów. Na przykład: kolor, tło i liczba kolumn
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Możesz kupić nazwę domeny bezpośrednio na pulpicie nawigacyjnym uKit. Rekordy DNS zostaną automatycznie skonfigurowane dla naszego hostingu. Wszystkie strony działają z bezpiecznym protokołem HTTPS, a certyfikaty SSL są domyślnie generowane
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						To nigdy nie było prostsze — wystarczy kliknąć opcję «Opublikuj» i wszystkie wprowadzone przez Ciebie zmiany będą dostępne w głównej wersji witryny. Zachęcamy do eksperymentowania — system automatycznie tworzy kopie zapasowe i przechowuje do 10 wersji witryny. Możesz cofnąć się jednym kliknięciem
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Dodaj witrynę do wyszukiwarek i zacznij ją promować. Połącz systemy analityczne, aby analizować konkretne działania, które Twoi odwiedzający wykonują na stronie. Możesz to wszystko zrobić z pulpitu nawigacyjnego uKit. Wiele funkcji jest zautomatyzowanych. Na przykład kreator SEO, który pomaga w promocji
				</Text>
				<Link
					href="https://ukit.com/pl/signUp"
					color="--white"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Platforma jest idealna do prowadzenia różnych witryn przeznaczonych dla biznesu: stron docelowych, witryn promocyjnych, katalogów, sklepów internetowych i nie tylko
				</Text>
			</Box>
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Czas samemu sprawdzić uKit — skorzystaj z 14-dniowego okresu próbnego dla każdej nowej witryny. Nie są wymagane żadne dane karty ani inne prywatne informacje
				</Text>
				<Link
					href="https://ukit.com/pl/signUp"
					color="--secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/utworz-portfolio-artysty/"} place={"endOfHead"} rawKey={"617ef3d341516409870de2fa"} />
		</RawHtml>
	</Theme>;
});