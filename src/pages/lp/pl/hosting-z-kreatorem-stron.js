...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/hosting-z-kreatorem-stron"} />
		<Helmet>
			<title>
				Hosting z Kreatorem Stron — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Większość twórców witryn internetowych i usług hostingowych ogranicza zużywane zasoby serwera. Ale nie uKit. Dzięki uKit zyskujesz nieograniczony hosting, ruch sieciowy i nieograniczoną liczbę stron w dowolnym planie"} />
			<meta property={"og:title"} content={"Hosting z Kreatorem Stron — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Większość twórców witryn internetowych i usług hostingowych ogranicza zużywane zasoby serwera. Ale nie uKit. Dzięki uKit zyskujesz nieograniczony hosting, ruch sieciowy i nieograniczoną liczbę stron w dowolnym planie"} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					Większość twórców witryn internetowych i usług hostingowych ogranicza zużywane zasoby serwera. Ale nie uKit. Dzięki uKit zyskujesz nieograniczony hosting, ruch sieciowy i nieograniczoną liczbę stron w dowolnym planie
				</Text>
				<Link
					background="#4773ff"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Aby ułatwić Ci rozpoczęcie pracy, przygotowaliśmy setki szablonów o różnych motywach. Wszystkie są całkowicie bezpłatne, łatwo konfigurowalne i mają adaptacyjny projekt
				</Text>
			</Box>
			<Box
				align-items="flex-start"
			...
			>
				...
				<Image
					...
					sm-border-radius="6px"
				/>
				<Image loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_advert_en.webp?v=2021-10-31T13:56:49.544Z" border-radius="18px" sm-border-radius="6px" />
			</Box>
			<Box
				justify-content="center"
				align-items="center"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white" text-align="center">
					Nie musisz instalować i konfigurować systemów CMS — silnik serwisu zostaje zastąpiony wygodnym kreatorem online, który pozwala szybko samodzielnie stworzyć standardowy projekt dla biznesu bez specjalnej wiedzy
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					<Text color="--white" font="--lead" text-align="center" margin="0px 0px 0px 0px">
						Niezawodny nieograniczony hosting
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Nie ma potrzeby instalowania i konfigurowania systemu CMS
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gotowy do użycia kreator online
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Wszystkie niezbędne widżety i elementy interfejsu
					</Text>
				</Box>
				<Box
					width="33%"
				...
				>
					...
					/>
					<Text color="--white" font="--lead" text-align="center" margin="0px 0px 0px 0px">
						Narzędzia sklepu internetowego i opcje płatności online
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Adaptacyjne szablony tematyczne
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Automatyczna konfiguracja zakupionej domeny
					</Text>
				</Box>
			</Box>
		</Section>
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Jak uzyskać stronę internetową z hostingiem w uKit Builder?
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					Usługa została zaprojektowana z myślą o minimalnym wysiłku z Twojej strony, aby rozpocząć swój projekt. Wszystko jest już skonfigurowane lub zostanie skonfigurowane automatycznie po aktywowaniu wybranych opcji. Do pracy z platformą nie są wymagane żadne specjalistyczne umiejętności
				</Text>
			</Box>
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Ogromna liczba różnych opcji projektowych zaspokoi wszystkie Twoje potrzeby. Wszystkie są nowoczesne, adaptacyjne i mają już sensowną treść. Po prostu zastąp dane kontaktowe własnymi i możesz przejść do publikowania. Chcesz edytować strukturę witryny, zmienić lokalizację bloku lub usunąć niepotrzebne elementy? Możesz to wszystko zrobić w naszym przyjaznym dla użytkownika edytorze wizualnym
					</Text>
					<Link
						border-style="solid"
						display="inline"
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Niezależnie od abonamentu uKit, który subskrybujesz, możesz przesłać nieograniczoną liczbę plików i utworzyć dowolną liczbę stron. Do swojej witryny możesz dodać dowolne elementy: obrazy, filmy, tekst i inne pliki. Dostępne są gotowe widżety do tworzenia galerii, sliderów, bloków z recenzjami, osi czasu, cenników, kart produktów i nie tylko. The sky is the limit!
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Nie musisz nic robić, aby skonfigurować wersję witryny mobilnej. Możesz ukryć niepotrzebne elementy i zmienić ustawienia projektu (tło, kolor, siatka itp.). Konstruktor robi wszystko sam — wszystkie bloki automatycznie dostosowują się do aktualnej rozdzielczości ekranu
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Jeśli nie masz własnej, możesz zarejestrować nową domenę z popularnym rozszerzeniem na pulpicie nawigacyjnym uKit. Wszystkie niezbędne rekordy DNS zostaną wprowadzone automatycznie. Wszyscy użytkownicy otrzymują bezpłatne certyfikaty SSL, a przekierowania są konfigurowane automatycznie, dzięki czemu strona domyślnie działa z bezpiecznym protokołem HTTPS
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Możesz edytować swoją witrynę tyle, ile potrzebujesz. Dzięki uKit nie musisz nawet tworzyć kopii zapasowych — system robi je za Ciebie automatycznie. Aby zmiany były dostępne dla użytkowników, po prostu kliknij przycisk «Opublikuj»
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Rozwijaj swoją witrynę i angażuj nowych odbiorców. Aby Ci w tym pomóc, uKit zapewnia zestaw niezbędnych narzędzi: rozwiązania sklepu internetowego, gotowe integracje z CRM, systemy analityczne i mailingowe, kreator SEO (aby sprawdzić gotowość witryny do promocji) oraz dodanie witryny do Google Search Console za pomocą jednego kliknięcia
				</Text>
				<Link
					href="https://ukit.com/pl/signUp"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Dzięki uKit możesz stworzyć dowolny rodzaj witryny biznesowej za pomocą kilku kliknięć i bez specjalnej wiedzy. Witryny wyglądają świeżo, profesjonalnie i są łatwe w utrzymaniu, więc nie ma potrzeby zatrudniania zewnętrznych specjalistów
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					{" "}
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/utworz-portfolio-deweloperskie">
						<Image
						...
						<Text margin="0px 0px 0px 0px" font="--lead" md-margin="0px 0px 30px 0px">
							Utwórz portfolio deweloperskie
						</Text>
						{" "}
					</Link>
				</Box>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/utworz-witryne-internetowa-dla-pracownikow-ochrony-zdrowia">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
						...
						<Text margin="0px 0px 0px 0px" font="--lead">
							Utwórz witrynę internetową dla pracowników ochrony zdrowia
						</Text>
					</Link>
				</Box>
			</Box>
			...
			>
				<Box
					...
					display="flex"
				>
					<Link href="/lp/pl/utworz-witryne-warsztatu-samochodowego" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead" md-margin="0px 0px 30px 0px">
							Utwórz witrynę warsztatu samochodowego
						</Text>
					</Link>
				</Box>
				<Box
			...
			>
				<Box
					...
					flex-direction="column"
				>
					<Link href="/lp/pl/utworz-strone-internetowa-firmy-deweloperskiej" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/pl/utworz-strone-internetowa-radcy-prawnego" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							width="100%"
							display="flex"
							align-items="center"
		...
		>
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Stwórz stronę internetową z uKit i uzyskaj nieograniczony hosting
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Po prostu zarejestruj się lub zaloguj na swoje konto i zacznij tworzyć swój pierwszy projekt. Nie są wymagane żadne dane osobowe. Otrzymujesz 14-dniowy okres próbny
				</Text>
				<Link
					margin="0px 0px 0px 0px"
					border-width="1px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/hosting-z-kreatorem-stron/"} place={"endOfHead"} rawKey={"618949d47201cf80544b2a0f"} />
		</RawHtml>
	</Theme>;
});