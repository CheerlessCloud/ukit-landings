...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/kreator-stron-promocyjnych"} />
		<Helmet>
			<title>
				uKit - Kreator Stron Promocyjnych
			</title>
			<meta name={"description"} content={"Potrzebujesz skutecznej strony docelowej z opcjami płatności online, która kolekcjonuje przesłane formularze i ma inne funkcje? Ale nie chcesz wydać fortuny na programistów, projektantów i innych specjalistów? uKit to najwyższej klasy platforma do tworzenia stron internetowych i stron docelowych. Wizualny, intuicyjny edytor i narzędzia SEO do promocji w jednym miejscu"} />
			<meta property={"og:title"} content={"uKit - Kreator Stron Promocyjnych"} />
			<meta property={"og:description"} content={"Potrzebujesz skutecznej strony docelowej z opcjami płatności online, która kolekcjonuje przesłane formularze i ma inne funkcje? Ale nie chcesz wydać fortuny na programistów, projektantów i innych specjalistów? uKit to najwyższej klasy platforma do tworzenia stron internetowych i stron docelowych. Wizualny, intuicyjny edytor i narzędzia SEO do promocji w jednym miejscu"} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Potrzebujesz skutecznej strony docelowej z opcjami płatności online, 
która kolekcjonuje przesłane formularze i ma inne funkcje? Ale nie 
chcesz wydać fortuny na programistów, projektantów i innych 
specjalistów? uKit to najwyższej klasy platforma do tworzenia stron 
internetowych i stron docelowych. Wizualny, intuicyjny edytor i 
narzędzia SEO do promocji w jednym miejscu
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				<Text font="--lead" width="95%" margin="0px 0px 0px 0px" color="--darkL1">
					Formularze zamówień i bezpłatne powiadomienia
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Wszystkie szablony są adaptacyjne i świetnie wyglądają na wszystkich urządzeniach. Możesz wybrać dowolny gotowy projekt, uwzględniając specyfikę Twojej firmy. Na przykład gabinet kosmetyczny czy hotel. Łatwo zmienić parametry projektu i dostosować szablon do swoich potrzeb
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					uKit — nagradzany kreator witryn
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Możesz tworzyć strony docelowe za pomocą uKit, przeciągając i upuszczając wybrane elementy. Nie wymaga kodowania ani specjalnej wiedzy lub umiejętności. Interfejs edytora jest przejrzysty i łatwy w obsłudze, nawet dla początkujących. I jest jeszcze więcej funkcji uKit do odkrycia
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Zestaw bloków dla każdej firmy
					</Text>
				</Box>
				<Box
					align-items="flex-start"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Jak stworzyć stronę docelową za pomocą uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Wszystko czego potrzebujesz do tworzenia skutecznych stron docelowych jest już na platformie. Dzięki uKit nie ma stromej krzywej uczenia się — większość zadań jest zautomatyzowana lub znacznie uproszczona. Nawet nowicjusz sobie z tym poradzi. Wystarczy wykonać poniższe podstawowe kroki, a Twoja witryna jest gotowa!
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Zacznij od szablonu tematycznego — w naszym katalogu są ich setki. Wybierz jeden i przekonaj się, jak łatwa jest praca z edytorem uKit. Możesz zmieniać schematy kolorów, tła, czcionki, efekty animacji, a nawet cały szablon. Po zmianie szablon witryny zachowuje swoją zawartość, więc nie musisz się martwić, że Twój tekst, obrazy itp. zostaną utracone
					</Text>
					<Link
						font="--lead"
						padding="15px 25px 16px 25px"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Stwórz wymarzoną stronę promocyjną! Zastąp zawartość domyślną zawartością niestandardową, dodawaj i usuwaj bloki zgodnie z potrzebami, dodaj swoje dane kontaktowe i skonfiguruj formularze opinii i powiadomienia. W razie potrzeby połącz systemy płatności online, CRM, mailing i analityki. Wszelkie strony promocyjne, które stworzysz za pomocą uKit, będą naprawdę skuteczne
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Strony stworzone w uKit ładują się szybko i świetnie prezentują się na wszystkich typach urządzeń. Nie musisz niczego edytować samodzielnie. Ale są też zaawansowane ustawienia, które pozwalają ukryć bloki lub poszczególne elementy, zmienić wygląd osobnych sekcji i nie tylko
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Zamiast bezpłatnej domeny technicznej trzeciego poziomu możesz podłączyć istniejącą domenę drugiego poziomu lub zarejestrować nową. Możesz kupić nową nazwę domeny na pulpicie nawigacyjnym uKit. Certyfikaty SSL i wersja strony HTTPS są udostępniane za darmo
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px">
						Opublikuj Swoją Stronę Promocyjną
					</Text>
					<Text
						width="84%"
						lg-width="100%"
						...
						font="--base"
					>
						Kliknij «Opublikuj» i strona jest gotowa dla klientów. Chcesz edytować i ulepszać swoją witrynę? W przypadku jakichkolwiek zmian dostępny jest darmowy system tworzenia kopii zapasowych — kopie automatyczne i do 10 kopii ręcznych
					</Text>
				</Box>
				<Box md-width="100%" width="50%" margin="0px 0px 0px 0px" display="flex">
					<Image
		...
		<Section lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0" padding="40px 0 130px 0" color="--darkL1">
			...
			>
				...
				<Text text-align="center" margin="0px 0px 36px 0px" font="--base" color="--darkL1">
					Połącz systemy analityczne i dodaj swoją witrynę do Google Search Console. Śledź swoje statystyki w jednym miejscu i w wygodnym formacie
				</Text>
				<Link
					color="--white"
					border-width="1px"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text text-align="center" margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Śledź swoje statystyki w jednym miejscu i w wygodnym formacie. Dzięki uKit możesz tworzyć nie tylko skuteczne strony docelowe, ale także inne rodzaje projektów dla swojej firmy, takie jak pełnoprawne strony internetowe, strony promocyjne, &lt;1 &gt;portfele i sklepy internetowe
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px" width="100%">
				<Box
					...
					display="flex"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pl/oprogramowanie-do-tworzenia-stron-internetowych" color="--darkL1">
						<Image
							border-radius="18px"
				...
				<Box
					...
					md-width="100%"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/ile-kosztuje-utworzenie-witryny">
						<Image
			...
			>
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link href="/lp/pl/utworz-witryne-nauczyciela" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/pl/utworz-strone-internetowa-radcy-prawnego" color="--darkL1" hover-color="--primary">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/pl/stworz-strone-internetowa-agencji-nieruchomosci" color="--darkL1" hover-color="--primary">
						<Image
							width="100%"
							display="flex"
							align-items="center"
				...
				<Box
					...
					md-width="100%"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/stworz-portfolio-projektanta-wnetrz">
						<Image
		...
		<Section background="--color-secondary" lg-padding="100px 0 100px 0" padding="130px 0 130px 0" color="--darkL1">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Stwórz Stronę Promocyjną za pomocą uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Zarejestruj się na platformie i możesz sam sprawdzić wszystkie funkcje uKit w 14-dniowym okresie próbnym
				</Text>
				<Link
					font="--lead"
					display="inline"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/kreator-stron-promocyjnych/"} place={"endOfHead"} rawKey={"6175bd8c9a4614335db50adb"} />
		</RawHtml>
	</Theme>;
});