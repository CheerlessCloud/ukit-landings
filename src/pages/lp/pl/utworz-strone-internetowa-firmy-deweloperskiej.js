...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/utworz-strone-internetowa-firmy-deweloperskiej"} />
		<Helmet>
			<title>
				Utwórz stronę internetową firmy deweloperskiej — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Wysokiej jakości bloki portfolio, gotowe szablony, sekcje cenników, formularze zwrotne, powiadomienia SMS i inne tematyczne elementy projektu.\nNie są wymagane żadne umiejętności programowania. Samodzielne tworzenie witryny jest szybkie i łatwe."} />
			<meta property={"og:title"} content={"Utwórz stronę internetową firmy deweloperskiej — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Wysokiej jakości bloki portfolio, gotowe szablony, sekcje cenników, formularze zwrotne, powiadomienia SMS i inne tematyczne elementy projektu.\nNie są wymagane żadne umiejętności programowania. Samodzielne tworzenie witryny jest szybkie i łatwe."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					Wysokiej jakości bloki portfolio, gotowe szablony, sekcje cenników, formularze zwrotne, powiadomienia SMS i inne tematyczne elementy projektu.
					<br />
					Nie są wymagane żadne umiejętności programowania. Samodzielne tworzenie witryny jest szybkie i łatwe
				</Text>
				<Link
			...
			<Box lg-display="flex" lg-justify-content="center" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						position="static"
					>
						Przyjazny dla użytkownika kreator online
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Przykłady szablonów stron internetowych firmy deweloperskiej
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Musisz tylko kupić lub podłączyć swoją domenę. Wszystko inne znajdziesz w kreatorze. Nie musisz być programistą ani projektantem stron internetowych. Łatwy do uruchomienia i edycji
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				<Image
					...
					sm-border-radius="6px"
				/>
				<Image border-radius="18px" sm-border-radius="6px" loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_cat_en.webp?v=2021-09-28T16:00:01.205Z" />
			</Box>
			<Box
				align-items="center"
				position="relative"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Kluczowe funkcje tworzenia stron internetowych firm deweloperskich
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Wbudowany kreator SEO oznacza, że nie musisz zatrudniać specjalistów 
internetowych do promowania swojej witryny. Możesz zbudować stronę z 
gotowych bloków i widżetów. Integrację z usługami zewnętrznymi 
konfiguruje się za pomocą kilku kliknięć
				</Text>
			</Box>
			<Box
				lg-width="100%"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Szablony tematyczne dla firm deweloperskich
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Blok wielostronicowy z kontaktami
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Zestaw widżetów do tworzenia portfolio
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Wbudowane formularze do zbierania wniosków
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Czaty online, przyciski oddzwaniania
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Jak stworzyć stronę internetową firmy deweloperskiej z uKit
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					Uruchomienie własnej witryny jest łatwe, nawet jeśli nie masz umiejętności kodowania ani innej specjalnej wiedzy. Proces zajmie tylko kilka godzin. Po prostu wykonaj poniższe czynności:
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Będziesz mógł wybierać spośród setek gotowych do użycia projektów 
tematycznych dla różnych typów witryn biznesowych, bez względu na to, 
czy są one jednostronicowe czy wielostronicowe. Szablon zawiera znaczącą
 treść, która ilustruje, gdzie i jaki rodzaj treści należy uwzględnić. 
Możesz zostawić lub dostosować zawartość, jak wolisz. Za pomocą kilku 
kliknięć można również zmienić schematy kolorów i czcionki
					</Text>
					<Link
						text-decoration-line="initial"
						font="--lead"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Dodawaj lub edytuj treść tekstową, przesyłaj zdjęcia i filmy oraz pokaż jakość swojej usługi/produktu za pomocą innych elementów witryny: suwaków, galerii, osi czasu, bloków z krokami, cenników, itp. Obrazy można edytować bezpośrednio w kreatorze
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						uKit dostosowuje strony internetowe do wszystkich ekranów bez udziału użytkownika. Ale jeśli chcesz, możesz ukryć pojedyncze elementy lub całe widżety i dostosować tło i projekt osobno dla tabletów lub smartfonów
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Możesz zarejestrować nową nazwę domeny na pulpicie nawigacyjnym uKit. Hosting zostanie skonfigurowany automatycznie. Witryna będzie obsługiwać bezpieczny protokół HTTPS i nie są wymagane żadne dodatkowe kroki, aby uzyskać certyfikaty SSL
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Gdy tylko klikniesz przycisk «Opublikuj», witryna stanie się dostępna dla odwiedzających witrynę. Możesz edytować jego zawartość w dowolnym momencie: uKit pozwala zachować do 10 kopii zapasowych. Jeśli zrobisz coś źle, po prostu cofnij się do właściwej wersji lub cofnij akcję w edytorze za pomocą przycisku «Wstecz»
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Nie zapomnij dodać strony do wyszukiwarek i zadbać o promocję SEO. Gotowość witryny możesz sprawdzić w specjalnym kreatorze. Pokaże Ci dokładnie, co musisz zmienić w swojej witrynie, aby zapewnić sobie wysoką pozycję w wynikach wyszukiwania
				</Text>
				<Link
					color="--white"
					font="--lead"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Konstruktor uKit pozwala uruchomić dowolne tematyczne projekty biznesowe w ciągu zaledwie kilku godzin bez specjalnej wiedzy i umiejętności
				</Text>
			</Box>
			...
			>
				<Box
					...
					display="flex"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pl/utworz-strone-docelowa">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
		...
		>
			...
			>
				<Text
					...
					as="h2"
				>
					Stwórz stronę internetową firmy deweloperskiej z uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Zacznij korzystać z platformy bez żadnych zobowiązań i przedpłat. Sprawdź szablony i funkcje kreatora już teraz za darmo
				</Text>
				<Link
					text-decoration-line="initial"
					font="--lead"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/utworz-strone-internetowa-firmy-deweloperskiej/"} place={"endOfHead"} rawKey={"615c7608df089181a52fdb0a"} />
		</RawHtml>
	</Theme>;
});