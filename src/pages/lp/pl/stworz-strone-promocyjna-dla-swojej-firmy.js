...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pl/stworz-strone-promocyjna-dla-swojej-firmy"} />
		<Helmet>
			<title>
				Stwórz stronę promocyjną dla swojej firmy — uKit. Kreator stron internetowych dla firm
			</title>
			<meta name={"description"} content={"Bez kodu, mnóstwo gotowych szablonów, darmowe powiadomienia SMS i zamówienia, nielimitowany hosting. Stwórz stronę w jedną noc!"} />
			<meta property={"og:title"} content={"Stwórz stronę promocyjną dla swojej firmy — uKit. Kreator stron internetowych dla firm"} />
			<meta property={"og:description"} content={"Bez kodu, mnóstwo gotowych szablonów, darmowe powiadomienia SMS i zamówienia, nielimitowany hosting. Stwórz stronę w jedną noc!"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Bez kodu, mnóstwo gotowych szablonów, darmowe powiadomienia SMS i zamówienia, nielimitowany hosting. Stwórz stronę w jedną noc!
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Wszystko, czego potrzebujesz, aby utworzyć witrynę, to niestandardowa domena, hosting i dobry kreator witryn. Dzięki uKit masz to wszystko w jednym miejscu
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Każdy może stworzyć własną witrynę — bez edycji kodu, tylko widżety i gotowe bloki. Szczegółowe przewodniki wizualne i samouczki oraz wiele szablonów. Do stworzenia pierwszej strony promocyjnej nie są wymagane żadne umiejętności programowania ani projektowania
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gotowe szablony, bloki i formularze
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Bezpłatna poczta e-mail oparta na domenie
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Stwórz własną stronę promocyjną w kilka godzin, nawet jeśli nigdy wcześniej tego nie robiłeś
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Jesteś fotografem, prawnikiem lub organizatorem ślubów? Mamy gotowe do użycia opcje projektowe dla wielu branż lub rodzajów małych firm
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Możesz zachować projekt szablonu i zastąpić jego domyślną zawartość. Możesz też dodać bloki w kreatorze. Lub całkowicie przeprojektuj całą zawartość strony. Konstruktor pozwala dodawać, usuwać, przenosić i powielać wszystkie elementy. Dodaj niestandardowy tekst i obrazy, aby zapewnić wysoką pozycję witryny w wynikach wyszukiwania
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Nasz kreator zrobi za Ciebie prawie wszystko. Wystarczy przejrzeć widoki urządzeń mobilnych i tabletów, i wprowadzić drobne poprawki w tych wersjach
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						sm-color="#3c3f4f"
					>
						Możesz uzyskać nową domenę na pulpicie nawigacyjnym uKit lub podłączyć istniejącą. Certyfikaty SSL dla wersji witryny HTTPS są bezpłatne i są konfigurowane automatycznie. Nie musisz niczego edytować samodzielnie
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Nie bój się, że zrobisz coś nie tak. Do 10 kopii zapasowych zostanie utworzonych automatycznie lub ręcznie. Zmiany możesz cofnąć w dowolnym momencie
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Teraz musisz dodać witrynę do wyszukiwarek i skonfigurować ustawienia SEO. uKit pozwala ustawić metatagi dla każdej strony Twojej witryny. Możesz także dodać swoją witrynę do wyszukiwarek i Map Google
				</Text>
				<Link
					href="https://ukit.com/pl/signUp"
					color="--white"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Components.Perelink href="/lp/pl/stworz-strone-internetowa-kliniki-stomatologicznej">
						<Image
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Components.Perelink href="/lp/pl/stworz-portfolio-projektanta-wnetrz">
						<Image
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Components.Perelink href="/lp/pl/stworz-strone-internetowa-placowki-edukacyjnej">
						<Image
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Components.Perelink href="/lp/pl/stworz-strone-internetowa-agencji-nieruchomosci">
						<Image
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_cleaning_en.webp?v=2021-09-28T16:25:14.701Z"
							width="100%"
							display="flex"
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Components.Perelink href="/lp/pl/utworz-strone-docelowa">
						<Image
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_banking_en.webp?v=2021-09-28T16:11:24.736Z"
							width="100%"
							display="flex"
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Components.Perelink href="/lp/pl/utworz-strone-internetowa-dla-prawnika">
						<Image
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_psychologist_en.webp?v=2021-09-28T16:00:29.898Z"
							width="100%"
							display="flex"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Stwórz własną stronę promocyjną za darmo podczas 14-dniowego okresu próbnego i już teraz poznaj wszystkie funkcje kreatora uKit
				</Text>
				<Link
					href="https://ukit.com/pl/signUp"
					color="--secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pl/stworz-strone-promocyjna-dla-swojej-firmy/"} place={"endOfHead"} rawKey={"6151b0f4ee4b201a3694f548"} />
		</RawHtml>
	</Theme>;
});