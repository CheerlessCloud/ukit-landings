...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/host-cu-un-constructor-de-website"} />
		<Helmet>
			<title>
				Host cu un constructor de website — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"Majoritatea constructorilor online de site-uri și serviciilor de host limitează resursele de server pe care acestea le consumă. Dar nu și uKit. Cu uKit, primiți găzduire, trafic nelimitat, dar și un număr nelimitat de pagini, în cadrul oricărui abonament"} />
			<meta property={"og:title"} content={"Host cu un constructor de website — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"Majoritatea constructorilor online de site-uri și serviciilor de host limitează resursele de server pe care acestea le consumă. Dar nu și uKit. Cu uKit, primiți găzduire, trafic nelimitat, dar și un număr nelimitat de pagini, în cadrul oricărui abonament"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					Majoritatea constructorilor online de site-uri și serviciilor de host limitează resursele de server pe care acestea le consumă. Dar nu și uKit. Cu uKit, primiți găzduire, trafic nelimitat, dar și un număr nelimitat de pagini, în cadrul oricărui abonament
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Pentru a fi mai ușor pentru dvs., am pregătit sute de șabloane pe diferite teme. Toate sunt complet gratuite, ușor personalizabile și au un design adaptiv
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white" text-align="center">
					Nu trebuie să instalați sau să configurați sisteme CMS — motorul site-ului este înlocuit de un constructor de website-uri online, convenabil, care vă permite să creați rapid un proiect standard pentru o afacere, direct de către dvs., fără a avea nevoie de cunoștințe speciale
				</Text>
			</Box>
			<Box
				width="100%"
			...
			>
				...
				>
					...
					<Text color="--white" font="--lead" text-align="center" margin="0px 0px 0px 0px">
						Găzduire nelimitată, de încredere
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Nu trebuie să instalați dvs. sau să configurați CMS-ul
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Constructor online gata de a fi folosit
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Toate widget-urile și elementele de interfață necesare
					</Text>
				</Box>
				<Box
					width="33%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Configurarea automată a domeniului achiziționat
					</Text>
				</Box>
			</Box>
		</Section>
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Cum să obțineți un website cu host, prin constructorul uKit
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					Serviciul este creat special pentru a fi nevoie doar de un minim de efort, pentru demararea proiectului. Totul este deja configurat sau fi configurat automat la activarea opțiunilor dorite. Nu sunt necesare cunoștințe speciale pentru a lucra cu platforma
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Numărul mare de diferite tipuri de design, cu siguranță, vor răspunde tuturor nevoilor dvs. Toate sunt moderne, adaptive și vin la pachet cu un conținut dedicat. Doar înlocuiți datele de contact cu cele proprii și puteți deja să publicați site-ul. Aveți nevoie să modificați structura site-ului, modifica locația secțiunii sau elimina elemente care nu vă sunt necesare? Puteți face toate acestea direct în editorul nostru vizual, extrem de ușor de utilizat
					</Text>
					<Link
						margin="0px 0px 0px 0px"
						border-width="1px"
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Indiferent de abonamentul uKit pe care-l achiziționați, puteți adăuga un număr nelimitat de fișiere și să creați oricâte pagini doriți. Puteți adăuga oricâte elemente pe site: imagini, video-uri, texte și alte fișiere. Sunt widget-uri predefinite pentru a crea galerii, slidere, secțiuni cu recenzii, cronologii, liste de prețuri, carduri de produs și multe altele. Cerul este limita!
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Nu va trebui să faceți nimic pentru a configura versiunea mobilă a site-ului. Puteți ascunde elementele nedorite sau modifica setările design-ului (fundal, culoare, număr de coloane, etc.). Constructorul face totul singur — toate secțiunile se adaptează automat la rezoluția curentă a ecranului
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Dacă nu aveți unul deja, puteți înregistra un nou domeniu cu o extensie populară direct din Panoul Administrativ uKit. Toate înregistrările necesare DNS vor fi adăugate în mod automat. Toți utilizatorii primesc certificate gratuite SSL și redirecționarea este configurată automat, astfel încât site-ul funcționează cu un protocol de securitate HTTPS în mod implicit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Vă puteți modifica website-ul oricât aveți nevoie. Cu uKit nici nu trebuie să realizați copii de rezervă — sistemul le creează pentru dvs. în mod automat. Pentru ca modificările să fie disponibile utilizatorilor, doar dați click pe butonul «Publică»
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Continuați cu dezvoltarea site-ului și captați atenția unei noi audiențe. Și pentru a vă ajuta să faceți acest lucru, uKit oferă un set de instrumente necesare: soluții pentru magazin online, integrări predefinite cu CRM, sisteme de analiză și de mailing, un instrument încorporat SEO (cu ajutorul acestuia puteți verifica disponibilitatea site-ului dvs. pentru promovare) și adăugarea site-ului dvs. în cadrul Google Search Console cu doar un singur click
				</Text>
				<Link
					border-style="solid"
					border-color="--color-secondary"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Cu uKit, puteți crea un website pentru orice tip de afacere, în doar câteva click-uri și fără a avea cunoștințe speciale. Site-urile au un aspect modern, profesional și sunt ușor de administrat, așadar nu veți avea nevoie să apelați la specialiști din exterior
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					{" "}
					<Link text-decoration-line="initial" href="/lp/ro/creati-portofoliul-unui-developer" color="--darkL1" hover-color="--primary">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Creați un website cu uKit și beneficiați de găzduire nelimitată
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Doar înregistrați-vă sau autentificați-vă în contul dvs. și începeți să creați primul dvs. proiect. Nu sunt necesare informații personale. Primiți o perioadă de probă gratuită de 14 zile
				</Text>
				<Link
					border-width="1px"
					border-style="solid"
		...
		<RawHtml>
			...
			<link href={"/lp/ro/host-cu-un-constructor-de-website/"} rel={"canonical"} place={"endOfHead"} rawKey={"618949d47201cf80544b2a0f"} />
		</RawHtml>
	</Theme>;
});