...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/cat-costa-sa-creati-un-website"} />
		<Helmet>
			<title>
				Cât costă să creați un website? — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"Creați-vă, chiar dvs., un website cu uKit – de la $2.5/lună. Nu sunt necesare cunoștințe sau abilități speciale. Tot ce aveți nevoie pentru a realiza și a vă promova site-ul se regăsește deja pe platformă! În plus, beneficiați de host nelimitat. Aveți nevoie de un website dar nu aveți timp să-l realizați dvs.? Putem să vă creăm un website la cheie de la $100"} />
			<meta property={"og:title"} content={"Cât costă să creați un website? — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"Creați-vă, chiar dvs., un website cu uKit – de la $2.5/lună. Nu sunt necesare cunoștințe sau abilități speciale. Tot ce aveți nevoie pentru a realiza și a vă promova site-ul se regăsește deja pe platformă! În plus, beneficiați de host nelimitat. Aveți nevoie de un website dar nu aveți timp să-l realizați dvs.? Putem să vă creăm un website la cheie de la $100"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Creați-vă, chiar dvs., un website cu uKit — de la $2.5/lună. Nu sunt necesare cunoștințe sau abilități speciale. Tot ce aveți nevoie pentru a realiza și a vă promova site-ul se regăsește deja pe platformă! În plus, beneficiați de host nelimitat. Aveți nevoie de un website dar nu aveți timp să-l realizați dvs.? Putem să vă creăm un website la cheie de la $100
				</Text>
				<Link
					border-radius="100px"
					background="#4773ff"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Număr nelimitat de pagini și fișiere
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Exemple de șabloane tematice predefinite
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Toate design-urile sunt moderne, adaptive și complet gratuite. Cu siguranță veți găsi varianta potrivită pentru afacerea dvs. Puteți, de asemenea, activa o versiune a site-ului pentru cei cu deficiențe de vedere și modifica schemele de culori și font-uri. Fiecare șablon vine cu un conținut specific și formulare tip pop-up. Conectați-vă propriul domeniu, actualizați datele de contact și publicați site-ul
				</Text>
			</Box>
			<Box
		...
		<Section padding="130px 0 130px 0" lg-padding="100px 0 100px 0" background="--color-secondary" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Editor vizual ușor de utilizat. Orice pagină poate fi creată din secțiuni și elemente predefinite, doar trăgându-le și amplasându-le în locul dorit. Prețuri accesibile la abonamente, atât pentru afaceri cât și persoane fizice
				</Text>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Secțiuni și șabloane predefinite
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Instrumente încorporate pentru magazin online și a pagină de știri
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Host și număr de pagini nelimitat pentru fiecare abonament
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integrări predefinite cu CRM, chat live, newsletter și alte servicii
					</Text>
				</Box>
				<Box
					align-items="flex-start"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Toate opțiunile uKit sunt incluse în cadrul abonamentului: șabloane predefinite, instrumente SEO, conectarea propriului domeniu și sisteme de analiză. Cu doar puțin timp și efort, puteți să vă creați propriul website. Și nu aveți nevoie de cunoștințe sau abilități speciale
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Toate șabloanele predefinite din biblioteca noastră sunt complet gratuite. Puteți alege oricare din acestea și să le modificați schema de culori, font-uri, fundaluri și alți parametri de design. Fără plăți suplimentare. Totul inclus
					</Text>
					<Link
						color="--white"
						margin="0px 0px 0px 0px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Editor gratuit, ușor de utilizat
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Veți avea acces la toate secțiunile și widget-urile necesare, cu orice abonament: chat-uri live, slider, galerii, contoare cu numărătoare inversă, formulare de feedback, butoane de reapelare, liste de prețuri, cronologie, recenzii și multe altele. Doar le trageți, plasați și apoi le personalizați. Unele abonamente oferă acces la un editor de cod HTML (pentru profesioniști) și widget-uri magazin online (pentru a obține plăți online)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Toate șabloanele și secțiunile predefinite din constructor sunt adaptive. Astfel, site-ul dvs. va arăta perfect pe toate dispozitivele. Imaginile sunt adaptate automat la rezoluția dorită — pentru a optimiza traficul clienților și a se încărca cât mai repede posibil. Este posibil să ascundeți secțiuni individuale sau să le personalizați designul pentru anumite tipuri de dispozitive: telefoane, tablete și computere. Încărcarea lentă a imaginilor și stilurilor este activată cu un singur click. Toate aceste caracteristici sunt deja incluse în abonamentul dvs.
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Toți utilizatorii uKit primesc domenii de nivel trei personalizabile, gratuite, cu extensii populare. De asemenea, puteți alege să configurați o adresă URL preferată pentru site-ul dvs. Dacă aveți nevoie de un domeniu de nivel doi, îl puteți înregistra direct prin Panoul Administrativ uKit de la $8,99/an (înregistrare și reînnoire). Puteți conecta, oricând, un domeniu existent, achiziționat de la orice registrator terț. Indiferent de opțiunea pe care o alegeți, certificatele SSL sunt gratuite și configurate automat
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Copii de rezervă gratuite și găzduire nelimitată
					</Text>
					<Text
						width="84%"
						lg-width="100%"
						...
						font="--base"
					>
						Editați și publicați site-ul, modificați-l din nou, apoi republicați-l. Adăugați oricâte pagini aveți nevoie. Primiți spațiu nelimitat pe disc și puteți adăuga pe site oricâte fișiere doriți, indiferent de abonamentul ales. Sistemul poate crea până la 10 copii de rezervă ale site-ului dvs. Sunt create atât automat, cât și manual și pot fi restaurate cu un singur click. Toate acestea sunt incluse, implicit, în orice abonament uKit
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Acceptați plăți online, integrare CRM și servicii de newsletter, stabiliți obiectivele în sisteme de analiză. Puteți adăuga orice număr de produse, câmpuri din formulare, coduri promoționale, diferite metode de livrare
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Unele sarcini sunt automatizate, așadar nu vă vor ocupa mult timp. De exemplu, un instrument SEO special vă va ajuta să verificați dacă site-ul este pregătit pentru promovare. De asemenea, puteți conecta sisteme de analiză externe prin doar câteva click-uri, pentru a colecta și analiza informații despre vizitatorii site-ului dvs
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						margin="0px 0px 0px 0px"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Nu aveți timp să vă ocupați de toți acești pași? Atunci apelați la unul dintre profesioniștii noștri, din agenția web Divly
				</Text>
				<Link
					text-decoration-line="initial"
					margin="0px 0px 0px 0px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Platforma noastră vă permite să creați orice fel de site de afaceri, într-un timp scurt și fără abilități speciale: pagini de prezentare, site-uri promoționale, cataloage, portofolii, bloguri corporative, magazine online, site-uri pentru profesori, instituții de învățământ și alte proiecte
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/ro/constructor-de-site-uri-promotionale" color="--darkL1">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/ro/creator-de-portofoliu" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
			...
			>
				<Box
					...
					md-width="100%"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/ro/creati-un-site-de-promovare-pentru-afacerea-dvs" color="--darkL1">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/ro/creati-un-website-pentru-agentie-imobiliara" color="--darkL1">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		>
			...
			>
				<Text
					...
					font="--headline1"
				>
					Creați un website cu uKit — de la $2,5/lună
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Primiți o perioadă de probă gratuită de 14 zile cu toate funcțiile uKit, inclusiv magazinul online. Nu este nevoie să introduceți informații personale. Abonați-vă la uKit numai dacă vă plac rezultatele pe care le obțineți!
				</Text>
				<Link
					border-width="1px"
					border-color="--color-secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/ro/cat-costa-sa-creati-un-website/"} place={"endOfHead"} rawKey={"619e9e36d6eb73a50d0f5c51"} />
		</RawHtml>
	</Theme>;
});