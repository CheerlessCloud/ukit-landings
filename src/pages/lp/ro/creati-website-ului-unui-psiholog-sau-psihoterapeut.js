...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/creati-website-ului-unui-psiholog-sau-psihoterapeut"} />
		<Helmet>
			<title>
				Creați website-ului unui psiholog sau psihoterapeut — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"Dacă vă gândiți să vă creați propriul website, alegeți uKit și nu va mai trebui să angajați diverși specialiști. Este rapid: un constructor ușor de folosit, șabloane predefinite și host nelimitat"} />
			<meta property={"og:title"} content={"Creați website-ului unui psiholog sau psihoterapeut — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"Dacă vă gândiți să vă creați propriul website, alegeți uKit și nu va mai trebui să angajați diverși specialiști. Este rapid: un constructor ușor de folosit, șabloane predefinite și host nelimitat"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Dacă vă gândiți să vă creați propriul website, alegeți uKit și nu va mai
 trebui să angajați diverși specialiști. Este rapid: un constructor ușor
 de folosit, șabloane predefinite și host nelimitat
				</Text>
				<Link
					color="--white"
					font="--lead"
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Formulare de feedback predefinite
				</Text>
			</Box>
			<Box
				width="20%"
		...
		<Section md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-padding="80px 0 100px 0">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Exemple de design-uri pentru website-ul unui psiholog sau psihoterapeut
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Nu sunteți sigur de unde să începeți? Oferim soluții predefinite cu un conținut dedicat. Dacă nu știți sigur ce vă doriți, utilizați editorul nostru online, ușor de utilizat, pentru a schimba conținutul. Apoi, tot ce trebuie să faceți este să publicați site-ul și să vă conectați propriul domeniu
				</Text>
			</Box>
			<Box
			...
			>
				...
				/>
				<Image sm-border-radius="6px" loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_fastfood_en.webp?v=2021-10-03T16:49:03.527Z" border-radius="18px" />
			</Box>
			<Box
				display="flex"
				padding="0px 15px 0px 15px"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Nu trebuie să fiți un geniu în calculatoare sau designer web profesionist. Cu uKit, puteți crea un site doar trăgând și amplasând secțiuni predefinite și widget-uri. Site-ul dvs. va arăta perfect și va funcționa așa cum vă doriți
				</Text>
			</Box>
			<Box
				lg-width="100%"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Un set mare de secțiuni pentru a vă descrie serviciile
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formulare predefinite pentru programarea unei consultații
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Widget-uri pentru chat live și butoane pentru reapelare
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Crearea unui website dintr-o pagină de pe rețelele sociale
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Creați website-ului unui psiholog sau psihoterapeut cu uKit
				</Text>
				<Text color="--darkL1" margin="0px 0px 0px 0px" font="--base">
					Oricine o poate face, indiferent de cunoștințele și experiența pe care o are. Doar o noapte, iar site-ul dvs. este gata. Acesta va povesti potențialilor clienți despre cine sunteți dvs., despre serviciile oferite și vă va permite să afișați tarifele și să primiți cereri
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Catalogul uKit conține sute de șabloane gratuite cu diferite teme, inclusiv opțiuni predefinite pentru psihologi. Puteți alege orice design și să-l personalizați. Opțiuni de design precum fundal, seturi de font-uri, scheme de culori sau efecte de animație pentru secțiune pot fi modificate în doar câteva click-uri. Toate modificările sunt ușor de monitorizat în timp real
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Povestiți despre dvs., despre abilitățile și serviciile pe care le oferiți
					</Text>
					<Text
						lg-width="100%"
						margin="0px 0px 24px 0px"
						...
						width="84%"
					>
						Prezentați clienților punctele dvs. forte ca și expert. Oferiți-le mai multe informații despre formatul consultației (online sau offline), tarife, precum și unde și cum să vă înregistrați pentru o ședință. Adăugați diferite metode de contact precum conturile din media socială, număr de telefon, e-mail și messenger. Constructorul uKit oferă elemente de interfață predefinite și integrări pentru orice ați avea nevoie
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Nu trebuie să vă faceți griji că vizitatorii nu vor putea utiliza website-ul de pe dispozitivele mobile. Toate șabloanele și secțiunile uKit sunt adaptive, iar paginile arată perfect și funcționează corect de pe telefoane și tablete. Dacă este necesar, puteți ascunde secțiuni și elemente individuale, sau modifica parametrii de design pentru dispozitivul selectat
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Pentru a fi mai ușor pentru clienți să își amintească și să acceseze adresa site-ului dvs., conectați un domeniu unic. Puteți achiziționa un domeniu nou direct din Panoul Administrativ uKit. Toate site-urile de pe platformă funcționează cu un protocol de securitate HTTPS, iar certificatele SSL sunt disponibile în mod gratuit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Pentru aceasta, dați click pe butonul «Publică». Și nu uitați să faceți acest lucru de fiecare dată când modificați paginile. Nu trebuie să vă fie frică că veți face ceva greșit, deoarece uKit are un sistem de copii de rezervă automate și manuale. Puteți reveni la o versiune anterioară printr-un singur click
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0" padding="40px 0 130px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Nu vă opriți aici. Pentru a crește rata de conversie din căutări, trebuie să lucrați constant cu site-ul dvs. Pentru a-l face impecabil, am adăugat instrumente speciale SEO, o opțiune pentru a adăuga site-ul în cadrul Google Search Console, precum și posibilitatea de a integra sisteme de analiză cu site-ul dvs.
				</Text>
				<Link
					color="--white"
					padding="15px 25px 16px 25px"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Puteți crea diferite tipuri de site-uri, în doar câteva click-uri, prin platforma noastră: pagini de prezentare, magazine online, website-uri de promovare, portofolii, precum și bloguri simple
				</Text>
			</Box>
			...
			>
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/ro/creati-un-website-pentru-un-salon-de-infrumusetare" color="--darkL1">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
				...
				<Box
					...
					flex-direction="column"
				>
					<Link text-decoration-line="initial" href="/lp/ro/creati-website-ul-unui-hotel" color="--darkL1" hover-color="--primary">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
			...
			>
				...
				<Box
					...
					width="50%"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/ro/creati-website-ul-unei-cafenele-sau-a-unui-restaurant">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead">
							Creați website-ul unei cafenele sau a unui restaurant
						</Text>
					</Link>
				</Box>
			</Box>
		...
		<Section color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0" padding="130px 0 130px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Creați website-ul unui psiholog sau psihoterapeut cu uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Convingeți-vă chiar dvs. cât de eficient este uKit. Nu trebuie să introduceți datele de card sau alte informații personale. Beneficiați de o perioadă de probă gratuită de 14 zile
				</Text>
				<Link
					font="--lead"
					margin="0px 0px 0px 0px"
		...
		<RawHtml>
			...
			<link href={"/lp/ro/creati-website-ului-unui-psiholog-sau-psihoterapeut/"} rel={"canonical"} place={"endOfHead"} rawKey={"618967ad06ff7e3a61cc6158"} />
		</RawHtml>
	</Theme>;
});