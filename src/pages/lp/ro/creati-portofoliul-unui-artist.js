...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/creati-portofoliul-unui-artist"} />
		<Helmet>
			<title>
				Creați portofoliul unui artist — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"Cu uKit, puteți construi un portofoliu funcțional cu un design modern și o versiune mobilă fără cunoștințe de programare – tot ce aveți nevoie este de o noapte și de imaginația dvs."} />
			<meta property={"og:title"} content={"Creați portofoliul unui artist — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"Cu uKit, puteți construi un portofoliu funcțional cu un design modern și o versiune mobilă fără cunoștințe de programare – tot ce aveți nevoie este de o noapte și de imaginația dvs."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Cu uKit, puteți construi un portofoliu funcțional cu un design modern și o versiune mobilă fără cunoștințe de programare — tot ce aveți nevoie este de o noapte și de imaginația dvs.
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Exemple de design-uri pentru portofoliul unui artist
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Puteți alege oricare dintre design-urile din catalog. Șabloanele pot fi ușor personalizate în funcție de nevoile și obiectivele dvs. Nu este nevoie să editați codul. Simplu ca bună ziua!
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Chiar dacă sunteți nou pe platformă, aveți garantat un site de portofoliu de înaltă calitate. Nu sunt necesare abilități speciale. Paginile sunt construite cu widget-uri și elemente predefinite — trebuie doar să le trageți și să le plasați unde doriți
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Șabloane tematice pentru portofolii{" "}
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Editor foto încorporat (cu efecte de animație predefinite)
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Cum să creați portofoliul unui artist cu uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Doar urmați pașii de mai jos și veți avea un portofoliu în numai câteva ore. Nu trebuie să vă faceți griji că ceva va merge prost. Chiar și începătorii se pot descurca
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Catalogul nostru este plin de modele tematice și universale. Puteți alege pe care-l doriți. În plus, puteți personaliza culorile, fonturile, fundalurile și alte opțiuni de design
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Povestiți despre dvs. și munca dvs. Și asigurați-vă că includeți exemple. Puteți construi un portofoliu cu o singură pagină sau cu mai multe pagini — nu există limită pentru numărul de pagini sau elemente. În plus, uKit oferă găzduire nelimitată, astfel încât să puteți adăuga câte lucrări de artă doriți. Și pentru a face munca dvs. să pară și mai captivantă, puteți folosi slide-uri și widget-uri galerie
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Toate șabloanele și secțiunile uKit sunt adaptive, astfel încât site-ul dvs. va arăta grozav pe toate dispozitivele. Dacă este necesar, puteți ascunde elemente individuale sau puteți seta design-uri pentru secțiuni alternative, dedicate mobilelor și tabletelor. De exemplu: culoarea, fundalul și numărul de coloane
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Puteți achiziționa un nume de domeniu direct din Panoul Administrativ uKit. Înregistrările DNS vor fi configurate automat pentru host-ul nostru. Toate site-urile funcționează cu protocolul HTTPS securizat, iar certificatele SSL sunt generate implicit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Nu a fost niciodată mai ușor — doar dați click pe butonul «Publicați» și toate modificările pe care le-ați făcut vor fi disponibile pe versiunea principală a site-ului. Nu ezitați să experimentați — sistemul face copii de rezervă automate și stochează până la 10 versiuni de site. Puteți reveni la o versiune anterioară printr-un singur click
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Adăugați-vă site-ul în motoarele de căutare și începeți promovarea lui. Conectați sisteme analytics pentru a analiza anumite acțiuni ale vizitatorilor de pe website. Puteți face acest lucru în cadrul Panoului Administrativ uKit. Numeroase instrumente sunt automate. De exemplu, instrumentul SEO care vă ajută cu promovarea
				</Text>
				<Link
					border-width="1px"
					border-style="solid"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 0px 0px" font="--base">
					Platforma este perfectă pentru a crea o varietate de site-uri concepute pentru afaceri: pagini de prezentare, site-uri de promovare, cataloage, magazine online și multe altele
				</Text>
			</Box>
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Creați portofoliul unui artist cu uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Este timpul să-l testați chiar dvs. — utilizați perioada de probă de 14 zile oferită pentru fiecare site nou. Nu sunt necesare date de card sau alte informații private
				</Text>
				<Link
					border-width="1px"
					display="inline"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/ro/creati-portofoliul-unui-artist/"} place={"endOfHead"} rawKey={"617ef3d341516409870de2fa"} />
		</RawHtml>
	</Theme>;
});