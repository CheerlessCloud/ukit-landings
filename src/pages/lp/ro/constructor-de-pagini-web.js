...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/constructor-de-pagini-web"} />
		<Helmet>
			<title>
				uKit - constructor de pagini web 
			</title>
			<meta name={"description"} content={"Aveți nevoie să creați un site tip pagină unică, rapid și fără a angaja specialiști terți? uKit este aici pentru a vă ajuta! Vine cu o bibliotecă bogată de șabloane predefinite pentru pagini de destinație și site-uri promoționale, cu toate secțiunile și instrumentele necesare, precum și opțiuni SEO suplimentare "} />
			<meta property={"og:title"} content={"uKit - constructor de pagini web "} />
			<meta property={"og:description"} content={"Aveți nevoie să creați un site tip pagină unică, rapid și fără a angaja specialiști terți? uKit este aici pentru a vă ajuta! Vine cu o bibliotecă bogată de șabloane predefinite pentru pagini de destinație și site-uri promoționale, cu toate secțiunile și instrumentele necesare, precum și opțiuni SEO suplimentare "} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Aveți nevoie să creați un site tip pagină unică, rapid și fără a angaja specialiști terți? uKit este aici pentru a vă ajuta! Vine cu o bibliotecă bogată de șabloane predefinite pentru pagini de destinație și site-uri promoționale, cu toate secțiunile și instrumentele necesare, precum și opțiuni SEO suplimentare
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Integrare cu sisteme tip CRM și analytics
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Nu este nevoie să porniți de la zero — accelerați procesul cu ajutorul șabloanelor tematice predefinite. Personalizați conținutul și publicați proiectul. Acum totul este aproape gata
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					uKit — un constructor de website-uri de top, all-inclusive
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Puteți crea, chiar dvs., orice fel de pagină de destinație, site promoțional, portofoliu etc. Este necesar doar puțin timp. Nu este nevoie să angajați experți pentru a vă promova site-ul în motoarele de căutare. Totul este deja încorporat în platformă
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Șabloane, secțiuni și alte elemente predefinite
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Notificări gratuite nelimitate (SMS + e-mail)
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Conectarea ușoară a domeniului
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Alte integrări (CRM, chat-uri live, plată online)
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Aveți nevoie doar de puțin timp să înțelegeți constructorul. Chiar dacă este prima dată când lucrați cu platforma, veți putea crea, pe cont propriu, un website tip pagină unică, complet funcțional și deosebit. O colecție de tutoriale detaliate, sfaturi interactive și asistență tehnică 24/24 vă vor ajuta, la nevoie
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Alegeți șablonul care vi se potrivește cel mai bine. Catalogul nostru conține sute de opțiuni predefinite, pentru orice tip de afacere. Fiecare șablon are un conținut dedicat, fișiere media și ferestre pop-up. Schema de culori, efectele de animație și seturile de fonturi pot fi modificate prin doar câteva click-uri. De asemenea, este ușor să schimbați șablonul cu altul, fără a pierde din conținut
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						În uKit, paginile sunt construite cu elemente predefinite. Sistemul oferă un set de secțiuni și widget-uri pentru orice: cronometre cu numărătoare inversă, ferestre tip pop-up, butoane de reapelare, chat-uri live, galerii, carduri de produse, coș de cumpărături (pentru crearea unui magazin online și acceptarea plăților online) și multe altele. Doar trageți și plasați-le pe pagină, apoi personalizați-le după preferințe
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Totul este gata — site-urile create cu uKit se adaptează indiferent de rezoluția ecranului. Imaginile sunt optimizate automat, astfel încât viteza de descărcare este întotdeauna mare. Puteți să vă asigurați că paginile sunt afișate așa cum ar trebui și să lăsați totul «ca atare», sau puteți ascunde elemente individuale pentru a nu încărca designul site-ului pentru telefoane și/sau tablete
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Puteți să conectați un nume de domeniu existent sau să cumpărați unul nou, direct din Panoul Administrativ uKit. Toate extensiile populare vă vor fi disponibile. Certificatele SSL sunt gratuite, iar redirecționarea către versiunea HTTPS a site-ului este setată automat
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Să nu vă fie teamă să schimbați conținutul site-ului dvs. Constructorul uKit oferă un sistem de creare a copiilor de rezervă automate și manuale. Puteți crea până la 10 copii de rezervă și reveni la orice versiune anterioară printr-un singur click
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Pentru a urmări indicatorii de performanță, conectați Google Analytics, adăugați site-ul în Google Search Console, verificați disponibilitatea acestuia pentru promovarea în motoarele de căutare cu ajutorul instrumentului SEO — toate acestea se pot face prin doar câteva click-uri în uKit
				</Text>
				<Link
					href="https://ukit.com/ro/signUp"
					color="--white"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					uKit este cea mai bună soluție pentru website-ul unei afaceri. Orice proiect tematic este lansat într-o clipă. Nu sunt necesare abilități sau cunoștințe speciale. Cu ajutorul constructorului nostru, puteți crea cu ușurință: website-uri promoționale, pagini de destinație și portofolii
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/ro/utworz-strone-docelowa" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_devices_en.webp?v=2021-11-29T22:05:08.486Z"
							width="100%"
							display="flex"
			...
			>
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/ro/utworz-strone-internetowa-dla-prawnika" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Creați-vă propriul website tip pagină unică chiar acum și testați constructorul nostru. Începeți gratuit cu o probă de 14 zile pentru fiecare site nou
				</Text>
				<Link
					href="https://ukit.com/ro/signUp"
					color="--secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/ro/constructor-de-pagini-web/"} place={"endOfHead"} rawKey={"61728b2456c65c1a397047dd"} />
		</RawHtml>
	</Theme>;
});