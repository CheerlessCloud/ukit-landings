...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/stworz-strone-internetowa-z-kursami-online"} />
		<Helmet>
			<title>
				Stwórz stronę internetową z kursami online — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"Stwórz swoją witrynę ze zintegrowaną płatnością online — nie potrzebujesz żadnych specjalistów internetowych, możesz to zrobić sam. Nieograniczona ilość stron i hosting, darmowe powiadomienia SMS"} />
			<meta property={"og:title"} content={"Stwórz stronę internetową z kursami online — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"Stwórz swoją witrynę ze zintegrowaną płatnością online — nie potrzebujesz żadnych specjalistów internetowych, możesz to zrobić sam. Nieograniczona ilość stron i hosting, darmowe powiadomienia SMS"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Stwórz swoją witrynę ze zintegrowaną płatnością online — nie potrzebujesz żadnych specjalistów internetowych, możesz to zrobić sam. Nieograniczona ilość stron i hosting, darmowe powiadomienia SMS
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Gotowe formularze opinii/zamówień i powiadomienia
				</Text>
			</Box>
			<Box
				display="flex"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Przykłady szablonów stron internetowych kursów online
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Jedno- i wielostronicowe szablony tematyczne dla każdej firmy. Każdy projekt ma kilka schematów kolorystycznych. Wybierz dowolny z nich
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Nowoczesny, pełnoprawny kreator stron, który pomoże Ci stworzyć dowolny rodzaj strony internetowej za pomocą gotowych elementów i widżetów. Narzędzia SEO i połączenie z usługami stron trzecich mogą poprawić wydajność Twojej witryny i przyciągnąć nowych klientów
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gotowe szablony na stronę edukacyjną
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Łatwa integracja płatności online
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Adaptacyjny projekt (przyjazny dla urządzeń mobilnych)
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Zbieranie przesłanych formularzy ze strony (np. wyskakujące okienka)
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Łatwe przesyłanie filmów i plików
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Jak stworzyć stronę internetową z kursami online
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Każdy może nauczyć się edytować i publikować własną witrynę. Wystarczy trochę czasu i inspiracji. Jeśli utkniesz, zawsze możesz skontaktować się z zespołem pomocy technicznej, aby poprosić o pomoc
				</Text>
			</Box>
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Najłatwiej jest wybrać odpowiedni szablon z katalogu. Wszystkie są darmowe. Następnie możesz edytować treść i opublikować swoją witrynę. Możesz też użyć zaawansowanych ustawień, aby zmienić schemat kolorów i czcionki lub zbudować własny zestaw bloków i elementów itp. Wszystko to można zrobić bez programistów czy projektantów — poradzisz sobie
					</Text>
					<Link
						margin="0px 0px 0px 0px"
						border-width="1px"
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Opisz swoje korzyści, usługi i ceny. Dzięki uKit możesz dodawać dowolny rodzaj treści: pliki, filmy, formularze, galerie, recenzje, wyskakujące okienka, czaty na żywo, przyciski oddzwaniania i inne. Nie ma ograniczeń co do liczby stron ani miejsca na dysku. Wszelkie zmiany w elemencie pojawiają się na stronie za pomocą zaledwie kilku kliknięć
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Twoja witryna jest gotowa do działania na telefonach i tabletach. Nie ma potrzeby konfigurowania żadnych dodatkowych ustawień. Jeśli chcesz, możesz ukryć niektóre elementy i bloki dla konkretnych urządzeń lub zmienić ich wygląd (kolor i tło). Nie musisz przyspieszać ładowania ani optymalizować obrazów dla małych ekranów — system zrobi to wszystko za Ciebie
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Tworząc witrynę, otrzymujesz bezpłatną domenę trzeciego poziomu. Ale jeśli potrzebujesz wysokiej jakości witryny, którą łatwo znaleźć w sieci, lepiej kupić domenę drugiego poziomu. Możesz to zrobić bezpośrednio na pulpicie nawigacyjnym uKit. Bezpieczna wersja HTTPS zostanie skonfigurowana automatycznie
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Kliknij opcję «Opublikuj» i strona jest gotowa dla pierwszych odwiedzających. Możesz dodawać do niej treści, dodawać nowe strony, zmieniać strukturę... Zmiany zostaną zastosowane dopiero po ponownym opublikowaniu witryny. Jeśli zrobisz coś źle, nie martw się — jednym kliknięciem możesz przywrócić kopię zapasową
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0" padding="40px 0 130px 0">
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Wbudowany kreator SEO pokaże, co musisz poprawić w swojej witrynie, aby promować ją w wyszukiwarkach. Dodatkowo możesz dodać swoją witrynę do Google Search Console i podłączyć analitykę za pomocą zaledwie kilku kliknięć
				</Text>
				<Link
					hover-background="linear-gradient(to right,#537cff,#537cff)"
					color="--white"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Dowolny typ witryny dla Twojej firmy: portfolio, strony docelowe, strony promocyjne, sklepy internetowe itp. Wszystko, czego potrzebujesz, to jeden przyjazny dla użytkownika program do tworzenia witryn internetowych — nie jest wymagana żadna specjalna wiedza ani umiejętności
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/ro/creati-un-website-pentru-un-consilier-juridic" color="--darkL1" hover-color="--primary">
						<Image
							width="100%"
							display="flex"
							align-items="center"
		...
		<Section color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0" padding="130px 0 130px 0">
			...
			>
				<Text
					...
					text-align="center"
				>
					Stwórz stronę internetową z kursami online z uKit
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Już dziś sprawdź funkcje uKit. Wystarczy trochę czasu i wyobraźnia. Za każdą utworzoną witrynę otrzymujesz bezpłatny 14-dniowy okres próbny
				</Text>
				<Link
					padding="15px 25px 16px 25px"
					margin="0px 0px 0px 0px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/ro/stworz-strone-internetowa-z-kursami-online/"} place={"endOfHead"} rawKey={"6189577c5780a3b1ef1386aa"} />
		</RawHtml>
	</Theme>;
});