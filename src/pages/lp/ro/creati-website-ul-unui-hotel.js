...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/creati-website-ul-unui-hotel"} />
		<Helmet>
			<title>
				Creați website-ul unui hotel — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"Nu trebuie să angajați un profesionist pentru a crea un website pentru hotelul dvs. Tot ce aveți nevoie este uKit — un constructor de website-uri online. Deja oferă hosting nelimitat, formulare predefinite cu notificări gratuite și instrumente SEO"} />
			<meta property={"og:title"} content={"Creați website-ul unui hotel — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"Nu trebuie să angajați un profesionist pentru a crea un website pentru hotelul dvs. Tot ce aveți nevoie este uKit — un constructor de website-uri online. Deja oferă hosting nelimitat, formulare predefinite cu notificări gratuite și instrumente SEO"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				>
					Creați website-ul unui hotel
				</Text>
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					Nu trebuie să angajați un profesionist pentru a crea un website pentru hotelul dvs. Tot ce aveți nevoie este uKit — un constructor de website-uri online. Deja oferă hosting nelimitat, formulare predefinite cu notificări gratuite și instrumente SEO
				</Text>
				<Link
					background="#4773ff"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Constructor convenabil cu tehnologie drag’n’drop
				</Text>
			</Box>
			<Box
				padding="0px 20px 0px 0px"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Exemple de design-uri pentru website-ul unui hotel
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Pe lângă design-urile tematice, primiți și un conținut predefinit, completat cu text și imagini. Conținutul poate fi adaptat cu ușurință. A începe și a lansa un website nu a fost niciodată mai ușor
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				<Image
					...
					sm-top="-44px"
				/>
				<Image loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_auto_en.jpg?v=2021-10-31T16:06:10.863Z" border-radius="18px" sm-border-radius="6px" />
			</Box>
			<Box
				lg-width="100%"
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white" text-align="center">
					Nu mai cheltuiți o avere pe întreținerea website-ului. Cu uKit, puteți face totul dvs. Unele elemente sunt automatizate, așadar nu vă vor ocupa mult timp. Nu aveți nevoie nici de cunoștințe speciale — doar intuiție și imaginație
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Ferestre tip pop-up și formulare de comandă și feedback
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Integrarea cu CRM și sisteme de plată online
					</Text>
				</Box>
				<Box
					width="33%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Widget-uri pentru media socială
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					<Text font="--lead" text-align="center" margin="0px 0px 0px 0px" color="--white">
						Tot ce este necesar pentru prezentarea hotelului și a camerelor
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Host nelimitat (trafic ∞, pagini ∞, spațiu pe disc ∞)
					</Text>
				</Box>
				<Box
					flex-direction="column"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Cum să creați un website pentru un hotel cu uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Lansarea unui site cu uKit este floare la ureche. Actualizarea conținutului și a datelor de contact este rapidă. Trebuie doar să urmați pașii de mai jos. Puteți să o faceți dvs., chiar și fără pic de experiență
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Lansarea unui website este rapidă, dacă nu vreți să porniți de la zero. uKit oferă o gamă largă de șabloane predefinite — trebuie doar să alegeți stilul și structura potrivită. Toate șabloanele au mai multe opțiuni pentru schemele de culori. Font, fundal și alți parametri de design pot fi modificați dintr-un singur foc
					</Text>
					<Link
						margin="0px 0px 0px 0px"
						border-style="solid"
			...
			>
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Descrieți serviciile și tarifele practicate de hotelul dvs.
					</Text>
					<Text
						font="--base"
						width="84%"
						...
						color="--dark"
					>
						Nu sunteți limitat de tipul de conținut: adăugați imagini din hotel, camere, bar, zona pentru copii, etc. Adăugați cât de multe poze aveți nevoie, video-uri, includeți hărți interactive Google Maps, adăugați texte pentru descrieri și tabele, și multe altele. Host nelimitat în cadrul tuturor abonamentelor. Noile elemente de pe pagină sunt adăugate sub formă de secțiuni și widget-uri predefinite, în editorul vizual
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Adăugați informații despre programări și plată
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Afișați prețurile pe camere, adăugați lista de prețuri pentru servicii extra, creați formulare pentru cazare, conectați sisteme de plată online. Pentru a face acest lucru, există un modul pentru magazin online și integrări cu cele mai populare instrumente de plată, CRM și sisteme de mailing. Notificările SMS și e-mail din formulare vor fi trimise către dvs. în mod gratuit
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Toate site-urile create cu uKit sunt afișate corect pe toate tipurile de dispozitive. Am avut grijă de asta pentru dvs. Dar puteți modifica modul de afișare și opțiunile de design pentru secțiuni individuale, să le ascundeți pentru diferite tipuri de dispozitive și modifica afișarea pentru tablete (pe una sau două coloane)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Adresa website a hotelului dvs. ar trebui să fie ușor de recunoscut, de citit și de ținut minte. Puteți înregistra un domeniu nou direct din Panoul Administrativ uKit. Site-ul va rula automat cu un protocol de securitate HTTPS (certificatul SSL este oferit în mod gratuit)
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Când site-ul este gata, tot ce trebuie să faceți este să-l arătați potențialilor clienți. Pentru aceasta, dați click pe butonul Publică. Puteți schimba conținutul, adăuga pagini noi sau le puteți șterge pe cele irelevante, dacă este necesar. Creați copii de rezervă dacă nu doriți să pierdeți informații importante, astfel încât să puteți reveni rapid la o versiune anterioară, în caz de erori. Opțiunea de backup este complet gratuită
					</Text>
				</Box>
			</Box>
		</Section>
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Pentru a vă asigura că site-ul are succes și atrage clienți, este recomandat să-l promovați în cadrul motoarelor de căutare. Instrumentul SEO încorporat vă va ajuta în acest sens. Pentru a contoriza toți indicatorii cheie de pe site, puteți să-l adăugați în cadrul Google Search Console și Google Analytics. Durează doar câteva minute
				</Text>
				<Link
					color="--white"
					margin="0px 0px 0px 0px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Toate tipurile de site-uri pentru afaceri pot fi create prin intermediul uKit fără cunoștințe de programare. Puteți crea unul chiar și dacă este prima dată când realizați un website. Cu ajutorul uKit, este ușor să creați website-uri de promovare, cataloage, pagini de prezentare, blog-uri corporate și chiar și magazine online
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					{" "}
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/ro/creati-o-pagina-de-prezentare">
						<Image
				...
				<Box
					...
					flex-direction="column"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/ro/creati-un-website-pentru-un-dezvoltator-imobiliar">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		>
			...
			>
				<Text
					...
					font="--headline1"
				>
					Creați un website pentru un hotel cu uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Este timpul să vedeți cum funcționează uKit. Nu vă costă nimic. Perioada de probă de 14 zile este gratuită
					<Link
						white-space="normal"
						text-indent="0"
						text-overflow="clip"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/ro/creati-website-ul-unui-hotel/"} place={"endOfHead"} rawKey={"61897d782873826dd66e6182"} />
		</RawHtml>
	</Theme>;
});