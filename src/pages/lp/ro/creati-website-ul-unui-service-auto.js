...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/creati-website-ul-unui-service-auto"} />
		<Helmet>
			<title>
				Creați website-ul unui service auto — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"În cadrul constructorul de website-uri uKit, nu doar că puteți crea un site de înaltă calitate pentru un atelier de reparații auto, ci îl și puteți promova fără profesioniști web sau SEO. Rapid, accesibil și eficient"} />
			<meta property={"og:title"} content={"Creați website-ul unui service auto — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"În cadrul constructorul de website-uri uKit, nu doar că puteți crea un site de înaltă calitate pentru un atelier de reparații auto, ci îl și puteți promova fără profesioniști web sau SEO. Rapid, accesibil și eficient"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				<Text
					...
					as="h1"
				>
					Creați website-ul unui service auto
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					În cadrul constructorul de website-uri uKit, nu doar că puteți crea un site de înaltă calitate pentru un atelier de reparații auto, ci îl și puteți promova fără profesioniști web sau SEO. Rapid, accesibil și eficient
				</Text>
				<Link
					border-radius="100px"
					background="#4773ff"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Exemple de design-uri pentru website-ul unui atelier de reparații auto
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Toate șabloanele din catalog vin cu un conținut tematic, așa că nu va trebui să faceți multe editări. Trebuie doar să actualizați datele de contact și să vă adăugați propriul domeniu
				</Text>
			</Box>
			<Box
				display="flex"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Atunci când comandați un website la cheie, plătiți pentru munca unui număr mare de profesioniști. Cu uKit, primiți un serviciu care se adaptează afacerii dvs. Totul este pregătit și aproape complet configurat, așadar tot ce aveți de făcut este să adăugați detaliile finale pe site
				</Text>
			</Box>
			<Box
				justify-content="center"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Șabloane predefinite pentru website-ul unui atelier de reparații auto
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formulare de feedback și comandă predefinite
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Integrarea cu Google Maps și rețele sociale
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Creați website-ul unui service auto cu uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Cu uKit, nu sunt lucruri dificile de învățat. Puteți, cu ușurință, administra și configura un site, chiar dacă este pentru prima dată. Totul este automatizat, așa că oricine o poate face
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Șabloanele predefinite, structura paginii și conținutul — trebuie doar să alegeți opțiunea potrivită pentru dvs. și să o configurați după preferințe. Toate elementele paginii din constructor pot fi modificate, șterse, duplicate sau mutate. De asemenea, puteți schimba schemele de culori, fontul și fundalul
					</Text>
					<Link
						border-width="1px"
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Afișați lista de servicii și tarife
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Povestiți potențialilor clienți despre dvs. și ce puteți face pentru dânșii. Afișați locația atelierului dvs. de reparații auto cu ajutorul hărților online (chiar dacă dețineți mai multe sedii). Adăugați lista de prețuri și nu uitați să distribuiți orice ofertă specială actuală sau viitoare. În cadrul uKit, numărul de pagini și spațiul pe disc sunt nelimitate, așadar puteți crea o pagină separată pentru fiecare serviciu oferit și să includeți o descriere detaliată, tarife, imagini și video
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Toate paginile noului website vor arăta perfect indiferent de rezoluția ecranului. Puteți ascunde secțiunile selectate sau anumite elemente pentru anumite tipuri de dispozitive, modifica parametrii de design: culoare, fundal, mod de afișare (de exemplu, pe tablete, widget-urile pot fi aranjate pe o coloană sau două)
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px">
						Conectați un domeniu ușor de reținut
					</Text>
					<Text
						lg-width="100%"
						margin="0px 0px 24px 0px"
						...
						width="84%"
					>
						uKit oferă utilizatorilor săi un domeniu de nivel trei gratuit și generează automat certificate SSL (pentru a lucra cu protocolul de securitate HTTPS). Dar dacă doriți să creșteți credibilitatea și loialitatea clienților dvs., înregistrați un domeniu unic. Puteți face acest lucru în cadrul Panoului Administrativ uKit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Dați click pe «Publică» și site-ul dvs. va fi gata pentru primii săi vizitatori. Schimbați conținutul actual, adăugați informații noi sau ștergeți-le pe cele irelevante. Fără limite. Puteți crea o copie de rezervă, astfel încât să reveniți la o versiune anterioară a site-ului, în orice moment. Sistemul copiilor de rezervă uKit nu aduce un cost suplimentar, totul este inclus!
					</Text>
				</Box>
		...
		<Section lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0" padding="40px 0 130px 0" color="--darkL1">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Acum, adăugați site-ul în cadrul Google Search Console pentru ca acesta să înceapă să fie indexat. Înainte de asta, nu uitați să verificați dacă site-ul este pregătit pentru publicare, cu ajutorul instrumentului SEO încorporat. Cele mai multe opțiuni, inclusiv conectarea unui sistem de analiză, se pot configura în doar câteva click-uri. Dacă este necesar, puteți conecta servicii terțe, precum Google Tag Manager, Facebook Pixel și multe altele
				</Text>
				<Link
					border-style="solid"
					color="--white"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					uKit este constructorul perfect pentru website-ul oricărui tip de afacere. Platforma vă permite să administrați și să gestionați, cu ușurință, pagini de prezentare, site-uri promoționale, portofolii și chiar și magazine online
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/ro/creati-un-website-pentru-profesionisti-din-domeniul-sanatatii" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Creați website-ul unui atelier de reparații auto cu uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Petreceți oricât timp aveți nevoie pentru a descoperi serviciile noastre. Aveți o perioadă de probă gratuită, de 14 zile, pentru a testa toate opțiunile oferite de uKit, pentru fiecare website nou creat. Vedeți rezultatele și decideți dacă uKit este soluția potrivită pentru dvs.
					<Link
		...
		<RawHtml>
			...
			<link href={"/lp/ro/creati-website-ul-unui-service-auto/"} rel={"canonical"} place={"endOfHead"} rawKey={"617ed74ef97a2047fe807c68"} />
		</RawHtml>
	</Theme>;
});