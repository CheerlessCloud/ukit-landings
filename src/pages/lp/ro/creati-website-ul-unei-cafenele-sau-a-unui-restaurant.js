...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/creati-website-ul-unei-cafenele-sau-a-unui-restaurant"} />
		<Helmet>
			<title>
				Creați website-ul unei cafenele sau a unui restaurant — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"Cu uKit, puteți crea un website profesional, aspectuos și complet funcțional pentru o cafenea sau un restaurant, pe cont propriu. Vine cu host nelimitat, notificări SMS gratuite și instrumente SEO predefinite"} />
			<meta property={"og:title"} content={"Creați website-ul unei cafenele sau a unui restaurant — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"Cu uKit, puteți crea un website profesional, aspectuos și complet funcțional pentru o cafenea sau un restaurant, pe cont propriu. Vine cu host nelimitat, notificări SMS gratuite și instrumente SEO predefinite"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Cu uKit, puteți crea un website profesional, aspectuos și complet funcțional pentru o cafenea sau un restaurant, pe cont propriu. Vine cu host nelimitat, notificări SMS gratuite și instrumente SEO predefinite
				</Text>
				<Link
		...
		<Section md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-padding="80px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Exemple de design-uri pentru website-ul unei cafenele sau a unui restaurant
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Șabloanele vă vor ajuta să începeți să vă creați website-ul chiar dacă nu aveți experiență sau cunoștințe speciale. Puteți modifica orice doriți, direct în interfața vizuală. Apoi doar conectați-vă domeniul și publicați site-ul
				</Text>
			</Box>
			<Box
				flex-direction="row"
		...
		<Section padding="130px 0 130px 0" lg-padding="100px 0 100px 0" background="--color-secondary" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Nu este necesar să angajați pe cineva pentru administrarea, design-ul sau configurarea SEO a site-ului. Toate acestea le puteți face chiar dvs., cu ajutorul uKit. Avem instrumente speciale sau soluții predefinite pentru fiecare acțiune
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Secțiuni predefinite pentru meniu și galerii
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Editor foto cu filtre predefinite
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formulare de comandă și feedback, ferestre tip pop-up
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integrarea cu CRM și notificări gratuite
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Număr nelimitat de pagini și imagini
					</Text>
				</Box>
				<Box
					align-items="flex-start"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Cum să creați un website pentru o cafenea sau un restaurant cu uKit
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					Procesul de creare a unui website este impecabil, așadar nu va trebui să angajați niciun dezvoltator experimentat. Aveți nevoie doar de puțin timp și inspirație. Pentru a vă asigura că nu omiteți ceva, urmați pașii de mai jos
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Vă recomandăm să începeți cu unul dintre șabloanele predefinite din cadrul catalogului nostru. Toate au diferite scheme de culori. Fonturile și ceilalți parametri de design pot fi modificați prin doar câteva click-uri. Dacă aveți propria viziune pentru site, puteți începe cu un șablon gol și să construiți site-ul utilizând elementele predefinite
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						border-width="1px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Povestiți clienților despre dvs.
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Adăugați poze sau video cu interiorul cafenelei/restaurantului, adăugați meniul și cele mai populare feluri de mâncare. Afișați prețurile și ofertele speciale. Nu uitați să prezentați și angajații, sau măcar bucătarul șef. Specificați care sunt orele de funcționare și distribuiți locația dvs. cu ajutorul Google Maps. Constructorul nostru online vă va ajuta să completați toate aceste elemente. Trageți și amplasați secțiunile necesare pe pagină, modificați conținutul și personalizați design-ul
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Site-ul dvs. va arăta perfect, în mod automat, atât pe telefoane cât și pe tablete. Dar, dacă aveți nevoie, puteți activa/dezactiva manual elemente sau secțiuni individuale pe diferite dispozitive, dar și modifica parametrii de design
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Creați un url ușor de utilizat
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Puteți înregistra un domeniu de nivel doi direct prin intermediul Panoului Administrativ uKit. Înregistrările DNS și protocolul de securitate HTTPS vor fi setate în mod automat. Nu doriți să achiziționați un domeniu? Utilizați un domeniu de nivel trei, gratuit, bazat pe extensiile oferite de uKit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Website-ul dvs. va fi pregătit pentru vizitatori imediat ce îl publicați. Tot ce trebuie să faceți este să dați click pe butonul «Publică» și toate modificările dvs. vor fi salvate. Nu vă faceți griji că veți șterge sau pierde ceva: uKit creează copii de rezervă automate pentru website (+ până la 10 copii manuale). Puteți reveni la o versiune anterioară printr-un singur click
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Integrați site-ul cu un CRM, dacă aveți nevoie. Configurați notificările instant din formulare astfel încât să puteți răspunde rapid clienților dvs. Adăugați site-ul pe Google din Panoul Administrativ uKit și integrați sistemele de analiză. Cu uKit, puteți face aceste lucruri în doar câteva click-uri. De asemenea, puteți să vă îmbunătățiți rangul în căutare cu ajutorul instrumentului încorporat SEO. Numeroase opțiuni sunt automate
				</Text>
				<Link
					href="https://ukit.com/ro/signUp"
					color="--white"
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 0px 0px" font="--base">
					Constructorul nostru vă permite să creați și să administrați orice site-uri pentru afacerile dvs., chiar dacă aveți zero experiență și expertiză: website-uri de prezentare, portofolii, pagini de prezentare, chiar și magazine online
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					font="--headline1"
				>
					Creați website-ul unei cafenele sau a unui restaurant cu uKit
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Vreți să vedeți despre ce este vorba? Puteți testa platforma gratuit, în timpul perioadei de probă de 14 zile. Testați toate opțiunile uKit și vedeți ce rezultate puteți obține
				</Text>
				<Link
					padding="15px 25px 16px 25px"
					border-width="1px"
		...
		<RawHtml>
			...
			<link href={"/lp/ro/creati-website-ul-unei-cafenele-sau-a-unui-restaurant/"} rel={"canonical"} place={"endOfHead"} rawKey={"618a4c41e658bd023e2315b2"} />
		</RawHtml>
	</Theme>;
});