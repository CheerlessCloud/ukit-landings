...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/creator-de-portofoliu"} />
		<Helmet>
			<title>
				uKit - Creator de portofolii
			</title>
			<meta name={"description"} content={"Spuneți-le potențialilor clienți despre dvs. și arătați-le cele mai bune lucrări, direct pe propriul site, creat cu uKit. Sute de șabloane tematice, integrări și găzduire nelimitată vă vor permite să vă lansați site-ul "} />
			<meta property={"og:title"} content={"uKit - Creator de portofolii"} />
			<meta property={"og:description"} content={"Spuneți-le potențialilor clienți despre dvs. și arătați-le cele mai bune lucrări, direct pe propriul site, creat cu uKit. Sute de șabloane tematice, integrări și găzduire nelimitată vă vor permite să vă lansați site-ul "} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Spuneți-le potențialilor clienți despre dvs. și arătați-le cele mai bune lucrări, direct pe propriul site, creat cu uKit. Sute de șabloane tematice, integrări și găzduire nelimitată vă vor permite să vă lansați site-ul
				</Text>
				<Link
					border-style="solid"
		...
		<Section md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-padding="80px 0 100px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Exemple de șabloane de portofoliu
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Cu siguranță veți găsi șablonul tematic potrivit pentru afacerea dvs., în bogata bibliotecă a platformei. De exemplu, prin doar câteva click-uri, puteți crea un portofoliu de designer de interior sau un portofoliu de dezvoltator. Toate șabloanele sunt personalizabile: puteți modifica fundalul, schemele de culori, fonturile, locația secțiunilor pe pagini, efectele de animație și multe altele
				</Text>
			</Box>
			<Box
				flex-direction="row"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0">
			...
			>
				<Text
					...
					color="--white"
				>
					uKit — Cel mai bun constructor complet de portofolii
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Nu trebuie să fii programator sau web designer. Îți poți face propriul portofoliu, chiar dacă nu ai construit vreodată vreun site. Puteți face totul pe cont propriu, fără a fi necesar să angajați specialiști
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Șabloane adaptive, predefinite, pentru portofolii
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Formulare de feedback încorporate
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Găzduire nelimitată (spațiu pe disc, trafic și pagini)
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Înregistrarea ușoară a unui domeniu
					</Text>
				</Box>
				<Box
					lg-width="50%"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Cum să creați un portofoliu cu uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Multe sarcini sunt deja automatizate și necesită foarte puțin control din partea dvs. Doar urmați pașii de mai jos și site-ul va fi gata de funcționare. O să vă placă rezultatul!
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Design-ul website-ului este reprezentația portofoliului dvs. Toate șabloanele uKit sunt gratuite și au o structură și un conținut predefinite. Și, sunt realizate de profesioniști. Așadar, va fi nevoie doar de un efort minim pentru a schimba site-ul. Dacă doriți, puteți edita rapid schema de culori, parametrii de fundal și font, precum și să activați efecte de animație pentru diferite secțiuni. Setările sunt foarte ușor de configurat
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Descrieți-vă abilitățile și arătați exemple din ce ați lucrat
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Puteți crea o pagină separată pentru fiecare dintre lucrările dvs. și puteți oricâte fișiere media doriți. Există chiar și un editor foto încorporat. Host-ul uKit este nelimitat, așa că nu trebuie să vă faceți griji cu privire la spațiu sau limitele de trafic. Nu uitați să adăugați diverse modalități de a putea fi contactat de către clienți: chat-uri live, formulare, butoane de reapelare, link-uri către rețele sociale și messenger, număr de telefon și e-mail. Veți primi notificări, în mod gratuit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Toate site-urile și paginile create prin uKit arată grozav pe orice dispozitiv datorită secțiunilor și șabloanelor adaptive. Puteți lăsa totul «ca atare», sau puteți ascunde secțiuni sau elemente individuale, le puteți schimba aspectul pe telefoane, tablete sau PC-uri
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Selectați un domeniu gratuit sau înregistrați un nume nou prin Panoul Administrativ uKit. Chiar dacă aveți deja propriul domeniu, îl puteți conecta la site-ul uKit. De asemenea, primiți gratuit protocolul HTTPS și certificatul SSL
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						După ce dați click pe butonul «Publică», orice modificări pe care le-ați făcut vor fi transferate în versiunea principală a site-ului. Nu uitați să vă republicați site-ul după fiecare modificare. Și, pentru a vă asigura că munca dvs. nu este pierdută, utilizați sistemul de creare a copiilor gratuite: până la 10 copii manuale + copii automate
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0" padding="40px 0 130px 0" color="--darkL1">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Actualizați site-ul cu exemple de lucrări noi și monitorizați statisticile vizitelor și statusul indexării. Adăugați-vă site-ul în Google Search Console sau conectați Google Analytics direct din Panoul Administrativ uKit în doar câteva click-uri
				</Text>
				<Link
					font="--lead"
					background="--color-secondary"
		...
		<Section background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0" padding="130px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Platforma noastră poate fi utilizată pentru diverse sarcini, de exemplu pentru a lansa un site pentru un avocat, preparator, consilier juridic, designer, artist, makeup artist, etc. uKit este constructorul perfect pentru orice tip de afacere
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				<Box
					...
					display="flex"
				>
					<Link href="/lp/ro/host-cu-un-constructor-de-website" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							border-radius="18px"
			...
			>
				...
				<Box
					...
					md-width="100%"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/ro/creati-un-website-pentru-un-consilier-juridic" color="--darkL1">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
			...
			>
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link href="/lp/ro/software-pentru-creare-de-website-uri" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Pentru a începe să lucrați cu platforma și să beneficiați de perioada de probă gratuită, trebuie doar să vă înregistrați în cadrul sistemului. Testați toate opțiunile uKit și vedeți cât de eficient este pentru dvs.
				</Text>
				<Link
					border-style="solid"
					border-radius="100px"
		...
		<RawHtml>
			...
			<link href={"/lp/ro/creator-de-portofoliu/"} rel={"canonical"} place={"endOfHead"} rawKey={"6176819f0a8d1dbdd2983598"} />
		</RawHtml>
	</Theme>;
});