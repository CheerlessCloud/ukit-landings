...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ro/creati-un-portofoliu-de-design-interior"} />
		<Helmet>
			<title>
				Creați un portofoliu de design interior — uKit. Constructor de site-uri pentru afaceri
			</title>
			<meta name={"description"} content={"Acum este mai ușor ca niciodată, doar folosiți uKit. Host nelimitat, șabloane predefinite și un editor ușor de utilizat. Puteți face totul chiar dvs., fără a fi necesar să angajați specialiști web."} />
			<meta property={"og:title"} content={"Creați un portofoliu de design interior — uKit. Constructor de site-uri pentru afaceri"} />
			<meta property={"og:description"} content={"Acum este mai ușor ca niciodată, doar folosiți uKit. Host nelimitat, șabloane predefinite și un editor ușor de utilizat. Puteți face totul chiar dvs., fără a fi necesar să angajați specialiști web."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Acum este mai ușor ca niciodată, doar folosiți uKit. Host nelimitat, șabloane predefinite și un editor ușor de utilizat. Puteți face totul chiar dvs., fără a fi necesar să angajați specialiști web
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Colectarea formularelor trimise de pe website
				</Text>
			</Box>
			<Box
				align-self="flex-start"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Exemple de șabloane pentru website-ul unui designer interior
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Un șablon predefinit tip portofoliu necesită un minim de efort pentru a fi modificate. Platforma uKit oferă toate funcțiile de care ați avea nevoie. Chiar și un începător se poate descurca cu procesul de editare
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					color="--white"
				>
					Opțiuni esențiale pentru website-uri de design interior
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Constructorul este ușor de utilizat, oferă secțiuni predefinite și conținut prestabilit. Toate funcționalitățile sunt în același loc și pot fi implementate fără cunoștințe de programare — doar prin câteva click-uri. Puteți pune în practică orice idee, chiar dvs
				</Text>
			</Box>
			<Box
				lg-flex-wrap="wrap"
			...
			>
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Chat-uri și widget-uri pentru a colecta feedback-ul vizitatorilor
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Notificări SMS de pe site, gratuite
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Secțiuni predefinite pentru portofoliu
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Editor încorporat pentru imagini, cu diferite filtre
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Cum să creați portofoliul de design interior cu uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Nu trebuie să vă faceți griji că nu vă ridicați la nivelul sarcinii. 
Constructorul de website-uri uKit este ușor de utilizat de oricine, 
chiar și pentru cei fără experiență în crearea de website-uri
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Puteți utiliza orice șablon vă place și se potrivește cu ideea viitorului site. Puteți schimba, în orice moment, șablonul cu un altul. Schema de culori și fonturile sunt modificate centralizat. Structura secțiunii este ușor de modificat, cu o simplă tragere și amplasare în locul dorit. Nu sunt necesare cunoștințe tehnice, ci doar acest constructor de website-uri convenabil
					</Text>
					<Link
						font="--lead"
						margin="0px 0px 0px 0px"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Șabloanele tematice vin la pachet cu un conținut implicit. Puteți să-l păstrați, editați sau înlocui complet, în funcție de ce preferați pentru website-ul dvs. Puteți să vă adăugați propriile imagini, modifica online, aplica filtre, precum și să adăugați video-uri, documente, fișiere și multe altele. Nu există limite în ceea ce privește structura și numărul de pagini. În plus, beneficiați de host nelimitat
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Dacă sunteți mulțumit cu website-ul pe care tocmai l-ați creat, atunci publicați-l. uKit îl va adapta automat pentru toate dispozitivele. Chiar și așa, puteți face unele modificări pentru fiecare tip de ecran, dacă doriți — se pot ascunde unele elemente, schimba culorile sau personaliza un meniu special
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Orice proiect uKit primește un subdomeniu gratuit. Dar, pentru a vă arăta profesionalismul și să obțineți rezultate mai bune în motoarele de căutare, este de preferat să vă achiziționați propriul domeniu personalizat. Puteți face acest lucru direct din Panoul Administrativ uKit. Protocolul HTTPS va fi activat în mod automat
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						În cazul în care apar probleme sau erori, sistemul creează automat copii de rezervă a site-ului, de fiecare dată când modificați conținutul acestuia. Așadar, nu trebuie să vă faceți griji pentru eventualele greșeli. Puteți modifica paginile oricât aveți nevoie. Amintiți-vă, însă, să dați click pe butonul «Publică», astfel încât utilizatorii dvs. să vadă modificările
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Adăugați-vă site-ul în motoarele de căutare pentru a începe indexarea. Doriți mai multe informații despre comportamentul utilizatorilor dvs.? Activați integrarea cu Google Analytics. Nu sunteți sigur dacă website-ul dvs. este pregătit pentru a fi promovat? Verificați-l cu instrumentul încorporat SEO. Toate aceste opțiuni sunt deja disponibile în cadrul Panoului Administrativ uKit
				</Text>
				<Link
					text-decoration-line="initial"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Constructorul nostru online vă permite să lansați orice tip de website pentru afaceri, fără a fi necesare cunoștințe sau abilități speciale. Interfața platformei a fost creată având în gând persoanele fără experiență în realizarea de website-uri. Aici puteți crea, cu ușurință, pagini de prezentare, website-uri de promovare, portofolii, cataloage, chiar și magazine online
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Creați un portofoliu de design interior cu uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Perioada de probă gratuită, de 14 zile, vă va permite să testați toate opțiunile oferite de uKit și să vedeți cum funcționează acesta
					<Link
		...
		<RawHtml>
			...
			<link href={"/lp/ro/creati-un-portofoliu-de-design-interior/"} rel={"canonical"} place={"endOfHead"} rawKey={"6159dd49eca9df435759a9f6"} />
		</RawHtml>
	</Theme>;
});