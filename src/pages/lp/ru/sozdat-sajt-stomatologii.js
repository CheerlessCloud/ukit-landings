		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Image
					...
					height="213.95px"
				/>
				<Image border-radius="18px" sm-border-radius="6px" loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/4.png?v=2021-08-20T04:30:34.014Z" />
			</Box>
			<Box
				width="33.333%"
				margin="60px 0px 0px 0px"
