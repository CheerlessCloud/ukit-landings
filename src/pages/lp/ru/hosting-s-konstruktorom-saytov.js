		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Image
					...
					sm-left="auto"
				/>
				<Image sm-border-radius="6px" loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_advert_ru.webp?v=2021-09-24T09:05:09.415Z" border-radius="18px" />
			</Box>
			<Box
				align-items="center"
				position="relative"
