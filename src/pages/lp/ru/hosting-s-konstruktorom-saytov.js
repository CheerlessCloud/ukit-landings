...
import { BsColumnsGutters, BsDocuments, BsArrowLeftRight, BsCheckBox, BsGear, BsDiamond, BsLaptop, BsArrowRepeat, BsCreditCard, BsWindow, BsBell, BsGraphUp, BsBarChart, BsChat, BsCloud, BsShieldShaded, BsPlus } from "react-icons/bs";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ru/hosting-s-konstruktorom-saytov"} />
		<Helmet>
			<title>
				Хостинг с конструктором сайтов — uKit. Конструктор сайтов для бизнеса
			</title>
			<meta name={"description"} content={"Многие сервисы онлайн-конструктов, а тем более классические хостинги, ограничивают потребляемые ресурсы сервера. Но не uKit. У нас вы получаете безлимитный хостинг (дисковое пространство), неограниченный сетевой трафик и бесконечное количество страниц в любом тарифе"} />
			<meta property={"og:title"} content={"Хостинг с конструктором сайтов — uKit. Конструктор сайтов для бизнеса"} />
			<meta property={"og:description"} content={"Многие сервисы онлайн-конструктов, а тем более классические хостинги, ограничивают потребляемые ресурсы сервера. Но не uKit. У нас вы получаете безлимитный хостинг (дисковое пространство), неограниченный сетевой трафик и бесконечное количество страниц в любом тарифе"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					Многие сервисы онлайн-конструктов, а тем более классические хостинги, ограничивают потребляемые ресурсы сервера. Но не uKit. У нас вы получаете безлимитный хостинг (дисковое пространство), неограниченный сетевой трафик и бесконечное количество страниц в любом тарифе
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Чтобы вам было проще начать, мы подготовили несколько сотен шаблонов разной тематики. Все они предоставляются совершенно бесплатно, легко настраиваются и имеют адаптивную вёрстку
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				<Image
					...
					height="207.95px"
				/>
				<Image src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_advert_ru.webp?v=2021-09-24T09:05:09.415Z" border-radius="18px" sm-border-radius="6px" loading="lazy" />
			</Box>
			<Box
				width="33.333%"
				margin="60px 0px 0px 0px"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					text-align="center"
				>
					Ключевые преимущества uKit для создания сайта
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white" text-align="center">
					Вам не придётся устанавливать и настраивать никакую CMS-систему — движок сайта заменён удобным онлайн-конструктором, который в интерактивном режиме позволяет быстро создавать типовые проекты для бизнеса только своими силами, без каких-либо специальных знаний
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Надёжный и по-настоящему безлимитный хостинг
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Не нужно устанавливать и настраивать свою CMS
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Все необходимые виджеты и элементы интерфейса
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Модуль магазина и приём оплаты онлайн
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Адаптивные тематические шаблоны{"\n\n"}
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Бесплатные SMS-уведомления из форм
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Автонастройка купленного домена{"\n\n"}
					</Text>
				</Box>
			</Box>
		</Section>
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Как получить сайт с хостингом в конструкторе uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					От вас потребуется минимум действий, которые легко описываются шагами ниже. Многие процессы автоматизированы и не требуют специальных знаний. Вы сможете сделать качественный сайт без опыта и навыков программирования — простым перетягиванием элементов в редакторе
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Огромное количество разных вариантов на любой вкус и цвет. Все современные, адаптивные и уже с осмысленным наполнением. Достаточно только заменить контактные данные на свои и можно переходить к процессу публикации. Нужно поправить структуру сайта или поменять расположение блоков, убрать лишние? Сделайте это в нашем удобном визуальном редакторе{"\n\n"}
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						В любом тарифе uKit вы никак не ограничиваетесь ни по количеству загружаемых файлов, ни по количеству созданных страниц. Вы можете добавлять любые элементы на свой сайт: изображения, видео, текст и даже произвольные файлы. Есть готовые виджеты для организации галерей, слайдеров, блоков с отзывами, таймлайнами, прайсами и товарами из каталога магазина. Всё ограничивается только вашей фантазией
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Ваше участие в настройке версии сайта для планшетов или для смартфонов — минимальное. Можно скрыть громоздкие или ненужные элементы, поменять настройки их внешнего вида (отдельный фон, цвет, сетка в две колонки для планшетов). Всё остальное конструктор сделает сам — все блоки редактора автоматически адаптируются под текущее разрешение экрана
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Если у вас нет своего, то зарегистрировать новый домен в популярных зонах, включая RU и РФ, можно непосредственно из панели управления uKit. Необходимые DNS-записи для связывания с хостингом будут внесены автоматически. Всем клиентам подключаются бесплатные SSL-сертификаты и настраиваются редиректы, чтобы сайт по умолчанию работал на защищённом протоколе HTTPS
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Вы можете редактировать свой сайт сколько угодно. В uKit даже не нужно отвлекаться на процедуру резервного копирования — система делает бэкапы в автоматическом режиме. Чтобы внесённые вами изменения стали доступны пользователям — просто нажмите кнопку публикации
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Продолжайте развивать свой сайт и наращивать аудиторию. А чтобы помочь вам в этом, uKit предоставляет комплекс всех необходимых инструментов: модуль магазина, готовые интеграции с CRM, системами аналитики и с рассылками, рекламный модуль (для самостоятельного ведения рекламных кампаний), SEO-визард (для проверки готовности страниц к продвижению) и добавление сайта в панель вебмастера в один клик
				</Text>
				<Link
					href="https://ukit.com/ru/signup"
					color="--white"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Практически любой тип бизнес-сайтов создаётся в нашем конструкторе в несколько кликов и без каких-либо специальных знаний. Сайты выглядят современно, продумано и легко обслуживаются без привлечения сторонних специалистов
				</Text>
			</Box>
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					text-align="center"
				>
					Получить сайт в uKit с безлимитным хостингом
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Просто авторизуйтесь в аккаунте и начните настройку своего первого проекта. Никаких обязательств или ввода данных банковских карт. 14 дней бесплатного тестирования
				</Text>
				<Link
					href="https://ukit.com/ru/signup"
					color="--secondary"
