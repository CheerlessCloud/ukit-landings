...
import { BsColumns, BsCheckBox, BsEnvelope, BsPhone, BsCloud, BsWindow, BsLock, BsColumnsGutters, BsBookmark, BsEye, BsXSquare } from "react-icons/bs";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ru/sozdat-sajt-advokata"} />
		<Helmet>
			<title>
				Создайте сайт адвоката — uKit. Конструктор сайтов для бизнеса
			</title>
			<meta name={"description"} content={"Красивый, адаптивный и действительно функциональный сайт можно сделать своими руками. Достаточно выбрать платформу uKit. Не нужно быть программистом или иметь любые другие профильные навыки: есть готовые шаблоны, виджеты и другие элементы, удобный онлайн-конструктор, масса дополнительных сервисов"} />
			<meta property={"og:title"} content={"Создайте сайт адвоката — uKit. Конструктор сайтов для бизнеса"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				<Text
					...
					as="h1"
				>
					Создайте сайт адвоката
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Красивый, адаптивный и действительно функциональный сайт можно сделать своими руками. Достаточно выбрать платформу uKit. Не нужно быть программистом или иметь любые другие профильные навыки: есть готовые шаблоны, виджеты и другие элементы, удобный онлайн-конструктор, масса дополнительных сервисов
				</Text>
				<Link
					color="--white"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Примеры шаблонов сайтов для адвокатов
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Выбирайте любой готовый дизайн и адаптируйте его под себя. Для максимально быстрого старта шаблоны поставляются с осмысленным наполнением — остаётся только поменять контактные данные на свои
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				/>
				<Image src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_autolaw_ru.webp?v=2021-09-07T08:56:18.654Z" border-radius="18px" sm-border-radius="6px" loading="lazy" />
			</Box>
			<Box
				justify-content="center"
				align-items="center"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Возможности uKit для создания сайтов адвокатов
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Сайт может быть одностраничным (лендинг/визитка) или со сложной структурой. Любые элементы подключаются в пару кликов: кнопки заказа звонка, онлайн-чаты и формы сбора заявок. Для работы с конструктором не нужны специальные знания — вы всё сможете сделать своими руками, потратив несколько часов
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Готовые шаблоны юридической тематики
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Полный набор самых востребованных элементов
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Бесплатные SMS-уведомления о событиях
					</Text>
				</Box>
				<Box
					align-items="flex-start"
			...
			>
				<Image
					...
					src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/FireShot%20Capture%20383%20-%20%D0%93%D0%BB%D0%B0%D0%B2%D0%BD%D0%B0%D1%8F%20-%20wefdewf.ukit%201.webp?v=2021-09-15T11:08:12.715Z"
					width="100%"
					loading="lazy"
				/>
			</Box>
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Как самостоятельно создать сайт адвоката в uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Даже если вы впервые используете uKit, у вас всё получится без помощи сторонних специалистов. Алгоритм максимально прост — достаточно пройти по стандартным шагам, обозначенным ниже
				</Text>
			</Box>
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						В нашем каталоге сотни готовых шаблонов для разных тематик, включая юриспруденцию. Выбирайте любой и адаптируйте его под себя. Цветовые палитры, наборы шрифтов и эффекты анимации меняются в пару кликов. Все настройки выполняются в визуальном редакторе. Никаких навыков программирования вам не потребуется
					</Text>
					<Link
						border-style="solid"
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Позаботьтесь о наполнении контентом
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Оригинальный контент лучше индексируется поисковыми системами. Плюс, вы сможете максимально точно описать свои преимущества и особенности работы. В конструкторе можно загрузить свои фото и отредактировать их онлайн (с наложением фильтров), добавить видеоролики, блоки с отзывами, файлы и другой контент, создать любое количество страниц. Интерфейс редактора действительно простой и удобный
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Вам не нужно создавать отдельную мобильную версию сайта — все блоки и элементы конструктора адаптивные. Вам нужно только убедиться, что всё работает и отображается как надо. Для тонкой настройки вы можете скрыть отдельные блоки или скорректировать цвет/фон выбранных секций
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Приобрести свой домен второго уровня, можно не покидая панели управления uKit. Настройка DNS-записей и привязка SSL-сертификатов для защищённой HTTPS-версии сайта выполняется автоматически
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Когда вы решите, что сайт готов к своим первым посетителям — нажмите кнопку «Опубликовать». Вы можете и дальше менять контент, добавлять новые страницы и удалять старые. Чтобы вы не боялись потерять все свои данные, в uKit есть система автоматического резервного копирования
					</Text>
				</Box>
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Не забудьте добавить сайт в поисковые системы, чтобы он начал индексироваться. Сделать это можно по ссылкам из админ-панели. Если вы хотите больше знать о своих посетителях — подключите систему аналитики. Плюс, в uKit есть встроенный SEO-визард для проверки готовности к продвижению и рекламный модуль, который обеспечивает простой запуск и ведение рекламных кампаний
				</Text>
				<Link
					padding="15px 25px 16px 25px"
					margin="0px 0px 0px 0px"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Онлайн-конструктор uKit — это простой и удобный инструмент для создания любых типов сайтов. Здесь легко можно сделать своими руками: визитки, каталоги, лендинги и даже интернет-магазины
				</Text>
			</Box>
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/ru/sozdat-sajt-agentstva-nedvizhimosti">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_coworking_ru.webp?v=2021-09-07T07:45:42.330Z"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Создать сайт адвоката в uKit
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Запустите свой сайт прямо сейчас, без каких-либо обязательств и указания платёжных реквизитов. Бесплатный тестовый доступ — целых 14 дней. Вы сможете изучить все возможности системы и убедиться в её эффективности
					<Link
						text-overflow="clip"
						hyphens="manual"
						href="https://ukit.com/ru/signup"
		...
		<RawHtml>
			...
			<link href={"/lp/ru/sozdat-sajt-advokata/"} rel={"canonical"} place={"endOfHead"} rawKey={"61430c81c48fb6f984550af1"} />
		</RawHtml>
	</Theme>;
});