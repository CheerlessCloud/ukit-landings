	...
	return <Theme theme={theme}>
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				...
				<Image
					...
					sm-right="-11px"
				/>
				<Image border-radius="18px" sm-border-radius="6px" loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/RTS1kyhE6814GQuucWfh.webp?v=2021-09-04T14:20:09.784Z" />
			</Box>
			<Box
				width="33.333%"
				margin="60px 0px 0px 0px"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/ru/konstruktor-lendingov">
						<Image
							loading="lazy"
			...
			>
				<Box
					...
					display="flex"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/ru/konstruktor-odnostranichnyh-sajtov" color="--darkL1">
						<Image
							loading="lazy"
			...
			>
				<Box
					...
					padding="0px 15px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/ru/sozdat-sajt-dezajnera-interjerov" color="--darkL1">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
