...
import { BsColumns, BsDocumentText, BsGear, BsGraphUp, BsTablet, BsWindow, BsCreditCard, BsDocuments, BsCameraVideo, BsBarChart } from "react-icons/bs";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ru/sozdat-sajt-dlya-prodazhi-onlajn-kursov1"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
