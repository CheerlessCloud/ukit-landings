...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/ru/sozdat-sajt-dezajnera-interjerov"} />
		<Helmet>
			<title>
				Создайте сайт-портфолио дизайнера интерьеров — uKit. Конструктор сайтов для бизнеса
			</title>
			<meta name={"description"} content={"Нет ничего проще, если выбрать конструктор uKit. Безлимитный хостинг, готовые шаблоны и максимально простой редактор. Со всем можно справиться без сторонних специалистов"} />
			<meta property={"og:title"} content={"Создайте сайт-портфолио дизайнера интерьеров — uKit. Конструктор сайтов для бизнеса"} />
			<meta property={"og:description"} content={"Нет ничего проще, если выбрать конструктор uKit. Безлимитный хостинг, готовые шаблоны и максимально простой редактор. Со всем можно справиться без сторонних специалистов"} />
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Вы можете использовать любой, даже нетематический шаблон. Главное, чтобы он вам нравился и соответствовал задачам сайта. Цветовая схема и шрифты меняются централизованно, в любой момент шаблон можно заменить на другой. Настройка структуры блоков выполняется простым перетаскиванием. Никакого кода и программирования, только удобный онлайн-конструктор
					</Text>
					<Link
						border-width="1px"
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Тематические шаблоны поставляются вместе с типовым наполнением. Его можно оставить, отредактировать под себя, а можно полностью заменить. Вы можете загружать свои картинки, редактировать их онлайн, накладывать стильные фильтры, вставлять видеоролики, добавлять документы и файлы. Никаких ограничений по структуре и количеству страниц, полностью безлимитный хостинг
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Если вас всё устраивает, просто опубликуйте сайт. Конструктор uKit автоматически адаптирует страницы для экранов любых устройств. Хотя при желании вы можете внести свои коррективы: скрыть отдельные элементы, поменять цвета и настроить специальное меню
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Любой проект в uKit получает бесплатное доменное имя, оно может быть читаемым и выглядеть красиво. Но чтобы подчеркнуть ваш профессионализм и получить лучшие позиции в поиске, стоит приобрести свой домен второго уровня. Сделать это можно прямо в панели управления. Защищённая HTTPS-версия сайта будет настроена автоматически
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						На случай проблем и ошибок система делает автоматические резервные копии сайта при каждом изменении контента. Вы можете не переживать о том, что сделали что-то не так. Страницы можно редактировать сколько угодно. Главное не забыть нажать кнопку публикации, чтобы изменения увидели ваши пользователи
					</Text>
				</Box>
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Чтобы сайт начал индексироваться, добавьте его в поисковые системы. Хотите максимум подробностей о поведении ваших пользователей? Настройте интеграцию с системой аналитики. Нужно запустить рекламные кампании? Воспользуйтесь рекламным модулем. Сомневаетесь в готовности сайта к продвижению? Запустите проверку в SEO-визарде. Все эти возможности уже встроены в панель управления сайтом
				</Text>
				<Link
					href="https://ukit.com/ru/signup"
					text-decoration-line="initial"
		...
		<Section background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0" padding="130px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Наш онлайн-конструктор позволяет запускать любые типы бизнес-сайтов без специальных знаний и навыков. Интерфейс системы рассчитан в первую очередь на новичков. Здесь легко сделать своими руками: лендинги, визитки, портфолио, каталоги и даже интернет-магазины
				</Text>
			</Box>
			...
			>
				<Box
					...
					padding="0px 15px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/ru/sozdat-sait-vizitku-online">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Создать сайт-портфолио дизайнера интерьеров в uKit
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					14 дней бесплатного тестирования ни к чему вас не обязывают. Вы сможете детально изучить все возможности системы и лично убедиться в эффективности конструктора
					<Link
						hyphens="manual"
						href="https://ukit.com/ru/signup"
		...
		<RawHtml>
			...
			<link href={"/lp/ru/sozdat-sajt-dezajnera-interjerov/"} rel={"canonical"} place={"endOfHead"} rawKey={"613fa20719035ef3eab74902"} />
		</RawHtml>
	</Theme>;
});