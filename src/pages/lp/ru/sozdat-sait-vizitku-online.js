...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" sm-overflow-x="hidden">
			...
			>
				...
				<Image
					...
					sm-border-radius="6px"
				/>
				<Image loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_complex_ru.webp?v=2021-09-05T17:11:42.996Z" border-radius="18px" sm-border-radius="6px" />
			</Box>
			<Box
				justify-content="center"
				align-items="center"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/ru/sozdat-sait-vizitku-online/"} place={"endOfHead"} rawKey={"613fa176563ca1d15033748f"} />
		</RawHtml>
	</Theme>;
});