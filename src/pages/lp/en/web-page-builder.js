...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/en/web-page-builder"} />
		<Helmet>
			<title>
				Web Page Builder — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Need to make a one-page site quickly and without hiring third-party specialists? uKit is here to help! It has a rich library of ready-made templates for landing pages and promo sites, all the necessary blocks and tools, as well as additional SEO options "} />
			<meta property={"og:title"} content={"Web Page Builder — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Need to make a one-page site quickly and without hiring third-party specialists? uKit is here to help! It has a rich library of ready-made templates for landing pages and promo sites, all the necessary blocks and tools, as well as additional SEO options "} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Need to make a one-page site quickly and without hiring third-party specialists? uKit is here to help! It has a rich library of ready-made templates for landing pages and promo sites, all the necessary blocks and tools, as well as additional SEO options
				</Text>
				<Link
					border-radius="100px"
					background="#4773ff"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					No need to start from scratch — speed up the process by using ready-made thematic templates. Customize the content and publish the project. Now everything is almost ready to go
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					uKit — a Top Notch, All-Inclusive Website Builder
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					You can create any landing page, promo site, portfolio, etc. yourself. All you need is a couple of hours. No need to hire experts to promote your site in search. Everything is already built into the platform
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Ready-made templates, blocks, sections, and other elements{" "}
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Free unlimited notifications (SMS + email)
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Other integrations (CRM, live chats, online payment)
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					It will take a little time to get the hang of the builder. Even if you’re working with the platform for the first time, you will be able to make a functional and beautiful one-page website on your own. Detailed knowledge base, interactive tips, and 24-hour technical support specialists will help you
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Choose a template that suits you best. Our catalog contains hundreds of ready-made options for any business. Each template has meaningful content, media files, and pop-ups. The color scheme, animation effects, and font sets can be changed in a few clicks. It’s also easy to swap out the template for another one, without losing any content
					</Text>
					<Link
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Pages in uKit are built with ready-made elements. The system has a set of blocks, sections, and widgets for everything: countdown timers, pop-ups, callback buttons, live chats, galleries, product cards, shopping cart (for creating an online store and accepting online payments), and more. Just drag and drop them onto the page and customize as much as you want
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Everything is ready — all sites built with uKit adapt to any screen resolution. Images are automatically optimized, so download speed is always high. You can make sure that the pages are displayed as they should be and leave everything «as is», or you can hide individual elements so that they don’t overload the site design for phones and/or tablets
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						You can connect your existing domain name or buy a new one right on the uKit Dashboard. All popular extensions will be available to you. SSL certificates are free, and redirect to the HTTPS site version is set automatically
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Don’t be afraid to change the content on your site. The uKit builder provides an automatic and manual backup system. You can create up to 10 backups and roll back to any site version with one click
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					To track performance indicators, connect Google Analytics, add the site 
to the Google Search Console, check your site readiness for promotion in
 search with the SEO wizard – all this can be done with a few clicks in 
uKit
				</Text>
				<Link
					border-radius="100px"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					uKit is the best go-to solution for business websites. Any thematic project is launched in a snap. No special skills or knowledge are required. With our builder, you can easily create: promo websites, landing pages, and portfolios
				</Text>
			</Box>
			...
			>
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/en/create-an-educational-facility-website">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
				...
				<Box
					...
					display="flex"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/en/create-a-lawyer-website">
						<Image
							loading="lazy"
		...
		>
			...
			>
				...
				<Text color="--lightD1" text-align="center" margin="0px 0px 36px 0px" font="--lead">
					Craft your one-page website right now and try our builder in action. Start for free with a 14-day trial for each new site
				</Text>
				<Link
					color="--secondary"
					text-decoration-line="initial"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/en/web-page-builder/"} place={"endOfHead"} rawKey={"61728b2456c65c1a397047dd"} />
		</RawHtml>
	</Theme>;
});