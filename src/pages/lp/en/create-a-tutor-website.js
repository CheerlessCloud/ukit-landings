...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/en/create-a-tutor-website"} />
		<Helmet>
			<title>
				Create a Tutor Website — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Ready-to use thematic designs, free HTTPS protocols, full set of SEO attributes, unlimited hosting, SMS notifications about requests from your site, and an easy-to-navigate visual interface"} />
			<meta property={"og:title"} content={"Create a Tutor Website — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Ready-to use thematic designs, free HTTPS protocols, full set of SEO attributes, unlimited hosting, SMS notifications about requests from your site, and an easy-to-navigate visual interface"} />
		...
		>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				<Box
					...
					width="50%"
				>
					<Link text-decoration-line="initial" href="/lp/en/create-an-educational-facility-website" color="--darkL1" hover-color="--primary">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/en/create-a-tutor-website/"} place={"endOfHead"} rawKey={"615b1bf9e0da58b40567450a"} />
		</RawHtml>
	</Theme>;
});