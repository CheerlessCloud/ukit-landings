...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/en/create-an-artist-portfolio"} />
		<Helmet>
			<title>
				Create an Artist Portfolio — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"With uKit, you can build a functional portfolio with a modern design and a mobile version without doing any programming – all you need is one night and your imagination"} />
			<meta property={"og:title"} content={"Create an Artist Portfolio — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"With uKit, you can build a functional portfolio with a modern design and a mobile version without doing any programming – all you need is one night and your imagination"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					With uKit, you can build a functional portfolio with a modern design and a mobile version without doing any programming — all you need is one night and your imagination
				</Text>
				<Link
					background="#4773ff"
					display="inline"
		...
		<Section md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-padding="80px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Examples of Artist Portfolio Designs
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					You can choose any of the designs in the catalog. Templates can be easily redesigned according to your needs and objectives. No need to edit the code. It’s a piece of cake!
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Even if you’re new to the platform, you’re guaranteed a high-quality portfolio site. No special skills are required. Pages are built with ready-made widgets and elements — just drag and drop them where you want
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Thematic templates for portfolios
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Beautiful sliders and galleries
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Built-in photo editor (with ready-made animation effects)
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Feedback forms, callback forms, live chats
					</Text>
				</Box>
				<Box
					md-width="100%"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					How to Create an Artist Portfolio with uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Just follow the steps below, and you’ll have a portfolio in just a few hours. No need to worry something will go wrong. Even beginners can handle it
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Our catalog is full of thematic and universal designs. You can pick whichever one you like. Plus, you can customize colors, fonts, backgrounds, and other design options
					</Text>
					<Link
						display="inline"
						color="--white"
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Tell us about yourself and your work. And be sure to include examples. You can build a single- or multi-page portfolio — there’s no limit to the number of pages or elements. Plus, uKit provides unlimited hosting, so you can upload as many artworks as you want. And to make your work look even more captivating, you can use slider and gallery widgets
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						All uKit templates and blocks are adaptive, so your site will look great on all devices. If needed, you can hide individual elements, or set alternative design blocks for phones and tablets. For example: color, background, and the number of columns
					</Text>
				</Box>
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						You can buy a domain name directly on the uKit Dashboard. DNS records will be automatically configured for our hosting. All sites work with the secure HTTPS protocol, and SSL certificates are generated by default
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						It’s never been easier — just click the «Publish» button and all the changes you’ve made will be available on the main site version. Feel free to experiment — the system makes automatic backups and stores up to 10 site versions. You can roll back with one click
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Add the site to search engines and start promoting it. Connect analytics systems to analyze specific actions your visitors do on the website. You can do this all from the uKit Dashboard. Many tools are automated. For example, the SEO wizard that helps with promotion
				</Text>
				<Link
					color="--white"
					font="--lead"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					The platform is perfect for running a variety of sites designed for business: landing pages, promo sites, catalogs, online stores, and more
				</Text>
			</Box>
			...
			>
				<Box
					...
					width="50%"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/en/create-a-legal-advisor-website">
						<Image
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/en/create-a-promo-website-for-your-business" color="--darkL1" hover-color="--primary">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
		...
		>
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Create an Artist Portfolio with uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Time to check out uKit for yourself – make use of the 14-day trial for every new site. No card data or other private info required
				</Text>
				<Link
					margin="0px 0px 0px 0px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/en/create-an-artist-portfolio/"} place={"endOfHead"} rawKey={"617ef3d341516409870de2fa"} />
		</RawHtml>
	</Theme>;
});