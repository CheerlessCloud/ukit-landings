...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/en/landing-page-builder"} />
		<Helmet>
			<title>
				Landing Page Builder — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Need an effective landing page with online payment options, collection of submitted forms, and other features? But don't want to splash out on developers, designers, and other specialists? uKit is a first-class platform for creating websites and landing pages. A visual, intuitive editor and SEO tools for promotion all in one place "} />
			<meta property={"og:title"} content={"Landing Page Builder — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Need an effective landing page with online payment options, collection of submitted forms, and other features? But don't want to splash out on developers, designers, and other specialists? uKit is a first-class platform for creating websites and landing pages. A visual, intuitive editor and SEO tools for promotion all in one place "} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Need an effective landing page with online payment options, collection 
of submitted forms, and other features? But don't want to splash out on 
developers, designers, and other specialists? uKit is a first-class 
platform for creating websites and landing pages. A visual, intuitive 
editor and SEO tools for promotion all in one place
				</Text>
				<Link
					color="--white"
					font="--lead"
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				<Text font="--lead" width="95%" margin="0px 0px 0px 0px" color="--darkL1">
					Order forms and free notifications{" "}
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					All templates are adaptive and look great on all devices. You can pick any ready-made design, taking into account the specifics of your business. For example, a beauty studio or a hotel business. It’s easy to change the design parameters and adapt the template to your needs
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					uKit — Award-Winning Site Builder
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					You can create landing pages with uKit by dragging and dropping the elements you want. No coding or special knowledge or skills required. The editor interface is clear and easy to handle, even for beginners. And there are still more uKit features for you to discover
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Set of blocks for any business
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Ready-made templates for landing pages
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Everything you need to create effective landing pages is already there, on the platform. With uKit, there’s no steep learning curve — most tasks are automated or greatly simplified. Even a newbie can handle it. Just follow the basic steps below and your site is ready!
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Start with a thematic template — there are hundreds of them in our catalog. Choose one and see for yourself how easy it is to work with the uKit editor. You can change color schemes, backgrounds, fonts, animation effects, and even the whole template. When changed, the site template keeps its content, so no worries your text, images, etc. will be lost
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						margin="0px 0px 0px 0px"
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Create a dream landing page! Replace the default content with custom content, add and remove blocks as you need, add your contact info, and set up feedback forms and notifications. If needed, connect online payments, CRM, mailing, and analytics systems. Any landing pages you create with uKit will be really effective
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Websites created in uKit load quickly and look great on all types of device. You don’t need to do anything here yourself. But there are also advanced settings that allow you to hide blocks or individual elements, change the design of separate sections, and more
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Instead of a free third-level technical domain, you can connect your existing second-level domain or register a new one. You can purchase a new domain name on the uKit Dashboard. SSL certificates and the HTTPS site version are provided for free
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Click «Publish» and the site is ready for customers. Want to edit and improve your site? In case of any changes, there is a free backup system — automatic backups and up to 10 manual backups
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Connect analytics systems and add your site to the Google Search Console. Track your statistics in one place and in a convenient format
				</Text>
				<Link
					border-color="--color-secondary"
					background="--color-secondary"
		...
		<Section background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0" padding="130px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					With uKit, you can create not only effective landing pages but also other types of project for your business, such as full-fledged websites, promo sites, portfolios, and online stores
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="36px 0px 30px 0px" width="100%" display="flex">
				...
				>
					<Link href="/lp/en/promo-site-builder" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
				...
				<Box
					...
					display="flex"
				>
					<Link href="/lp/en/website-builder-software" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
			...
			>
				...
				<Box
					...
					width="50%"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/en/create-a-legal-advisor-website" color="--darkL1">
						<Image
							width="100%"
							display="flex"
							align-items="center"
		...
		<Section lg-padding="100px 0 100px 0" padding="130px 0 130px 0" color="--darkL1" background="--color-secondary">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Create a Landing Page with uKit Now
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Sign up for the platform and you can check out all the uKit features yourself with a 14-day trial period
				</Text>
				<Link
					href="https://ukit.com/signup"
					color="--secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/en/landing-page-builder/"} place={"endOfHead"} rawKey={"6175bd8c9a4614335db50adb"} />
		</RawHtml>
	</Theme>;
});