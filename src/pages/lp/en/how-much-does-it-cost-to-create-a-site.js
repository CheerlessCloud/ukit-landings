...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/en/how-much-does-it-cost-to-create-a-site"} />
		<Helmet>
			<title>
				How Much Does It Cost to Create a Site? — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Create a website with uKit on your own – from $2.5/mo. No special knowledge or skills are required. All you need to work on and promote your site is already on the platform! Plus, you get unlimited hosting. Need a turnkey site but no time to develop it yourself? We can do it for you from $100"} />
			<meta property={"og:title"} content={"How Much Does It Cost to Create a Site? — uKit. Website builder for business"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Create a website with uKit on your own — from $2.5/mo. No special knowledge or skills are required. All you need to work on and promote your site is already on the platform! Plus, you get unlimited hosting. Need a turnkey site but no time to develop it yourself? We can do it for you from $100
				</Text>
				<Link
					color="--white"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Examples of Ready-Made Thematic Templates
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					All designs are modern, adaptive, and completely free. You’re sure to find a design for your business. You can also activate a site version for the visually impaired, and change the color scheme and fonts. Each template contains meaningful content and pop-up forms. Connect your domain, update your contact info, and publish the site
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section padding="130px 0 130px 0" lg-padding="100px 0 100px 0" background="--color-secondary">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					User-friendly visual editor. Any page can be built from ready-made blocks and elements by dragging and dropping them. Affordable subscription prices for businesses and individuals
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Built-in online store tools and a news page
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Unlimited hosting and number of pages on each plan
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Ready-made integrations with CRM, live chat, newsletter, and other services
					</Text>
				</Box>
				<Box
					flex-direction="column"
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					All the uKit features are included in your subscription plan: ready-made templates, SEO wizard, connecting your domain and analytics. With just a bit of time and input, you can create your own website. And you don’t need any special knowledge or skills
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						All ready-made templates in our library are completely free. You can choose any of them and change the color scheme, fonts, background, and other design parameters. No additional paid options. All inclusive
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						border-width="1px"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						You will get access to all the necessary blocks and widgets on any plan: live chats, sliders, galleries, countdown counters, feedback forms, callback buttons, price lists, timelines, reviews, and more. Just drag and drop, then customize them. Some plans give access to an HTML code editor (for pros) and online store widgets (to get online payments)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						All ready-made templates and blocks in the builder are adaptive. So your site will look perfect on all devices. Images are automatically adapted to the desired resolution — to optimize customer traffic and load as quickly as possible. It is possible to hide individual blocks or customize their design for selected types of device: phones, tablets, and PCs. Lazy loading of images and styles is activated with a single click. All these features are already included in your plan
					</Text>
				</Box>
				<Box display="flex" md-width="100%" width="50%" margin="0px 0px 0px 0px">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						All uKit users get free customizable third-level domains with popular extensions. You can also choose to set up a preferred URL for your site. If you need a second-level domain, you can register it directly on the uKit Dashboard from $8.99/year (registration and renewal). You can always connect an existing domain purchased from any third-party registrar. Whichever option you choose, SSL certificates are free and configured automatically
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Free Backups and Unlimited Hosting
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Edit and publish your site, edit again, then republish. Add as many pages as you need. You get unlimited disk space and can add any number of files to your site whatever plan you are subscribed to. The system can create up to 10 backups of your site. They are created both automatically or manually and can be restored with one click. All this is included by default in any uKit plan
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Accept online payments, integrate CRM and newsletter services, set your goals in analytics. Any number of products, fields in the forms, promo codes, different shipping methods
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Some tasks are automated, so these don’t take up any of your time. For example, a special SEO wizard will help you check if the site is ready for promotion. You can also connect external analytics with a few clicks to collect and analyze information about your site visitors
					</Text>
					<Link
						href="https://ukit.com/signup"
						color="--white"
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					No time to deal with all these steps? Just hire one of our pros from the Divly web agency
				</Text>
				<Link
					text-decoration-line="initial"
					font="--lead"
		...
		<Section md-padding="80px 0 100px 0" padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Our platform allows you to create all kinds of business sites in no time and without any special skills: landing pages, promo sites, catalogs, portfolios, corporate blogs, online stores, websites for teachers, educational institutions, and other projects
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/en/create-a-landing-page" color="--darkL1" hover-color="--primary">
						<Image
			...
			>
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link href="/lp/en/create-a-legal-advisor-website" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
		...
		<Section lg-padding="100px 0 100px 0" padding="130px 0 130px 0" color="--darkL1" background="--color-secondary">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Create a Website with uKit — from $2.5/mo
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Get a free 14-day trial period with all uKit features including the online store. No need to enter any personal info. Subscribe to uKit only if you like the results you’re getting!
				</Text>
				<Link
					text-decoration-line="initial"
					margin="0px 0px 0px 0px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/en/how-much-does-it-cost-to-create-a-site/"} place={"endOfHead"} rawKey={"619e9e36d6eb73a50d0f5c51"} />
		</RawHtml>
	</Theme>;
});