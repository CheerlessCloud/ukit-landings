	...
	return <Theme theme={theme}>
		...
		<Section background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0" padding="130px 0 100px 0">
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Link text-decoration-line="initial" href="/lp/en/create-a-tutor-website" color="--darkL1" hover-color="--primary">
						<Image
							border-radius="18px"
			...
			>
				...
				<Box
					...
					flex-direction="column"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/en/create-a-promo-website-for-your-business" color="--darkL1">
						<Image
							loading="lazy"
