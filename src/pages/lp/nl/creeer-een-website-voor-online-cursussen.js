...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-online-cursussen"} />
		<Helmet>
			<title>
				Creëer een website voor online cursussen — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Maak uw site met geïntegreerde online betaling - u heeft geen web profs nodig, u kunt het zelf doen. Een onbeperkt aantal pagina's en hosting, gratis sms-berichten"} />
			<meta property={"og:title"} content={"Creëer een website voor online cursussen — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Maak uw site met geïntegreerde online betaling - u heeft geen web profs nodig, u kunt het zelf doen. Een onbeperkt aantal pagina's en hosting, gratis sms-berichten"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Maak uw site met geïntegreerde online betaling — u heeft geen web profs nodig, u kunt het zelf doen. Een onbeperkt aantal pagina’s en hosting, gratis sms-berichten
				</Text>
				<Link
					background="#4773ff"
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Kant-en-klare feedback en meldingen
				</Text>
			</Box>
			<Box
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van website-templates voor online cursussen
				</Text>
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Thema-sjablonen met één of meerdere pagina’s voor elk bedrijf. Elk ontwerp heeft verschillende kleurenschema’s. Kies een van hen
				</Text>
			</Box>
			<Box
				flex-direction="row"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0">
			...
			>
				...
				<Text color="--white" margin="0px 0px 30px 0px" font="--base">
					Een moderne, volwaardige sitebouwer waarmee u elk soort website kunt maken met behulp van kant-en-klare elementen en widgets. SEO-tools en verbinding met diensten van derden kunnen de prestaties van uw site verbeteren en nieuwe klanten aantrekken
				</Text>
			</Box>
			<Box
				lg-flex-wrap="wrap"
			...
			>
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Kant-en-klare sjablonen voor een onderwijswebsite
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Eenvoudige betalingsintegratie
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Verzameling van ingediende formulieren van de website (bv. pop-upvensters)
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Upload eenvoudig video’s en bestanden
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Zo maakt u een website voor online cursussen
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Iedereen kan leren zijn eigen site te bewerken en te publiceren. U heeft alleen wat tijd en inspiratie nodig. Als u vastloopt, kunt u altijd contact opnemen met het ondersteuningsteam om hulp te vragen
				</Text>
			</Box>
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						De eenvoudigste optie is een geschikt sjabloon uit de catalogus te kiezen. Ze zijn allemaal gratis. Daarna kunt u de inhoud bewerken en uw site publiceren. Of u kunt de geavanceerde instellingen gebruiken om het kleurenschema en de lettertypen te veranderen, of uw eigen set blokken en elementen samen te stellen, enz. Dit alles kan gedaan worden zonder programmeurs of ontwerpers — u kunt het aan
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Beschrijf uw voordelen, diensten en prijzen. Met uKit kunt u elk type inhoud toevoegen: bestanden, video’s, formulieren, galerijen, beoordelingen, pop-ups, live chats, terugbelknoppen en nog veel meer. Er is geen limiet aan het aantal pagina’s of schijfruimte. Elke wijziging aan een element verschijnt op de pagina in slechts een paar klikken
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Uw site is klaar voor gebruik op telefoons en tablets. U hoeft geen extra instellingen te configureren. Als u wilt, kunt u sommige elementen en blokken verbergen voor specifieke apparaten, of hun ontwerp (kleur en achtergrond) wijzigen. U hoeft het laden niet te versnellen of afbeeldingen te optimaliseren voor kleine schermen — het systeem doet het allemaal voor u
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Wanneer u een site maakt, krijgt u een gratis domein op het derde niveau. Maar als u een site van hoge kwaliteit nodig hebt die gemakkelijk te vinden is op het web, is het beter om een domein op het tweede niveau te kopen. U kunt dit direct doen op het uKit Dashboard. De HTTPS-versie van de site wordt automatisch geconfigureerd
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Klik op ’’Publiceren’’ en de site is klaar voor zijn eerste bezoekers. U kunt er inhoud aan blijven toevoegen, nieuwe pagina’s toevoegen, de structuur veranderen... De wijzigingen worden pas toegepast nadat de site opnieuw is gepubliceerd. Als u iets verkeerd doet, geen zorgen — u kunt met één klik teruggaan naar de back-upversie
					</Text>
				</Box>
		...
		<Section lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0" padding="40px 0 130px 0" color="--darkL1">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					De ingebouwde SEO-wizard zal laten zien wat u moet verbeteren aan uw site om deze te promoten in zoekmachines. Bovendien kunt u uw site toevoegen aan de Google Search Console en met slechts een paar klikken analyses koppelen
				</Text>
				<Link
					background="--color-secondary"
					display="inline"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Elk type website voor uw bedrijf: portfolio’s, landingspagina’s, promo websites, online winkels, enz. Alles wat u nodig heeft is een gebruiksvriendelijke online site builder — geen speciale kennis of vaardigheden vereist
				</Text>
			</Box>
		...
		<Section color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0" padding="130px 0 130px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Creëer een website voor online cursussen met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Bekijk uKit’s functies vandaag. U heeft alleen wat tijd en inspiratie nodig. Voor elke site die u maakt, krijgt u een gratis 14-dagen proefversie
				</Text>
				<Link
					font="--lead"
					padding="15px 25px 16px 25px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-online-cursussen/"} place={"endOfHead"} rawKey={"6189577c5780a3b1ef1386aa"} />
		</RawHtml>
	</Theme>;
});