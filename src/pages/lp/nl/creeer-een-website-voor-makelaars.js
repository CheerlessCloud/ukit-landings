...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-makelaars"} />
		<Helmet>
			<title>
				Creëer een website voor makelaars — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Onbeperkte hosting en een onbeperkt aantal pagina's, kant-en-klare ontwerpen, gebruiksvriendelijke visuele editor, integratie met CRM, sms-berichten. Geen programmeervaardigheden vereist. U kunt uw eigen website in één keer maken."} />
			<meta property={"og:title"} content={"Creëer een website voor makelaars — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Onbeperkte hosting en een onbeperkt aantal pagina's, kant-en-klare ontwerpen, gebruiksvriendelijke visuele editor, integratie met CRM, sms-berichten. Geen programmeervaardigheden vereist. U kunt uw eigen website in één keer maken."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Onbeperkte hosting en een onbeperkt aantal pagina’s, kant-en-klare ontwerpen, gebruiksvriendelijke visuele editor, integratie met CRM, sms-berichten. Geen programmeervaardigheden vereist. U kunt uw eigen website in één keer maken
				</Text>
				<Link
					font="--lead"
		...
		<Section lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Voorbeelden van website-templates voor makelaars
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Alles wat u nodig hebt voor uw site, vindt u in uKit: aankoop van uw eigen domein, integraties met CRM en live chats, domein op basis van e-mail, gratis SSL-certificaat, onbeperkte hosting, enz. U hoeft alleen maar een van de ontwerpopties te kiezen of te beginnen met het bouwen van een site vanaf nul
				</Text>
			</Box>
			<Box
				lg-width="100%"
			...
			>
				...
				<Image
					...
					sm-border-radius="6px"
				/>
				<Image loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_service_en.webp?v=2021-10-04T19:25:32.838Z" border-radius="18px" sm-border-radius="6px" />
			</Box>
			<Box
				align-items="center"
				position="relative"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Belangrijkste kenmerken voor het creëren van websites voor makelaars
				</Text>
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					U hoeft geen programmeurs in te huren of de basis van webdesign te leren om met uKit hoogwaardige websites voor makelaars in onroerend goed te bouwen. U kunt in een handomdraai een site maken in een speciale online builder met kant-en-klare widgets en blokken
				</Text>
			</Box>
			<Box
				lg-flex-wrap="wrap"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Thematische sjablonen voor vastgoedmakelaars
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Eenvoudige integratie met CRM en de uCalc formulierenbouwer
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Live chats en feedbackformulieren
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Stappen, tijdlijnen, beoordelingen, en andere kant-en-klare elementen
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Zo creëert u een website voor makelaars met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Zelfs als u helemaal nieuw bent op het platform en geen technische vaardigheden hebt in het bouwen van sites, kunt u nog steeds maken wat u nodig hebt. U krijgt toegang tot een functioneel online platform waar u uw dienst-/productbeschrijvingen, prijslijsten, feedbackformulieren en andere elementen kunt toevoegen
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						U kunt beginnen met een thema-ontwerp of een ander sjabloon uit de catalogus — er zijn er meer dan 300. U kunt hun lettertype of kleurenschema in één keer veranderen. U kunt ook alle elementen en widgets die u nodig hebt, toevoegen, wijzigen en verwijderen. Het sjabloon kan op elk moment worden bewerkt, en de inhoud blijft ongewijzigd
					</Text>
					<Link
						color="--white"
						text-decoration-line="initial"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						U kunt de tekst en afbeeldingen die bij het sjabloon horen laten staan. Maar als u een professioneler ogende site wilt maken, voeg dan aangepaste inhoud toe: teksten, foto’s en video’s. U kunt ook afbeeldingen bewerken in de bouwer: filters gebruiken, afbeeldingen bijsnijden, vormen overlappen, en meer
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Alle interface-elementen passen zich automatisch aan de schermresolutie van alle apparaten aan. Als een bepaald element u niet bevalt, kunt u het verbergen op een bepaald toestel of een alternatieve look creëren, bijvoorbeeld door de achtergrond en het aantal kolommen te wijzigen
					</Text>
				</Box>
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Bedenk uw eigen domeinnaam en registreer deze direct op het uKit Dashboard, of koppel een bestaande domeinnaam. U hoeft niet eens handmatig uw DNS records aan te passen om door te verwijzen naar hosting. Gratis SSL-certificaten die de HTTPS-versie van de site ondersteunen, worden automatisch gegenereerd en geconfigureerd
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Klik op «Publiceren» en uw site is helemaal klaar voor zijn eerste bezoekers. Voel u vrij om de pagina-inhoud te wijzigen en te experimenteren: uKit kan tot 10 handmatige en automatische back-ups opslaan. Ging er iets mis? Herstel gewoon de juiste site versie vanuit de backup
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Om het voor bezoekers gemakkelijker te maken uw site te vinden, besteedt u aandacht aan de SEO metatags van elke pagina. Om er zeker van te zijn dat uw site klaar is voor publicatie, gebruikt u de ingebouwde SEO wizard om uw site te verbeteren
				</Text>
				<Link
					href="https://ukit.com/signUp"
					border-width="1px"
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					uKit is een gebruiksvriendelijke en zeer effectieve online bouwer voor het maken van een bedrijfswebsite. Er is geen speciale kennis of ervaring vereist. Je kunt elk project in een paar uur zelf maken
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Creëer een website voor makelaars met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Bekijk de prachtige ontwerpen en functionaliteit van uKit nu gratis. U zult er ongetwijfeld weg van zijn!
					<Link
						text-overflow="clip"
						hyphens="manual"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-makelaars/"} place={"endOfHead"} rawKey={"615d5350c3297f01fde1b758"} />
		</RawHtml>
	</Theme>;
});