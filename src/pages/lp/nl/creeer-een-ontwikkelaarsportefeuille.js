...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-ontwikkelaarsportefeuille"} />
		<Helmet>
			<title>
				Creëer een ontwikkelaarsportefeuille — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Geen tijd om te programmeren? Geen ontwerpideeën? Geen probleem - u kunt uw portfolio snel opbouwen met uKit: een rijke kant-en-klare sjabloonbibliotheek, een eenvoudige en handige visuele editor, en volledig onbeperkte hosting"} />
			<meta property={"og:title"} content={"Creëer een ontwikkelaarsportefeuille — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Geen tijd om te programmeren? Geen ontwerpideeën? Geen probleem - u kunt uw portfolio snel opbouwen met uKit: een rijke kant-en-klare sjabloonbibliotheek, een eenvoudige en handige visuele editor, en volledig onbeperkte hosting"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				>
					Creëer een ontwikkelaarsportefeuille
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Geen tijd om te programmeren? Geen ontwerpideeën? Geen probleem — u kunt uw portfolio snel opbouwen met uKit: een rijke kant-en-klare sjabloonbibliotheek, een eenvoudige en handige visuele editor, en volledig onbeperkte hosting
				</Text>
				<Link
					border-width="1px"
					border-style="solid"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Voorbeelden van portfolio-ontwerpen voor ontwikkelaars
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Alle functies zijn klaar voor gebruik. Er zijn thematische één- en meerbladige, moderne en populaire ontwerpopties. Na het kiezen van een sjabloon, verbindt u uw domein en publiceert u de site
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Met deze flexibele, gebruiksvriendelijke bouwer kunt u uw potentiële klanten vertellen over uzelf, uw vaardigheden en ervaring, en voorbeelden van uw werk laten zien
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Kant-en-klare blokken voor portfolio’s en landingspagina’s
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Pop-upvensters, livechatknoppen en feedbackformulieren
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Zo creëert u een website voor ontwikkelaars met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Investeer wat tijd en u zult een indrukwekkend resultaat krijgen. uKit heeft alles voor u om snel een site te bouwen — alles wat u hoeft te doen is de individuele parameters configureren en uw site publiceren
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Ontwikkelt u mobiele apps of bent u gespecialiseerd in Python, C++ of Java? Wij hebben honderden kant-en-klare sjablonen voor verschillende bedrijven. U kunt ze allemaal kiezen. Elk sjabloon heeft verschillende kleurenschema’s, lettertypes, animatie-effecten en achtergronden die kunnen worden bewerkt. De set blokken en de paginastructuur kunnen gemakkelijk worden aangepast aan uw wensen
					</Text>
					<Link
						text-decoration-line="initial"
						margin="0px 0px 0px 0px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Beschrijf uw vaardigheden en toon voorbeelden van uw werk
					</Text>
					<Text
						width="84%"
						lg-width="100%"
						...
						font="--base"
					>
						Vertel de wereld over uw beste vaardigheden en bewijs uw professionaliteit met voorbeelden. Met uKit kunt u een willekeurig aantal pagina’s maken, bestanden uploaden, video’s, afbeeldingen en andere inhoud toevoegen. Hosting is volledig onbeperkt. Afbeeldingen kunnen direct in de bouwer worden bewerkt: bijsnijden, effecten toepassen, roteren, enz.
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Alle uKit-blokken en -widgets zijn responsive op alle apparaten, dus u hoeft niets opnieuw te doen. Maar als het nodig is, kunt u geselecteerde elementen of secties verbergen, en hun achtergrond en ontwerp wijzigen voor telefoons of tablets. uKit past afbeeldingen automatisch aan de schermgrootte aan, en werkt ook met het lui laden van grote mediabestanden, zodat pagina’s op alle apparaten snel laden
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						U kunt een populaire domeinextensie kopen op het uKit Dashboard. De HTTPS-versie is geconfigureerd en werkt standaard — geen veiligheidswaarschuwingen voor de bezoekers van uw site
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						U kunt pagina’s zo veel veranderen en aanpassen als u wilt. Zij worden pas van kracht na publicatie. uKit kan automatische en handmatige back-ups van de site maken (tot 10 versies), wat herstel in slechts één klik betekent
					</Text>
				</Box>
		...
		<Section color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0" padding="40px 0 130px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					U kunt ook analytics koppelen en uw site toevoegen aan de Google Search Console op het uKit Dashboard. Dit wordt automatisch gedaan. U kunt ook controleren of uw site klaar is voor promotie met onze ingebouwde SEO-wizard
				</Text>
				<Link
					href="https://ukit.com/signup"
					text-decoration-line="initial"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					In onze bouwe, kunt u niet alleen portfolio’s, maar ook promo-websites, catalogi, zakelijke sites, online winkels, landingspagina’s en andere sitetypes maken
				</Text>
			</Box>
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Creëer een ontwikkelaarsportefeuille met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					14 dagen gratis uitproberen zonder uw persoonlijke gegevens in te voeren. Meld u nu aan en zie zelf hoe de bouwer voor u kan werken
				</Text>
				<Link
					margin="0px 0px 0px 0px"
					border-color="--color-secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-ontwikkelaarsportefeuille/"} place={"endOfHead"} rawKey={"617ea5961822ad90071748f2"} />
		</RawHtml>
	</Theme>;
});