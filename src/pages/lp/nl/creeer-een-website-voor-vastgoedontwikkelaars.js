...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-vastgoedontwikkelaars"} />
		<Helmet>
			<title>
				Creëer een website voor vastgoedontwikkelaars — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Portfolioblokken van hoge kwaliteit, kant-en-klare sjablonen, prijslijstsecties, feedbackformulieren, sms-berichten en andere thematische ontwerpelementen.\nGeen programmeervaardigheden vereist. Zelf een site bouwen is snel en eenvoudig."} />
			<meta property={"og:title"} content={"Creëer een website voor vastgoedontwikkelaars — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Portfolioblokken van hoge kwaliteit, kant-en-klare sjablonen, prijslijstsecties, feedbackformulieren, sms-berichten en andere thematische ontwerpelementen.\nGeen programmeervaardigheden vereist. Zelf een site bouwen is snel en eenvoudig."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 50px 0px" font="--base">
					Portfolioblokken van hoge kwaliteit, kant-en-klare sjablonen, prijslijstsecties, feedbackformulieren, sms-berichten en andere thematische ontwerpelementen.
					<br />
					Geen programmeervaardigheden vereist. Zelf een site bouwen is snel en eenvoudig
				</Text>
				<Link
			...
			<Box lg-display="flex" lg-justify-content="center" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						position="static"
					>
						Gebruiksvriendelijke online bouwer
					</Text>
				</Box>
				<Box
					width="25%"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Voorbeelden van website-templates voor vastgoedontwikkelaars
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					U hoeft alleen uw domein te kopen of te verbinden. Al het andere is te vinden in de bouwer. U hoeft geen programmeur of webdesigner te zijn. Gemakkelijk te beginnen en aan te passen
				</Text>
			</Box>
			<Box
				lg-width="100%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Belangrijkste kenmerken voor het creëren van websites voor vastgoedontwikkelaars
				</Text>
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					De ingebouwde SEO-wizard betekent dat u geen webspecialisten hoeft in te huren om uw site te promoten. U kunt een pagina opbouwen uit kant-en-klare blokken en widgets. Integratie met externe diensten is in een paar klikken geregeld
				</Text>
			</Box>
			<Box
				lg-width="100%"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Thematische sjablonen voor vastgoedontwikkelingsbedrijven
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Blok van meerdere pagina’s met contacten
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Een set widgets voor het maken van een portfolio
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Ingebouwde formulieren voor het verzamelen van verzoeken
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Zo creëert u een website voor vastgoedontwikkelaars met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Het lanceren van uw eigen site is eenvoudig, zelfs als u geen codeervaardigheden of andere speciale kennis hebt. Het proces zal slechts een paar uur duren. Volg simpelweg onderstaande stappen:
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						U kunt kiezen uit honderden kant-en-klare thematische ontwerpen voor verschillende soorten zakelijke websites, ongeacht of ze een pagina of meerdere pagina’s bevatten. Een sjabloon wordt geleverd met zinvolle inhoud die illustreert waar en wat voor soort inhoud u moet opnemen. U kunt de inhoud laten staan of aanpassen, zoals u verkiest. Kleurenschema’s en lettertypes kunnen ook in een paar klikken worden gewijzigd
					</Text>
					<Link
						color="--white"
						text-decoration-line="initial"
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Voeg tekst toe of bewerk tekst, upload foto’s en video’s, en toon de kwaliteit van uw dienst/product met andere site-elementen: sliders, galerijen, tijdlijnen, blokken met stappen, prijslijsten, enz. Afbeeldingen kunnen direct in de bouwer worden bewerkt
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						uKit past websites zonder gebruikersinput aan alle schermen aan. Maar als u wilt, kunt u afzonderlijke elementen of hele widgets verbergen, en de achtergrond en het ontwerp afzonderlijk aanpassen voor tablets of smartphones
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						U kunt een nieuw domein registreren op het uKit Dashboard. De hosting 
zal automatisch worden geconfigureerd. De site zal het veilige 
HTTPS-protocol ondersteunen, en er zijn geen extra stappen nodig om 
SSL-certificaten te verkrijgen
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Zodra u op de knop «Publiceren» klikt, wordt de site beschikbaar voor bezoekers. U kunt de inhoud op elk moment wijzigen: met uKit kunt u tot 10 back-ups bewaren. Als u iets verkeerd doet, rolt u gewoon terug naar de juiste versie of maakt u de actie ongedaan in de editor met de «Terug»-knop
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Vergeet niet de site toe te voegen aan zoekmachines en zorg voor SEO-promotie. U kunt de gereedheid van de site controleren in een speciale wizard. Deze zal u precies laten zien wat u moet veranderen aan uw site om ervoor te zorgen dat u hoog scoort in de zoekresultaten
				</Text>
				<Link
					href="https://ukit.com/signUp"
					font="--lead"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Met de uKit-bouwer kunt u elk thematisch bedrijfsproject in slechts een paar uur opstarten zonder speciale kennis of vaardigheden
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Creëer een website voor vastgoedontwikkelaars met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Begin met het gebruik van het platform zonder enige verplichting of vooruitbetaling. Bekijk de bouwersjablonen en functionaliteit nu gratis
					<Link
						word-break="normal"
						white-space="normal"
						text-indent="0"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-vastgoedontwikkelaars/"} place={"endOfHead"} rawKey={"615c7608df089181a52fdb0a"} />
		</RawHtml>
	</Theme>;
});