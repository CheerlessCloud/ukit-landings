...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/portfoliobouwer"} />
		<Helmet>
			<title>
				uKit - Portfoliobouwer
			</title>
			<meta name={"description"} content={"Informeer potentiële klanten over jezelf en laat ze je beste werk zien op je website - gemaakt met uKit. Dankzij honderden themasjablonen, integraties en onbeperkte hosting kun je met een gerust hart je site lanceren. "} />
			<meta property={"og:title"} content={"uKit - Portfoliobouwer"} />
			<meta property={"og:description"} content={"Informeer potentiële klanten over jezelf en laat ze je beste werk zien op je website - gemaakt met uKit. Dankzij honderden themasjablonen, integraties en onbeperkte hosting kun je met een gerust hart je site lanceren. "} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Informeer potentiële klanten over jezelf en laat ze je beste werk zien op je website — gemaakt met uKit. Dankzij honderden themasjablonen, integraties en onbeperkte hosting kun je met een gerust hart je site lanceren
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Voorbeelden van portfoliosjablonen
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					In de uitgebreide bibliotheek van het platform vind je vast en zeker de juiste thematische ontwerpen voor je bedrijf. Met een paar klikken kun je bijvoorbeeld een interieurportfolio of een ontwikkelaarsportfolio maken. Alle sjablonen zijn aanpasbaar: je kunt de achtergrond wijzigen, het kleurenpalet, lettertypes, positie van blocks op de pagina’s, animaties, en nog veel meer
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				<Image
					...
					loading="lazy"
				/>
				<Image sm-border-radius="6px" loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_industry_en.jpg?v=2021-10-31T16:06:43.865Z" border-radius="18px" />
			</Box>
			<Box
				position="relative"
				lg-width="100%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					uKit — De beste veelzijdige portfoliobouwer
				</Text>
				<Text color="--white" margin="0px 0px 30px 0px" font="--base">
					Je hoeft geen programmeur of webdesigner te zijn. Maak je eigen portfolio, zelfs als je nog nooit een website gemaakt hebt. Je kunt alles zelf doen, zonder een beroep te doen op specialisten
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Kant-en-klare aanpasbare ontwerpen voor portfolio’s
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Geïntegreerde feedbackformulieren
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Onbeperkte hosting (schijfruimte, verkeer, en pagina’s)
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Hoe maak je een portfolio met uKit?
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Vele taken zijn reeds geautomatiseerd en vergen weinig moeite. Volg gewoon de onderstaande stappen, en de site is klaar voor gebruik. Het resultaat zal je zeker bevallen!
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Het ontwerp van je website is het gezicht van je portfolio. Alle uKit sjablonen zijn gratis en hebben een kant-en-klare structuur en inhoud. Ze werden ontworpen door professionals. Het kost erg weinig moeite om de website te wijzigen. Als je wilt, kun je eenvoudig het kleurenpalet, de achtergrond en de lettertypes bewerken, en ook animaties inschakelen op verschillende blocks. De instellingen zijn erg eenvoudig te beheren
					</Text>
					<Link
						margin="0px 0px 0px 0px"
						border-width="1px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Omschrijf je vaardigheden en laat voorbeelden van je werk zien
					</Text>
					<Text
						width="95%"
						lg-width="100%"
						...
						font="--base"
					>
						Maak een aparte pagina voor elk van je werkstukken, en upload een onbeperkt aantal mediabestanden. Er is ook een geïntegreerde foto-editor. uKit hosting is onbeperkt, dus hoef je je geen zorgen te maken over ruimte- of bezoekerslimieten. Vergeet niet verschillende contactmogelijkheden toe te voegen: live chats, formulieren, callback-knoppen, links naar sociale netwerken en messengers, telefoonnummers, en e-mailadressen. Je krijgt gratis meldingen
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Alle websites en pagina’s die in uKit gemaakt zijn zien er op elk toestel geweldig uit, en dit dankzij de aanpasbare blocks en sjablonen. Je kunt het origineel behouden, of je kunt afzonderlijke blocks of elementen verbergen, óf hun weergave wijzigen voor telefoons, tablets, of PC’s
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Koppel een gebruiksvriendelijk domein
					</Text>
					<Text
						lg-width="100%"
						margin="0px 0px 24px 0px"
						...
						width="84%"
					>
						Kies een gratis domein of registreer een nieuwe naam op het uKit dashboard. Zelfs als je al een eigen domein hebt, kun je het koppelen aan je uKit site. Je krijgt ook een gratis HTTPS-protocol en een SSL-certificaat
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Nadat je op de knop «Publiceren» geklikt hebt, worden alle wijzigingen die je aangebracht hebt overgebracht naar de hoofdversie van de site. Vergeet niet na elke wijziging je site opnieuw te publiceren. En om ervoor te zorgen dat je werk niet verloren gaat, gebruik je het gratis back-up systeem: tot 10 handmatige + automatische back-ups
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Actualiseer je website met voorbeelden van nieuw werk, en houd je bezoekersstatistieken en de indexeringsstatus in de gaten. Voeg je site toe aan de Google Search Console of sluit met een paar muisklikken op het uKit Dashboard Google Analytics aan
				</Text>
				<Link
					text-decoration-line="initial"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 0px 0px" font="--base">
					Ons platform kan voor verschillende doeleinden gebruikt worden, bijvoorbeeld om een website te maken voor een advocaat, docent, juridisch adviseur, ontwerper, kunstenaar, visagist, enz. uKit is de perfecte bouwer voor elk bedrijf
				</Text>
			</Box>
			...
			>
				<Box
					...
					md-width="100%"
				>
					<Link href="/lp/nl/creeer-een-website-voor-een-auto-reparatiebedrijf" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		>
			...
			>
				...
				<Text color="--lightD1" text-align="center" margin="0px 0px 36px 0px" font="--lead">
					Om met het platform te beginnen werken en van de gratis proefperiode te profiteren, hoef je je alleen maar aan te melden. Bekijk de functies van uKit en ontdek zelf hoe doeltreffend het is
				</Text>
				<Link
					color="--secondary"
					text-decoration-line="initial"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/portfoliobouwer/"} place={"endOfHead"} rawKey={"6176819f0a8d1dbdd2983598"} />
		</RawHtml>
	</Theme>;
});