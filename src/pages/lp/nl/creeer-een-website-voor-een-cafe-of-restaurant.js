...
import { BsColumns, BsEnvelopeOpen, BsPhone, BsBell, BsGraphUp, BsColumnsGutters, BsGrid, BsImages, BsEnvelope, BsCheckBox, BsCreditCard } from "react-icons/bs";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-een-cafe-of-restaurant"} />
		<Helmet>
			<title>
				Creëer een website voor een café- of restaurant — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Met uKit, kunt u zelf een professionele, goed uitziende, en functionele website voor een café of restaurant maken. Het wordt geleverd met onbeperkte hosting, gratis sms-berichten, en kant-en-klare SEO-tools"} />
			<meta property={"og:title"} content={"Creëer een website voor een café- of restaurant — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Met uKit, kunt u zelf een professionele, goed uitziende, en functionele website voor een café of restaurant maken. Het wordt geleverd met onbeperkte hosting, gratis sms-berichten, en kant-en-klare SEO-tools"} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Met uKit, kunt u zelf een professionele, goed uitziende, en functionele website voor een café of restaurant maken. Het wordt geleverd met onbeperkte hosting, gratis sms-berichten, en kant-en-klare SEO-tools
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van ontwerpen voor café- en restaurantwebsites
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Met sjablonen kunt u beginnen met het bouwen van uw site, zelfs als u geen ervaring of speciale kennis hebt. Alles wat u niet bevalt, kunt u gemakkelijk veranderen in de online visuele interface. En dan gewoon uw domein aansluiten en de site publiceren
				</Text>
			</Box>
			<Box
				flex-direction="row"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					U hoeft niemand in te huren om uw site te onderhouden, te ontwerpen, of SEO op te zetten. U kunt dit alles zelf doen met uKit. Er is een speciale tool of eenvoudige oplossing voor elke taak
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Stijlvolle thematische sjablonen
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Kant-en-klare blokken voor het menu en de galerijen
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Foto-editor met kant-en-klare filters
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Feedback- en bestelformulieren, pop-up vensters
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integratie met CRM en gratis meldingen
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Onbeperkt aantal pagina’s en afbeeldingen
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1">
			...
			>
				<Text
					...
					as="h2"
				>
					Zo creëert u een website voor uw café of restaurant met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Het bouwproces van de site is naadloos, dus u hoeft geen professionele ontwikkelaars in te huren. U heeft alleen wat tijd en inspiratie nodig. En om er zeker van te zijn dat u niets mist, volgt u de onderstaande stappen
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Wij raden u aan te beginnen met een van de kant-en-klare sjablonen in onze catalogus. Ze hebben allemaal verschillende kleurenschema’s. Lettertypen en andere ontwerpparameters kunnen in een paar klikken worden gewijzigd. Als u uw eigen visie op de site hebt, kunt u beginnen met een blanco vel en uw site bouwen met behulp van kant-en-klare elementen
					</Text>
					<Link
						display="inline"
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Upload een foto of video van het interieur van het café/restaurant, voeg uw menu en meest populaire gerechten toe. Toon prijzen en speciale aanbiedingen. Vergeet niet uw medewerkers of op zijn minst uw chef te introduceren. Deel de openingstijden mee en toon de locatie op Google Maps. Onze online bouwer zal u helpen al deze taken te volbrengen. Sleep de nodige blokken naar de pagina, verander de inhoud en pas het ontwerp aan
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Uw site zal er automatisch perfect uitzien op telefoons en tablets. Maar indien nodig, kunt u handmatig afzonderlijke elementen of blokken op verschillende toestellen in- of uitschakelen of hun ontwerpparameters wijzigen
					</Text>
				</Box>
				<Box margin="0px 0px 0px 0px" display="flex" md-width="100%" width="50%">
					<Image
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Creëer een gebruiksvriendelijke URL
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						U kunt een nieuw domein registreren op het uKit Dashboard. DNS-records en een veilig HTTPS-protocol worden automatisch ingesteld. U wilt geen geld besteden aan een domein? Gebruik een gratis domein op derde niveau op basis van de extensies aangeboden door uKit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Uw site zal klaar zijn om bezocht te worden zodra hij gepubliceerd is. Het enige wat u hoeft te doen is op de ’’Publiceren’’-knop te klikken en al uw bewerkingen zullen worden opgeslagen. Wees niet bang om iets te verknoeien of te verliezen: uKit maakt automatisch back-ups van de site (+ tot 10 handmatige back-ups). U kunt met één klik teruggaan naar een oudere versie
					</Text>
				</Box>
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Integreer uw site met CRM als dat nodig is. Stel directe meldingen van formulieren in, zodat u klanten snel kunt antwoorden. Voeg de site toe aan Google op het uKit Dashboard en integreer analytische systemen. Met uKit kunt u alles doen in enkele klikken. U kunt ook uw site ranking in search verbeteren met behulp van onze speciale SEO-wizard. Veel functies zijn geautomatiseerd
				</Text>
				<Link
					border-radius="100px"
					display="inline"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Met onze bouwer kunt u alle sites voor uw bedrijven maken en onderhouden, zelfs met nul ervaring en expertise: promo-websites, portfolio’s, landingspagina’s, en zelfs online winkels
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					display="flex"
				>
					<Link text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-makelaars" color="--darkL1" hover-color="--primary">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		<Section background="--color-secondary" lg-padding="100px 0 100px 0" padding="130px 0 130px 0" color="--darkL1">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Creëer een website voor uw café of restaurant met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Wilt u het zelf in actie zien? U kunt het platform gratis uitproberen tijdens de proefperiode van 14 dagen. Bekijk alle uKit-functies en ontdek wat u kunt doen
				</Text>
				<Link
					margin="0px 0px 0px 0px"
					border-width="1px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-een-cafe-of-restaurant/"} place={"endOfHead"} rawKey={"618a4c41e658bd023e2315b2"} />
		</RawHtml>
	</Theme>;
});