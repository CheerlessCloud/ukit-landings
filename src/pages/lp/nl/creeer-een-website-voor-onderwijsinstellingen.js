...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-onderwijsinstellingen"} />
		<Helmet>
			<title>
				Creëer een website voor onderwijsinstellingen — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"De uKit websitebouwer is perfect voor vele taken, waaronder het bouwen van websites voor onderwijsinstellingen: kleuterscholen, scholen, voorbereidende scholen, beroepsscholen, hogescholen, online scholen, enz. Dit kunnen zowel commerciële als niet-commerciële instellingen zijn."} />
			<meta property={"og:title"} content={"Creëer een website voor onderwijsinstellingen — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"De uKit websitebouwer is perfect voor vele taken, waaronder het bouwen van websites voor onderwijsinstellingen: kleuterscholen, scholen, voorbereidende scholen, beroepsscholen, hogescholen, online scholen, enz. Dit kunnen zowel commerciële als niet-commerciële instellingen zijn."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					De uKit websitebouwer is perfect voor vele taken, waaronder het bouwen van websites voor onderwijsinstellingen: kleuterscholen, scholen, voorbereidende scholen, beroepsscholen, hogescholen, online scholen, enz. Dit kunnen zowel commerciële als niet-commerciële instellingen zijn
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead" width="95%">
					Versie voor visueel gehandicapten
				</Text>
			</Box>
			<Box
				align-self="flex-start"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van website-templates voor onderwijsinstellingen
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Formele stijl en verschillende thema-opties. Sjablonen zijn opgebouwd uit kant-en-klare blokken die kunnen worden verplaatst, toegevoegd, bewerkt en verwijderd. Koppel gewoon uw domein en neem de tijd om de inhoud van de site aan te passen
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				>
					Belangrijkste kenmerken voor websites van onderwijsinstellingen
				</Text>
				<Text font="--base" color="--white" text-align="center" margin="0px 0px 30px 0px">
					U kunt een volwaardige website maken met een complexe structuur of alleen een landingspagina. De bouwer is gemakkelijk te gebruiken, zelfs als u geen programmeerervaring hebt en u nieuw bent op het platform
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Volledige naleving van wettelijke voorschriften
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Certificaten of andere documenten uploaden en op de site plaatsen
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					<Text font="--lead" text-align="center" margin="0px 0px 0px 0px" color="--white">
						Kant-en-klare thematische blokken: galerijen, beoordelingen, en personeelskaarten
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text color="--white" font="--lead" text-align="center" margin="0px 0px 0px 0px">
						Stijlvolle, moderne sjablonen voor onderwijsinstellingen
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Automatische promotie in zoekmachines
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Online betalingsmogelijkheid voor rechtspersonen
					</Text>
				</Box>
			</Box>
		</Section>
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Zo creëert u een website voor onderwijsinstellingen met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					U hoeft niet bang te zijn dat u de vaardigheden niet heeft. uKit-bouwer is zeer gemakkelijk te gebruiken, op welk niveau u ook bent. Zelfs degenen die geen ervaring hebben met het maken van websites pikken het snel op
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						We hebben al een heleboel thematische ontwerpopties voorbereid met standaard inhoud: kies er gewoon een die het best bij u past. Alle sjablonen kunnen gemakkelijk worden bewerkt en gevuld met de nodige informatie, blokken en elementen. De versie voor visueel gehandicapten wordt met één klik geactiveerd
					</Text>
					<Link
						border-radius="100px"
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Elke tekst, afbeelding, video, bestand of ander inhoudstype kan 
gemakkelijk worden vervangen, toegevoegd of gewijzigd. U kunt uw 
certificaten, contracten, prijslijsten en andere documenten uploaden, 
lerarenkaarten maken en aankondigingen, beoordelingen en nieuws 
toevoegen. En u kunt dit allemaal zelf doen met behulp van een handige 
online bouwer
					</Text>
				</Box>
			</Box>
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Alle pagina’s die u hebt gemaakt zijn al aangepast aan alle apparaten. U hoeft niets handmatig aan te passen. U kunt de displaymodus veranderen en het zelf zien. Indien nodig kunt u afzonderlijke blokken verbergen of het uiterlijk van de site aanpassen voor tablets en telefoons
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Om een nieuwe domeinnaam te registreren of te verlengen, hoeft u het uKit Dashboard niet eens te verlaten. Uw domeininstellingen worden automatisch ingesteld, dus u hoeft niets handmatig te wijzigen. En de SSL-certificaten worden automatisch ingeschakeld en geconfigureerd
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Na publicatie kunt u uw site op elk moment wijzigen of aanpassen. Uw gebruikers zullen de wijzigingen pas zien nadat u de site opnieuw hebt gepubliceerd. Mislukte experimenten of andere fouten kunnen gemakkelijk worden geëlimineerd door terug te spoelen naar de eerdere versies van de site die zijn opgeslagen in het back-upgedeelte
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Zorg voor de promotie en indexering van uw site: voeg hem toe aan zoekmachines in een paar klikken vanaf het dashboard. U kunt ook controleren of uw site klaar is voor zoekmachines met onze ingebouwde SEO-wizard
				</Text>
				<Link
					href="https://ukit.com/signUp"
					color="--white"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Het is een zeer flexibele sitebouwer. Elk project kan worden uitgevoerd zonder dat u enige ervaring of hulp nodig hebt. Zelfs als u het nog nooit gedaan hebt
				</Text>
			</Box>
			<Box margin="36px 0px 30px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					{" "}
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-landingspagina">
						<Image
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					flex-direction="column"
				>
					<Link text-decoration-line="initial" href="/lp/nl/creeer-een-promo-website-voor-uw-bedrijf" color="--darkL1" hover-color="--primary">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
			...
			>
				<Box
					...
					padding="0px 15px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-uw-tandheelkundige-kliniek" color="--darkL1">
						<Image
							width="100%"
							display="flex"
							align-items="center"
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-portfolio-voor-interieurontwerp" color="--darkL1">
						<Image
			...
			>
				<Box
					...
					width="50%"
				>
					<Link text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-tutors" color="--darkL1" hover-color="--primary">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead" md-margin="0px 0px 30px 0px">
							Creëer een website voor tutors
						</Text>
					</Link>
				</Box>
				<Box
					...
					width="50%"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-docenten">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Creëer een website voor onderwijsinstellingen met uKit
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Probeer alle platformfunctionaliteiten gratis uit. Begin nu en ervaar zelf hoe eenvoudig en efficiënt uKit is
					<Link
						word-break="normal"
						white-space="normal"
						text-indent="0"
		...
		<RawHtml>
			...
			<link href={"/lp/nl/creeer-een-website-voor-onderwijsinstellingen/"} rel={"canonical"} place={"endOfHead"} rawKey={"6159e1df2c3a9db666910452"} />
		</RawHtml>
	</Theme>;
});