...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-portfolio-voor-interieurontwerp"} />
		<Helmet>
			<title>
				Creëer een portfolio voor interieurontwerp — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Het is nog nooit zo makkelijk geweest, gebruik gewoon uKit. Onbeperkte hosting, kant-en-klare sjablonen, en een gebruiksvriendelijke editor. U kunt alles zelf doen zonder externe webspecialisten in te huren."} />
			<meta property={"og:title"} content={"Creëer een portfolio voor interieurontwerp — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Het is nog nooit zo makkelijk geweest, gebruik gewoon uKit. Onbeperkte hosting, kant-en-klare sjablonen, en een gebruiksvriendelijke editor. U kunt alles zelf doen zonder externe webspecialisten in te huren."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Het is nog nooit zo makkelijk geweest, gebruik gewoon uKit. Onbeperkte hosting, kant-en-klare sjablonen, en een gebruiksvriendelijke editor. U kunt alles zelf doen zonder externe webspecialisten in te huren
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van website-templates voor interieurontwerpers
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Een kant-en-klare portfoliosjabloon vereist minimale inspanning om te herontwerpen. Het uKit-platform biedt alle functionaliteit die u nodig hebt. Zelfs een beginner kan het bewerkingsproces doen
				</Text>
			</Box>
			<Box
				lg-width="100%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Belangrijkste kenmerken voor websites voor interieurontwerp
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					De bouwer is eenvoudig te navigeren, heeft kant-en-klare blokken, en standaard inhoud. Alle functionaliteit is op één plaats en kan zonder enige coderingskennis worden ingesteld — in slechts een paar klikken. U kunt elk idee zelf implementeren
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Chats en widgets om feedback van bezoekers te verzamelen
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Gratis SMS-berichten van de site
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Kant-en-klare blokken voor het portfolio
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Ingebouwde foto-editor met verschillende filters
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Zo creëert u een portfolio voor interieurontwerp met uKit
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					U hoeft zich geen zorgen te maken dat u de taak niet aankan. uKit builder is voor iedereen zeer eenvoudig te gebruiken, zelfs als u helemaal geen ervaring hebt met het maken van websites
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						U kunt elk gewenst sjabloon gebruiken dat voldoet aan de doelstellingen van uw toekomstige site. U kunt het sjabloon op elk moment wijzigen. Het kleurenschema en de lettertypes worden centraal gewijzigd. De structuur van blokken is eenvoudig te veranderen met slepen en neerzetten. Er zijn geen technische vaardigheden vereist, alleen deze handige online bouwer
					</Text>
					<Link
						border-style="solid"
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Thematische sjablonen bevatten standaard inhoud. U kunt deze behouden, bewerken of volledig vervangen, afhankelijk van wat beter zou zijn voor uw site. U kunt uw eigen afbeeldingen uploaden, ze online bewerken, filters toepassen en video’s, documenten, bestanden en meer toevoegen. Geen beperkingen qua structuur en aantal pagina’s. En u krijgt onbeperkte hosting
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Als u tevreden bent met uw nieuw gemaakte site, publiceert u deze. uKit past deze automatisch aan voor alle apparaten. En toch kunt u voor elke schermresolutie enkele wijzigingen aanbrengen als dat nodig is: verberg enkele elementen, verander de kleuren, of pas een speciaal menu aan
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Elk uKit-project krijgt een gratis domeinnaam. Maar om uw professionaliteit te tonen en een betere ranking in zoekmachines te krijgen, is het beter om uw eigen second-level domein te kopen. U kunt dit direct doen op het uKit Dashboard. HTTPS-protocol zal automatisch worden ingesteld
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						In geval van problemen en fouten maakt het systeem automatische back-ups van de site telkens wanneer u inhoud wijzigt. Dus u hoeft niet bang te zijn dat u iets verkeerd doet. U kunt pagina’s zoveel bewerken als u wilt. Vergeet alleen niet op de knop «Publiceren» te drukken, zodat uw gebruikers de wijzigingen kunnen zien
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Voeg de site toe aan zoekmachines om de indexering te starten. Wilt u meer details over het gedrag van uw gebruikers? Stel de integratie met Google Analytics in. Weet u niet zeker of uw site klaar is voor promotie? Bekijk het in onze SEO-wizard. Al deze functies zijn al ingebouwd in uw dashboard
				</Text>
				<Link
					border-color="--color-secondary"
					background="--color-secondary"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Met onze online bouwer kunt u elk type bedrijfswebsite starten zonder speciale kennis of vaardigheden. De service-interface is ontwikkeld met nieuwelingen in gedachten. Hier kunt u gemakkelijk landingspagina’s, promo-websites, portfolio’s, catalogi, en zelfs online winkels maken
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					font="--headline1"
				>
					Creëer een portfolio voor interieurontwerp met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Met de gratis proefperiode van 14 dagen kunt u alle uKit-functies zelf uitproberen en zien hoe ze werken
					<Link
						hyphens="manual"
						href="https://ukit.com/ru/signup"
		...
		<RawHtml>
			...
			<link href={"/lp/nl/creeer-een-portfolio-voor-interieurontwerp/"} rel={"canonical"} place={"endOfHead"} rawKey={"6159dd49eca9df435759a9f6"} />
		</RawHtml>
	</Theme>;
});