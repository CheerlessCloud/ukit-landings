...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/promotiewebsitebouwer"} />
		<Helmet>
			<title>
				uKit - Promotiewebsitebouwer
			</title>
			<meta name={"description"} content={"Maak een mooie en functionele online promotiewebsite met de uKit-bouwer. Hij biedt een groot aantal responsieve, kant-en-klare themasjablonen en gratis meldingen van feedbackformulieren. Je kunt zelf een website samenstellen zonder dat je hiervoor beroep hoeft te doen op specialisten. "} />
			<meta property={"og:title"} content={"uKit - Promotiewebsitebouwer"} />
			<meta property={"og:description"} content={"Maak een mooie en functionele online promotiewebsite met de uKit-bouwer. Hij biedt een groot aantal responsieve, kant-en-klare themasjablonen en gratis meldingen van feedbackformulieren. Je kunt zelf een website samenstellen zonder dat je hiervoor beroep hoeft te doen op specialisten. "} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Maak een mooie en functionele online promotiewebsite met de uKit-bouwer. Hij biedt een groot aantal responsieve, kant-en-klare themasjablonen en gratis meldingen van feedbackformulieren. Je kunt zelf een website samenstellen zonder dat je hiervoor beroep hoeft te doen op specialisten
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				<Text width="95%" margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Feedbackformulieren en callback-knoppen
				</Text>
			</Box>
			<Box
				width="20%"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van ontwerpen voor promotiewebsites
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Kies het sjabloon dat bij je bedrijf past. In onze bibliotheek vind je ontwerpen voor een advocaat, leraar, arts, kunstenaar, enz. Je hoeft niet helemaal van nul te beginnen. Bij de meeste sjablonen kun je het kleurenpalet wijzigen, net als de lettertypes, animaties, achtergrond en vele andere parameters
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					uKit — Promotiewebsitebouwer van topklasse
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Je hoeft niet te kunnen programmeren of websites kunnen ontwerpen. Het platform is perfect voor beginnelingen. Slechts één uur en je promotiesite is klaar. Op het dashboard kun je niet alleen een domein aankopen en aan je site koppelen, maar ook statistieken en de Google Search Console inschakelen. Sommige taken zijn reeds geautomatiseerd en vergen weinig inspanning
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Kant-en-klare sjablonen voor promotiewebsites
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Pop-up vensters, feedbackformulieren en callback-knoppen
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Een domein aankopen en koppelen op het dashboard
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integraties met CRM, statistieken, live chats
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Zo creëer je een promotiewebsite met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Het lukt je zeker, zelfs als het je eerste keer is dat je een site maakt. uKit is de perfecte tool voor het maken van landingspagina’s, promotiewebsites en andere bedrijfssites. Als je er niet uit komt, kun je altijd de hulp inroepen van onze technische hulpverleners
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Je krijgt toegang tot een uitgebreide bibliotheek van themasjablonen (meer dan 40 categorieën), die allemaal al ingevuld zijn met inhoud die je zo nodig kunt aanpassen. In slechts enkele klikken kun je het kleurenpalet, lettertypes, achtergrond, animaties en andere parameters wijzigen, en bovendien de structuur van blocks en widgets aanpassen. Het is een fluitje van een cent!
					</Text>
					<Link
						border-style="solid"
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Vervang de contactgegevens door je eigen: links naar sociale netwerken, messengers, telefoonnummers, en e-mailadressen. De block met de contactgegevens kan veranderd worden in een block met meerdere pagina’s (als je een site met meerdere pagina’s maakt). Informeer je klanten over jezelf en je diensten, voeg een prijslijst en andere bestanden toe — de hosting op uKit is onbeperkt. Bied andere manieren van communicatie die gunstiger kunnen zijn voor je klanten: live chat, callback-knoppen, en online formulieren. Je krijgt meldingen per mail of telefoon (sms-berichten zijn gratis)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Ervaar zelf dat je promotiesite er op alle toestellen geweldig uitziet, zonder dat je daar extra moeite voor hoeft te doen. Alles is in orde en werkt. Als je wilt, kun je sommige blocks verbergen op verschillende soorten toestellen: tablets, smartphones, en PC’s
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						De uKit-bouwer biedt gratis third-level domeinen. Maar als je duidelijke second-level domeinnamen nodig hebt, kun je deze direct bij de aanbieder kopen en met onze hosting koppelen, óf ze aankopen op het uKit dashboard, wat veel gemakkelijker is. Je krijgt gratis SSL-certificaten en een automatische doorverwijzing naar de HTTPS-versie
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Je site is klaar! Toon je klanten je contactgegevens en krijg meldingen van feedback- en bestelformulieren. Wees niet bang om je site te bewerken — klik gewoon op de knop «Publiceren» om je wijzigingen op te slaan. Of gebruik het geïntegreerde back-up systeem — je kunt tot 10 handmatige back-ups maken, en dan zijn er nog de automatisch gemaakte back-ups
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Gebruik de geïntegreerde uKit SEO-tools om je site beter te laten presteren. Houd de doeltreffendheid van je site in de gaten via analysesystemen en zoekmachines (de Google Search Console). Je kunt al deze tools inschakelen met een paar muisklikken
				</Text>
				<Link
					href="https://ukit.com/signup"
					font="--lead"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 0px 0px" font="--base">
					Met uKit is het erg eenvoudig om een professionele website, landingspagina, portfolio, of online winkel te maken. Hiervoor heb je geen speciale kennis of vaardigheden nodig
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/nl/portfoliobouwer">
						<Image
							loading="lazy"
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_advert_en.webp?v=2021-10-31T13:56:49.544Z"
							width="100%"
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link href="/lp/nl/webpaginabouwer" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_foods_en.webp?v=2021-11-09T09:53:54.262Z"
			...
			>
				...
				<Box
					...
					flex-direction="column"
				>
					<Link href="/lp/nl/creeer-een-website-voor-makelaars" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead">
							Creëer een website voor makelaars
						</Text>
					</Link>
				</Box>
			</Box>
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Ontdek nu gratis alle functies van uKit en kijk zelf of het iets voor jou is
				</Text>
				<Link
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/promotiewebsitebouwer/"} place={"endOfHead"} rawKey={"6172f61c090214973880705b"} />
		</RawHtml>
	</Theme>;
});