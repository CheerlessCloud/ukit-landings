...
import { BsColumns, BsGrid, BsEnvelope, BsBell, BsGraphUp, BsPencil, BsPhone, BsAt, BsBarChart, BsBucket } from "react-icons/bs";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/webpaginabouwer"} />
		<Helmet>
			<title>
				uKit - Webpaginabouwer
			</title>
			<meta name={"description"} content={"Wil je snel een enkele webpagina maken zonder hiervoor externe specialisten in te schakelen? uKit kan je hierbij helpen! uKit beschikt over een uitgebreide bibliotheek van kant-en-klare sjablonen voor landingspagina's en promotiewebsites, alle nodige blocks en tools, én extra SEO-mogelijkheden. "} />
			<meta property={"og:title"} content={"uKit - Webpaginabouwer"} />
			<meta property={"og:description"} content={"Wil je snel een enkele webpagina maken zonder hiervoor externe specialisten in te schakelen? uKit kan je hierbij helpen! uKit beschikt over een uitgebreide bibliotheek van kant-en-klare sjablonen voor landingspagina's en promotiewebsites, alle nodige blocks en tools, én extra SEO-mogelijkheden. "} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Wil je snel een enkele webpagina maken zonder hiervoor externe specialisten in te schakelen? uKit kan je hierbij helpen! uKit beschikt over een uitgebreide bibliotheek van kant-en-klare sjablonen voor landingspagina’s en promotiewebsites, alle nodige blocks en tools, én extra SEO-mogelijkheden
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Feedback- en callback-formulieren
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Integratie met CRM en statistieken
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Voorbeelden van ontwerpen voor landingspagina"s
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Je hoeft niet van nul te beginnen — doe het sneller door gebruik te maken van kant-en-klare themasjablonen. Bewerk de inhoud en publiceer het project. Nu is alles bijna klaar
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				<Image
					...
					bottom="-96.66666666666666px"
					sm-border-radius="6px"
					height="158.04966666666667px"
					width="251.33333333333334px"
					lg-bottom="-67px"
				/>
				<Image
					border-radius="18px"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					uKit — een uitstekende en complete websitebouwer
				</Text>
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					Met uKit maak je zelf allerlei landingspagina’s, promotiewebsites, portfolio’s, enz. Het kost slechts een paar uur. Je hoeft ook geen experts in te huren om je site te promoten bij de zoekmachines. Alles is reeds geïntegreerd in het platform
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Kant-en-klare sjablonen, blocks, secties, en andere elementen
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Onbeperkte gratis meldingen (SMS + e-mail){"\n   "}
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Eenvoudig koppelen aan een domein
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Andere integraties (CRM, live chats, online betalingen)
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
			...
			<Box width="58.333%" margin="20px 0px 0px 8.333999999999996%" lg-margin="30px 0px 0px 0px" lg-width="100%">
				<Image
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Zo creëer je een landingspagina met uKit
				</Text>
				<Text color="--darkL1" margin="0px 0px 0px 0px" font="--base">
					Om de bouwer in de vingers te krijgen heb je slechts een paar uur nodig. Zelfs als je voor het eerst met het platform werkt, zul je gegarandeerd in je eentje een functionele en fraaie webpagina kunnen maken. Je wordt ondersteund door een uitgebreide kennisbank, interactieve tips, en 24 uur per dag technische support door specialisten
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Kies een sjabloon dat het beste bij je past. Onze catalogus bevat honderden kant-en-klare mogelijkheden voor elk bedrijf. Elk sjabloon bevat relevante inhoud, mediabestanden, en pop-ups. Het kleurenpalet, animaties en lettertypes kunnen in slechts enkele klikken gewijzigd worden. Het is ook erg gemakkelijk om het sjabloon te vervangen door een ander, zonder daarbij je inhoud kwijt te raken
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						De pagina’s in uKit worden opgebouwd met kant-en-klare elementen. Het systeem beschikt over een reeks blocks, secties en widgets voor allerlei zaken: aftellers, pop-ups, callback-knoppen, live chats, galerijen, productkaarten, winkelwagens (om een webwinkel te maken en online betalingen te accepteren), en nog veel meer. Je hoeft ze alleen maar naar de pagina te slepen en ze naar wens aan te passen
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Alles wordt voor je geregeld — alle websites die met uKit werden gebouwd passen zich automatisch aan elke schermresolutie aan. Beelden worden automatisch geoptimaliseerd, zodat de downloadsnelheid altijd hoog is. Je kunt ervoor zorgen dat de pagina’s worden weergegeven zoals ze opgesteld zijn, of je kunt afzonderlijke elementen verbergen zodat ze de opmaak van de website niet overbelasten voor telefoons en/of tablets
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Je kunt je bestaande domeinnaam verbinden of een nieuwe aankopen, en dat rechtstreeks op het uKit dashboard. Alle populaire extensies staan tot je beschikking. DE SSL-certificaten zijn gratis, en er wordt automatisch een omleiding naar de HTTPS-versie ingesteld
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Wees niet bang om de inhoud van je site te veranderen. De uKit bouwer biedt een automatisch en een handmatig back-up systeem. Je kunt tot 10 back-ups maken en met één klik terugkeren naar elke versie van de site
					</Text>
				</Box>
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					De prestaties opvolgen, Google Analytics koppelen, de site toevoegen aan de Google Search Console, nagaan of je site klaar is voor promotie met de SEO-wizard — dit alles doe je met uKit in slechts enkele klikken
				</Text>
				<Link
					font="--lead"
					border-width="1px"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 0px 0px" font="--base">
					uKit is de beste oplossing voor{" "}
					<Link href="https://ukit.com/lp/ru/sozdat-sait-vizitku-online">
						bedrijfswebsites
					</Link>
					.
 Elk themaproject kan in een handomdraai worden gelanceerd. Hiervoor heb
 je geen speciale kennis of vaardigheden nodig. Met onze bouwer kun je 
erg eenvoudig promotiewebsites, landingspagina's en portfolio's 
opstellen
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px" width="100%">
				...
				>
					<Link href="/lp/nl/creeer-een-kunstenaarsportfolio" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							border-radius="18px"
				...
				<Box
					...
					md-width="100%"
				>
					<Link href="/lp/nl/websitebouwer-software" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
			...
			>
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link href="/lp/nl/creeer-een-website-voor-psychologen-of-psychotherapeuten" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							width="100%"
							display="flex"
							align-items="center"
		...
		<Section lg-padding="100px 0 100px 0" padding="130px 0 130px 0" color="--darkL1" background="--color-secondary">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Je vindt uKit ongetwijfeld erg leuk
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Ontwerp nu je webpagina en ontdek onze bouwer. Begin gratis met een 14-daagse proefperiode voor elke nieuwe site
				</Text>
				<Link
					border-color="--color-secondary"
					border-radius="100px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/webpaginabouwer/"} place={"endOfHead"} rawKey={"61728b2456c65c1a397047dd"} />
		</RawHtml>
	</Theme>;
});