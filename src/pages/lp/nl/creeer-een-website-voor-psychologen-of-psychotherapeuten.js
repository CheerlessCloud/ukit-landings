...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-psychologen-of-psychotherapeuten"} />
		<Helmet>
			<title>
				Creëer een website voor psychologen of psychotherapeuten — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Als u overweegt uw eigen site te maken, kies dan uKit, en u zult geen specialisten van derden hoeven in te huren. Het is snel en gemakkelijk te gebruiken: een gebruikersvriendelijke bouwer, kant-en-klare sjablonen, en onbeperkte hosting"} />
			<meta property={"og:title"} content={"Creëer een website voor psychologen of psychotherapeuten — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Als u overweegt uw eigen site te maken, kies dan uKit, en u zult geen specialisten van derden hoeven in te huren. Het is snel en gemakkelijk te gebruiken: een gebruikersvriendelijke bouwer, kant-en-klare sjablonen, en onbeperkte hosting"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Als u overweegt uw eigen site te maken, kies dan uKit, en u zult geen specialisten van derden hoeven in te huren. Het is snel en gemakkelijk te gebruiken: een gebruikersvriendelijke bouwer, kant-en-klare sjablonen, en onbeperkte hosting
				</Text>
				<Link
					background="#4773ff"
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					ant-en-klare feedbackformulieren
				</Text>
			</Box>
			<Box
				display="flex"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van website-ontwerpen voor psychologen en psychotherapeuten
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Weet u niet zeker waar te starten? Wij geven kant-en-klare opties met zinvolle inhoud. Als het niet helemaal is wat u zoekt, kunt u onze gebruikersvriendelijke online editor gebruiken om de inhoud te veranderen. Dan hoeft u alleen nog maar de site te publiceren en uw domein te koppelen
				</Text>
			</Box>
			<Box
				display="flex"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					U hoeft geen computer expert of een pro web designer te zijn. Met uKit kunt u een site maken door kant-en-klare blokken en widgets te slepen en neer te zetten. Uw site zal er niet alleen perfect uitzien, maar ook werken zoals u dat wilt
				</Text>
			</Box>
			<Box
				justify-content="center"
			...
			>
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Grote set blokken om uw diensten te beschrijven
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Kant-en-klare formulieren om een consultatie aan te vragen
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Live chat widgets en terugbelknoppen
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Een website maken van uw sociale netwerkpagina
					</Text>
				</Box>
				<Box
					align-items="flex-start"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Zo creëert u een website voor een psycholoog of psychotherapeut met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Iedereen kan het doen, ongeacht de kennis en ervaring die u hebt. Uw site kan klaar zijn in een avond. Het zal uw potentiële klanten over u en uw diensten vertellen, en u in staat stellen prijzen te tonen en aanvragen te ontvangen
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						De uKit-catalogus bevat honderden gratis sjablonen over verschillende onderwerpen, waaronder kant-en-klare opties voor psychologen. U kunt elk ontwerp kiezen en het aanpassen. Ontwerpopties zoals achtergronden, lettertypesets, kleurenschema’s of blokanimatie-effecten kunnen met een paar muisklikken worden gewijzigd. En alle veranderingen kunnen gemakkelijk in real time worden gevolgd
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						margin="0px 0px 0px 0px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Beschrijf uzelf, uw vaardigheden en uw diensten
					</Text>
					<Text
						lg-width="100%"
						margin="0px 0px 24px 0px"
						...
						width="84%"
					>
						Vertel uw potentiële klanten over uw sterke punten als expert. Geef ze meer informatie over de vorm van het consult (online of offline), de prijzen, en waar en hoe ze zich kunnen aanmelden voor een sessie. Voeg verschillende contactmethodes toe, zoals uw sociale netwerkaccounts, telefoonnummer, e-mail en messengers. De uKit-bouwer biedt kant-en-klare interface-elementen en integraties voor elke taak
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						U hoeft zich geen zorgen te maken dat uw websitebezoekers uw website niet vanaf hun mobiele apparaten kunnen gebruiken. Alle uKit-sjablonen en -blokken zijn aanpasbaar, en de pagina’s zien er prachtig uit en werken goed op telefoons en tablets. Indien nodig kunt u afzonderlijke blokken of elementen verbergen, en hun ontwerpparameters wijzigen voor het geselecteerde apparaat
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Om het voor klanten gemakkelijker te maken het adres van uw site te onthouden en in hun browser in te voeren, koppelt u een unieke domeinnaam. U kunt een nieuw domein kopen op het uKit Dashboard. Alle sites op het platform werken met een veilig HTTPS-protocol, en SSL-certificaten zijn gratis beschikbaar
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Om dit te doen, klikt u op ’’Publiceren’’. En vergeet niet om het te doen elke keer dat u wijzigingen aanbrengt in de pagina’s. U hoeft niet bang te zijn dat u iets verkeerd doet, want uKit heeft een systeem van automatische en handmatige back-ups. U kunt met één muisklik terugkeren naar de benodigde siteversie
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Stop niet. Om de conversie vanuit search te verhogen, moet u regelmatig met uw site aan de slag. Om het voor u naadloos te laten verlopen, hebben we speciale SEO-tools toegevoegd, een wizard om de site toe te voegen aan de Google Search Console, en een mogelijkheid om analytische systemen te integreren met uw site
				</Text>
				<Link
					border-style="solid"
					background="--color-secondary"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					U kunt verschillende soorten sites maken in een paar klikken op ons platform: landing pages, online winkels, promo websites, portfolio’s, en eenvoudige blogs
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px" width="100%">
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-landingspagina" color="--darkL1">
						<Image
							width="100%"
							display="flex"
							align-items="center"
			...
			>
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link href="/lp/nl/creeer-een-website-voor-een-cafe-of-restaurant" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				...
				>
					Maak een website voor psychologen of psychotherapeuten met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Ervaar zelf hoe effectief uKit is. U hoeft geen kaartgegevens of andere persoonlijke info in te voeren. U krijgt een gratis proefperiode van 14 dagen
				</Text>
				<Link
					text-decoration-line="initial"
					font="--lead"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-psychologen-of-psychotherapeuten/"} place={"endOfHead"} rawKey={"618967ad06ff7e3a61cc6158"} />
		</RawHtml>
	</Theme>;
});