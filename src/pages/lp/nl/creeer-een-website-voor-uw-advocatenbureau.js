...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-uw-advocatenbureau"} />
		<Helmet>
			<title>
				Creëer een website voor uw advocatenbureau — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Geen briefings, geen vervelende goedkeuringen, geen wachttijden - met uKit kunt u zelf een website maken zonder tussenpersonen. Gebruiksklare thematische sjablonen, onbeperkte hosting en sms-berichten."} />
			<meta property={"og:title"} content={"Creëer een website voor uw advocatenbureau — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Geen briefings, geen vervelende goedkeuringen, geen wachttijden - met uKit kunt u zelf een website maken zonder tussenpersonen. Gebruiksklare thematische sjablonen, onbeperkte hosting en sms-berichten."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Geen briefings, geen vervelende goedkeuringen, geen wachttijden — met uKit kunt u zelf een website maken zonder tussenpersonen. Gebruiksklare thematische sjablonen, onbeperkte hosting en sms-berichten
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van website-templates voor advocaten
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Kant-en-klare paginastructuur en zinvolle inhoud in elke template. Het enige wat u hoeft te doen is de contactinformatie te wijzigen en uw domein te verbinden. Alle templates zijn gemakkelijk aan te passen
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Wat u krijgt voor uw site
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Een volwaardige website met originele inhoud in een eenvoudige of complexe structuur. Portfolioblokken, klantenbeoordelingen, online chats en terugbelformulieren zijn in een paar klikken toegevoegd. Alles kan zelf worden opgezet zonder specialisten van derde partijen
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Professionele thematische templates
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Zo creëert u een website voor uw advocatenpraktijk met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					De workflow is naadloos voor alle gebruikers, zowel beginners als professionals. Het duurt maar een paar uur om de bouwer goed te leren kennen
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Wij hebben een rijke bibliotheek van prachtige ontwerpen voor advocaten, hoewel u elk van de ontwerpen in de catalogus kunt kiezen. Kleuren, lettertypes, blokstructuren, animatie-effecten en achtergronden zijn allemaal aanpasbaar. Bovendien kunt u zelfs de versie van de site voor slechtzienden in- of uitschakelen. Geen HTML-code bewerken en niet programmeren. Alles wordt gedaan met kant-en-klare widgets en elementen
					</Text>
					<Link
						border-style="solid"
						display="inline"
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Als u de inhoud van de template goed vindt, laat dan alles zoals het is. Maar vergeet niet de inhoud aan te passen aan uw specifieke kenmerken en de contactinformatie te wijzigen. Als u volledig originele inhoud wilt, kunt u elk element bewerken: tekst, afbeeldingen, video’s en meer. U kunt zelfs uw eigen bestanden uploaden. Met uKit zijn er geen beperkingen qua aantal pagina’s of schijfruimte — ze zijn onbeperkt
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						U hoeft zelfs helemaal niets aan te passen. Alle site-elementen zijn al aanpasbaar. U moet er alleen voor zorgen dat alles er precies zo uitziet als bedoeld. Maar indien nodig, kunt u sommige blokken verbergen en de achtergrondinstellingen wijzigen. De pagina-elementen kunnen ook in twee kolommen worden gerangschikt voor tablets
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Om de site goed te laten indexeren in zoekmachines, is het beter om een aangepaste domeinnaam te kopen. U kunt een domein kiezen en hem aan uw site koppelen op het uKit Dashboard. SSL-certificaten en HTTPS-protocollen worden automatisch geconfigureerd
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Eén klik en alle wijzigingen die u hebt aangebracht, zijn beschikbaar voor de bezoekers van uw site. U hoeft dus niet bang te zijn dat u iets verkeerd doet, uKit maakt automatisch back-ups en u kunt handmatig back-ups maken. Alle wijzigingen kunnen indien nodig worden teruggedraaid
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Voeg uw site toe aan de zoekmachines om de indexering te beginnen. Indien nodig, kunt u analytics aansluiten en de in uKit ingebouwde SEO-tools gebruiken om te controleren of de site klaar is voor promotie
				</Text>
				<Link
					href="https://ukit.com/signUp"
					margin="0px 0px 0px 0px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Promo-websites, landingspagina’s, catalogi, portfolio’s, en andere soorten sites voor het bedrijfsleven kunnen worden gemaakt op uKit zonder enige speciale vaardigheden
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					as="h2"
				>
					Creëer een website voor uw advocatenbureau met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Om alle uKit-functies te zien en het platform uit te proberen, bieden wij een proefperiode van 14 dagen. Meld u gewoon aan voor het systeem en ga aan de slag met uw droomsite
				</Text>
				<Link
					margin="0px 0px 0px 0px"
					border-color="--color-secondary"
		...
		<RawHtml>
			...
			<link href={"/lp/nl/creeer-een-website-voor-uw-advocatenbureau/"} rel={"canonical"} place={"endOfHead"} rawKey={"615b3f42fb549cd81aefa1fc"} />
		</RawHtml>
	</Theme>;
});