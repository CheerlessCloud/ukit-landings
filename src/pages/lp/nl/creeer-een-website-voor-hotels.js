...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-hotels"} />
		<Helmet>
			<title>
				Creëer een website voor hotels — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"U hoeft geen professionele ontwikkelaars in te huren om een site voor uw hotel te maken. Alles wat u nodig hebt is uKit - een online websitebouwer. Het heeft al onbeperkte hosting, kant-en-klare formulieren met gratis meldingen, en SEO tools"} />
			<meta property={"og:title"} content={"Creëer een website voor hotels — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"U hoeft geen professionele ontwikkelaars in te huren om een site voor uw hotel te maken. Alles wat u nodig hebt is uKit - een online websitebouwer. Het heeft al onbeperkte hosting, kant-en-klare formulieren met gratis meldingen, en SEO tools"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					U hoeft geen professionele ontwikkelaars in te huren om een site voor uw hotel te maken. Alles wat u nodig hebt is uKit — een online websitebouwer. Het heeft al onbeperkte hosting, kant-en-klare formulieren met gratis meldingen, en SEO tools
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				<Text font="--lead" margin="0px 0px 0px 0px" color="--darkL1">
					Handige bouwer met ’drag & drop’-technologie
				</Text>
			</Box>
			<Box
				width="20%"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Voorbeelden van website-designs voor hotels
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					U krijgt niet alleen thematische ontwerpen, maar ook kant-en-klare inhoud met tekst en afbeeldingen. De inhoud is gemakkelijk aan te passen om het u eigen te maken. Het starten en lanceren van uw site is nog nooit zo eenvoudig geweest
				</Text>
			</Box>
			<Box
				display="flex"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white" text-align="center">
					Geef geen fortuin meer uit aan het onderhoud van uw website door derden. Met uKit kunt u alles zelf doen. Sommige taken zijn zelfs geautomatiseerd, zodat ze geen tijd van u vergen. U hebt ook geen speciale kennis nodig — alleen uw intuïtie en verbeelding
				</Text>
			</Box>
			<Box
				width="100%"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Pop-upvensters en feedback- en bestelformulieren
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Alles voor de presentatie van uw hotel en de kamers
					</Text>
				</Box>
				<Box
					width="33%"
				...
				>
					...
					/>
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Onbeperkte hosting (∞ verkeer, ∞ pagina’s, ∞ schijfruimte)
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Zo creëert u een website voor hotels met uKit
				</Text>
				<Text color="--darkL1" margin="0px 0px 0px 0px" font="--base">
					Een site lanceren in uKit is een fluitje van een cent. De inhoud en contactinformatie bijwerken is snel gebeurd. Volg simpelweg onderstaande stappen. U kunt het zelf doen, zelfs met nul ervaring
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Het lanceren van een website gaat sneller als u niet vanaf nul begint. uKit biedt een enorm aantal kant-en-klare sjablonen — kies gewoon de meest geschikte stijl en structuur. Alle sjablonen hebben verschillende kleurenschema’s. Lettertypes, achtergronden en andere ontwerpparameters kunnen in één keer worden gewijzigd
					</Text>
					<Link
						font="--lead"
						border-style="solid"
			...
			>
				...
				>
					...
					<Text color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px">
						Beschrijf uw hoteldiensten en prijzen
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						U bent niet beperkt door het inhoudstype: voeg foto’s toe van uw hotel, de kamers, de bar, de kinderhoek, enz. Upload zoveel foto’s als u nodig hebt, voeg video’s toe, sluit interactieve Google Maps in, voeg tekstomschrijvingen en tabellen toe, enzovoort. Hosting is onbeperkt op elk plan. Nieuwe pagina-elementen worden toegevoegd in de vorm van kant-en-klare blokken en widgets in de visuele editor
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px">
						Voeg boekings- en betalingsinformatie toe
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Toon kamerprijzen, voeg een prijslijst toe voor extra diensten, maak boekingsformulieren, sluit online betalingssystemen aan. Om dit te doen, is er een winkelmodule en integratie met populaire betalingstools, CRM en mailingsystemen. SMS- en e-mailberichten van de formulieren worden gratis naar u verzonden
					</Text>
				</Box>
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Alle in uKit gemaakte sites worden op alle schermen correct weergegeven. Het is allemaal voor u geregeld. Maar u kunt de zichtbaarheid en ontwerpopties van afzonderlijke blokken aanpassen, ze verbergen op verschillende apparaattypes, en het raster voor tablets wijzigen (in één of twee kolommen)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Het adres van uw hotelwebsite moet herkenbaar zijn, en gemakkelijk te lezen en te onthouden. U kunt een nieuw domein direct op het uKit Dashboard registreren. De site zal automatisch werken met een beveiligd HTTPS-protocol (SSL-certificaat wordt gratis verstrekt)
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Als de site klaar is, hoeft u hem alleen nog maar aan uw potentiële klanten te laten zien. Om dit te doen, klik je op de knop ’’Publiceren’’. U kunt de inhoud wijzigen, nieuwe pagina’s toevoegen en irrelevante pagina’s verwijderen, indien nodig. Maak back-ups zodat u geen belangrijke informatie verliest, en snel iets ongedaan kunt maken in geval van fouten. De back-up functionaliteit is helemaal gratis
					</Text>
				</Box>
			</Box>
		</Section>
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Om de site te laten werken en klanten aan te trekken, is het beter om hem te promoten in zoekmachines. De uKit SEO-wizard zal u daarbij helpen. Om alle belangrijke indicatoren van de site te volgen, kunt u deze toevoegen aan de Google Search Console en Google Analytics. Dit duurt maar enkele minuten
				</Text>
				<Link
					background="--color-secondary"
					hover-background="linear-gradient(to right,#537cff,#537cff)"
		...
		<Section background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0" padding="130px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Allerlei soorten bedrijfssites worden in uKit gemaakt zonder enige programmeerervaring. U kunt dit, zelfs als het de eerste keer is dat u een site bouwt. Met uKit is het gemakkelijk om promo-websites, catalogi, landingspagina’s, bedrijfsblogs, en zelfs online winkels te maken
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-makelaars" color="--darkL1">
						<Image
			...
			>
				<Box
					...
					padding="0px 15px 0px 0px"
				>
					<Link href="/lp/nl/creeer-een-website-voor-uw-advocatenbureau" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
			...
			>
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-promo-website-voor-uw-bedrijf" color="--darkL1">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				...
				>
					Creëer een website voor hotels met uKit
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Het is tijd om uKit in actie te zien. En het kost u niets! De proefperiode is 14 dagen gratis
					<Link
						hyphens="manual"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-hotels/"} place={"endOfHead"} rawKey={"61897d782873826dd66e6182"} />
		</RawHtml>
	</Theme>;
});