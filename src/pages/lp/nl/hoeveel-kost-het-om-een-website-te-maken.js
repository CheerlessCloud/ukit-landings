...
import { BsColumns, BsGear, BsPhone, BsCheckBox, BsDocumentsAlt, BsColumnsGutters, BsDiamond, BsBucket, BsDocuments, BsBell, BsArrowLeftRight, BsBarChart, BsCreditCard } from "react-icons/bs";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/hoeveel-kost-het-om-een-website-te-maken"} />
		<Helmet>
			<title>
				Hoeveel kost het om een website te maken? — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Maak zelf een website met uKit - vanaf $2.5/maand. Hiervoor heb je geen speciale kennis of vaardigheden nodig. Al het nodige om je site te bewerken en te promoten is reeds op het platform aanwezig! Bovendien ontvang je onbeperkte hosting. Wil je een kant-en-klare website maar heb je geen tijd om deze zelf te ontwerpen? Vanaf $100 kunnen wij dat voor je doen."} />
			<meta property={"og:title"} content={"Hoeveel kost het om een website te maken? — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Maak zelf een website met uKit - vanaf $2.5/maand. Hiervoor heb je geen speciale kennis of vaardigheden nodig. Al het nodige om je site te bewerken en te promoten is reeds op het platform aanwezig! Bovendien ontvang je onbeperkte hosting. Wil je een kant-en-klare website maar heb je geen tijd om deze zelf te ontwerpen? Vanaf $100 kunnen wij dat voor je doen."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				<Text
					...
					as="h1"
				>
					Hoeveel kost het om een website te maken?
				</Text>
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Maak zelf een website met uKit — vanaf $2.5/maand. Hiervoor heb je geen speciale kennis of vaardigheden nodig. Al het nodige om je site te bewerken en te promoten is reeds op het platform aanwezig! Bovendien ontvang je onbeperkte hosting. Wil je een kant-en-klare website maar heb je geen tijd om deze zelf te ontwerpen? Vanaf $100 kunnen wij dat voor je doen
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Honderden kant-en-klare sjablonen
				</Text>
			</Box>
			<Box
				padding="0px 20px 0px 0px"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van kant-en-klare themasjablonen
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Alle ontwerpen zijn modern, aanpasbaar, en volledig gratis. Je vindt gegarandeerd een passend ontwerp voor jouw bedrijf. Bovendien is het mogelijk om een versie voor slechtzienden in te stellen, en het kleurenschema en de lettertypes te wijzigen. Elk sjabloon bevat relevante inhoud en pop-up formulieren. Koppel de site aan je domein, werk je contactgegevens bij, en publiceer de website
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Gebruiksvriendelijke visuele editor. Elke pagina stel je samen door eenvoudigweg kant-en-klare blocks en elementen er naartoe te slepen. Betaalbare abonnementen voor zowel bedrijven als particulieren
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Kant-en-klare blocks en sjablonen
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Geïntegreerde tools voor online winkels en nieuwspagina’s
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Onbeperkte hosting en pagina’s op elk abonnement
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Kant-en-klare integraties met CRM, live chat, nieuwsbrief, en andere diensten
					</Text>
				</Box>
				<Box
					flex-direction="column"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Alle functies van uKit zijn opgenomen in je abonnement: kant-en-klare sjablonen, SEO-wizard, je domein koppelen en statistieken. Met slechts een beetje tijd en inzet kun je je eigen website maken. En daar is geen speciale kennis of vaardigheden voor nodig
				</Text>
			</Box>
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Alle kant-en-klare sjablonen in onze bibliotheek zijn volledig gratis. Kies een sjabloon, wijzig het kleurenpalet, de lettertypes, de achtergrond en talloze andere parameters. Geen bijkomende opties tegen betaling. Alles inbegrepen
					</Text>
					<Link
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Gratis, gebruiksvriendelijke editor
					</Text>
					<Text
						color="--dark"
						font="--base"
						...
						margin="0px 0px 24px 0px"
					>
						Bij elk abonnement krijg je toegang tot alle nodige blocks en widgets: live chats, sliders, galerijen, aftellers, feedbackformulieren, callback-knoppen, prijslijsten, tijdlijnen, recensies, en nog veel meer. Je sleept ze simpelweg erin en past ze aan. Sommige abonnementen bieden toegang tot een editor voor HTML-code (voor professionals) en widgets voor online winkels (om online betalingen te ontvangen)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				<Box
					...
					justify-content="center"
				>
					<Image src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/three.svg?v=2021-08-19T23:48:35.499Z" margin="0px 0px 24px 0px" width="48px" height="48px" />
					<Text md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1" font="--headline3">
						Gratis mobiele versie
					</Text>
					<Text
						width="84%"
						lg-width="100%"
						...
						font="--base"
					>
						Alle kant-en-klare sjablonen en blocks in de editor kunnen aangepast worden. Op die manier ziet je site er perfect uit op alle toestellen. Afbeeldingen worden automatisch aangepast aan de gewenste resolutie — dit om het verkeer te optimaliseren en ze zo snel mogelijk te laden. Het is ook mogelijk om afzonderlijke blocks te verbergen of hun vormgeving aan te passen voor bepaalde soorten toestellen: telefoons, tablets, en PC’s. Lazy loading van afbeeldingen en stijlen wordt geactiveerd met één enkele klik. Al deze functies zijn reeds in je abonnement inbegrepen
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Alle uKit-gebruikers krijgen gratis personaliseerbare third-level domeinen met populaire uitbreidingen. Je kunt er ook voor kiezen om een specifieke URL in te stellen voor je website. Als je een second-level domein nodig hebt, kun je dat rechtstreeks op het uKit dashboard registreren vanaf $8.99/jaar (registratie en hernieuwing). Je kunt ook altijd de website koppelen aan een bestaand domein dat je bij een externe aanbieder hebt geregistreerd. Welke optie je ook kiest, de SSL-certificaten zijn gratis en worden automatisch ingesteld
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Gratis back-ups en onbeperkte hosting
					</Text>
					<Text
						width="84%"
						lg-width="100%"
						...
						font="--base"
					>
						Bewerk en publiceer je site, bewerk ze opnieuw, en publiceer ze dan opnieuw. Voeg onbeperkt pagina’s toe. Je ontvangt onbeperkte opslagruimte en kunt een onbeperkt aantal bestanden aan je site toevoegen, ongeacht je abonnement. Het systeem kan tot 10 back-ups van je site maken. Deze worden zowel automatisch als handmatig gemaakt en de site kan met één klik hersteld worden. Dit alles is standaard inbegrepen in elk uKit abonnement
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				<Box
					...
					display="flex"
				>
					<Image margin="0px 0px 24px 0px" width="48px" height="48px" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/6.svg?v=2021-09-28T20:17:25.803Z" />
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Online winkel — vanaf $6/maand
					</Text>
					<Text
						font="--base"
						width="84%"
						...
						color="--dark"
					>
						Maak online betalingen mogelijk en integreer een CRM-systeem. Een onbeperkt aantal producten, velden in de formulieren, kortingscodes, verschillende verzendmethoden, enzovoort
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				<Box
					...
					md-width="100%"
				>
					<Image width="48px" height="48px" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/7.svg?v=2021-09-28T20:17:31.417Z" margin="0px 0px 24px 0px" />
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						SEO-wizard
					</Text>
					<Text
						...
						width="84%"
					>
						Sommige taken zijn geautomatiseerd, zodat deze geen tijd meer opslokken. Met een speciale SEO-wizard kun je bijvoorbeeld nagaan of de site kan worden gepromoot. Je kunt ook met enkele muisklikken externe statistieken toevoegen om informatie en analyses te verzamelen over de bezoekers van je site
					</Text>
					<Link
						href="https://ukit.com/signup"
						text-decoration-line="initial"
		...
		<Section padding="40px 0 130px 0" color="--darkL1" lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0">
			...
			>
				...
				<Text text-align="center" margin="0px 0px 36px 0px" font="--base" color="--darkL1">
					Heb je geen tijd om hiermee bezig te zijn? Schakel dan één van onze professionals van het webbureau Divly in
				</Text>
				<Link
					color="--white"
					padding="15px 25px 16px 25px"
					...
					background="--color-secondary"
					hover-background="linear-gradient(to right,#537cff,#537cff)"
					href="https://divly.net/form/step1/site"
					text-decoration-line="initial"
					font="--lead"
					margin="0px 0px 0px 0px"
					border-style="solid"
					display="inline"
				>
					Bestel een kant-en-klare website
				</Link>
			</Box>
		</Section>
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Wat kun je nog meer maken met uKit?
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Met ons platform kun je in een handomdraai en zonder specifieke kennis allerlei bedrijfswebsites maken: landingspagina’s, promotiepagina’s, catalogi, portfolio’s, bedrijfsblogs, online winkels, websites voor leraren, onderwijsinstellingen, en andere projecten
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="36px 0px 30px 0px" width="100%" display="flex">
				...
				>
					<Link href="/lp/nl/promotiewebsitebouwer" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							border-radius="18px"
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/nl/portfoliobouwer" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							loading="lazy"
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/nl/creeer-een-website-voor-onderwijsinstellingen" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-juridische-adviseurs" color="--darkL1">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-kunstenaarsportfolio">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead" md-margin="0px 0px 30px 0px">
							Creëer een kunstenaarsportfolio
						</Text>
					</Link>
				</Box>
				<Box
					...
					md-width="100%"
				>
					<Link href="/lp/nl/creeer-een-website-voor-hotels" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		<Section padding="130px 0 130px 0" color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Maak een website met uKit — vanaf $2.5/maand
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Probeer 14 dagen gratis alle functies van uKit, inclusief de online winkel. Hiervoor hoef je geen persoonlijke gegevens in te voeren. Abonneer je alleen op uKit als je tevreden bent met de resultaten!
				</Text>
				<Link
					font="--lead"
					border-style="solid"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/hoeveel-kost-het-om-een-website-te-maken/"} place={"endOfHead"} rawKey={"619e9e36d6eb73a50d0f5c51"} />
		</RawHtml>
	</Theme>;
});