...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-tutors"} />
		<Helmet>
			<title>
				Creëer een website voor tutors — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"Gebruiksklare thematische ontwerpen, gratis HTTPS-protocollen, volledige set SEO-attributen, onbeperkte hosting, sms-berichten over verzoeken van uw site, en een gemakkelijk te navigeren visuele interface"} />
			<meta property={"og:title"} content={"Creëer een website voor tutors — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"Gebruiksklare thematische ontwerpen, gratis HTTPS-protocollen, volledige set SEO-attributen, onbeperkte hosting, sms-berichten over verzoeken van uw site, en een gemakkelijk te navigeren visuele interface"} />
		...
		<Section md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					Gebruiksklare thematische ontwerpen, gratis HTTPS-protocollen, volledige set SEO-attributen, onbeperkte hosting, sms-berichten over verzoeken van uw site, en een gemakkelijk te navigeren visuele interface
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van website-templates voor tutors
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					U kunt een van de beschikbare sjablonen kiezen en ze naar wens bewerken. Alle functies die u nodig hebt, zitten al in het systeem, dus technische vaardigheden zijn niet nodig
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Belangrijkste kenmerken voor het creëren van websites voor tutors
				</Text>
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					Met een intuïtieve en handige editor kunt u elk soort webpagina maken van kant-en-klare blokken zonder dat u specialistische kennis nodig hebt. De site zal er goed uitzien...en goed werken. U zult alles in een mum van tijd zelf kunnen doen
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Thematische jablonen en kant-en-klare blokken
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Onbeperkte hosting en aantal pagina’s
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Kant-en-klare formulieren en gratis SMS-berichten
					</Text>
				</Box>
				<Box
					flex-direction="column"
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Zo creëert u een website voor tutors met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					U kunt uw site in één keer bouwen, zonder enige programmeerkennis of ervaring. Antwoorden op al uw vragen vindt u in de kennisbank, de FAQ’s of bij het technische ondersteuningsteam
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Kies elk ontwerp dat u wilt: thematisch of niet, één pagina of meerdere pagina’s. Kleuren en lettertypes kunnen in een paar klikken worden gewijzigd. Meer elementen nodig op de pagina? Sleep ze gewoon in de bouwermodus. U hoeft hiervoor geen webdesigner of programmeur te zijn — u kunt alles zelf doen
					</Text>
					<Link
						hover-background="linear-gradient(to right,#537cff,#537cff)"
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Als u onze sjablonen voor tutors gebruikt, kunt u de inhoud laten zoals die is of deze vervangen door aangepaste inhoud. U kunt afbeeldingen uploaden, teksten bewerken, video’s en bestanden toevoegen. Er is geen limiet aan het aantal pagina’s of schijfruimte. Er zijn ook kant-en-klare widgets: galerijen, prijslijsten, werkstappen, referenties, live chats, terugbelknoppen, en nog veel meer
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						De bouwer past automatisch alle site pagina’s aan voor mobiele apparaten. Maar u kunt een speciale menuversie instellen, kleurenschema’s veranderen, sommige blokken verbergen, en andere parameters configureren voor tablets en/of telefoons, indien nodig. Uw site zal snel laden op alle apparaten
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						uKit biedt een gratis leesbaar third-level domein. Maar voor een betere bekendheid en een effectieve promotie in search, is het beter om een eigen domein te kopen. Dit kan direct op het uKit-dashboard worden gedaan. De HTTPS-versie van de site wordt automatisch geconfigureerd
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						U kunt de inhoud van de site, de structuur en de sjablonen bewerken wanneer u maar wilt. En als er iets misgaat, hoeft u alleen maar een vorige of oudere siteversie uit het archief terug te zetten. uKit slaat tot 10 backups per project op
					</Text>
				</Box>
				<Box display="flex" md-width="100%" width="50%" margin="0px 0px 0px 0px">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Vergeet niet om te controleren of uw site klaar is voor promotie in onze SEO-wizard. Deze zal u laten zien wat en waar u uw site moet veranderen om betere zoekmachine-resultaten te bereiken
				</Text>
				<Link
					font="--lead"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Met onze bouwer kan iedereen in een paar klikken een eenvoudige zakelijke site maken zonder speciale vaardigheden of kennis: webpagina’s, promo-websites, en portfolio’s
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					width="50%"
				>
					<Link text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-uw-tandheelkundige-kliniek" color="--darkL1" hover-color="--primary">
						<Image
							loading="lazy"
		...
		>
			...
			>
				...
				>
					Creëer een website voor tutors met uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Om ons platform uit te proberen, meldt u zich aan voor het systeem en kiest u een van de sjablonen. Een 14-daagse proefperiode is gratis
					<Link
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-tutors/"} place={"endOfHead"} rawKey={"615b1bf9e0da58b40567450a"} />
		</RawHtml>
	</Theme>;
});