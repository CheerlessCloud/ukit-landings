...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-docenten"} />
		<Helmet>
			<title>
				Creëer een website voor docenten — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"U kunt zelf een portfoliosite maken in slechts één avond. Geen codering, volledige naleving van wettelijke voorschriften, gebruiksklare thematische sjablonen, intuïtieve interface, en onbeperkte hosting. Alle functies die u nodig hebt binnen handbereik."} />
			<meta property={"og:title"} content={"Creëer een website voor docenten — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"U kunt zelf een portfoliosite maken in slechts één avond. Geen codering, volledige naleving van wettelijke voorschriften, gebruiksklare thematische sjablonen, intuïtieve interface, en onbeperkte hosting. Alle functies die u nodig hebt binnen handbereik."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					U kunt zelf een portfoliosite maken in slechts één avond. Geen codering, volledige naleving van wettelijke voorschriften, gebruiksklare thematische sjablonen, intuïtieve interface, en onbeperkte hosting. Alle functies die u nodig hebt binnen handbereik
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Sjablonen en kant-en-klare blokken
				</Text>
			</Box>
			<Box
				display="flex"
		...
		<Section md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-padding="80px 0 100px 0">
			...
			>
				<Text
					...
					as="h2"
				>
					Voorbeelden van website-templates voor docenten
				</Text>
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Een kant-en-klare structuur en standaardinhoud die een minimum aan bewerkingen vereist. En toch kunt u alles veranderen wat u wilt: het ontwerp, de inhoud en de structuur
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				/>
				<Image loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_psychologist_en.webp?v=2021-09-28T16:00:29.898Z" border-radius="18px" sm-border-radius="6px" />
			</Box>
			<Box
				display="flex"
				padding="0px 15px 0px 15px"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0">
			...
			>
				<Text
					...
					color="--white"
				>
					Belangrijkste kenmerken voor effectieve lerarenwebsites
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					U kunt beginnen met een thema of een ander sjabloon. Er zijn ook opties voor meerdere pagina’s en voor één pagina. Een domeinnaam wordt gratis verstrekt, maar u kunt ook een domein op het tweede niveau kopen of een bestaand domein koppelen. U kunt alle elementen in een paar klikken configureren en bewerken zonder enige ervaring met coderen
				</Text>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Sjablonen voor educatieve websites
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Volledige naleving van de wetgeving
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Eenvoudige een gebruiksvriendelijke editor
					</Text>
				</Box>
				<Box
					md-width="100%"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Zo creëert u een website voor docenten met uKit
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					U kunt eenvoudig een site maken met behulp van drag ’n drop technologie — geen noodzaak voor enige professionele hulp. Maar als u vastloopt en ergens niet uitkomt, kunt u gebruik maken van de kennisbank, FAQ’s en technische ondersteuning
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						U kunt gebruik maken van kant-en-klare ontwerpen om de implementatie van de functies en thematische secties die u nodig hebt op te zoeken. In de meeste gevallen kan de inhoud worden gelaten zoals hij is, of kan hij worden aangepast zoals u verkiest. Alles is gemakkelijk in gebruik en probleemloos. Bovendien kunt u voor elk sjabloon een versie voor slechtzienden activeren
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Voeg uw eigen afbeeldingen, tekst, video’s, beoordelingen, galerijen, certificaten, documentbestanden en alle andere inhoud toe. Afbeeldingen kunnen direct in de bouwer worden bewerkt. uKit legt geen beperkingen op inzake hosting of aantal pagina’s. De structuur is gemakkelijk in overeenstemming te brengen met de huidige wetgeving
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Aangezien uKit automatisch een mobiele versie van de site maakt, hoeft u er alleen maar voor te zorgen dat de pagina’s van de site op alle apparaten correct worden weergegeven. U kunt individuele instellingen wijzigen indien nodig: weergave/verbergen van geselecteerde blokken, kleurenschema, en mobiel menu
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						U kunt een gratis domeinnaam gebruiken die door uKit wordt verstrekt, of uw eigen domein registreren/aansluiten. Als u een domein van uKit koopt, hoeft u dit niet te configureren: alle noodzakelijke DNS-records worden automatisch aangemaakt. In ieder geval wordt de HTTPS site versie automatisch gratis aangemaakt
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						U kunt de inhoud van de site wijzigen zoals u wilt, maar alle wijzigingen worden pas van kracht wanneer u uw site publiceert. Experimenteer zoveel als u wilt. Geen zorgen, uKit biedt automatische en handmatige back-ups in geval van problemen, zodat u met één klik terug kunt gaan naar de vorige siteversies
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		<Section lg-padding="40px 0 100px 0" md-padding="40px 0 60px 0" padding="40px 0 130px 0" color="--darkL1">
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Om te beginnen met het indexeren van de site, voegt u hem toe aan zoekmachines. U kunt dit doen op het uKit Dashboard. Bovendien kunt u controleren of de site klaar is voor promotie met een speciale SEO-wizard
				</Text>
				<Link
					border-radius="100px"
					background="--color-secondary"
		...
		<Section padding="130px 0 100px 0" background="--color-lightD1" lg-padding="100px 0 100px 0" md-padding="80px 0 100px 0">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Onze websitebouwer is klaar voor elke taak: met behulp van kant-en-klare blokken en ontwerpen kunt u verschillende soorten projecten maken zonder enige programmeerkennis of -vaardigheden
				</Text>
			</Box>
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-uw-advocatenbureau">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
			...
			>
				...
				<Box
					...
					width="50%"
				>
					<Link href="/lp/nl/creeer-een-website-voor-tutors" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_abstract_en.webp?v=2021-09-28T15:59:44.719Z"
							width="100%"
							display="flex"
		...
		<Section color="--darkL1" background="--color-secondary" lg-padding="100px 0 100px 0" padding="130px 0 130px 0">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Creëer een website voor docenten met uKit
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					U kunt het uKit-platform gratis gebruiken. Proefperiode — 14 dagen
					<Link
						hyphens="manual"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-docenten/"} place={"endOfHead"} rawKey={"6159e77568a321c9b0ac57c1"} />
		</RawHtml>
	</Theme>;
});