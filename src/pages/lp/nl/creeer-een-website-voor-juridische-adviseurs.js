...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/nl/creeer-een-website-voor-juridische-adviseurs"} />
		<Helmet>
			<title>
				Creëer een website voor juridische adviseurs — uKit. Website builder for business
			</title>
			<meta name={"description"} content={"U kunt zelf een mooie, aanpasbare en functionele website bouwen. Alles wat u hiervoor nodig heeft is uKit. U hoeft geen programmeur te zijn of over andere speciale vaardigheden te beschikken: het platform biedt kant-en-klare sjablonen, widgets en andere elementen, plus een handige online bouwer en een heleboel extra diensten."} />
			<meta property={"og:title"} content={"Creëer een website voor juridische adviseurs — uKit. Website builder for business"} />
			<meta property={"og:description"} content={"U kunt zelf een mooie, aanpasbare en functionele website bouwen. Alles wat u hiervoor nodig heeft is uKit. U hoeft geen programmeur te zijn of over andere speciale vaardigheden te beschikken: het platform biedt kant-en-klare sjablonen, widgets en andere elementen, plus een handige online bouwer en een heleboel extra diensten."} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					U kunt zelf een mooie, aanpasbare en functionele website bouwen. Alles wat u hiervoor nodig heeft is uKit. U hoeft geen programmeur te zijn of over andere speciale vaardigheden te beschikken: het platform biedt kant-en-klare sjablonen, widgets en andere elementen, plus een handige online bouwer en een heleboel extra diensten
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Voorbeelden van website-templates voor juridische adviseurs
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Kies uit een groot aantal kant-en-klare ontwerpen, pas ze aan uw site aan, pas de inhoud aan en wijzig de contactinformatie
				</Text>
			</Box>
			<Box
				lg-width="100%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Belangrijkste kenmerken voor het creëren van websites voor juridische adviseurs
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					De site kan één (een landingspagina/promo website) of vele pagina’s met een complexe structuur bevatten. Alle elementen zijn in een paar klikken met elkaar verbonden: terugbelknoppen, online chats en feedbackformulieren. U hoeft geen programmeerkennis te hebben om met de bouwer te werken — u kunt alles zelf doen in slechts een paar uur
				</Text>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Volledige set van de populairste elementen
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Zo creëert u een website voor juridische adviseurs met uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Zelfs als dit de eerste keer is dat u uKit gebruikt, hebt u geen specialisten van derden nodig. Het bouwproces van de site is naadloos en probleemloos. Volg simpelweg onderstaande stappen:
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Onze sjablooncatalogus bevat honderden kant-en-klare ontwerpen van verschillende categorieën, waaronder juridisch. Kies er een en pas hem aan uw behoeften aan. Kleurenschema’s, lettertypes en animatie-effecten kunnen in een paar klikken worden gewijzigd. Alle settings worden gemaakt in de visuele editor. Geen programmeervaardigheden vereist
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Originele inhoud wordt beter geïndexeerd door zoekmachines, dus het is een goed idee om de standaard inhoud aan te passen. Bovendien kunt u uw voordelen en kenmerken zo nauwkeurig mogelijk beschrijven. In de bouwer kunt u uw foto’s uploaden en online bewerken (met filters), video’s, feedbackformulieren, bestanden en andere inhoud toevoegen, en het gewenste aantal pagina’s aanmaken. De visuele interface is zeer handig en gemakkelijk te navigeren
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						U hoeft geen aparte mobiele versie van de site te maken — alle blokken en elementen passen zich aan alle apparaten aan. U moet er alleen voor zorgen dat alles werkt en wordt weergegeven zoals het hoort. Voor fine-tuning kunt u afzonderlijke blokken verbergen of de kleur/achtergrond van geselecteerde secties aanpassen
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						U kunt uw aangepaste domein kopen op het uKit Dashboard. DNS-records en SSL-certificaten worden automatisch ingesteld voor het maken van de beveiligde HTTPS-versie van uw site
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Wanneer uw site klaar is voor de eerste bezoekers, klikt u op «Publiceren». U kunt de inhoud blijven bewerken, nieuwe pagina’s toevoegen en de oude verwijderen. uKit heeft een automatisch back-upsysteem, zodat u uw sitegegevens niet verliest
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Vergeet niet de site toe te voegen aan zoekmachines, zodat hij geïndexeerd wordt. U kunt dit doen met links op het dashboard. Als u meer wilt weten over uw bezoekers, sluit dan een analytisch systeem zoals Google Analytics aan. Plus, uKit heeft een ingebouwde SEO-wizard om te controleren of uw site klaar is voor promotie
				</Text>
				<Link
					href="https://ukit.com/signUp"
					margin="0px 0px 0px 0px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					De online uKit-bouwer is een moderne, gebruiksvriendelijke dienst voor het maken van elk type site die u gemakkelijk zelf kunt maken: promowebsites, catalogi, landingspagina’s, en zelfs online winkels
				</Text>
			</Box>
			<Box margin="36px 0px 30px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				<Box
					...
					display="flex"
				>
					<Link text-decoration-line="initial" href="/lp/nl/creeer-een-landingspagina" color="--darkL1" hover-color="--primary">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
			...
			>
				<Box
					...
					md-width="100%"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/nl/creeer-een-website-voor-vastgoedontwikkelaars" color="--darkL1">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
		...
		>
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Creëer een website voor juridische adviseurs met uKit
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Start uw site nu zonder enige betalingsgegevens te geven. Gratis 14-dagen proefabonnement. U kunt alle uKit-functies verkennen en zien of het platform geschikt is voor u
					<Link
						text-overflow="clip"
						hyphens="manual"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/nl/creeer-een-website-voor-juridische-adviseurs/"} place={"endOfHead"} rawKey={"615c6a7964d240d94e4df747"} />
		</RawHtml>
	</Theme>;
});