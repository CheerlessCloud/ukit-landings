...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-para-seu-hotel"} />
		<Helmet>
			<title>
				Crie um site para seu hotel — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Você não precisa contratar nenhum desenvolvedor profissional para criar um site para o seu hotel. Tudo que você precisa é o uKit: o construtor de sites online. Ele já tem hospedagem ilimitada, formulários prontos com notificações gratuitas e ferramentas de SEO"} />
			<meta property={"og:title"} content={"Crie um site para seu hotel — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Você não precisa contratar nenhum desenvolvedor profissional para criar um site para o seu hotel. Tudo que você precisa é o uKit: o construtor de sites online. Ele já tem hospedagem ilimitada, formulários prontos com notificações gratuitas e ferramentas de SEO"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Crie um site para seu hotel
				</Text>
				<Text color="--dark" margin="0px 0px 50px 0px" font="--base">
					Você não precisa contratar nenhum desenvolvedor profissional para criar um site para o seu hotel. Tudo que você precisa é o uKit: o construtor de sites online. Ele já tem hospedagem ilimitada, formulários prontos com notificações gratuitas e ferramentas de SEO
				</Text>
				<Link
					display="inline"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Construtor fácil de usar com tecnologia de arrastar e soltar
				</Text>
			</Box>
			<Box
				lg-flex-direction="column"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Exemplos de modelos para sites de hotel
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Você não tem apenas designs temáticos, mas também conteúdo pronto com texto e imagens. O conteúdo é facilmente adaptado para torná-lo seu. Criar e lançar seu site nunca foi tão fácil
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--white" text-align="center" margin="0px 0px 30px 0px" font="--base">
					Pare de gastar com agências para a manutenção do seu site. Com o uKit, você pode fazer tudo sozinho. Algumas tarefas são até automatizadas, portanto, não ocupam praticamente nada do seu tempo. Você também não precisa de nenhum conhecimento especial, apenas de sua intuição e imaginação
				</Text>
			</Box>
			<Box
				lg-width="100%"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Formulários de contato, para pedidos e pop-ups
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Integração com CRMs e sistemas de pagamento online
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Tudo para apresentar seu hotel e suas acomodações
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Hospedagem ilimitada (tráfego, páginas e disco ilimitados)
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Como criar um site para o seu hotel no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					O lançamento de um site no uKit é moleza. Atualizar o conteúdo e as informações de contato é muito rápido. Apenas siga os passos abaixo. Você pode fazer isso sozinho, mesmo sem experiência
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Lançar um site é mais rápido se você não começar do zero. O uKit oferece um grande número de modelos prontos, basta escolher o estilo e a estrutura que mais se adequam ao seu projeto. Todos os modelos têm vários esquemas de cores, fontes, planos de fundo e outros parâmetros de design que podem ser alterados de uma só vez
					</Text>
					<Link
						border-width="1px"
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Descreva os serviços e preços do seu hotel
					</Text>
					<Text
						color="--dark"
						font="--base"
						...
						margin="0px 0px 24px 0px"
					>
						Você não está limitado pelo tipo de conteúdo: adicione fotos de seu hotel: quartos, bar, área infantil, etc. Faça upload de quantas fotos precisar, adicione vídeos, incorpore Google Maps interativo, adicione texto, tabelas e assim por diante. A hospedagem é ilimitada em qualquer plano. Novos elementos de página são adicionados na forma de blocos prontos e widgets no editor visual
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Adicione informações de reservas e pagamentos
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Mostre os preços dos quartos, adicione uma lista de preços para serviços extras, use os formulários para reservas, conecte sistemas de pagamento online. Para fazer isso, há um módulo de loja online e integração com as ferramentas de pagamento mais populares, CRMs e sistemas de mala direta. Notificações grátis via SMS e e-mail são enviadas quando um cliente preenche um formulário
					</Text>
				</Box>
			...
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Todos os sites criados no uKit são exibidos corretamente em todos os dispositivos. Está tudo prontinho para você. Mas você pode ajustar a visibilidade e as opções de design de blocos individuais, ocultá-los em diferentes tipos de dispositivos e alterar a grade para tablets (em uma ou duas colunas)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						O site do seu hotel deve ser reconhecível e fácil de ler e lembrar. Você pode registrar um novo domínio diretamente no Painel de Controle do uKit. O site será configurado automaticamente para usar HTTPS e o certificado SSL é fornecido gratuitamente
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Quando o site estiver pronto, você precisa torná-lo acessível aos seus clientes em potencial. Para fazer isso, basta clicar no botão «Publicar». Você pode alterar o conteúdo, adicionar novas páginas e excluir as irrelevantes, se necessário. Crie backups para não perder informações importantes e poder reverter rapidamente em caso de erros. O sistema de backup é totalmente gratuito
					</Text>
				</Box>
			</Box>
		</Section>
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Para fazer o site funcionar e atrair mais clientes, é importante divulgá-lo nos mecanismos de busca. O assistente de SEO do uKit te ajuda com isso. Para monitorar todos os indicadores do site, você pode adicioná-lo ao Google Search Console e ao Google Analytics. Leva apenas alguns minutos
				</Text>
				<Link
					padding="15px 25px 16px 25px"
					border-width="1px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Todos os tipos de sites de negócios podem ser criados no uKit sem nenhuma experiência em programação. Você consegue, mesmo que seja a primeira vez que estiver construindo um site. Com o uKit, é fácil criar sites promocionais, catálogos, landing pages, blogs corporativos e até mesmo lojas online
				</Text>
			</Box>
			<Box margin="36px 0px 30px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					{" "}
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-uma-landing-page" color="--darkL1">
						<Image
		...
		>
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Crie um site para o seu hotel no uKit
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					É hora de ver o uKit em ação. E não vai te custar nada: o período de avaliação grátis é de 14 dias
					<Link
						white-space="normal"
						text-indent="0"
						text-overflow="clip"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-site-para-seu-hotel/"} place={"endOfHead"} rawKey={"61897d782873826dd66e6182"} />
		</RawHtml>
	</Theme>;
});