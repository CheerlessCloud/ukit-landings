...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-sites-para-professores"} />
		<Helmet>
			<title>
				Crie sites para professores — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Você mesmo pode criar um site de portfólio em apenas uma noite. Sem códigos, total conformidade com os requisitos legais, modelos prontos para usar, interface intuitiva e hospedagem ilimitada. Todos os recursos de que você precisa ao seu alcance."} />
			<meta property={"og:title"} content={"Crie sites para professores — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Você mesmo pode criar um site de portfólio em apenas uma noite. Sem códigos, total conformidade com os requisitos legais, modelos prontos para usar, interface intuitiva e hospedagem ilimitada. Todos os recursos de que você precisa ao seu alcance."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Você mesmo pode criar um site de portfólio em apenas uma noite. Sem códigos, total conformidade com os requisitos legais, modelos prontos para usar, interface intuitiva e hospedagem ilimitada. Todos os recursos de que você precisa ao seu alcance
				</Text>
				<Link
					color="--white"
					font="--lead"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Modelos e blocos pré-construídos
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				<Text font="--lead" margin="0px 0px 0px 0px" color="--darkL1">
					Versão para deficientes visuais
				</Text>
			</Box>
			<Box
				align-self="flex-start"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Exemplos de sites para professores
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Uma estrutura pronta e conteúdo padrão que requer alterações mínimas. E ainda assim você pode mudar tudo o que quiser: o design, o conteúdo e a estrutura
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Os principais recursos para o site de um professor
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Você pode começar com qualquer um dos modelos. Existem também de várias páginas e de página única. Um domínio genérico é fornecido gratuitamente, mas você pode também adquirir um domínio ou mesmo usar um existente. Você pode configurar e editar todos os elementos com apenas alguns cliques, sem qualquer experiência de codificação
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Modelos para sites educacionais
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Como criar sites para professores
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Você pode criar um site facilmente arrastando e soltando os elementos necessários sem necessidade de ajuda profissional. Mas se você ficar perdido e não conseguir fazer a alteração que deseja, pode usar nossa base de conhecimento, as perguntas frequentes e o suporte técnico
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Você pode dar uma olhada nos designs prontos para verificar a implementação das funções e seções temáticas de que precisa. Na maioria dos casos, o conteúdo pode ser deixado como está ou você pode adaptá-lo como preferir. Tudo é fácil de manusear e sem complicações. Até a versão para deficientes visuais pode ser ativada de forma simples para qualquer modelo
					</Text>
					<Link
						color="--white"
						text-decoration-line="initial"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Adicione suas próprias imagens, textos, vídeos, reviews, galerias, certificados, arquivos de documentos e qualquer outro conteúdo. As imagens podem ser editadas diretamente no construtor. O uKit não impõe limitações de hospedagem ou número de páginas. A estrutura é de fácil adequação à legislação vigente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Uma vez que o uKit cria automaticamente uma versão móvel do site, você pode confiar que as páginas do site serão exibidas corretamente em todos os dispositivos. Você pode também alterar configurações individuais, se necessário: exibir ou ocultar blocos selecionados, esquema de cores ou o menu do site
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode usar um domínio gratuito fornecido pelo uKit ou o seu próprio. Se você adquirir um domínio pelo uKit, não precisará configurá-lo: todos os registros de DNS necessários são feitos automaticamente. Em qualquer caso, o site é acessível via HTTPS automaticamente de graça
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode editar o conteúdo do site da maneira que desejar, mas todas as alterações terão efeito apenas quando você publicar o seu site. Experimente o quanto você precisar, não se preocupe. Além disso, o uKit fornece backups automáticos e manuais em caso de problemas, para que você possa voltar às versões anteriores do site com um clique
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Para que seu site seja indexado, adicione-o aos mecanismos de busca. Você pode fazer isso no próprio Painel de Controle do uKit. Além disso, você pode verificar se o site está pronto para divulgação com o assistente de SEO
				</Text>
				<Link
					href="https://ukit.com/pt-BR/signUp"
					color="--white"
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 0px 0px" font="--base">
					Nosso construtor de sites está pronto para qualquer projeto: usando blocos e designs prontos, você pode criar diferentes tipos de sites sem nenhum conhecimento ou habilidade de programação
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				<Box
					...
					flex-direction="column"
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/crie-uma-landing-page" color="--darkL1" hover-color="--primary">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
			...
			>
				<Box
					...
					width="50%"
				>
					<Link href="/lp/pt-br/construtor-de-portfolio" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-de-clinica-odontologica">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
		...
		>
			...
			>
				...
				>
					Crie sites para professores com o uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Você pode começar a usar a plataforma uKit gratuitamente. Período de avaliação: 14 dias
					<Link
						word-break="normal"
						white-space="normal"
						text-indent="0"
		...
		<RawHtml>
			...
			<link href={"/lp/pt-br/crie-sites-para-professores/"} rel={"canonical"} place={"endOfHead"} rawKey={"6159e77568a321c9b0ac57c1"} />
		</RawHtml>
	</Theme>;
});