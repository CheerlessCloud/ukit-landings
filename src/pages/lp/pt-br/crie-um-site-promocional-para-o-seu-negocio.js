...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-promocional-para-o-seu-negocio"} />
		<Helmet>
			<title>
				Crie um Site Promocional para o seu negócio — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Sem códigos, vários modelos prontos, notificações de pedidos por SMS grátis, hospedagem ilimitada. Crie seu site em uma noite!"} />
			<meta property={"og:title"} content={"Crie um Site Promocional para o seu negócio — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Sem códigos, vários modelos prontos, notificações de pedidos por SMS grátis, hospedagem ilimitada. Crie seu site em uma noite!"} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Sem códigos, vários modelos prontos, notificações de pedidos por SMS grátis, hospedagem ilimitada. Crie seu site em uma noite!
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Tudo que você precisa para criar um site é um domínio personalizado, a hospedagem e um bom construtor de sites. Com o uKit, você tem tudo isso em um só lugar
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Qualquer um pode criar seu próprio site — sem edição de código, apenas widgets e blocos prontos. Guias visuais detalhados e tutoriais, além de diversos modelos. Nenhuma habilidade prévia de programação ou design é necessária para criar seu primeiro site promocional
				</Text>
			</Box>
			<Box
				flex-wrap="wrap"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos, blocos e formulários pré-construídos
					</Text>
				</Box>
				<Box
					md-width="100%"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Crie você mesmo um site promocional em algumas horas, mesmo que nunca o tenha feito antes
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Você é um(a) fotógrafo(a), advogado(a) ou organizador(a) de eventos? Temos opções de design prontas para empresas dos mais diversos setores e para pequenos negócios
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						border-radius="100px"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode manter o design do modelo e substituir seu conteúdo padrão. Ou você pode adicionar blocos no construtor. Ou redesenhar completamente todo o conteúdo da página. O construtor permite adicionar, remover, mover e duplicar todos os elementos. Adicione textos e imagens personalizados para garantir que seu site fique bem ranqueado nos resultados das pesquisas
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Nosso construtor faz tudo para você. Você só precisa revisar as versões de smartphone e tablet e fazer pequenos ajustes
					</Text>
				</Box>
			...
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						sm-color="#3c3f4f"
					>
						Você pode obter um novo domínio no próprio Painel de Controle do uKit ou conectar um existente. Os certificados SSL necessários para a versão HTTPS do site são gratuitos e configurados automaticamente. Você não precisa configurar nada manualmente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Não tenha medo de fazer algo errado. Até 10 backups são criados automática ou manualmente. Você pode reverter as alterações a qualquer momento
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Agora você precisa adicionar o site aos mecanismos de pesquisa e definir as configurações de SEO. O uKit permite que você defina meta tags para cada página do seu site. Você também pode adicionar seu site a mecanismos de busca e ao Google Maps
				</Text>
				<Link
					color="--white"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Crie qualquer tipo de site você mesmo, mesmo que nunca o tenha feito antes
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Components.Perelink href="/lp/pt-br/crie-um-site-de-clinica-odontologica">
						<Image
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Components.Perelink href="/lp/pt-br/crie-sites-para-professores">
						<Image
							width="100%"
							display="flex"
							align-items="center"
			...
			>
				<Box
					...
					display="flex"
				>
					<Components.Perelink href="/lp/pt-br/construtor-de-landing-pages">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					md-width="100%"
				>
					<Components.Perelink href="/lp/pt-br/crie-um-site-para-sua-empreiteira">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_cleaning_en.webp?v=2021-09-28T16:25:14.701Z"
			...
			>
				<Box
					...
					md-width="100%"
				>
					<Components.Perelink href="/lp/pt-br/software-para-a-criacao-de-sites">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Components.Perelink href="/lp/pt-br/construtor-de-paginas-da-web">
						<Image
							width="100%"
							display="flex"
							align-items="center"
		...
		>
			...
			>
				...
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Crie um site promocional gratuitamente durante o período de avaliação de 14 dias e experimente todos os recursos do construtor uKit agora mesmo
				</Text>
				<Link
					text-decoration-line="initial"
					padding="15px 25px 16px 25px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-site-promocional-para-o-seu-negocio/"} place={"endOfHead"} rawKey={"6151b0f4ee4b201a3694f548"} />
		</RawHtml>
	</Theme>;
});