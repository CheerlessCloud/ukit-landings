...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-para-sua-imobiliaria"} />
		<Helmet>
			<title>
				Crie um site para sua imobiliária — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Hospedagem ilimitada e um número ilimitado de páginas, designs prontos, editor visual fácil de usar, integração com CRM, notificações por SMS. Nenhuma habilidade de programação é necessária. Você pode criar seu próprio site de uma só vez."} />
			<meta property={"og:title"} content={"Crie um site para sua imobiliária — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Hospedagem ilimitada e um número ilimitado de páginas, designs prontos, editor visual fácil de usar, integração com CRM, notificações por SMS. Nenhuma habilidade de programação é necessária. Você pode criar seu próprio site de uma só vez."} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Hospedagem ilimitada e um número ilimitado de páginas, designs prontos, editor visual fácil de usar, integração com CRM, notificações por SMS. Nenhuma habilidade de programação é necessária. Você pode criar seu próprio site de uma só vez
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Exemplos de modelos para sites de imobiliárias
				</Text>
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Tudo o que você precisa para o seu site, você encontra no uKit: adquira seu próprio domínio, integração com CRM e chats, e-mail personalizado, certificado SSL grátis, hospedagem ilimitada e muito mais. Você só precisa escolher uma das opções de design ou se preferir, construir o site do zero
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Os principais recursos para a criação do site da sua imobiliária
				</Text>
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					Não há necessidade de contratar programadores ou aprender web design para construir um site de alta qualidade para sua imobiliária com o uKit. Você pode criar o site em nosso construtor online especial usando widgets e blocos prontos rapidamente
				</Text>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Funcionalidades para lojas online
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos temáticos para imobiliárias e consultores imobiliários
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Fácil integração com CRM e o construtor de formulários uCalc
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Chats e formulários de contato
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Passo-a-passos, linhas de tempo, avaliações e outros elementos já prontos
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Como criar um site para sua imobiliária no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Mesmo que a plataforma seja completamente nova e você não tenha nenhuma habilidade técnica na construção de sites, ainda assim você conseguirá criar o que precisa. Você terá acesso a uma plataforma online onde poderá adicionar suas descrições de serviços e produtos, listas de preços, formulários de contato e outros elementos
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Você pode começar com um modelo específico para seu ramo ou qualquer outro modelo do catálogo — existem mais de 300 deles. Você pode alterar a fonte em todo o site ou o esquema de cores de uma só vez. Você também pode adicionar, modificar e remover quaisquer elementos e widgets necessários. A qualquer momento, o modelo pode ser substituído e o conteúdo permanecerá inalterado
					</Text>
					<Link
						border-radius="100px"
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Você pode até deixar o texto e as imagens que vêm com o modelo, eles não são apenas textos sem significado. Mas se você quiser criar um site com aparência mais profissional, recomendamos adicionar conteúdo personalizado: textos, fotos e vídeos. Você pode até editar imagens no construtor: use filtros, recorte imagens, faça sobreposições e muito mais
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Todos os elementos da interface se adaptam automaticamente à resolução da tela de todos os dispositivos. Se você não gosta da aparência de um elemento em particular, pode ocultá-lo em um determinado dispositivo ou criar uma aparência alternativa, por exemplo, alterando o plano de fundo e o número de colunas
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Crie o seu próprio domínio e registre-o diretamente no Painel de Controle do uKit ou conecte um já existente. Você nem mesmo precisa editar manualmente seus registros DNS para redirecionar para a hospedagem. Os certificados SSL necessários para a versão HTTPS do site são gerados e configurados automaticamente, além de serem gratuitos
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Clique em «Publicar» e seu site estará totalmente pronto para os primeiros visitantes. Sinta-se à vontade para alterar o conteúdo da página e experimentar: o uKit pode armazenar até 10 backups manuais e automáticos. Deu algo errado? Basta restaurar a versão correta do site a partir do backup
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 36px 0px" font="--base" color="--darkL1">
					Para facilitar que seu site seja encontrado pelos seus clientes em potencial, preste atenção às metatags de SEO de cada página. Para certificar-se de que seu site está pronto para a divulgação, use o assistente de SEO integrado
				</Text>
				<Link
					hover-background="linear-gradient(to right,#537cff,#537cff)"
					color="--white"
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					O uKit é um construtor online fácil de usar e altamente eficaz para a criação de um site de negócios. Nenhum conhecimento especial ou experiência são necessários. Você pode fazer qualquer projeto sozinho em apenas algumas horas
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-para-sua-empreiteira" color="--darkL1">
						<Image
							width="100%"
							display="flex"
							align-items="center"
			...
			>
				...
				>
					<Link href="/lp/pt-br/crie-um-site-de-clinica-odontologica" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead">
							crie-um-site-de-clinica-odontologica
						</Text>
					</Link>
				</Box>
			</Box>
			...
			>
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/pt-br/crie-um-site-para-seu-hotel" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		>
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Crie um site para sua imobiliária no uKit
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Confira os belos designs e as funcionalidades do uKit gratuitamente agora mesmo. Você com certeza vai adorar!
				</Text>
				<Link
					border-width="1px"
					border-radius="100px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-site-para-sua-imobiliaria/"} place={"endOfHead"} rawKey={"615d5350c3297f01fde1b758"} />
		</RawHtml>
	</Theme>;
});