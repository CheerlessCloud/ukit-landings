...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-para-sua-instituicao-de-ensino"} />
		<Helmet>
			<title>
				Crie um site para sua Instituição de Ensino — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"O construtor de sites uKit é perfeito para as mais diversas tarefas, incluindo a construção de sites para instituições educacionais: jardins de infância, escolas, cursinhos, escolas profissionalizantes, faculdades, escolas on-line e muito mais. Podem ser instituições comerciais e não comerciais."} />
			<meta property={"og:title"} content={"Crie um site para sua Instituição de Ensino — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"O construtor de sites uKit é perfeito para as mais diversas tarefas, incluindo a construção de sites para instituições educacionais: jardins de infância, escolas, cursinhos, escolas profissionalizantes, faculdades, escolas on-line e muito mais. Podem ser instituições comerciais e não comerciais."} />
		...
		<Section md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 50px 0px" font="--base">
					O construtor de sites uKit é perfeito para as mais diversas tarefas, incluindo a construção de sites para instituições educacionais: jardins de infância, escolas, cursinhos, escolas profissionalizantes, faculdades, escolas on-line e muito mais. Podem ser instituições comerciais e não comerciais
				</Text>
				<Link
					border-width="1px"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Exemplos de modelos de sites para instituições de ensino
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Estilo formal e várias opções de temas. Os modelos são construídos a partir de blocos prontos que podem ser movidos, adicionados, removidos e editados. Basta conectar seu domínio e gastar um pouco de tempo para personalizar o conteúdo do site
				</Text>
			</Box>
			<Box
				lg-width="100%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Os principais recursos para sites de instituições educacionais
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white" text-align="center">
					Você pode criar um site completo com uma estrutura complexa ou apenas uma landing page. O construtor é fácil de usar, mesmo que você não tenha nenhuma experiência em programação e seja novato na plataforma
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					<Text font="--lead" text-align="center" margin="0px 0px 0px 0px" color="--white">
						Carregue e disponibilize certificados ou outros documentos no site
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Blocos temáticos já prontos: galerias, resenhas e cartões de funcionários
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					<Text color="--white" font="--lead" text-align="center" margin="0px 0px 0px 0px">
						Modelos prontos modernos e com muito estilo, especialmente para escolas, colégios e afins
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Divulgação automática em mecanismos de busca
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Opções de pagamento para pessoas jurídicas
					</Text>
				</Box>
			</Box>
		</Section>
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Como criar um site para sua instituição de ensino no uKit
				</Text>
				<Text color="--darkL1" margin="0px 0px 0px 0px" font="--base">
					Não se preocupe se você não tem habilidades especiais para isso. o construtor uKit é muito fácil de usar, independentemente do nível em que você esteja. Mesmo aqueles sem experiência na criação de sites conseguem se orientar rapidamente conosco
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Já preparamos muitas opções de modelos temáticos com conteúdo já preenchido: basta escolher o que mais combina com seu projeto. Todos os modelos podem ser facilmente editados e preenchidos com as informações, blocos e elementos necessários. Uma versão para deficientes visuais pode ser ativada em apenas um clique
					</Text>
					<Link
						border-radius="100px"
						display="inline"
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Qualquer texto, imagem, vídeo, arquivo ou outro tipo de conteúdo pode ser facilmente substituído, adicionado ou modificado. Você poderá fazer o upload de seus certificados, contratos, listas de preços e outros documentos, criar perfis dos professores, adicionar anúncios, avaliações e notícias. E você pode fazer tudo isso sozinho usando o nosso construtor online
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Todas as páginas que você criar já saem adaptadas a todos os dispositivos. Você não precisa editar nada sozinho. Você pode alternar o modo de exibição e ver por si mesmo. Se necessário, você pode ocultar blocos individuais ou ajustar a aparência deles para tablets e telefones em específico
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Para registrar um novo domínio ou renová-lo, você nem precisa sair do Painel de Controle do uKit. As configurações do seu domínio são definidas automaticamente, você não precisa fazer nada manualmente. E os certificados SSL são habilitados e configurados automaticamente também
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Após a publicação, você pode alterar seu site a qualquer momento, adaptando-o às mais diferentes necessidades. Seus usuários verão as alterações somente depois que você republicar o site. Experimentos mal sucedidos ou outros erros podem ser facilmente corrigidos voltando para as versões anteriores do site que estão armazenadas na seção de backup
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Cuide da divulgação e indexação do seu site: adicione-o aos mecanismos de busca em poucos cliques no Painel de Controle. Você também pode verificar se o seu site está pronto para os mecanismos de busca com nosso assistente de SEO integrado
				</Text>
				<Link
					color="--white"
					text-decoration-line="initial"
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Nosso produto é um construtor de sites muito flexível. Qualquer projeto pode ser executado sem que você precise de nenhuma experiência ou ajuda. Mesmo que você nunca tenha feito isso antes
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/crie-seu-portfolio-de-design-de-interiores" color="--darkL1" hover-color="--primary">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
			...
			>
				<Box
					...
					display="flex"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/software-para-a-criacao-de-sites">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
							src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_abstract_en.webp?v=2021-09-28T15:59:44.719Z"
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-seu-site-de-coaching-ou-mentoria">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		>
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Crie um site para sua instituição de ensino com o uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Experimente toda a plataforma de graça. Comece agora e veja você mesmo como o uKit é fácil e conveniente
				</Text>
				<Link
					border-style="solid"
					display="inline"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-site-para-sua-instituicao-de-ensino/"} place={"endOfHead"} rawKey={"6159e1df2c3a9db666910452"} />
		</RawHtml>
	</Theme>;
});