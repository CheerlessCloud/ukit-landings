...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/construtor-de-landing-pages"} />
		<Helmet>
			<title>
				uKit - Construtor de Landing Pages
			</title>
			<meta name={"description"} content={"Precisa de uma landing page eficaz com opções de pagamento online, formulários de coleta e outros recursos? Mas não quer gastar com desenvolvedores, designers e outros especialistas? O uKit é uma plataforma de primeira classe para a criação de sites e landing pages. Um editor visual e intuitivo e ferramentas de SEO para promoção, tudo em um só lugar "} />
			<meta property={"og:title"} content={"uKit - Construtor de Landing Pages"} />
			<meta property={"og:description"} content={"Precisa de uma landing page eficaz com opções de pagamento online, formulários de coleta e outros recursos? Mas não quer gastar com desenvolvedores, designers e outros especialistas? O uKit é uma plataforma de primeira classe para a criação de sites e landing pages. Um editor visual e intuitivo e ferramentas de SEO para promoção, tudo em um só lugar "} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Precisa de uma landing page eficaz com opções de pagamento online, formulários de coleta e outros recursos? Mas não quer gastar com desenvolvedores, designers e outros especialistas? O uKit é uma plataforma de primeira classe para a criação de sites e landing pages. Um editor visual e intuitivo e ferramentas de SEO para promoção, tudo em um só lugar
				</Text>
				<Link
					color="--white"
					font="--lead"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text font="--lead" width="95%" margin="0px 0px 0px 0px" color="--darkL1">
					Formulários de pedido e notificações gratuitas
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Exemplos de Modelos de Landing Pages
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Todos os modelos são responsivos e ficam bem em qualquer dispositivo. Você pode escolher um design pronto, levando em consideração as especificidades do seu negócio. Por exemplo, um salão de beleza ou um hotel. É fácil alterar os parâmetros de design e adaptar o modelo às suas necessidades
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					uKit — O Premiado Construtor de sites
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Você pode criar landing pages com o uKit arrastando e soltando os elementos que desejar. Não é necessário saber programar ou ter conhecimento técnico especial. A interface do editor é clara e fácil de usar, mesmo para iniciantes. E ainda existem mais recursos do uKit para você descobrir
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Blocos prontos para qualquer atividade
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Pop-ups, formulários de contato e botão de retorno de chamada
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Notificações via SMS e e-mail grátis
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Designs prontos para landing pages
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Serviços integrados: CRM, analytics, newsletters
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Como criar uma Landing Page no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Tudo que você precisa para criar landing pages eficazes já está na plataforma. Com o uKit, não há uma íngreme curva de aprendizado, a maioria das tarefas é automatizada ou bastante simplificada. Até um novato consegue, basta seguir os passos abaixo e seu site estará pronto!
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Comece com um modelo temático entre as centenas em nosso catálogo. Escolha um e veja por si mesmo como é fácil trabalhar com o editor do uKit. Você pode alterar os esquemas de cores, imagens de fundo, fontes, efeitos de animação e até mesmo o modelo inteiro. Quando você altera o modelo, o conteúdo é mantido, então não se preocupe, seus textos e imagens não serão perdidos
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						margin="0px 0px 0px 0px"
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						É hora de colocar as mãos na massa! Substitua o conteúdo do modelo pelo seu conteúdo personalizado, adicione e remova blocos conforme necessário, adicione suas informações de contato, ative os formulários pré-criados e ative as notificações. Se necessário, conecte formas de pagamento online, CRM, e-mail marketing e analytics. Qualquer Landing Page que você criar com o uKit será realmente eficiente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Qualquer site criado no uKit funciona automaticamente em todos os tipos de dispositivo. A configuração da versão móvel da página é totalmente automática. No entanto, existem configurações avançadas que permitem ocultar blocos ou elementos individuais, alterar o design de seções separadas e muito mais
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Embora você possa usar um de nossos domínios gratuitos, você pode conectar seu próprio domínio existente ou registrar um novo. Você pode fazer isso no próprio Painel de Controle do uKit. O certificado SSL e a versão HTTPS do site são gerados automaticamente e sem nenhum custo adicional
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Clique em «Publicar» e o site estará pronto para receber seus clientes. Quer editar e melhorar seu site? Faça qualquer alteração que você quiser sem se preocupar, é fácil voltar atrás com o sistema de backups automáticos e manuais
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Conecte serviços de estatísticas e adicione seu site ao Google Search Console. Acompanhe todas as estatísticas do site em um só lugar de forma conveniente
				</Text>
				<Link
					border-color="--color-secondary"
					background="--color-secondary"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Com o uKit, você pode criar não apenas Landing Pages eficazes, mas também outros tipos de projetos para seus negócios como websites completos, sites promocionais, portfólios e lojas online
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					font="--headline1"
				>
					Crie sua Landing Page no uKit agora
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Se cadastre na plataforma e você poderá conferir todos os recursos do uKit com um período de avaliação de 14 dias
				</Text>
				<Link
					href="https://ukit.com/pt-BR/signUp"
					color="--secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/construtor-de-landing-pages/"} place={"endOfHead"} rawKey={"6175bd8c9a4614335db50adb"} />
		</RawHtml>
	</Theme>;
});