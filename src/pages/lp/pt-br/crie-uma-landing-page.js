...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-uma-landing-page"} />
		<Helmet>
			<title>
				Crie uma Landing Page — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Modelos prontos, uma ampla gama de categorias temáticas e elementos de design, notificações de formulários, integrações, hospedagem ilimitada.\nCrie uma landing page você mesmo em poucas horas"} />
			<meta property={"og:title"} content={"Crie uma Landing Page — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Modelos prontos, uma ampla gama de categorias temáticas e elementos de design, notificações de formulários, integrações, hospedagem ilimitada.\nCrie uma landing page você mesmo em poucas horas"} />
		...
		<Section md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Modelos prontos, uma ampla gama de categorias temáticas e elementos de design, notificações de formulários, integrações, hospedagem ilimitada.
					<br />
					Crie uma landing page você mesmo em poucas horas
				</Text>
				<Link
		...
		>
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Escolha qualquer modelo da biblioteca. Personalize o conteúdo ou substitua o modelo por outro, se necessário. Hospedagem ilimitada e certificados SSL grátis em todos os planos
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					O que oferecemos para sua Landing Page
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Com o uKit, não há necessidade de ser um profissional da web para criar belas landing pages de alta qualidade que funcionam com perfeição. Você também não precisa trabalhar com código-fonte, apenas blocos prontos e widgets. Ampla liberdade de design e integrações com outros serviços
				</Text>
			</Box>
			<Box
				width="33.333%"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Sistema de analytics de alta qualidade
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Chat e botão de retorno de chamada
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Timers, listas de preço, linhas do tempo
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Mesmo se você não for um profissional da web e estiver usando o construtor uKit pela primeira vez, pode criar sua primeira landing page em apenas algumas horas
				</Text>
			</Box>
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Temos muitas opções de designs temáticos para os mais diversos setores. Basta selecionar aquele que melhor se adapta ao seu negócio e personalizá-lo. Adicione ou remova widgets e, a seguir, defina a fonte e a cor desejadas para o texto
					</Text>
					<Link
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Os modelos já contêm textos prontos, não apenas placeholders. No entanto, se você deseja um site único e eficaz, deve adicionar um texto personalizado. Faça o upload de imagens e edite no próprio construtor, o uKit possui um editor de imagens embutido
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Você pode ocultar quaisquer elementos ou mesmo blocos inteiros e implementar um estilo de design alternativo para smartphones e tablets.
						<br />
						No preview você pode certificar-se de que tudo funciona como deveria
					</Text>
				</Box>
				<Box display="flex" md-width="100%" width="50%" margin="0px 0px 0px 0px">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Conecte seu domínio e publique sua Landing Page
					</Text>
					<Text
						font="--base"
						width="84%"
						...
						color="--dark"
					>
						Você pode obter um novo domínio no próprio Painel de Controle do uKit. Nesse caso, os registros DNS serão configurados automaticamente. Os certificados SSL são gratuitos e também configurados automaticamente. Você não precisa editar nada manualmente.
						<br />
						Para sua segurança, o uKit armazena até 10 backups do seu site. Não tenha medo de editar seu site ou cometer erros. Você pode restaurar a versão anterior do seu site a qualquer momento
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Você pode conectar o Google Analytics e o Facebook Pixel. Isso leva apenas alguns minutos.
						<br />
						Rastreie o desempenho de sua landing page em tempo real ou durante um período específico de tempo sem sair do Painel de Controle do uKit
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Agora você precisa adicionar o site aos mecanismos de pesquisa e definir as configurações de SEO. O uKit permite que você defina meta tags para cada página do seu site. Você pode também usar o assistente de SEO para verificar se o seu site está pronto para publicação
				</Text>
				<Link
					text-decoration-line="initial"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Crie qualquer tipo de site com nosso construtor, mesmo que nunca o tenha feito antes
				</Text>
			</Box>
			...
			>
				<Box
					...
					width="50%"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/construtor-de-sites-promocionais">
						<Image
							border-radius="18px"
							margin="0px 0px 18px 0px"
							loading="lazy"
		...
		>
			...
			>
				<Text
					...
					text-align="center"
				>
					Você está pronto para criar sua Landing Page no uKit?
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Crie sua própria landing page do zero agora mesmo usando blocos ou um modelo pronto. Nenhuma habilidade de programação ou conhecimento especial necessário
				</Text>
				<Link
					color="--secondary"
					text-decoration-line="initial"
		...
		<RawHtml>
			...
			<link href={"/lp/pt-br/crie-uma-landing-page/"} rel={"canonical"} place={"endOfHead"} rawKey={"6153428713a22cefa64c1f19"} />
		</RawHtml>
	</Theme>;
});