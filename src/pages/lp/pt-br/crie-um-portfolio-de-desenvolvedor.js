...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-portfolio-de-desenvolvedor"} />
		<Helmet>
			<title>
				Crie um portfólio de desenvolvedor — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Sem tempo para escrever códigos? Sem ideias de design? Sem problemas: você pode construir rapidamente seu portfólio com o uKit: uma vasta biblioteca de modelos prontos, um editor visual simples e conveniente e hospedagem totalmente ilimitada"} />
			<meta property={"og:title"} content={"Crie um portfólio de desenvolvedor — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Sem tempo para escrever códigos? Sem ideias de design? Sem problemas: você pode construir rapidamente seu portfólio com o uKit: uma vasta biblioteca de modelos prontos, um editor visual simples e conveniente e hospedagem totalmente ilimitada"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Sem tempo para escrever códigos? Sem ideias de design? Sem problemas: você pode construir rapidamente seu portfólio com o uKit: uma vasta biblioteca de modelos prontos, um editor visual simples e conveniente e hospedagem totalmente ilimitada
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Exemplos de modelos para portfólio de desenvolvedor
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Todos os recursos estão prontos para uso. Existem modelos temáticos de uma e várias páginas, modernos e populares. Após escolher seu modelo, basta conectar seu domínio e publicar o site
				</Text>
			</Box>
			<Box
				flex-direction="row"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Este construtor flexível e fácil de usar permite que você mostre a seus clientes em potencial tudo sobre você, suas habilidades e experiência, além de mostrar exemplos de seu trabalho
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Blocos prontos para portfólios e landing pages
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos modernos e atualizados
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formulários pop-up, chat no site e formulários de contato
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Como criar um site de desenvolvedor no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Investindo apenas um pouco de tempo você obtém resultados realmente impressionantes. O uKit tem tudo para você construir um site rapidamente: basta é configurar os parâmetros iniciais e publicar seu site
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Você desenvolve aplicativos móveis ou se especializa em Python, C ++ ou Java? Temos centenas de modelos prontos para diferentes negócios. Você pode escolher qualquer um deles. Cada modelo possui vários esquemas de cores, fontes, efeitos de animação e planos de fundo e tudo isso pode ser editado à vontade. O conjunto de blocos e a estrutura da página podem ser facilmente alterados para atender aos seus requisitos
					</Text>
					<Link
						color="--white"
						text-decoration-line="initial"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Descreva suas habilidades e mostre exemplos de seu trabalho
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Mostre ao mundo as suas melhores habilidades e prove seu profissionalismo com exemplos. Com o uKit, você pode criar qualquer número de páginas, fazer upload de arquivos, adicionar vídeos, imagens e qualquer outro conteúdo. A hospedagem é absolutamente ilimitada. As imagens podem ser editadas diretamente no construtor: cortar, aplicar efeitos, girar, etc.
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Todos os blocos e widgets do uKit funcionam em todos os dispositivos, então você não precisa refazer nada. Mas, se necessário, você pode ocultar elementos ou seções inteiras e alterar seu plano de fundo e design para smartphones ou tablets. O uKit adapta automaticamente as imagens ao tamanho da tela e também otimiza o carregamento de arquivos de mídia grandes, para que as páginas carreguem rapidamente em todos os dispositivos
					</Text>
				</Box>
				<Box md-width="100%" width="50%" margin="0px 0px 0px 0px" display="flex">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode adquirir um domínio popular no próprio Painel de Controle do uKit. A versão HTTPS é configurada e funciona por padrão, sem alertas de segurança para os visitantes do seu site
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Você pode alterar e personalizar as páginas o quanto quiser. Elas ficam online somente após a publicação. O uKit faz backups automáticos e manuais (até 10 versões) do site, o que significa que a recuperação pode ser feita com apenas um clique
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 36px 0px" font="--base" color="--darkL1">
					Você também pode conectar o Analytics e adicionar seu site ao Google Search Console através do Painel de Controle do uKit. Isso é feito automaticamente. Você também pode verificar se o seu site está pronto para promoção com o assistente integrado de SEO
				</Text>
				<Link
					border-width="1px"
					border-color="--color-secondary"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Em nosso construtor, você pode criar não apenas portfólios, mas também sites promocionais, catálogos, sites de negócios, lojas online, landing pages e outros tipos de site
				</Text>
			</Box>
			<Box margin="36px 0px 30px 0px" width="100%" display="flex" flex-wrap="wrap">
				<Box
					...
					display="flex"
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/crie-um-site-para-sua-empreiteira" color="--darkL1" hover-color="--primary">
						<Image
			...
			>
				<Box
					...
					display="flex"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-de-clinica-odontologica" color="--darkL1">
						<Image
							loading="lazy"
		...
		>
			...
			>
				<Text
					...
					color="--white"
				>
					Crie um portfólio de desenvolvedor com o uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Período de avaliação gratuito de 14 dias sem qualquer informação de pagamento. Inscreva-se agora e veja por si mesmo como o construtor pode trabalhar para você
				</Text>
				<Link
					text-decoration-line="initial"
					padding="15px 25px 16px 25px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-portfolio-de-desenvolvedor/"} place={"endOfHead"} rawKey={"617ea5961822ad90071748f2"} />
		</RawHtml>
	</Theme>;
});