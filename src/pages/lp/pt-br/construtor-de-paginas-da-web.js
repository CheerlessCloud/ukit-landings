...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/construtor-de-paginas-da-web"} />
		<Helmet>
			<title>
				uKit - construtor de páginas da web 
			</title>
			<meta name={"description"} content={"Precisa fazer um site de uma página rapidamente e sem gastar com especialistas terceirizados? O uKit está aqui para te ajudar! Aqui você encontra uma vasta biblioteca de modelos prontos para landing pages e sites promocionais, todos os blocos e ferramentas necessários, bem como opções adicionais de SEO "} />
			<meta property={"og:title"} content={"uKit - construtor de páginas da web "} />
			<meta property={"og:description"} content={"Precisa fazer um site de uma página rapidamente e sem gastar com especialistas terceirizados? O uKit está aqui para te ajudar! Aqui você encontra uma vasta biblioteca de modelos prontos para landing pages e sites promocionais, todos os blocos e ferramentas necessários, bem como opções adicionais de SEO "} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Precisa fazer um site de uma página rapidamente e sem gastar com especialistas terceirizados? O uKit está aqui para te ajudar! Aqui você encontra uma vasta biblioteca de modelos prontos para landing pages e sites promocionais, todos os blocos e ferramentas necessários, bem como opções adicionais de SEO
				</Text>
				<Link
					border-radius="100px"
					background="#4773ff"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Formulários de contato e retorno de chamada
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Integração com CRM e estatísticas
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Não há necessidade de começar do zero, acelere o processo usando modelos temáticos prontos. Personalize o conteúdo e publique o projeto. Agora está quase tudo pronto
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					uKit, o construtor de sites com tudo incluso
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Você mesmo pode criar qualquer landing page, site promocional, portfólio, etc. Você só precisa de algumas horas. Não há necessidade de contratar especialistas para promover seu site nas pesquisas. Tudo já está instalado na plataforma
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos, blocos, seções e outros elementos prontos para usar
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Conexão de domínio simplificada
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integração com outros serviços de CRM, chat e pagamentos online
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Pode demorar um pouco para pegar o jeito do construtor. Mas mesmo que esteja trabalhando com a plataforma pela primeira vez, você certamente conseguirá criar um site de página única funcional e bonito sozinho(a). Nossa detalhada base de conhecimento, dicas interativas e suporte técnico 24 horas por dia irão ajudá-lo
				</Text>
			</Box>
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Escolha o modelo que melhor se adapta a você. Nosso catálogo contém centenas de opções prontas para qualquer negócio. Cada modelo possui conteúdo já pronto e utilizável, arquivos de mídia e pop-ups. O esquema de cores, efeitos de animação e conjuntos de fontes podem ser alterados em alguns cliques. Também é fácil trocar o modelo por outro, sem perder nenhum conteúdo
					</Text>
					<Link
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						As páginas no uKit são construídas com elementos prontos. O sistema possui blocos, seções e widgets para tudo: cronômetros de contagem regressiva, pop-ups, botões de retorno de chamada, chats ao vivo, galerias, cartões de produtos, carrinho de compras (para criar uma loja online e aceitar pagamentos online) e muito mais. Basta arrastá-los e soltá-los na página e personalizá-los o quanto quiser
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Tudo já está pronto: todos os sites construídos no uKit se adaptam a qualquer resolução de tela. As imagens são otimizadas automaticamente, então a velocidade de download é sempre alta. Você pode deixar tudo «como está» e ainda assim ter a certeza de que as páginas são exibidas como deveriam ser em qualquer dispositivo ou pode ocultar quaisquer elementos individuais para não sobrecarregar seus visitantes
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode conectar seu nome de domínio existente ou comprar um novo diretamente no Painel do uKit. É possível usar qualquer domínio registrado em qualquer site. Os certificados SSL são gratuitos e o redirecionamento para a versão do site HTTPS é configurado automaticamente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Não tenha medo de editar o conteúdo do seu site. O uKit oferece um sistema de backup automático e manual. Você pode criar até 10 backups e reverter para qualquer versão do site com um clique
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Para rastrear os indicadores de desempenho mais importantes, conecte o Google Analytics, adicione o site ao Google Search Console, verifique se o site está pronto para divulgação com o assistente de SEO — tudo isso pode ser feito com alguns cliques no uKit
				</Text>
				<Link
					border-radius="100px"
					display="inline"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					O uKit é a melhor solução para sites de negócios. Qualquer projeto, independente do tema, pode ser lançado em um piscar de olhos. Nenhuma habilidade ou conhecimento especial é necessário. Com nosso construtor, você pode criar facilmente: sites promocionais, landing pages e portfólios
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					display="flex"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-seu-site-de-consultor-juridico">
						<Image
							loading="lazy"
		...
		>
			...
			>
				...
				<Text color="--lightD1" text-align="center" margin="0px 0px 36px 0px" font="--lead">
					Crie seu site de página única agora mesmo e experimente nosso construtor em ação. Comece gratuitamente com o período de avaliação de 14 dias para cada novo site
				</Text>
				<Link
					color="--secondary"
					text-decoration-line="initial"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/construtor-de-paginas-da-web/"} place={"endOfHead"} rawKey={"61728b2456c65c1a397047dd"} />
		</RawHtml>
	</Theme>;
});