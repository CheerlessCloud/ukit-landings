...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/hospedagem-com-construtor-de-sites"} />
		<Helmet>
			<title>
				Hospedagem com Construtor de Sites — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"A maioria dos construtores de sites e serviços de hospedagem limitam os recursos usados dos servidores. Mas não o uKit. Conosco você obtém hospedagem, tráfego de rede e quantidade de páginas ilimitados em qualquer plano"} />
			<meta property={"og:title"} content={"Hospedagem com Construtor de Sites — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"A maioria dos construtores de sites e serviços de hospedagem limitam os recursos usados dos servidores. Mas não o uKit. Conosco você obtém hospedagem, tráfego de rede e quantidade de páginas ilimitados em qualquer plano"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					A maioria dos construtores de sites e serviços de hospedagem limitam os recursos usados dos servidores. Mas não o uKit. Conosco você obtém hospedagem, tráfego de rede e quantidade de páginas ilimitados em qualquer plano
				</Text>
				<Link
		...
		<Section lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Exemplos de modelos de sites
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Para facilitar o começo de sua jornada, preparamos centenas de modelos com diferentes temas. Todos eles são absolutamente gratuitos, facilmente personalizáveis e têm design responsivo
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white" text-align="center">
					Você não precisa instalar e configurar sistemas de CMS, aqui você tem um construtor online conveniente que permite que você crie rapidamente um projeto para qualquer empresa sem nenhum conhecimento especial
				</Text>
			</Box>
			<Box
				width="100%"
			...
			>
				...
				>
					...
					<Text text-align="center" margin="0px 0px 0px 0px" color="--white" font="--lead">
						Hospedagem confiável e ilimitada
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Não há necessidade de instalar e configurar um CMS
					</Text>
				</Box>
				<Box
					width="33%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Construtor online pronto para usar
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					<Text font="--lead" text-align="center" margin="0px 0px 0px 0px" color="--white">
						Todos os Widgets e elementos de interface necessários
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text color="--white" font="--lead" text-align="center" margin="0px 0px 0px 0px">
						Loja online e ferramentas de pagamento
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead" text-align="center">
						Versão HTTPS do site sem custo adicional
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Como obter um site com hospedagem no Construtor uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					O serviço é projetado para você iniciar seu projeto com o mínimo de esforço. Tudo já está configurado ou será configurado automaticamente conforme você escolher as opções necessárias. Não é preciso habilidades especiais para trabalhar com a plataforma
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						O grande número de opções de designs diferentes atenderá a todas as suas necessidades. Eles são todos modernos, responsivos e já possuem conteúdo pronto. Basta substituir as informações de contato pelas suas e você pode ir direto para a divulgação. Precisa editar a estrutura do site, alterar a localização do bloco ou remover elementos desnecessários? Você pode fazer tudo isso em nosso editor visual
					</Text>
					<Link
						color="--white"
						text-decoration-line="initial"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Qualquer que seja o plano do uKit que você esteja usando, você pode fazer o upload de um número ilimitado de arquivos e criar qualquer número de páginas. Você pode adicionar qualquer elemento ao seu site: imagens, vídeos, texto e outros arquivos. Existem widgets prontos para criar galerias, sliders, blocos com resenhas, cronogramas, listas de preços, cartões de produtos e muito mais. O céu é o limite!
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você não precisará fazer nada para configurar a versão móvel do site. Você pode ocultar elementos desnecessários e alterar as configurações de design (imagem de fundo, cor, grade, etc.). O construtor faz tudo sozinho, todos os blocos se adaptam automaticamente à resolução da tela do visitante
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Se você não tiver o seu próprio, você pode registrar um novo domínio com qualquer extensão popular no Painel de Controle do uKit. Todas as configurações de DNS necessárias serão feitas automaticamente. Além disso, todos os usuários obtêm certificados SSL gratuitos e os redirecionamentos são configurados automaticamente para que o site seja exibido por HTTPS, o protocolo seguro recomendado por padrão
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode editar seu site o quanto precisar. Com o uKit, você nem precisa lembrar de fazer backups, o sistema faz isso automaticamente. Para finalizar as alterações para os visitantes, basta clicar no botão «Publicar»
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Continue desenvolvendo seu site e atraindo uma nova audiência. E para ajudá-lo a fazer isso, o uKit fornece todas as ferramentas necessárias: soluções de loja online, integrações prontas com CRM, analytics, marketing de e-mail, um assistente de SEO (para verificar se o seu site está pronto para a divulgação) e a possibilidade de adicionar seu site ao Google Search Console com um clique
				</Text>
				<Link
					font="--lead"
					border-style="solid"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Com o uKit, você pode criar qualquer tipo de site de negócios em apenas alguns cliques e sem nenhum conhecimento especial. Os sites ficam com um look profissional e são fáceis de manter, portanto, não há necessidade de contratar especialistas
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					{" "}
					<Link text-decoration-line="initial" href="/lp/pt-br/crie-um-portfolio-de-desenvolvedor" color="--darkL1" hover-color="--primary">
						<Image
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					flex-direction="column"
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/crie-um-site-de-profissional-de-saude" color="--darkL1" hover-color="--primary">
						<Image
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-para-sua-oficina-mecanica" color="--darkL1">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link href="/lp/pt-br/crie-um-portfolio-de-artista" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
			...
			>
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/crie-seu-site-de-consultor-juridico" color="--darkL1" hover-color="--primary">
						<Image
							loading="lazy"
		...
		>
			...
			>
				<Text
					...
					font="--headline1"
				>
					Crie um site com o uKit e obtenha hospedagem ilimitada
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Basta se cadastrar ou fazer login na sua conta e começar a criar seu primeiro projeto. Nenhuma informação de pagamento é necessária. Você recebe um período de avaliação de 14 dias
				</Text>
				<Link
					margin="0px 0px 0px 0px"
					border-width="1px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/hospedagem-com-construtor-de-sites/"} place={"endOfHead"} rawKey={"618949d47201cf80544b2a0f"} />
		</RawHtml>
	</Theme>;
});