...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/quanto-custa-criar-um-site"} />
		<Helmet>
			<title>
				Quanto Custa Criar Um Site? — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Crie um site com suas próprias mãos no uKit, a partir de $2.5 por mês. Não é preciso ter nenhuma habilidade técnica especial. Tudo que você precisa para editar e promover o seu site já se encontra na plataforma! Incluindo também hospedagem ilimitada. Além disso, se você precisa de um site pronto mas não tem tempo de criá-lo sozinho(a), nós podemos fazer isso para você por apenas $100"} />
			<meta property={"og:title"} content={"Quanto Custa Criar Um Site? — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Crie um site com suas próprias mãos no uKit, a partir de $2.5 por mês. Não é preciso ter nenhuma habilidade técnica especial. Tudo que você precisa para editar e promover o seu site já se encontra na plataforma! Incluindo também hospedagem ilimitada. Além disso, se você precisa de um site pronto mas não tem tempo de criá-lo sozinho(a), nós podemos fazer isso para você por apenas $100"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Crie um site com suas próprias mãos no uKit, a partir de $2.5 por mês. Não é preciso ter nenhuma habilidade técnica especial. Tudo que você precisa para editar e promover o seu site já se encontra na plataforma! Incluindo também hospedagem ilimitada. Além disso, se você precisa de um site pronto mas não tem tempo de criá-lo sozinho(a), nós podemos fazer isso para você por apenas $100
				</Text>
				<Link
					color="--white"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Centenas de modelos já prontos
				</Text>
			</Box>
			<Box
				lg-margin="0px 0px 30px 0px"
			...
			>
				...
				<Text font="--lead" margin="0px 0px 0px 0px" color="--darkL1">
					Quantidade ilimitada de páginas e arquivos
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Exemplos De Modelos Temáticos Prontos
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Todos os modelos são modernos, responsivos e completamente gratuitos. Você certamente vai encontrar um que se enquadre ao seu negócio. Você pode alterar o esquema de cores e fontes ou mesmo gerar automaticamente uma versão do site para pessoas com dificuldades visuais. Cada modelo é preenchido com textos e imagens úteis, incluindo os formulários pop-up mais usados. Conecte seu domínio, atualize suas informações de contato e publique o site
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section padding="130px 0 130px 0" lg-padding="100px 0 100px 0" background="--color-secondary" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Editor visual intuitivo. qualquer página pode ser construída a partir de blocos e elementos prontos, arrastando e soltando. Preços acessíveis para empresas e indivíduos
				</Text>
			</Box>
			<Box
				padding="0px 15px 0px 15px"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos e blocos prontos para o uso
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Período de avaliação de 14 dias
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Hospedagem ilimitada em cada plano
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integração já pronta com serviços de CRM, chat, e-mail marketing e muito mais
					</Text>
				</Box>
				<Box
					flex-direction="column"
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Todos os recursos do uKit estão incluídos em seu plano de serviços: modelos prontos, assistente de SEO, uso de domínio próprio e analytics. Com apenas um pouco de tempo e informações básicas, você pode criar seu próprio site, não é preciso nenhum conhecimento técnico especial
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Todos os modelos prontos em nossa biblioteca são totalmente gratuitos. Você pode escolher qualquer um deles e alterar o esquema de cores, fontes, imagem de fundo e outros parâmetros do design. Sem opções adicionais pagas, tudo incluso
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						border-width="1px"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você tem acesso imediato a todos os blocos e widgets essenciais em qualquer plano: chats ao vivo, banners, galerias, contadores, formulários de contato, listas de preços, cronogramas, avaliações de clientes e muito mais. Basta arrastar e soltar cada elemento e personalizá-lo. Alguns planos dão acesso a Widgets especiais como o editor de código HTML e loja online
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Todos os modelos e blocos prontos são responsivos, ou seja, seu site ficará perfeito em qualquer dispositivo. Até as imagens são carregadas automaticamente na resolução necessária, otimizando o tráfego e carregando o site o mais rápido possível. É possível ocultar blocos individuais ou mesmo editar o design do site de forma diferente para dispositivo diferentes. Funções avançadas como Lazy Loading e edição de estilo são ativadas com um único clique. Todos esses recursos já estão incluídos em qualquer plano de serviço
					</Text>
				</Box>
				<Box display="flex" md-width="100%" width="50%" margin="0px 0px 0px 0px">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Todos os usuários do uKit podem usar nossos domínios sem nenhum custo em seus sites. Você também pode, e deve, usar um domínio personalizado e exclusivo em seu site. Se você ainda não tem um domínio para seu site, você pode registrá-lo no próprio Painel de Controle do uKit a partir de $8.99 por ano. E se você já tem um domínio registrado em outro lugar, você pode usá-lo também! E para facilitar ainda mais, qualquer que seja a opção que você escolher, nós provemos o certificado SSL para seu site de forma gratuita e com configuração automática
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Backups grátis e hospedagem ilimitada
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Edite e publique seu site quantas vezes você quiser. Adicione quantas páginas você precisar. Você tem espaço em disco ilimitado e pode adicionar qualquer número de arquivos ao seu site, independentemente do plano de serviços que estiver usando. Para sua segurança e comodidade, o sistema pode armazenar até 10 backups de seu site. Eles são criados de forma automática ou manual e podem ser restaurados com um clique. Tudo isso está incluído por padrão em qualquer plano uKit
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Loja Online a partir de $6 por mês
					</Text>
					<Text
						color="--dark"
						font="--base"
						...
						margin="0px 0px 24px 0px"
					>
						Aceite pagamentos online, integre um CRM ou serviços de e-mail marketing, defina seus objetivos nas estatísticas do site. Sem limites de produtos, campos nos formulários, códigos promocionais e métodos de envio
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Automatizamos o máximo possível de tarefas, liberando seu tempo. Por exemplo, o assistente SEO te ajudará a verificar se o site já está pronto para publicação e divulgação. Você também pode conectar serviços de estatísticas externos com apenas alguns cliques para analisar as informações sobre os visitantes do seu site
					</Text>
					<Link
						href="https://ukit.com/pt-BR/signUp"
						color="--white"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Sem tempo para lidar com tudo isso? Basta contratar um dos profissionais da agência Divly
				</Text>
				<Link
					text-decoration-line="initial"
					font="--lead"
				...
				>
					Solicite um site pronto para o uso
				</Link>
			</Box>
		</Section>
		<Section
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Nossa plataforma permite que você crie todos os tipos de sites de negócios de forma rápida e sem nenhuma habilidade especial: landing pages, sites promocionais, catálogos, portfólios, blogs corporativos, lojas online, sites para professores, instituições educacionais e outros projetos
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link href="/lp/pt-br/crie-sites-para-advogados" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							margin="0px 0px 18px 0px"
							loading="lazy"
		...
		>
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Crie um site no uKit a partir de $2.5 por mês
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Obtenha um período de teste gratuito de 14 dias com todos os recursos do uKit, incluindo a loja online. Não há necessidade de inserir nenhuma informação pessoal. Adquira um plano do uKit apenas se gostar dos resultados que obter!
				</Text>
				<Link
					text-decoration-line="initial"
					margin="0px 0px 0px 0px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/quanto-custa-criar-um-site/"} place={"endOfHead"} rawKey={"619e9e36d6eb73a50d0f5c51"} />
		</RawHtml>
	</Theme>;
});