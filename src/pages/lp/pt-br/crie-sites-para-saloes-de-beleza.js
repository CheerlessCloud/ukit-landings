...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-sites-para-saloes-de-beleza"} />
		<Helmet>
			<title>
				Crie sites para salões de beleza — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Crie um site fabuloso e amigável por conta própria. O uKit tem tudo o que você precisa e muito mais: um construtor fácil de usar, modelos prontos, hospedagem ilimitada, formulários e notificações, ferramentas especiais de SEO"} />
			<meta property={"og:title"} content={"Crie sites para salões de beleza — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Crie um site fabuloso e amigável por conta própria. O uKit tem tudo o que você precisa e muito mais: um construtor fácil de usar, modelos prontos, hospedagem ilimitada, formulários e notificações, ferramentas especiais de SEO"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Crie um site fabuloso e amigável por conta própria. O uKit tem tudo o que você precisa e muito mais: um construtor fácil de usar, modelos prontos, hospedagem ilimitada, formulários e notificações, ferramentas especiais de SEO
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Exemplos de modelos para salões de beleza
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Não há necessidade de criar o site a partir do zero, é muito mais fácil de começar com um modelo temático pronto. Os esquemas de cores e fontes podem ser alterados depois em alguns cliques. Aí basta conectar seu domínio e publicar o site. Simples assim!
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Com o uKit, você pode construir o seu próprio site para salão de beleza, mesmo que seja sua primeira vez fazendo algo assim. A plataforma é desenvolvida para usuários iniciantes e profissionais. Você não precisará de ajuda de terceiros
				</Text>
			</Box>
			<Box
				justify-content="center"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos elegantes com conteúdo temático
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Tudo que você precisa para apresentar seus serviços de forma profissional
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Aplicando seus próprios filtros no editor de fotos integrado
					</Text>
				</Box>
				<Box
					md-width="100%"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Como criar um site para um salão de beleza no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Quer criar um site lindíssimo sem gastar uma fortuna em desenvolvedores? O que pode ser mais fácil?! Crie uma conta no uKit e comece a criar seu site. Nós te ajudamos em todas as etapas. Muitas das tarefas são automatizadas
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Todos os modelos prontos no catálogo são totalmente gratuitos e não têm restrições. Selecione o que você gosta e personalize. Existem soluções para salões de beleza, cosmetologistas e SPAs
					</Text>
					<Link
						text-decoration-line="initial"
						font="--lead"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 24px 0px" color="--darkL1" font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif">
						Fale para seus clientes sobre você e mostre seu trabalho
					</Text>
					<Text
						width="84%"
						lg-width="100%"
						...
						font="--base"
					>
						Descreva suas habilidades e adicione sua lista de serviços. Apresente sua equipe e dê exemplos do que eles fazem melhor. Mostre onde fica seu salão em um mapa online e mencione os serviços em domicílio, se houver. Adicione uma lista de preços e informações sobre ofertas e descontos especiais. Arraste os blocos para mudar o layout e edite seu conteúdo
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Mude para o modo de visualização e verifique como ficaram suas páginas em todos os tipos de dispositivos. Se necessário, você pode ocultar elementos individuais ou blocos em diferentes tipos de dispositivos: PCs, tablets ou smartphones. Além disso, você pode usar configurações isoladas para cada bloco
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode definir para seu site um endereço bonito e memorável diretamente do Painel de Controle do uKit. Toda as configurações de DNS necessárias são feitas automaticamente. Todos os sites no uKit recebem certificados SSL gratuitos e são acessíveis via HTTPS
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Seu site agora está pronto para seus primeiros visitantes. Após cada atualização ou edições de conteúdo, clique no botão «Publicar» para que as alterações se tornem visíveis para os visitantes. O uKit cria backups automáticos e permite que você crie backups manuais, assim você pode reverter as alterações com um clique
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					É importante sempre melhorar e promover seu site. E nossas ferramentas especiais vão te ajudar com isso: um assistente de SEO, uma seção com estatísticas e analytics, integração com sistemas de mailing e CRM, um assistente para adicionar o site ao Google Search Console, e mais. Você não precisa de nenhuma experiência ou conhecimento especial para usar tudo isso, vários recursos são aplicados automaticamente
				</Text>
				<Link
					border-width="1px"
					border-radius="100px"
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					O uKit permite que você crie rapidamente quase todos os tipos de sites de negócios: landing pages de alta eficiência, portfólios elegantes, sites promocionais e lojas online
				</Text>
			</Box>
			...
			>
				<Box
					...
					display="flex"
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/construtor-de-portfolio" color="--darkL1" hover-color="--primary">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
			...
			>
				<Box
					...
					display="flex"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-para-seu-bar-ou-restaurante">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-de-profissional-de-saude" color="--darkL1">
						<Image
							loading="lazy"
		...
		>
			...
			>
				<Text
					...
					font="--headline1"
				>
					Crie um site para seu salão de beleza com o uKit
				</Text>
				<Text color="--lightD1" text-align="center" margin="0px 0px 36px 0px" font="--lead">
					Confira todos os recursos do uKit e veja por si mesmo como funciona. Obtenha acesso gratuito por 14 dias sem precisar inserir qualquer informação pessoal
				</Text>
				<Link
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-sites-para-saloes-de-beleza/"} place={"endOfHead"} rawKey={"618a5613ac17c117460a630e"} />
		</RawHtml>
	</Theme>;
});