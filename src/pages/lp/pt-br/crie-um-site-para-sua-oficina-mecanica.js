...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-para-sua-oficina-mecanica"} />
		<Helmet>
			<title>
				Crie um site para sua Oficina Mecânica — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"No construtor de sites uKit, você pode não apenas criar um site de alta qualidade para sua oficina mecânica, mas também promovê-lo sem precisar de nenhum profissional de web ou SEO. Rápido, acessível e eficaz"} />
			<meta property={"og:title"} content={"Crie um site para sua Oficina Mecânica — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"No construtor de sites uKit, você pode não apenas criar um site de alta qualidade para sua oficina mecânica, mas também promovê-lo sem precisar de nenhum profissional de web ou SEO. Rápido, acessível e eficaz"} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Crie um site para sua Oficina Mecânica
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					No construtor de sites uKit, você pode não apenas criar um site de alta qualidade para sua oficina mecânica, mas também promovê-lo sem precisar de nenhum profissional de web ou SEO. Rápido, acessível e eficaz
				</Text>
				<Link
					color="--white"
		...
		<Section lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Exemplos de modelos de sites de oficinas
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Todos os modelos do catálogo vêm com conteúdo relevante ao tema, para que você não precise refazer todo o texto. Você só precisa atualizar suas informações de contato e adicionar seu domínio
				</Text>
			</Box>
			<Box
				align-items="flex-start"
			...
			>
				...
				<Image
					...
					sm-right="-11px"
				/>
				<Image border-radius="18px" sm-border-radius="6px" loading="lazy" src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/new_autolaw_en.webp?v=2021-09-29T12:17:58.595Z" />
			</Box>
			<Box
				align-items="center"
				position="relative"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					Ao encomendar um site pronto, você tem que pagar pelo trabalho de vários profissionais. Com o uKit, você obtém um serviço que se adapta ao seu negócio. Tudo está pronto e praticamente configurado, então tudo que você precisa fazer é dar os toques finais no site você mesmo
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos prontos para oficinas mecânicas
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formulários de pedidos e contato já prontos
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Número ilimitado de páginas e arquivos
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Como criar um site para sua oficina mecânica com o uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Com o uKit, a curva de aprendizado é mínima. Você pode facilmente criar e configurar seu site, mesmo que seja sua primeira vez. Tudo é automatizado, então qualquer um consegue
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Modelos com estrutura de página e conteúdo já prontos, você só precisa escolher a opção mais adequada e configurá-la para torná-la só sua. Todos os elementos de página no construtor podem ser editados, excluídos, duplicados e movidos. Você também pode alterar os esquemas de cores, fontes e imagens de fundo
					</Text>
					<Link
						border-style="solid"
						border-color="--color-secondary"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Conte a seus clientes em potencial sobre você e o que você pode fazer por eles. Mostre a localização da sua oficina mecânica no mapa online (mesmo que tenha várias lojas). Carregue sua lista de preços e não se esqueça de compartilhar ofertas e promoções. No uKit, o número de páginas e o espaço em disco são ilimitados, então você pode criar uma página separada para cada serviço e incluir uma descrição detalhada com preços, fotos e vídeos
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Todas as páginas do seu novo site ficam bem em telas de qualquer tamanho. Você pode ocultar seções ou elementos especificos em determinados tipos de dispositivo ou alterar seus parâmetros de design: cor, imagem de fundo, layout da grade (por exemplo, em tablets, os widgets podem ser organizados em uma ou duas colunas)
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						O uKit oferece aos seus clientes domínios gratuitos que podem ser parcialmente personalizados e gera automaticamente certificados SSL (para trabalhar com o protocolo HTTPS, mais seguro). Mas se você deseja aumentar sua credibilidade e fidelização de clientes, registre um nome de domínio exclusivo. Você pode fazer isso no Painel de Controle do seu site
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Clique em «Publicar» e o site está pronto para seus primeiros visitantes. Altere o conteúdo atual, adicione novas informações, remova informações irrelevantes. Não há limites. Você pode fazer backups para retornar a uma versão anterior do site a qualquer momento. O sistema de backup do uKit não tem custo extra, tudo está incluído!
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Por fim, adicione o site ao Google Search Console para que ele seja indexado. Antes disso, não se esqueça de verificar se o seu site está pronto para a divulgação com o assistente especial de SEO. A maioria das opções, incluindo a conexão com o Analytics, é configurada com apenas alguns cliques. Se necessário, você pode conectar outros serviços como o Google Tag Manager, Facebook Pixel e muito mais
				</Text>
				<Link
					background="--color-secondary"
					display="inline"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					O uKit é o construtor perfeito para qualquer tipo de site de negócios. A plataforma permite que você crie e mantenha facilmente páginas de destino, sites promocionais, portfólios e até lojas online
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/construtor-de-landing-pages" color="--darkL1" hover-color="--primary">
						<Image
							width="100%"
							display="flex"
							align-items="center"
			...
			>
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link href="/lp/pt-br/crie-seu-portfolio-de-design-de-interiores" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							width="100%"
							display="flex"
							align-items="center"
						...
						<Text font="--lead" md-margin="0px 0px 30px 0px" margin="0px 0px 0px 0px">
							Crie seu Portfólio de Design de Interiores
						</Text>
					</Link>
				</Box>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-para-sua-instituicao-de-ensino">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead">
							Crie um site para sua Instituição de Ensino
						</Text>
					</Link>
				</Box>
			</Box>
			...
			>
				<Box
					...
					flex-direction="column"
				>
					<Link href="/lp/pt-br/crie-um-portfolio-de-desenvolvedor" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							width="100%"
							display="flex"
							align-items="center"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead" md-margin="0px 0px 30px 0px">
							Crie um portfólio de desenvolvedor
						</Text>
					</Link>
				</Box>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-de-profissional-de-saude">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead">
							Crie um site de profissional de saúde
						</Text>
					</Link>
				</Box>
			</Box>
		...
		>
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Crie o site de sua oficina mecânica no uKit
				</Text>
				<Text font="--lead" color="--lightD1" text-align="center" margin="0px 0px 36px 0px">
					Use quanto tempo precisar para conhecer o serviço. Cada site criado tem 14 dias de avaliação gratuita no uKit. Veja o resultado por si mesmo e decida se o uKit é o ideal para você
				</Text>
				<Link
					border-style="solid"
					border-color="--color-secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-site-para-sua-oficina-mecanica/"} place={"endOfHead"} rawKey={"617ed74ef97a2047fe807c68"} />
		</RawHtml>
	</Theme>;
});