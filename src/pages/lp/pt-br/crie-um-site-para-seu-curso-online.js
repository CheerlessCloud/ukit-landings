...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-para-seu-curso-online"} />
		<Helmet>
			<title>
				Crie um site para seu Curso Online — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Criar seu site com formas de pagamento online integradas? Você não precisa de nenhum profissional da web, você pode fazer isso sozinho. Um número ilimitado de páginas e hospedagem, notificações gratuitas por SMS"} />
			<meta property={"og:title"} content={"Crie um site para seu Curso Online — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Criar seu site com formas de pagamento online integradas? Você não precisa de nenhum profissional da web, você pode fazer isso sozinho. Um número ilimitado de páginas e hospedagem, notificações gratuitas por SMS"} />
		...
		<Section md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" lg-overflow-x="hidden">
			...
			>
				...
				>
					Crie um site para seu Curso Online
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Criar seu site com formas de pagamento online integradas? Você não precisa de nenhum profissional da web, você pode fazer isso sozinho. Um número ilimitado de páginas e hospedagem, notificações gratuitas por SMS
				</Text>
				<Link
					color="--white"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--darkL1" font="--lead" margin="0px 0px 0px 0px">
					Formulários de contato e pedidos prontos
				</Text>
			</Box>
			<Box
				flex-direction="column"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Exemplos de modelos para cursos online
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Modelos temáticos de uma e várias páginas para qualquer empresa. Cada design tem vários esquemas de cores. Selecione e use qualquer um deles
				</Text>
			</Box>
			<Box
				flex-direction="row"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Um construtor de sites moderno e completo que ajuda você a criar qualquer tipo de site usando elementos prontos e widgets. Ferramentas de SEO e serviços externos integrados podem melhorar o desempenho do seu site e atrair novos clientes
				</Text>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos prontos sites de educação
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integração fácil de pagamentos online
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Coleção pronta de formulários de contato (incluindo pop-ups)
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Carregue vídeos e outros arquivos com facilidade
					</Text>
				</Box>
				<Box
					md-width="100%"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Como criar um site para seu curso online
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Qualquer um pode aprender a editar e publicar seu próprio site. Tudo que você precisa é de um pouco de tempo e inspiração. Se você não souber o que fazer, você sempre pode entrar em contato com a equipe de suporte para pedir ajuda
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						A opção mais fácil é selecionar o modelo adequado do catálogo. Eles são todos gratuitos. Depois disso, você pode editar o conteúdo e publicar seu site. Ou você pode usar as configurações avançadas para alterar o esquema de cores e fontes, ou construir seu próprio conjunto de blocos e elementos, etc. Tudo isso pode ser feito sem programadores ou designers — você mesmo faz sozinho
					</Text>
					<Link
						text-decoration-line="initial"
						border-width="1px"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Descreva seus serviços, preços e vantagens. Com o uKit, você pode adicionar qualquer tipo de conteúdo: arquivos, vídeos, formulários, galerias, resenhas, pop-ups, chats, botões de retorno de chamada e muito mais. Não há limite para o número de páginas ou espaço em disco. Quaisquer alterações em um elemento aparecem na página com apenas alguns cliques
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Seu site está sempre pronto para ser aberto em telefones e tablets. Não há necessidade de qualquer configuração adicional. Se desejar, você pode ocultar alguns elementos e blocos em dispositivos específicos ou alterar seu design (cor e fundo). Você não precisa se preocupar com a velocidade de carregamento ou otimizar imagens para telas pequenas, o sistema faz tudo para você
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Ao criar um site, você pode usar um dos nossos domínios inteiramente grátis. Mas se você precisa de um site de alta qualidade que seja fácil de encontrar na web, é melhor registrar um domínio próprio. Você pode fazer isso diretamente no painel do uKit. A versão HTTPS, mais segura, será configurada automaticamente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Clique em «Publicar» e seu site estará pronto para seus primeiros visitantes. Você pode então continuar adicionando conteúdo, novas páginas, alterar a estrutura... As alterações são aplicadas somente após a republicação do site. Se você fizer algo errado, não se preocupe — você pode reverter para a versão de backup com um clique
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 36px 0px" font="--base" color="--darkL1">
					O assistente integrado de SEO vai te mostrar o que você precisa melhorar em seu site para promovê-lo nos mecanismos de busca. Além disso, você pode adicionar seu site ao Google Search Console e Google Analytics em apenas alguns cliques
				</Text>
				<Link
					margin="0px 0px 0px 0px"
					border-width="1px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Qualquer tipo de site para o seu negócio: portfólios, landing pages, sites promocionais, lojas online, etc. Tudo o que você precisa é nosso construtor online de sites fácil de usar, sem necessidade de conhecimentos ou habilidades especiais
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/construtor-de-landing-pages">
						<Image
							width="100%"
							display="flex"
							align-items="center"
			...
			>
				<Box
					...
					md-width="100%"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-seu-portfolio-de-design-de-interiores" color="--darkL1">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		>
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Crie o site para seu Curso Online no uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Confira os recursos do uKit hoje mesmo. Tudo que você precisa é de um pouco de tempo e sua imaginação. Para cada site que você cria, você tem um período de avaliação gratuito de 14 dias
				</Text>
				<Link
					href="https://ukit.com/pt-BR/signUp"
					text-decoration-line="initial"
		...
		<RawHtml>
			...
			<link href={"/lp/pt-br/crie-um-site-para-seu-curso-online/"} rel={"canonical"} place={"endOfHead"} rawKey={"6189577c5780a3b1ef1386aa"} />
		</RawHtml>
	</Theme>;
});