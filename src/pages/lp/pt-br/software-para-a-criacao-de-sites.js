...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/software-para-a-criacao-de-sites"} />
		<Helmet>
			<title>
				Software para a criação de sites — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"O construtor uKit é muito mais conveniente e fácil de usar do que os programas tradicionais de construção de sites. Você não precisa instalar nada no seu PC ou se preocupar com atualizações do sistema. Nosso editor funciona em qualquer navegador moderno. As páginas são editadas arrastando e soltando blocos já prontos. Hospedagem ilimitada e muitas ferramentas adicionais para divulgação são fornecidas gratuitamente. Temos também integrações com serviços externos, como sistemas de mailing, bem como notificações por SMS de respostas de formulários"} />
			<meta property={"og:title"} content={"Software para a criação de sites — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"O construtor uKit é muito mais conveniente e fácil de usar do que os programas tradicionais de construção de sites. Você não precisa instalar nada no seu PC ou se preocupar com atualizações do sistema. Nosso editor funciona em qualquer navegador moderno. As páginas são editadas arrastando e soltando blocos já prontos. Hospedagem ilimitada e muitas ferramentas adicionais para divulgação são fornecidas gratuitamente. Temos também integrações com serviços externos, como sistemas de mailing, bem como notificações por SMS de respostas de formulários"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					O construtor uKit é muito mais conveniente e fácil de usar do que os programas tradicionais de construção de sites. Você não precisa instalar nada no seu PC ou se preocupar com atualizações do sistema. Nosso editor funciona em qualquer navegador moderno. As páginas são editadas arrastando e soltando blocos já prontos. Hospedagem ilimitada e muitas ferramentas adicionais para divulgação são fornecidas gratuitamente. Temos também integrações com serviços externos, como sistemas de mailing, bem como notificações por SMS de respostas de formulários
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text font="--lead" margin="0px 0px 0px 0px" color="--darkL1">
					Vasta gama de blocos prontos para usar
				</Text>
			</Box>
			<Box
				lg-width="33.33333%"
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Formulários de contato e notificações gratuitas
				</Text>
			</Box>
			<Box
				align-self="flex-start"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Modelos responsivos pré-construídos prontos para o uso, incluindo textos
 com significado, para sites de uma ou várias páginas para qualquer 
empresa. Tudo o que você precisa fazer é publicar na própria hospedagem 
do uKit. Você pode também adquirir um domínio diretamente no Painel de 
Controle do uKit
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--white" margin="0px 0px 30px 0px" font="--base">
					Com o uKit, você pode criar diferentes tipos de site: landing pages, sites promocionais, catálogos e lojas online. E tudo isso pode ser feito sem habilidades de programação ou design — use apenas sua imaginação. O construtor tem uma interface visual bastante intuitiva para que usuários de todos os níveis possam utilizá-lo
				</Text>
			</Box>
			<Box
				display="flex"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Rica biblioteca de designs temáticos
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formulários, galerias, chats ao vivo e muitos outros elementos de interface
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Construtor «arraste e solte» muito fácil de usar
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Notificações grátis via SMS e e-mail
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integrações com CRM, analytics, newsletters já prontas
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Versão HTTPS do site configurada automaticamente
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Como criar um site no uKit
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					O construtor uKit funciona em todos os navegadores modernos e não requer instalação no PC do usuário. A própria plataforma SaaS da empresa, desenvolvida para cargas elevadas, é responsável pela hospedagem dos sites. Você obtém tudo que precisa em um só lugar: editor de páginas, hospedagem, registro de domínio, notificações e integrações com outros serviços
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Não há necessidade de contratar programadores ou web designers, você mesmo pode construir um site. Você pode começar com qualquer modelo temático em nosso catálogo e personalizá-lo usando nosso editor visual com blocos e elementos prontos para seu site
					</Text>
					<Link
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						A hospedagem ilimitada do uKit permite que você crie quantas páginas quiser para o seu site e adicione quantos arquivos precisar. Você pode criar o projeto que mais se adeque ao seu negócio. Você também obtém acesso a elementos importantes de SEO: alt para imagens, metatags (title, description, keywords), código HTML pronto para compartilhar em redes sociais e todos os níveis de cabeçalho (h1, h2, h3, h4)
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Na realidade nenhuma configuração é necessária, todos os sites no uKit já saem prontos para telas de smartphones e tablets. Mas se quiser, você pode configurar parâmetros individuais. Por exemplo, você pode ocultar blocos em dispositivos específicos, configurar o número de colunas na grade para tablets e mudar o esquema de cores em certos tipos de dispositivo. Você pode ativar a opção de «lazy loading» e a otimização automática de imagens (compressão sem perda de qualidade)
					</Text>
				</Box>
				<Box md-width="100%" width="50%" margin="0px 0px 0px 0px" display="flex">
					<Image
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode escolher um das opções gratuitas oferecida pelo sistema, conectar um domínio existente ou registrar o seu próprio diretamente no Painel de Controle do uKit. Com a hospedagem no uKit, o site obtém automaticamente o protocolo HTTPS. Nenhuma configuração adicional é necessária
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Nossa plataforma foi desenvolvida para cargas elevadas e atende perfeitamente a qualquer volume de tráfego sem problemas. Todas as páginas criadas no construtor são publicadas com apenas um clique. Além disso, o sistema faz até 10 backups automáticos do seu site
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text text-align="center" margin="0px 0px 36px 0px" font="--base" color="--darkL1">
					Para facilitar a divulgação do seu site na busca e atrair clientes, desenvolvemos um conjunto de ferramentas especiais: um assistente de SEO (analisa automaticamente todas as páginas e dá recomendações de melhorias), o módulo de loja online (para recebimento de pagamentos online) e a integração com o Google Search Console e Google Analytics com apenas dois cliques
				</Text>
				<Link
					text-decoration-line="initial"
					border-radius="100px"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Você pode fazer qualquer site de negócios com o uKit em apenas alguns cliques. Algumas horas e o site está pronto
				</Text>
			</Box>
			...
			>
				<Box
					...
					display="flex"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-sites-para-professores" color="--darkL1">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					width="50%"
				>
					<Link href="/lp/pt-br/crie-sites-para-saloes-de-beleza" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							loading="lazy"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead">
							Crie sites para salões de beleza
						</Text>
					</Link>
				</Box>
			</Box>
			...
			>
				...
				<Box
					...
					width="50%"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-para-sua-empreiteira">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		>
			...
			>
				<Text
					...
					color="--white"
				>
					Crie um Site com o uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					É hora de ver o uKit em ação. Comece a usar a plataforma gratuitamente: período de avaliação de 14 dias sem nenhuma informação de cartão
				</Text>
				<Link
					href="https://ukit.com/pt-BR/signUp"
					text-decoration-line="initial"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-BR/software-para-a-criacao-de-sites/"} place={"endOfHead"} rawKey={"619eaf31ebfccf160983001e"} />
		</RawHtml>
	</Theme>;
});