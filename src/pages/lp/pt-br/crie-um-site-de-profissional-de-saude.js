...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-de-profissional-de-saude"} />
		<Helmet>
			<title>
				Crie um site de profissional de saúde — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Quer obter mais clientes para seu consultório particular? Crie seu próprio site. Não importa que tipo de profissional de saúde você seja - pediatra, dentista, dermatologista, neurologista ou ortopedista. Com apenas um pouco de tempo e algumas informações, você pode criar seu próprio site de profissional de saúde usando o construtor uKit"} />
			<meta property={"og:title"} content={"Crie um site de profissional de saúde — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Quer obter mais clientes para seu consultório particular? Crie seu próprio site. Não importa que tipo de profissional de saúde você seja - pediatra, dentista, dermatologista, neurologista ou ortopedista. Com apenas um pouco de tempo e algumas informações, você pode criar seu próprio site de profissional de saúde usando o construtor uKit"} />
		...
		<Section md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					Quer obter mais clientes para seu consultório particular? Crie seu próprio site. Não importa que tipo de profissional de saúde você seja — pediatra, dentista, dermatologista, neurologista ou ortopedista. Com apenas um pouco de tempo e algumas informações, você pode criar seu próprio site de profissional de saúde usando o construtor uKit
				</Text>
				<Link
		...
		<Section md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-padding="80px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Exemplos de designs de sites para profissionais de saúde
				</Text>
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Não é preciso criar o site do zero. O uKit fornece centenas de modelos temáticos. Use a pesquisa e selecione a opção de design que você mais gostar. Junto com o modelo, você obtém uma estrutura e conteúdo pronto, ambos fáceis de personalizar
				</Text>
			</Box>
			<Box
				width="33.333%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					A plataforma oferece tudo que você precisa para trabalhar com as páginas do site, bem como todos os recursos extras necessários como hospedagem ilimitada, registro de domínio, ferramentas de SEO, sistema de backup automático, suporte e muito mais
				</Text>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos prontos para sites de profissionais de saúde
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Uma coleção de formulários de contato e retorno de chamada
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Como criar sites para profissionais de saúde no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Você precisará reservar um tempo livre, cerca de 2 horas em um dia de folga ou à noite depois do trabalho. Apenas siga os passos abaixo. Muitas tarefas já são automatizadas e exigem muito pouco da sua atenção
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Recomendamos que você comece com um modelo pronto do catálogo do uKit. Navegue pelas opções e escolha a que você mais gostar. Cores e outras opções de design, incluindo fontes, planos de fundo e efeitos de animação em bloco podem ser alteradas a qualquer momento com apenas alguns cliques
					</Text>
					<Link
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Descreva seus serviços e suas vantagens
					</Text>
					<Text
						color="--dark"
						font="--base"
						...
						margin="0px 0px 24px 0px"
					>
						O principal objetivo do seu site deve ser assegurar aos clientes em potencial que você é um profissional experiente. Mostre seus certificados e documentos, fale um pouco do seu consultório, que lá você tem todo o equipamento necessário, mostre exemplos de seu trabalho e avaliações de pacientes. Tudo é fácil de fazer com os blocos prontos do construtor. Basta arrastar e soltar na página e editar o conteúdo. Nenhuma habilidade de programação ou conhecimento especial são necessários
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Seu site já funciona em dispositivos móveis sem nenhuma configuração especial. Se desejar, você pode definir configurações individuais: ocultar blocos e elementos específicos, alterar a cor ou o fundo apenas para certos tipos de dispositivos ou editar o formato da grade para tablets
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						width="90%"
					>
						Ao criar um site, você pode criar um endereço usando nossas extensões gratuitas. Mas recomendamos adquirir um domínio próprio, de preferência com o nome do seu consultório, pois é melhor para sua reputação e credibilidade perante seus clientes. Você pode fazer isso no próprio Painel de Controle do seu site. A versão HTTPS é conectada automaticamente e está disponível por padrão, sem quaisquer etapas adicionais
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode publicar seu site com um clique. O botão «Publicar» é uma espécie de botão «Salvar», então não se esqueça de clicar nele depois de fazer alterações nas páginas. O uKit faz o backup automático do site e permite que você faça até 10 backups manuais. Você pode voltar para a versão desejada com um único clique
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Adicione o site ao Google Search Console, conecte também o Analytics e monitore a eficácia de seu site online. Se você não tem experiência em promoção de sites, use nosso assistente de SEO, ele lhe dará recomendações sobre como melhorar seu site
				</Text>
				<Link
					border-radius="100px"
					background="--color-secondary"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Crie qualquer site por conta própria, sem programadores ou designers. O uKit é perfeito para criar sites promocionais, portfólios, landing pages, lojas online e outros tipos de sites de negócios
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Crie um site para profissionais de saúde com o uKit
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Explore todos os recursos do uKit e descubra se ele funciona bem para você: um período de avaliação de 14 dias é fornecido gratuitamente para cada novo site!
				</Text>
				<Link
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-site-de-profissional-de-saude/"} place={"endOfHead"} rawKey={"617eba7e1dae00ee7c0ca860"} />
		</RawHtml>
	</Theme>;
});