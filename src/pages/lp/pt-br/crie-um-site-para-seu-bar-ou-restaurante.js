...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-para-seu-bar-ou-restaurante"} />
		<Helmet>
			<title>
				Crie um site para seu bar ou restaurante — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Com o uKit, você pode criar um site profissional, bonito e funcional para seu bar, lanchonete ou restaurante por conta própria. Ele vem com hospedagem ilimitada, notificações gratuitas por SMS e ferramentas de SEO integradas"} />
			<meta property={"og:title"} content={"Crie um site para seu bar ou restaurante — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Com o uKit, você pode criar um site profissional, bonito e funcional para seu bar, lanchonete ou restaurante por conta própria. Ele vem com hospedagem ilimitada, notificações gratuitas por SMS e ferramentas de SEO integradas"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Com o uKit, você pode criar um site profissional, bonito e funcional para seu bar, lanchonete ou restaurante por conta própria. Ele vem com hospedagem ilimitada, notificações gratuitas por SMS e ferramentas de SEO integradas
				</Text>
				<Link
					color="--white"
		...
		<Section lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Exemplos de modelos de sites para bares, restaurantes e lanchonetes
				</Text>
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Os modelos te ajudam a começar a construir seu site, mesmo se você não tiver nenhuma experiência ou conhecimento técnico. Tudo o que você não gostar pode ser facilmente alterado no editor visual. E então basta conectar seu domínio e publicar o site
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section padding="130px 0 130px 0" lg-padding="100px 0 100px 0" background="--color-secondary" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Você não precisa contratar ninguém para manter seu site, projetá-lo ou configurar o SEO. Você mesmo pode fazer tudo isso com o uKit. Existe uma ferramenta especial ou uma solução ideal para cada tarefa
				</Text>
			</Box>
			<Box
				justify-content="center"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Blocos prontos para o menu e galerias
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Editor de fotos integrado com filtros prontos para usar
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Formulário de contato, pedidos e pop-up
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Integração com CRM e notificações gratuitas
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Quantidade ilimitada de páginas e imagens
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Formas de pagamento online integradas
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section color="--darkL1" md-padding="100px 0 20px 0" padding="130px 0 40px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Como criar um site para seu bar, restaurante ou lanchonete no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					O processo de construção do site é bem intuitivo, você não terá que contratar nenhum desenvolvedor profissional. Você só precisa de um pouco de tempo e inspiração. E para não deixar passar nenhum passo importante, siga as instruções abaixo
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Recomendamos começar com um dos modelos prontos em nosso catálogo. Todos eles têm diversos esquemas de cores, fontes e outros parâmetros de design podem ser alterados em alguns cliques. Se você tem sua própria visão do site, pode começar com um modelo em branco e construir seu site usando elementos prontos
					</Text>
					<Link
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1" font="--headline3">
						Fale do seu estabelecimento para os clientes
					</Text>
					<Text
						margin="0px 0px 24px 0px"
						color="--dark"
						...
						lg-width="100%"
					>
						Faça o upload de uma foto ou vídeo do interior do estabelecimento, adicione seu cardápio e os pratos mais populares. Mostre os preços e ofertas especiais. Não se esqueça de apresentar a equipe ou pelo menos o chef. Compartilhe o horário de funcionamento e mostre a localização no Google Maps. Nosso construtor online lhe ajudará a completar todas essas tarefas. Arraste e solte os blocos necessários nas páginas, altere o conteúdo e personalize o design
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Seu site ficará automaticamente perfeito em smartphones e tablets. Mas, se necessário, você pode ocultar ou exibir manualmente elementos ou blocos individuais em diferentes dispositivos, alterando seus parâmetros de design
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Você pode registrar seu domínio personalizado diretamente no Painel de Controle do uKit. Os registros de DNS e as configurações para o uso de HTTPS serão feitos automaticamente. Não quer gastar dinheiro em um domínio? Use um dos domínios gratuitos e personalizáveis oferecidos pelo uKit
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Assim que for publicado, o site se torna acessível na internet. Tudo que você precisa fazer é clicar no botão «Publicar» e todas as suas edições serão salvas. Não tenha medo de bagunçar ou perder algo: o uKit cria backups do site automaticamente (e mais 10 backups manuais). Você pode reverter para uma versão mais antiga com um clique
					</Text>
				</Box>
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Integre seu site com um CRM, se necessário. Configure notificações instantâneas de formulários para que você possa responder aos clientes rapidamente. Adicione o site ao Google no Painel de Controle do uKit e integre com o Analytics. No uKit, você pode fazer tudo isso em apenas alguns cliques. Nosso assistente especial de SEO ajuda a melhorar a classificação do seu site na pesquisa. Muitos recursos são automatizados
				</Text>
				<Link
					color="--white"
					font="--lead"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Nosso construtor permite que você crie e mantenha quaisquer sites para seus negócios, mesmo sem experiência: sites promocionais, portfólios, landing pages e até mesmo lojas online
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="36px 0px 30px 0px" width="100%" display="flex">
				<Box
					...
					margin="0px 0px 0px 0px"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-sites-para-saloes-de-beleza" color="--darkL1">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
		...
		>
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Crie um site para seu bar ou restaurante com o uKit
				</Text>
				<Text color="--lightD1" text-align="center" margin="0px 0px 36px 0px" font="--lead">
					Quer ver por si mesmo? Você pode experimentar a plataforma gratuitamente por 14 dias. Confira todos os recursos do uKit e veja o que você consegue criar
				</Text>
				<Link
					display="inline"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-site-para-seu-bar-ou-restaurante/"} place={"endOfHead"} rawKey={"618a4c41e658bd023e2315b2"} />
		</RawHtml>
	</Theme>;
});