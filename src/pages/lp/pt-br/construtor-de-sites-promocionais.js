...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/construtor-de-sites-promocionais"} />
		<Helmet>
			<title>
				uKit - construtor de sites promocionais
			</title>
			<meta name={"description"} content={"Crie sites promocionais fabulosos e funcionais com o construtor uKit. Oferecemos um grande número de modelos prontos e responsivos e notificações gratuitas de formulários de feedback. Você mesmo pode criar um site sem gastar com um especialista "} />
			<meta property={"og:title"} content={"uKit - construtor de sites promocionais"} />
			<meta property={"og:description"} content={"Crie sites promocionais fabulosos e funcionais com o construtor uKit. Oferecemos um grande número de modelos prontos e responsivos e notificações gratuitas de formulários de feedback. Você mesmo pode criar um site sem gastar com um especialista "} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Crie sites promocionais fabulosos e funcionais com o construtor uKit. Oferecemos um grande número de modelos prontos e responsivos e notificações gratuitas de formulários de feedback. Você mesmo pode criar um site sem gastar com um especialista
				</Text>
				<Link
					border-style="solid"
					border-radius="100px"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead" width="95%">
					Formulários de contato e botões de retornar chamada
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Notificações gratuitas (SMS e e-mail)
				</Text>
			</Box>
		</Section>
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Exemplos de modelos de Sites Promocionais
				</Text>
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Escolha o modelo que melhor se adapta ao seu negócio. Em nossa biblioteca, você encontrará modelos para advogados, professores, médicos, artistas e muito mais. Você não precisa começar do zero. Você pode alterar os esquemas de cores da maioria dos modelos, bem como fontes, efeitos de animação, planos de fundo e outros parâmetros
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section padding="130px 0 130px 0" lg-padding="100px 0 100px 0" background="--color-secondary" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					uKit — O melhor construtor de sites promocionais
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Você não precisa ter nenhum conhecimento prévio de programação ou design. A plataforma é perfeita para iniciantes. Em apenas uma hora seu site promocional estará pronto. No Painel de Controle você pode até comprar e conectar um domínio, além de conectar o Google Analytics e o Google Search Console. Muitas tarefas são automatizadas e exigem o mínimo de sua atenção
				</Text>
			</Box>
			<Box
				justify-content="center"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Designs prontos para sites promocionais
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Adquira e conecte seu domínio no Painel de Controle
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Integrações com sistemas de CRM, analytics e chats de atendimento
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Como criar um site promocional no uKit
				</Text>
				<Text font="--base" color="--darkL1" margin="0px 0px 0px 0px">
					Tenha certeza de seu sucesso, mesmo que seja sua primeira vez criando um site. O uKit é a ferramenta perfeita para construir landing pages, sites promocionais e outros sites de negócios. Se você tiver dúvidas, pode sempre pedir ajuda de nossos especialistas no suporte técnico
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Você terá acesso a uma rica biblioteca de modelos temáticos em mais de 40 categorias, todos eles já preenchidos com conteúdo relevante que você pode personalizar se necessário. Com alguns cliques, você pode alterar o esquema de cores, fontes, plano de fundo, animação e outros parâmetros, além de refazer a estrutura de blocos e widgets. É moleza!
					</Text>
					<Link
						border-width="1px"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Adicione suas informações de contato: links para redes sociais, mensageiros, número de telefone e e-mail. O bloco com informações de contato pode ser usado em várias páginas, evitando preencher os mesmos dados diversas vezes. Conte aos seus clientes sobre você e seus serviços, adicione listas de preços e outros arquivos, a hospedagem no uKit é ilimitada. Ofereça outras formas de comunicação que podem ser mais convenientes para seus clientes: chat ao vivo, botões de retornar chamada e formulários online. Você receberá notificações por e-mail ou SMS de graça
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Veja por si mesmo como o seu site promocional fica ótimo em todos os dispositivos, sem nenhum esforço extra de sua parte. Tudo pronto e funcionando de forma perfeita. Ainda assim, você pode ocultar alguns blocos em diferentes tipos de dispositivos: tablets, smartphones e PCs
					</Text>
				</Box>
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Todos os usuários do uKit podem usar nossos domínios gratuitamente. Mas se você precisar de um domínio personalizado, pode registrá-lo onde quiser e conectá-lo à nossa hospedagem, ou adquiri-lo no Painel de Controle do uKit, o que é muito mais fácil. Você obtém o certificado SSL gratuitamente e redirecionamento automático para a versão HTTPS do site
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Seu site está pronto! Mostre aos seus clientes suas informações de contato e receba notificações de mensagens e pedidos. Não tenha medo de editar seu site — basta clicar no botão «Publicar» para salvar suas alterações. Se algo der errado, use o sistema de backup: você pode criar até 10 backups manuais, sem mencionar as versões criadas automaticamente
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 36px 0px">
					Use as ferramentas de SEO integradas do uKit para melhorar o desempenho do seu site. Monitore a eficácia do seu site usando sistemas analíticos em mecanismos de busca (Google Search Console). Você pode conectar todas essas ferramentas com alguns cliques
				</Text>
				<Link
					padding="15px 25px 16px 25px"
					border-width="1px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Com o uKit, é fácil administrar um site profissional, landing pages, um portfólio ou uma loja online. Nenhum desses projetos requer habilidades ou conhecimentos especiais
				</Text>
			</Box>
			...
			>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/pt-br/crie-um-site-para-psicologos-ou-psiquiatras-com-o-ukit" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
						...
						<Text font="--lead" md-margin="0px 0px 30px 0px" margin="0px 0px 0px 0px">
							Crie um site para psicólogos ou psiquiatras com o uKit
						</Text>
					</Link>
				</Box>
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-um-site-para-sua-imobiliaria">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
		...
		>
			...
			>
				<Text
					...
					color="--white"
				>
					Conheça o uKit sem compromisso
				</Text>
				<Text color="--lightD1" text-align="center" margin="0px 0px 36px 0px" font="--lead">
					Experimente todos os recursos do uKit gratuitamente e veja por si mesmo se ele é o certo para você
				</Text>
				<Link
					padding="15px 25px 16px 25px"
					border-color="--color-secondary"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/construtor-de-sites-promocionais/"} place={"endOfHead"} rawKey={"6172f61c090214973880705b"} />
		</RawHtml>
	</Theme>;
});