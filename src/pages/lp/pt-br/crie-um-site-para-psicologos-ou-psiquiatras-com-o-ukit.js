...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-site-para-psicologos-ou-psiquiatras-com-o-ukit"} />
		<Helmet>
			<title>
				Crie um site para psicólogos ou psiquiatras com o uKit — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Se você está pensando em criar o seu próprio site, escolha o uKit e não precisará de contratar ninguém para ajudar. É rápido e fácil de usar: construtor intuitivo, modelos prontos e hospedagem ilimitada"} />
			<meta property={"og:title"} content={"Crie um site para psicólogos ou psiquiatras com o uKit — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Se você está pensando em criar o seu próprio site, escolha o uKit e não precisará de contratar ninguém para ajudar. É rápido e fácil de usar: construtor intuitivo, modelos prontos e hospedagem ilimitada"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Se você está pensando em criar o seu próprio site, escolha o uKit e não precisará de contratar ninguém para ajudar. É rápido e fácil de usar: construtor intuitivo, modelos prontos e hospedagem ilimitada
				</Text>
				<Link
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Formulários de contato pré-construídos
				</Text>
			</Box>
			<Box
				lg-width="33.33333%"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Exemplos de modelos para sites de psicólogo ou psiquiatras
				</Text>
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Não sabe por onde começar? Nós trazemos opções prontas com conteúdo funcional. Se eles não forem exatamente o que você está procurando, use nosso intuitivo editor online para alterar o conteúdo. Aí então tudo que você precisa fazer é publicar o site e conectar seu domínio
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Você não precisa ser um gênio da computação ou um web designer profissional. Com o uKit, você pode criar um site arrastando e soltando blocos e widgets prontos para uso. Seu site não só terá uma aparência perfeita, mas também funcionará da maneira que você deseja
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Blocos prontos para descrever seus serviços
					</Text>
				</Box>
				<Box
					padding="0px 20px 0px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formulários prontos para agendar consultas
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Notificações gratuitas por SMS e e-mail
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Widgets de chat e retorno de chamada
					</Text>
				</Box>
				<Box
					lg-width="50%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Crie seu site a partir de sua página nas redes sociais
					</Text>
				</Box>
				<Box
					display="flex"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Como criar um site de psicólogo ou psiquiatra com o uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Qualquer um pode fazer isso, não importa o conhecimento e a experiência que você tenha. Em apenas uma noite e seu site estará pronto. Ele informará seus clientes em potencial sobre você e seus serviços e permitirá que você mostre preços e receba solicitações
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						O catálogo do uKit contém centenas de modelos gratuitos de diferentes assuntos, incluindo opções prontas para psicólogos. Você pode escolher qualquer design e personalizá-lo. As opções como planos de fundo, conjuntos de fontes, esquemas de cores ou efeitos de animação em bloco, podem ser alteradas com alguns cliques. E todas as mudanças são facilmente rastreadas em tempo real
					</Text>
					<Link
						hover-background="linear-gradient(to right,#537cff,#537cff)"
			...
			>
				...
				>
					...
					<Text font="--headline3" md-font="normal 500 26px/32px &quot;Inter&quot;, sans-serif" margin="0px 0px 24px 0px" color="--darkL1">
						Descreva suas qualificações e serviços
					</Text>
					<Text
						font="--base"
						width="84%"
						...
						color="--dark"
					>
						Fale a seus clientes em potencial sobre seus pontos fortes como especialista. Informe sobre o formato da consulta (online ou offline), os preços, bem como onde e como agendar uma sessão. Adicione várias formas de contato como contas de redes sociais, número de telefone, e-mail e chat. O construtor uKit fornece elementos de interface prontos para uso e integrações para qualquer tarefa
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Você não precisa se preocupar se os visitantes vão conseguir visualizar o seu site em dispositivos móveis. Todos os modelos e blocos do uKit são responsivos, as páginas mantêm sua estética e funcionam bem em telefones e tablets. Se necessário, você pode ocultar blocos ou elementos individuais e alterar seus parâmetros de design para tipos de dispositivos específicos
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box margin="40px 0px 40px 0px" width="100%" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Para tornar mais fácil para os clientes lembrarem o endereço do seu site, conecte um nome de domínio exclusivo. Você pode adquirir um novo domínio no Painel de Controle do uKit. Todos os sites da plataforma funcionam com o protocolo HTTPS seguro e os certificados SSL estão disponíveis gratuitamente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						margin="0px 0px 24px 0px"
					>
						Para fazer isso, basta clicar em «Publicar». E não se esqueça de fazer isso sempre que fizer alterações nas páginas. Você não precisa ter medo de fazer algo errado, pois o uKit possui um sistema de backups automáticos e manuais. Você pode reverter para a versão necessária do site com um clique
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 36px 0px" font="--base">
					Não pare agora. Para aumentar a taxa de conversão, você precisa trabalhar com seu site regularmente. Para que isso seja mais prático para você, adicionamos ferramentas especiais de SEO, um assistente para adicionar o site ao Google Search Console e uma oportunidade para integrar analytics ao seu site
				</Text>
				<Link
					font="--lead"
					padding="15px 25px 16px 25px"
		...
		>
			...
			>
				...
				<Text color="--darkL1" text-align="center" margin="0px 0px 0px 0px" font="--base">
					Você pode criar vários tipos de site com apenas alguns cliques em nossa plataforma: landing pages, lojas online, sites promocionais, portfólios e blogs simples
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link href="/lp/pt-br/crie-um-site-para-seu-bar-ou-restaurante" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							justify-content="center"
							border-radius="18px"
							margin="0px 0px 18px 0px"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead">
							Crie um site para seu bar ou restaurante
						</Text>
					</Link>
				</Box>
			</Box>
		...
		>
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Crie um site de psicólogo ou psiquiatra com o uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					Veja você mesmo(a) como o uKit é eficaz. Você não precisa dar nenhuma informação de cartão ou qualquer outra informação pessoal, você sempre tem um período de avaliação de 14 dias
				</Text>
				<Link
					color="--secondary"
					padding="15px 25px 16px 25px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-site-para-psicologos-ou-psiquiatras-com-o-ukit/"} place={"endOfHead"} rawKey={"618967ad06ff7e3a61cc6158"} />
		</RawHtml>
	</Theme>;
});