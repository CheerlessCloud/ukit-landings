...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-seu-site-de-consultor-juridico"} />
		<Helmet>
			<title>
				Crie seu site de consultor jurídico — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Você mesmo pode criar um site bonito, responsivo e funcional. Tudo o que você precisa fazer é usar o uKit. Você não precisa ser um programador ou ter qualquer outra habilidade especial: a plataforma fornece modelos, widgets e outros elementos já prontos, além de um construtor online conveniente e muitos serviços adicionais."} />
			<meta property={"og:title"} content={"Crie seu site de consultor jurídico — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Você mesmo pode criar um site bonito, responsivo e funcional. Tudo o que você precisa fazer é usar o uKit. Você não precisa ser um programador ou ter qualquer outra habilidade especial: a plataforma fornece modelos, widgets e outros elementos já prontos, além de um construtor online conveniente e muitos serviços adicionais."} />
		...
		<Section lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Exemplos de modelos de sites para consultores jurídicos
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Escolha entre uma ampla variedade de designs prontos, adapte-os ao seu site, personalize o conteúdo e adicione suas informações de contato
				</Text>
			</Box>
			<Box
				lg-width="100%"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Os principais recursos para a criação de sites de consultores jurídicos
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					O site pode conter apenas uma página (uma landing page ou site promocional) ou várias, com uma estrutura complexa. Todos os elementos são adicionados em alguns cliques: botões de retorno de chamada, chats online e formulários de contato. Você não precisa de habilidades de programação para trabalhar com o construtor, você pode fazer tudo sozinho em apenas algumas horas
				</Text>
			</Box>
			<Box
				lg-width="100%"
			...
			>
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Conjunto completo dos elementos mais populares
					</Text>
				</Box>
				<Box
					md-width="100%"
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Como criar um site de consultor jurídico no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Mesmo que seja a primeira vez que você usa o uKit, você não precisará de especialistas terceirizados. O processo de construção do site é rápido e descomplicado. Apenas siga os passos abaixo:
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Nosso catálogo de modelos contém centenas de designs prontos de várias categorias, incluindo advocacia. Escolha um e adapte-o às suas necessidades. Os esquemas de cores, as fontes e os efeitos de animação podem ser alterados em alguns cliques. Todas as configurações são feitas no editor visual. Nenhum conhecimento de programação é necessário
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						border-style="solid"
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Um conteúdo original é mais valorizado pelos mecanismos de busca, por isso é uma boa ideia personalizar o conteúdo padrão. Além disso, você poderá descrever suas vantagens e serviços com a maior precisão possível. No construtor, você pode fazer upload de suas fotos e editá-las online (usando filtros), adicionar vídeos, formulários de contato, arquivos e outras mídias, assim como criar um número qualquer de páginas. O editor visual é muito conveniente e a interface fácil de navegar
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você não precisa criar uma versão mobile do site separada, todos os blocos e elementos são responsivos e se adaptam a todos os dispositivos. Você só precisa ter certeza que colocou cada bloco onde você queria e o resto é conosco. Você pode até ocultar blocos individuais ou ajustar a cor e plano de fundo para diferentes dispositivos
					</Text>
				</Box>
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode adquirir seu domínio personalizado no Painel de Controle do uKit. Os registros DNS e certificados SSL são configurados automaticamente para criar a versão HTTPS do seu site
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Quando o seu site estiver pronto para os primeiros visitantes, basta clicar em «Publicar». Você pode continuar editando o conteúdo, adicionando novas páginas e excluindo as antigas. O uKit possui um sistema de backup automático, para que você não perca os dados do seu site
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Não se esqueça de adicionar o site aos mecanismos de busca para que ele comece a ser indexado. Você pode fazer isso com alguns cliques no painel de controle. Se você quiser saber mais sobre seus visitantes, conecte o Google Analytics. Além disso, o uKit possui um assistente de SEO integrado para verificar se o seu site está pronto para a divulgação
				</Text>
				<Link
					background="--color-secondary"
					display="inline"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					O construtor online uKit é um serviço moderno e fácil de usar para criar facilmente qualquer tipo de site por conta própria: sites promocionais, catálogos, landing pages e até lojas online
				</Text>
			</Box>
		...
		>
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Crie seu site de consultor jurídico com o uKit
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					Lance seu site agora mesmo sem fornecer detalhes de pagamento. Período de avaliação gratuito de 14 dias. Você poderá explorar todos os recursos do uKit e descobrir se a plataforma é certa para você
					<Link
		...
		<RawHtml>
			...
			<link href={"/lp/pt-br/crie-seu-site-de-consultor-juridico/"} rel={"canonical"} place={"endOfHead"} rawKey={"615c6a7964d240d94e4df747"} />
		</RawHtml>
	</Theme>;
});