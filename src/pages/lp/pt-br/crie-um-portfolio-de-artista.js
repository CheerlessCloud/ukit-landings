...
import { BsColumns, BsImages, BsEnvelope, BsGear, BsTablet, BsColumnsGutters, BsImage, BsPencil, BsPhone, BsCloud, BsBarChart, BsEnvelopeOpen } from "react-icons/bs";
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-um-portfolio-de-artista"} />
		<Helmet>
			<title>
				Crie um Portfólio de Artista — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Com o uKit, você pode construir um portfólio funcional com um design moderno e uma versão mobile sem nenhuma programação, basta uma noite e sua imaginação"} />
			<meta property={"og:title"} content={"Crie um Portfólio de Artista — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Com o uKit, você pode construir um portfólio funcional com um design moderno e uma versão mobile sem nenhuma programação, basta uma noite e sua imaginação"} />
		...
		<Section padding="84px 0 100px 0" lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" lg-overflow-x="hidden">
			...
			>
				...
				<Text font="--base" color="--dark" margin="0px 0px 30px 0px">
					Com o uKit, você pode construir um portfólio funcional com um design moderno e uma versão mobile sem nenhuma programação, basta uma noite e sua imaginação
				</Text>
				<Link
					background="#4773ff"
					display="inline"
		...
		<Section padding="40px 0 80px 0" lg-overflow-x="hidden">
			...
			>
				...
				/>
				<Text margin="0px 0px 0px 0px" color="--darkL1" font="--lead">
					Galerias e sliders para imagens
				</Text>
			</Box>
			<Box
				lg-width="33.33333%"
		...
		<Section md-padding="40px 0 100px 0" padding="80px 0 183px 0" lg-padding="80px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Exemplos de modelos para Portfólio de Artista
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Você pode escolher qualquer um dos modelos no catálogo. Eles podem ser facilmente redesenhados de acordo com suas necessidades e objetivos. Não há necessidade de editar código-fonte. É moleza!
				</Text>
			</Box>
			<Box
				align-items="flex-start"
		...
		<Section lg-padding="100px 0 100px 0" background="--color-secondary" padding="130px 0 130px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Mesmo que você seja novo na plataforma, você tem a garantia de conseguir criar um site de portfólio de alta qualidade. Não são necessárias habilidades especiais. As páginas são construídas com widgets e blocos prontos, basta arrastar e soltar onde quiser
				</Text>
			</Box>
			<Box
				flex-direction="column"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Modelos prontos especialmente para portfólios
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Galerias e sliders profissionais
					</Text>
				</Box>
				<Box
					margin="0px 0px 42px 0px"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Editor de fotos integrado (com efeitos de animação prontos)
					</Text>
				</Box>
				<Box
					md-width="100%"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Formulários de contato, de retorno de chamada e chat
					</Text>
				</Box>
				<Box
					md-width="100%"
			...
			>
				<Image
					src="https://uploads.quarkly.io/611e3e5f17f5d1001e31a363/images/FireShot%20Capture%20409%20-%20Home%20-%20rdijoko.udo%201.webp?v=2021-10-31T19:28:47.545Z"
					width="100%"
					loading="lazy"
					align-self="auto"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					letter-spacing="-1px"
				>
					Como criar um Portfólio de Artista no uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Basta seguir os passos abaixo e você terá um portfólio em apenas algumas horas. Não se preocupe que algo vai dar errado ou você não vai conseguir. Até iniciantes conseguem com a gente
				</Text>
			</Box>
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						md-width="100%"
					>
						Nosso catálogo está repleto de designs temáticos e universais. Você pode escolher qualquer um que você gostar. Além disso, você pode personalizar cores, fontes, imagens de fundo e outras opções de design
					</Text>
					<Link
						display="inline"
						color="--white"
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Conte-nos sobre você e seu trabalho. E não se esqueça de incluir exemplos. Você pode criar um portfólio de uma ou várias páginas, não há limite para o número de páginas ou elementos. Além disso, o uKit oferece hospedagem ilimitada, para que você possa carregar quantos exemplos da sua arte desejar. E para tornar seu trabalho ainda mais cativante, você pode usar os widgets slider e galeria
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Todos os modelos e blocos do uKit são responsivos, para que seu site fique ótimo em todos os dispositivos. Se necessário, você pode ocultar elementos individuais ou definir blocos com designs alternativos para smartphones e tablets. Por exemplo: cor, imagem de fundo e o número de colunas
					</Text>
				</Box>
			...
			<Box flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%" display="flex">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Você pode adquirir um domínio diretamente no Painel de Controle do uKit. As configurações de DNS são feitas automaticamente para nossa hospedagem. Todos os sites funcionam com o protocolo HTTPS seguro e os certificados SSL são gerados automaticamente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						width="84%"
					>
						Fazer isso nunca foi tão fácil: basta clicar no botão «Publicar» e todas as alterações que você fez estarão disponíveis na versão online do site. Sinta-se à vontade para experimentar, o sistema faz backups automáticos e armazena até 10 versões do site. Você pode reverter o design com um clique
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Adicione seu site aos mecanismos de pesquisa e comece a promovê-lo. Conecte sistemas de análise para registrar ações específicas de seus visitantes no site. Você pode fazer tudo isso no Painel de Controle do uKit. Muitas ferramentas são automatizadas. Por exemplo: o assistente de SEO, que ajuda na promoção
				</Text>
				<Link
					color="--white"
					font="--lead"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					A plataforma é perfeita para criar uma variedade de sites para negócios: páginas de destino, sites promocionais, catálogos, lojas online e muito mais
				</Text>
			</Box>
			...
			>
				<Box
					...
					width="50%"
				>
					<Link color="--darkL1" hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/crie-sites-para-advogados">
						<Image
				...
				<Box
					...
					padding="0px 0px 0px 15px"
				>
					<Link href="/lp/pt-br/crie-seu-site-de-coaching-ou-mentoria" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							loading="lazy"
						...
						/>
						<Text margin="0px 0px 0px 0px" font="--lead">
							Crie seu site de Coaching ou Mentoria
						</Text>
					</Link>
				</Box>
			</Box>
		...
		>
			...
			>
				<Text
					...
					md-font="normal 700 36px/42px &quot;Inter&quot;, sans-serif"
				>
					Crie um Portfólio de Artista com o uKit
				</Text>
				<Text margin="0px 0px 36px 0px" font="--lead" color="--lightD1" text-align="center">
					É hora de conferir o uKit você mesmo: faça uso do período de avaliação de 14 dias para cada novo site. Nenhuma informação de cartão é necessária
				</Text>
				<Link
					margin="0px 0px 0px 0px"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-um-portfolio-de-artista/"} place={"endOfHead"} rawKey={"617ef3d341516409870de2fa"} />
		</RawHtml>
	</Theme>;
});