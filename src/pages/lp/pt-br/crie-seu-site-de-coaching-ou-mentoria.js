...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-seu-site-de-coaching-ou-mentoria"} />
		<Helmet>
			<title>
				Crie seu site de Coaching ou Mentoria — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Modelos temáticos prontos para usar, HTTPS gratuito, conjunto completo de atributos de SEO, hospedagem ilimitada, notificações por SMS de mensagens do seu site e uma interface visual fácil de usar."} />
			<meta property={"og:title"} content={"Crie seu site de Coaching ou Mentoria — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Modelos temáticos prontos para usar, HTTPS gratuito, conjunto completo de atributos de SEO, hospedagem ilimitada, notificações por SMS de mensagens do seu site e uma interface visual fácil de usar."} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text margin="0px 0px 50px 0px" font="--base" color="--dark">
					Modelos temáticos prontos para usar, HTTPS gratuito, conjunto completo de atributos de SEO, hospedagem ilimitada, notificações por SMS de mensagens do seu site e uma interface visual fácil de usar
				</Text>
				<Link
			...
			<Box lg-display="flex" lg-justify-content="center" display="flex" flex-wrap="wrap">
				...
				>
					...
					<Text
						...
						margin="0px 0px 0px 0px"
					>
						Modelos para coaches e mentores
					</Text>
				</Box>
				<Box
					md-width="100%"
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Exemplos de modelos de sites para coaches
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Você pode escolher qualquer um dos modelos disponíveis e editá-lo ao seu gosto. Todos os recursos de que você precisa já estão no sistema, portanto, nenhuma habilidade técnica especial é necessária
				</Text>
			</Box>
			<Box
				flex-direction="row"
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Os principais recursos para a criação de sites de coaches
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--white">
					Um editor intuitivo e conveniente permite que você crie qualquer tipo de página com blocos prontos sem a necessidade de nenhum conhecimento especializado. O site terá uma boa aparência... e funcionará bem. E você poderá fazer tudo sozinho em seu próprio ritmo
				</Text>
			</Box>
			<Box
				justify-content="center"
			...
			>
				...
				>
					...
					/>
					<Text color="--white" font="--lead" margin="0px 0px 0px 0px">
						Hospedagem e quantidade de páginas ilimitadas
					</Text>
				</Box>
				<Box
					display="flex"
				...
				>
					...
					<Text font="--lead" margin="0px 0px 0px 0px" color="--white">
						Formulários prontos e notificações via SMS gratuitas
					</Text>
				</Box>
				<Box
					lg-width="50%"
		...
		<Section padding="130px 0 40px 0" color="--darkL1" md-padding="100px 0 20px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					color="--darkL1"
				>
					Como criar um site de coaching com o uKit
				</Text>
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1">
					Você pode construir seu site de uma só vez, sem nenhuma experiência em programação. Encontre respostas para quaisquer perguntas que você possa ter em nossa base de dados, seção de perguntas frequentes ou com a equipe de apoio ao cliente
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Escolha o modelo de sua preferência: temático, de uma página ou de várias páginas. Todas as cores e fontes podem ser alteradas com apenas alguns cliques. Precisa de mais elementos na página? Basta arrastar e soltar no modo construtor. Você não precisa ser um web designer ou um programador para isso, você pode fazer tudo sozinho
					</Text>
					<Link
						border-style="solid"
						border-radius="100px"
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Usando nossos modelos de sites para coaches, você pode deixar o conteúdo já pré-criado ou substituí-lo com seu próprio conteúdo. Você pode carregar imagens, editar textos, adicionar vídeos e arquivos. Não há limite para o número de páginas ou o espaço em disco. Existem widgets prontos também: galerias, listas de preços, linhas de tempo, depoimentos, chats ao vivo, botões de retorno de chamada e muito mais
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						O construtor adapta automaticamente todas as páginas do site para dispositivos móveis. Mas você pode configurar uma versão especial do menu, alterar os esquemas de cores, ocultar alguns blocos e configurar outros parâmetros para tablets e/ou telefones, se necessário. Fora que seu site irá carregar rapidamente em todos os dispositivos
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
			...
			<Box display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px" width="100%">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						O uKit oferece domínios gratuitos para você usar. Mas para que seu site seja melhor reconhecido e a divulgação seja mais eficiente, é melhor usar um domínio personalizado. Isso pode ser feito diretamente no Painel do uKit. A versão HTTPS do site será configurada automaticamente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Você pode editar o conteúdo, a estrutura e os modelos do site sempre que desejar. E se algo der errado, tudo o que você precisa fazer é restaurar uma versão anterior do backup. O uKit armazena até 10 backups por projeto
					</Text>
				</Box>
				<Box width="50%" margin="0px 0px 0px 0px" display="flex" md-width="100%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					E não se esqueça de verificar se o seu site está pronto para a divulgação com nosso assistente de SEO. Ele mostrará o que você precisa alterar em seu site para obter os melhores resultados nos mecanismos de busca
				</Text>
				<Link
					margin="0px 0px 0px 0px"
					border-width="1px"
		...
		>
			...
			>
				...
				<Text margin="0px 0px 0px 0px" font="--base" color="--darkL1" text-align="center">
					Com nosso construtor, qualquer pessoa pode criar um site de negócios simples com apenas alguns cliques, sem nenhuma habilidade ou conhecimento especial: páginas da web, sites promocionais e portfólios
				</Text>
			</Box>
			...
			>
				...
				<Box
					...
					md-padding="0px 0px 0px 0px"
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/crie-um-site-promocional-para-o-seu-negocio" color="--darkL1" hover-color="--primary">
						<Image
							display="flex"
							align-items="center"
							justify-content="center"
		...
		>
			...
			>
				<Text
					...
					text-align="center"
				>
					Crie um site de coaching no uKit
				</Text>
				<Text color="--lightD1" text-align="center" margin="0px 0px 36px 0px" font="--lead">
					Para experimentar nossa plataforma, cadastre-se no sistema e escolha um dos modelos. Um período de avaliação de 14 dias está disponível gratuitamente
					<Link
						white-space="normal"
						text-indent="0"
						text-overflow="clip"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-seu-site-de-coaching-ou-mentoria/"} place={"endOfHead"} rawKey={"615b1bf9e0da58b40567450a"} />
		</RawHtml>
	</Theme>;
});