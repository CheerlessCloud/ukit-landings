...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"lp/pt-br/crie-seu-portfolio-de-design-de-interiores"} />
		<Helmet>
			<title>
				Crie seu Portfólio de Design de Interiores — uKit. Construtor de sites para empresas
			</title>
			<meta name={"description"} content={"Nunca foi tão fácil fazer isso, basta usar o uKit. Hospedagem ilimitada, modelos prontos e um editor fácil de usar. Você pode lidar com todo o processo sem precisar contratar nenhum web designer."} />
			<meta property={"og:title"} content={"Crie seu Portfólio de Design de Interiores — uKit. Construtor de sites para empresas"} />
			<meta property={"og:description"} content={"Nunca foi tão fácil fazer isso, basta usar o uKit. Hospedagem ilimitada, modelos prontos e um editor fácil de usar. Você pode lidar com todo o processo sem precisar contratar nenhum web designer."} />
		...
		<Section lg-padding="48px 15px 100px 15px" md-padding="60px 15px 50px 15px" padding="84px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				...
				<Text color="--dark" margin="0px 0px 30px 0px" font="--base">
					Nunca foi tão fácil fazer isso, basta usar o uKit. Hospedagem ilimitada, modelos prontos e um editor fácil de usar. Você pode lidar com todo o processo sem precisar contratar nenhum web designer
				</Text>
				<Link
		...
		<Section padding="80px 0 183px 0" lg-padding="80px 0 100px 0" md-padding="40px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					font="--headline1"
				>
					Exemplos de sites de Design de Interiores
				</Text>
				<Text margin="0px 0px 30px 0px" font="--base" color="--dark">
					Um modelo de portfólio pronto para uso requer pouco tempo e esforço para adaptar. A plataforma uKit fornece todas as funcionalidades que você precisa. Mesmo um novato pode lidar com todo o processo de edição
				</Text>
			</Box>
			<Box
		...
		<Section background="--color-secondary" padding="130px 0 130px 0" lg-padding="100px 0 100px 0" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					margin="0px 0px 24px 0px"
				>
					Os principais recursos para sites de design de interiores
				</Text>
				<Text font="--base" color="--white" margin="0px 0px 30px 0px">
					O construtor é fácil de usar, possui blocos prontos e conteúdo relevante. Todas as funcionalidades estão em um só lugar e podem ser configuradas sem editar nenhum código, bastam alguns cliques. Você pode implementar qualquer ideia por conta própria
				</Text>
			</Box>
			<Box
				lg-flex-wrap="wrap"
			...
			>
				...
				>
					...
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Chat e widgets para receber feedback dos visitantes
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Notificações do site via SMS gratuitas
					</Text>
				</Box>
				<Box
					align-items="flex-start"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Blocos prontos para portfólios
					</Text>
				</Box>
				<Box
					flex-direction="column"
				...
				>
					...
					/>
					<Text margin="0px 0px 0px 0px" color="--white" font="--lead">
						Editor de fotos integrado com vários filtros
					</Text>
				</Box>
			</Box>
			<Box
		...
		<Section md-padding="100px 0 20px 0" padding="130px 0 40px 0" color="--darkL1" lg-overflow-x="hidden">
			...
			>
				<Text
					...
					as="h2"
				>
					Como criar um portfólio de Design de Interiores com o uKit
				</Text>
				<Text color="--darkL1" margin="0px 0px 0px 0px" font="--base">
					Não há necessidade de se preocupar se você não tem conhecimentos especiais de web design. O construtor uKit é muito fácil de usar, mesmo que você não tenha nenhuma experiência na criação de sites
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Você pode usar qualquer modelo que atenda aos propósitos do seu futuro site. A qualquer momento você pode trocar o modelo com outro. O esquema de cores e as fontes pode ser alterados de forma centralizada. A estrutura dos blocos é fácil de mudar simplesmente arrastando e soltando. Nenhuma habilidade técnica é necessária, apenas este construtor online conveniente
					</Text>
					<Link
						padding="15px 25px 16px 25px"
						margin="0px 0px 0px 0px"
			...
			>
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Os modelos temáticos trazem conteúdo relevante. Você pode mantê-lo, editá-lo ou substituí-lo completamente, dependendo do que preferir para o seu site. Você pode fazer upload de suas próprias imagens, editá-las online e aplicar filtros, assim como adicionar vídeos, documentos, arquivos e muito mais. Sem limites de estrutura e número de páginas. Além disso, você tem também hospedagem ilimitada
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						color="--dark"
					>
						Se estiver satisfeito com seu recém-criado site, publique-o. O uKit o adapta automaticamente a todos os dispositivos. E ainda assim você pode fazer alterações para cada resolução de tela, se necessário: ocultar alguns elementos, alterar cores ou personalizar um menu especial
					</Text>
				</Box>
			...
			<Box width="100%" display="flex" flex-wrap="wrap" margin="40px 0px 40px 0px">
				...
				>
					...
					<Text
						...
						lg-width="100%"
					>
						Qualquer projeto no uKit pode usar um domínio gratuito. Mas para mostrar seu profissionalismo e obter uma melhor classificação nos mecanismos de busca, é melhor registrar seu próprio domínio. Você pode fazer isso diretamente no painel do uKit. O protocolo HTTPS é configurado automaticamente
					</Text>
				</Box>
			</Box>
			<Box
			...
			>
				...
				>
					...
					<Text
						...
						font="--base"
					>
						Em caso de problemas e erros, o sistema faz backups automáticos do site toda vez que você altera o conteúdo. Assim você não precisa se preocupar em fazer nada de errado. Você pode editar páginas o quanto precisar. Só não se esqueça de clicar no botão «Publicar» para que seus visitantes possam ver as alterações
					</Text>
				</Box>
				<Box margin="0px 0px 0px 0px" display="flex" md-width="100%" width="50%">
					<Image
		...
		>
			...
			>
				...
				<Text margin="0px 0px 36px 0px" font="--base" color="--darkL1" text-align="center">
					Adicione o site aos mecanismos de busca para iniciar sua indexação. Quer mais detalhes sobre o comportamento de seus usuários? Ative a integração com o Google Analytics. Não tem certeza se seu site está pronto para divulgação? Verifique em nosso assistente de SEO. Todos esses recursos já estão integrados ao seu Painel de Controle
				</Text>
				<Link
					margin="0px 0px 0px 0px"
					border-width="1px"
		...
		>
			...
			>
				...
				<Text font="--base" color="--darkL1" text-align="center" margin="0px 0px 0px 0px">
					Nosso construtor online permite que você crie qualquer tipo de site de negócios sem nenhum conhecimento ou habilidade especial. A interface de serviço é desenvolvida com os novatos em mente. Aqui você pode facilmente criar landing pages, sites promocionais, portfólios, catálogos e até lojas online
				</Text>
			</Box>
			<Box width="100%" display="flex" flex-wrap="wrap" margin="36px 0px 30px 0px">
				...
				>
					<Link text-decoration-line="initial" href="/lp/pt-br/crie-seu-site-de-coaching-ou-mentoria" color="--darkL1" hover-color="--primary">
						<Image
							border-radius="18px"
			...
			>
				<Box
					...
					padding="0px 15px 0px 0px"
				>
					<Link href="/lp/pt-br/crie-um-site-para-sua-instituicao-de-ensino" color="--darkL1" hover-color="--primary" text-decoration-line="initial">
						<Image
							align-items="center"
							justify-content="center"
							border-radius="18px"
				...
				<Box
					...
					flex-direction="column"
				>
					<Link hover-color="--primary" text-decoration-line="initial" href="/lp/pt-br/construtor-de-sites-promocionais" color="--darkL1">
						<Image
							loading="lazy"
		...
		>
			...
			>
				<Text
					...
					as="h2"
				>
					Crie um portfólio de design de interiores com o uKit
				</Text>
				<Text text-align="center" margin="0px 0px 36px 0px" font="--lead" color="--lightD1">
					O período de avaliação gratuito de 14 dias permitirá que você experimente todos os recursos do uKit e veja como eles funcionam
					<Link
						text-indent="0"
						text-overflow="clip"
						hyphens="manual"
		...
		<RawHtml>
			...
			<link rel={"canonical"} href={"/lp/pt-br/crie-seu-portfolio-de-design-de-interiores/"} place={"endOfHead"} rawKey={"6159dd49eca9df435759a9f6"} />
		</RawHtml>
	</Theme>;
});